...
- UI direction: Modern Immersive Studio with Terracotta & Sage surfaces, Outfit headings, Figtree body, realistic classroom architecture, a large 3D stage, bottom camera HUD, and right management rail.
...
- Wall decor uses layered acoustic panels, learning-progress modules, an orbit sculpture and an educational gallery, supported by warm terracotta and sage architectural lighting.
