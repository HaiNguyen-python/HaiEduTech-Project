# Cổng thanh toán 20 EUR/năm + mã kích hoạt học sinh nội bộ
...
- **Người học khác**: thanh toán online 20 EUR/năm qua Stripe (thẻ, Apple Pay, Google Pay...). Stripe lo thuế, chống gian lận, khiếu nại cho người mua ở ~80 nước (phí thêm +3,5%/giao dịch, có thể tắt sau).
- **Chuyển khoản Vietcombank**: vẫn giữ, thầy duyệt tay như hiện tại.
- Giáo viên/admin luôn được mở hết.

## Giao diện

- Cửa sổ "Nâng cấp" có 3 lựa chọn: Nhập mã kích hoạt / Thanh toán online 20 EUR / Chuyển khoản VN.
...
2. Tạo sản phẩm "HaiEduTech Premium - 1 năm", 20 EUR, thanh toán một lần mỗi năm (hoặc gói gia hạn tự động hằng năm nếu bạn muốn).
