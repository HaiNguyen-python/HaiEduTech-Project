...
ALTER TABLE public.your_corner_posts DROP CONSTRAINT IF EXISTS your_corner_posts_content_check;
ALTER TABLE public.your_corner_posts ADD CONSTRAINT your_corner_posts_content_check CHECK (char_length(content) >= 0 AND char_length(content) <= 5000);
ALTER TABLE public.your_corner_posts ALTER COLUMN content SET DEFAULT '';
ALTER TABLE public.your_corner_posts ADD COLUMN IF NOT EXISTS image_urls jsonb;
...
AS $function$
  ...
  agg AS (
    SELECT
      b.id, b.user_id, b.content, b.image_url, b.image_urls, b.subject, b.mood, b.visibility, b.created_at, b.poll,
