    ...
    lessons: [
      {
        ...
        vocabulary: [
          { word: "phở", meaning: "soup bún truyền thống", meaningEn: "noodle soup", example: "Phở bò Hà Nội nổi tiếng.", exampleEn: "Hanoi beef pho is famous.", partOfSpeech: "noun" },
          ...
          { word: "ngon", meaning: "có vị tốt", meaningEn: "delicious", example: "Món này rất ngon!", exampleEn: "This is delicious!", partOfSpeech: "adjective" },
          ...
          { word: "ngọt", meaning: "có vị đường", meaningEn: "sweet", example: "Chè rất ngọt.", exampleEn: "Dessert is sweet.", partOfSpeech: "adjective" },
        ],
        quiz: [
    ...
    lessons: [
      {
        ...
        vocabulary: [
          ...
          { word: "bán", meaning: "trao hàng lấy tiền", meaningEn: "to sell", example: "Cửa hàng bán trái cây.", exampleEn: "Shop sells fruit.", partOfSpeech: "verb" },
          { word: "giá", meaning: "số tiền phải trả", meaningEn: "price", example: "Giá bao nhiêu?", exampleEn: "How much?", partOfSpeech: "noun" },
          { word: "mặc cả", meaning: "thương lượng giá", meaningEn: "to bargain", example: "Ở chợ có thể mặc cả.", exampleEn: "You can bargain at market.", partOfSpeech: "verb" },
        ],
        quiz: [
