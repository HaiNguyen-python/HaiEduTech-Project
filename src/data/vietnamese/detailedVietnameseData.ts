...
export const detailedVFFModules: DetailedModule[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  // MODULE 6: Family & Home Life
  // ═══════════════════════════════════════════════════════════
  {
    id: "vff-family",
    title: "Gia đình & Cuộc sống ở nhà",
    titleEn: "Family & Home Life",
    icon: "🏠",
    color: "from-rose-500 to-pink-600",
    description: "Từ vựng và hội thoại để hòa nhập gia đình Việt: thăm hỏi, mời cơm, lễ Tết.",
    descriptionEn: "Vocabulary and dialogues to fit into a Vietnamese family: visiting, sharing meals, and holidays.",
    lessons: [
      {
        id: "vff-family-visit",
        title: "Lần đầu thăm nhà bạn gái/bạn trai Việt Nam",
        titleEn: "First Visit to Your Vietnamese Partner's Family",
        icon: "💐",
        scenario: "Bạn được mời đến nhà bạn gái/bạn trai Việt Nam lần đầu tiên.",
        scenarioEn: "You are invited to your Vietnamese partner's family home for the first time.",
        dialogue: [
          { speaker: "Partner", speakerLabel: "Người yêu", vi: "Hôm nay mình về nhà em nhé. Nhớ mang chút quà cho ba mẹ!", en: "Today we'll go to my home. Remember to bring a small gift for my parents!", literal: "Today self return home younger ok. Remember bring little gift for father mother!", keyWords: [{ word: "ba mẹ", pronunciation: "ba mẹ", meaning: "dad and mom (Southern)", tone: "ngang" }, { word: "quà", pronunciation: "quà", meaning: "gift", tone: "huyen" }] },
          { speaker: "You", speakerLabel: "Bạn", vi: "Mua gì hợp lý nhỉ? Hoa quả được không?", en: "What's appropriate to buy? Are fruits okay?", literal: "Buy what suitable polite-question? Fruit receive not?" },
          { speaker: "Partner", speakerLabel: "Người yêu", vi: "Hoa quả hoặc bánh trái cây. Tránh hoa cúc (chỉ dùng đám tang) nhé!", en: "Fruits or a fruit cake. Avoid chrysanthemums (only for funerals)!", literal: "Fruit or cake fruit. Avoid flower chrysanthemum (only use funeral) ok!", keyWords: [{ word: "tránh", pronunciation: "tránh", meaning: "avoid", tone: "sac" }, { word: "đám tang", pronunciation: "đám tang", meaning: "funeral", tone: "sac" }] },
          { speaker: "You", speakerLabel: "Bạn", vi: "(Đến nhà) Dạ, cháu chào hai bác ạ! Cháu là David.", en: "(Arriving) Hello, sir and ma'am! I'm David.", literal: "(Arrive home) Polite-yes, grandchild greet two uncle-aunt polite! Grandchild is David.", keyWords: [{ word: "cháu", pronunciation: "cháu", meaning: "I (to elders, lit. grandchild)", tone: "sac" }, { word: "bác", pronunciation: "bác", meaning: "uncle/aunt (older than parents)", tone: "sac" }] },
          { speaker: "Mom", speakerLabel: "Mẹ", vi: "Ôi cháu David! Vào nhà đi cháu. Đi đường xa có mệt không?", en: "Oh David dear! Come inside. Was the trip tiring?", literal: "Oh grandchild David! Enter house go grandchild. Go road far have tired not?" },
          { speaker: "You", speakerLabel: "Bạn", vi: "Dạ không mệt ạ. Cháu có chút quà nhỏ biếu hai bác.", en: "Not tired, ma'am. I have a small gift for you both.", literal: "Polite-yes not tired polite. Grandchild have little gift small offer two uncle-aunt.", keyWords: [{ word: "biếu", pronunciation: "biếu", meaning: "to respectfully give (to elders)", tone: "sac" }] },
          { speaker: "Dad", speakerLabel: "Bố", vi: "Cháu khách sáo quá! Ngồi đi cháu, uống nước. Cháu làm nghề gì?", en: "Too polite! Sit down, have some water. What do you do for work?", literal: "Grandchild guest-polite too-much! Sit go grandchild, drink water. Grandchild do profession what?", keyWords: [{ word: "khách sáo", pronunciation: "khách sáo", meaning: "overly formal/polite", tone: "sac" }] },
          { speaker: "You", speakerLabel: "Bạn", vi: "Dạ, cháu là kỹ sư phần mềm ạ. Cháu làm việc ở Hà Nội được 2 năm rồi.", en: "I'm a software engineer, sir. I've been working in Hanoi for 2 years.", literal: "Polite-yes, grandchild is engineer software polite. Grandchild work at Hanoi receive 2 year already.", keyWords: [{ word: "kỹ sư", pronunciation: "kỹ sư", meaning: "engineer", tone: "hoi" }] },
          { speaker: "Mom", speakerLabel: "Mẹ", vi: "Giỏi quá! Ở lại ăn cơm tối với gia đình nhé. Bác nấu canh chua cá lóc.", en: "Excellent! Stay for dinner with the family. I'm cooking sour fish soup.", literal: "Talented too-much! Stay receive eat rice evening with family ok. Aunt cook soup sour fish snakehead.", keyWords: [{ word: "canh chua", pronunciation: "canh chua", meaning: "Vietnamese sour soup", tone: "ngang" }] },
          { speaker: "You", speakerLabel: "Bạn", vi: "Dạ, cháu cảm ơn bác! Cháu rất thích món Việt Nam.", en: "Thank you, ma'am! I love Vietnamese food.", literal: "Polite-yes, grandchild feel-grace aunt! Grandchild very like dish Vietnam." },
        ],
        grammarPoints: [
          {
            pattern: "Cháu + Verb + bác / hai bác",
            patternEn: "'Cháu... bác' - Speaking respectfully to elders",
            explanation: "Khi nói chuyện với người cùng tuổi ba mẹ hoặc lớn hơn, tự xưng 'cháu' và gọi họ là 'bác' (lớn hơn ba mẹ) hoặc 'cô/chú' (nhỏ hơn ba mẹ). Đây là dấu hiệu của sự tôn trọng.",
            explanationEn: "When talking to people the age of your parents or older, refer to yourself as 'cháu' (grandchild) and call them 'bác' (older than parents) or 'cô/chú' (younger than parents). This signals respect.",
            examples: [
              { vi: "Cháu chào bác ạ.", en: "Hello, sir/ma'am.", literal: "Grandchild greet uncle/aunt polite." },
              { vi: "Cháu cảm ơn cô nhiều!", en: "Thank you so much, auntie!", literal: "Grandchild feel-grace aunt much!" },
              { vi: "Dạ, cháu hiểu rồi ạ.", en: "Yes, I understand, sir/ma'am.", literal: "Polite-yes, grandchild understand already polite." },
            ],
          },
          {
            pattern: "Biếu vs Tặng vs Cho",
            patternEn: "'Biếu / Tặng / Cho' - Three ways to give",
            explanation: "'Biếu' = tặng cho người lớn tuổi hơn (lịch sự nhất). 'Tặng' = tặng cho bạn bè, người cùng tuổi. 'Cho' = đưa cho người nhỏ tuổi hơn hoặc thân thiết. Chọn sai sẽ nghe rất kỳ.",
            explanationEn: "'Biếu' = give to elders (most respectful). 'Tặng' = give to friends or peers. 'Cho' = give to younger or close people. Choosing wrong sounds very strange.",
            examples: [
              { vi: "Cháu biếu hai bác chút trà.", en: "I have some tea for you (to elders).", literal: "Grandchild offer two uncle-aunt little tea." },
              { vi: "Mình tặng bạn cuốn sách.", en: "I give you this book (to a friend).", literal: "Self give friend book." },
              { vi: "Mẹ cho em kẹo.", en: "Mom gives candy to little sister.", literal: "Mom give younger candy." },
            ],
          },
        ],
        culturalNotes: [
          {
            title: "Quà cấm kỵ khi thăm nhà người Việt",
            titleEn: "Gift taboos when visiting a Vietnamese home",
            content: "Tránh: hoa cúc (dùng cho tang lễ), đồng hồ (đồng âm 'chia ly'), khăn tay (nghĩa là chia tay), dao kéo (cắt đứt quan hệ), giày dép (đi mất). Nên: hoa quả, bánh, trà, rượu nhập, kẹo bánh cho trẻ em.",
            contentEn: "Avoid: chrysanthemums (used at funerals), clocks (homonym with 'separation'), handkerchiefs (means goodbye), knives/scissors (cutting ties), shoes (walking away). Good choices: fruits, cakes, tea, imported wine, candy for children.",
          },
          {
            title: "Văn hóa mời cơm Việt Nam",
            titleEn: "Vietnamese 'inviting to eat' culture",
            content: "Trước khi ăn, người trẻ phải 'mời' người lớn: 'Con mời ba mẹ ăn cơm', 'Cháu mời ông bà ạ'. Đây là phép lịch sự cơ bản trong mọi gia đình Việt. Nếu là khách, bạn cũng nên nói: 'Cháu mời hai bác ăn cơm ạ' trước khi cầm đũa.",
            contentEn: "Before eating, the youngest 'invites' the elders: 'Con mời ba mẹ ăn cơm' (I invite mom and dad to eat). It's basic etiquette in every Vietnamese family. As a guest, you should also say 'Cháu mời hai bác ăn cơm ạ' before picking up your chopsticks.",
          },
        ],
        practice: {
          type: "fill-blank",
          instruction: "Hoàn thành câu giao tiếp với người lớn tuổi.",
          instructionEn: "Complete sentences for talking with elders.",
          items: [
      ...
      {
        id: "vff-family-meal",
        title: "Bữa cơm gia đình & Mời cơm",
        titleEn: "Family Meals & Inviting to Eat",
        icon: "🥢",
        scenario: "Bạn ngồi vào bàn ăn cùng gia đình Việt và học cách dùng đũa, mời cơm đúng kiểu.",
        scenarioEn: "You sit at the dinner table with a Vietnamese family and learn proper chopstick etiquette and meal greetings.",
        dialogue: [
          { speaker: "Mom", speakerLabel: "Mẹ", vi: "Cả nhà vào bàn đi! Cơm chín rồi.", en: "Everyone come to the table! Rice is ready.", literal: "Whole house enter table go! Rice cooked already.", keyWords: [{ word: "cả nhà", pronunciation: "cả nhà", meaning: "whole family/everyone", tone: "hoi" }] },
          { speaker: "Daughter", speakerLabel: "Con gái", vi: "Con mời ba mẹ ăn cơm. Em mời anh David ăn cơm ạ.", en: "I invite mom and dad to eat. I invite David to eat.", literal: "Child invite father mother eat rice. Younger invite older-brother David eat rice polite." },
          { speaker: "You", speakerLabel: "Bạn", vi: "Cháu mời hai bác và cả nhà ăn cơm ạ!", en: "I invite uncle, auntie, and the whole family to eat!", literal: "Grandchild invite two uncle-aunt and whole house eat rice polite!" },
          { speaker: "Dad", speakerLabel: "Bố", vi: "Ờ, cả nhà ăn đi. David ăn thử món canh chua xem.", en: "Yes, everyone eat. David, try the sour soup.", literal: "Yes, whole house eat go. David eat try dish soup sour see.", keyWords: [{ word: "ăn thử", pronunciation: "ăn thử", meaning: "try eating/taste", tone: "hoi" }] },
        ...
        grammarPoints: [
          {
            pattern: "[Self-pronoun] + mời + [people] + ăn cơm",
            patternEn: "'... mời ... ăn cơm' - The Vietnamese pre-meal greeting",
            explanation: "Trước khi ăn, người nhỏ tuổi mời từng người lớn theo thứ tự từ lớn nhất: ông bà → ba mẹ → anh chị. Khách (như bạn) nên mời cả gia đình một câu chung.",
            explanationEn: "Before eating, the youngest invites elders in order from oldest: grandparents → parents → older siblings. As a guest, you can invite the whole family in one phrase.",
            examples: [
              { vi: "Con mời ông bà ăn cơm.", en: "I invite grandparents to eat.", literal: "Child invite grandfather grandmother eat rice." },
              { vi: "Cháu mời cả nhà ăn cơm ạ.", en: "I invite the whole family to eat.", literal: "Grandchild invite whole house eat rice polite." },
              { vi: "Em mời anh chị ăn cơm.", en: "I invite older brother and sister to eat.", literal: "Younger invite older-brother older-sister eat rice." },
            ],
          },
          {
            pattern: "Vừa + Verb1 + vừa + Verb2",
            patternEn: "'Vừa... vừa...' - Both... and... / Doing two things at once",
            explanation: "Cấu trúc rất phổ biến để miêu tả 2 đặc tính/hành động cùng lúc.",
            explanationEn: "Very common pattern to describe two qualities or actions at the same time.",
            examples: [
              { vi: "Món này vừa ngon vừa rẻ.", en: "This dish is both delicious and cheap.", literal: "Dish this both delicious both cheap." },
              { vi: "Cô ấy vừa hát vừa nhảy.", en: "She is both singing and dancing.", literal: "She both sing both dance." },
              { vi: "Tôi vừa ăn vừa xem TV.", en: "I'm eating while watching TV.", literal: "I both eat both watch TV." },
            ],
          },
        ],
        culturalNotes: [
          {
            title: "Đũa cắm vào cơm = Tang lễ",
            titleEn: "Chopsticks stuck in rice = Funeral imagery",
            content: "Không bao giờ cắm đũa thẳng đứng vào bát cơm! Đó là hình ảnh của bát cơm cúng người chết. Khi nghỉ ăn, hãy đặt đũa song song trên miệng bát hoặc trên bàn. Cũng không gõ đũa vào bát (nghe như ăn xin), không chỉ đũa vào người khác.",
            contentEn: "NEVER stick chopsticks vertically into a rice bowl! That mirrors the offering bowl for the dead at funerals. When resting, lay chopsticks parallel across the bowl rim or on the table. Also: don't tap chopsticks on the bowl (sounds like a beggar), and don't point chopsticks at people.",
          },
          {
      ...
      {
        id: "vff-family-tet",
        title: "Tết Nguyên Đán - Năm mới Việt Nam",
        titleEn: "Tết - Vietnamese Lunar New Year",
        icon: "🧧",
        scenario: "Bạn ăn Tết cùng gia đình Việt Nam và học cách chúc Tết, lì xì.",
        scenarioEn: "You celebrate Tết with a Vietnamese family and learn New Year greetings and 'lucky money' customs.",
        dialogue: [
          { speaker: "Partner", speakerLabel: "Người yêu", vi: "Mai là mùng 1 Tết rồi! Mình dậy sớm đi chúc Tết ông bà nhé.", en: "Tomorrow is the first day of Tết! Let's wake up early to greet grandparents.", literal: "Tomorrow is day-1 Tết already! Self wake up early go wish Tết grandfather grandmother ok.", keyWords: [{ word: "mùng 1", pronunciation: "mùng một", meaning: "the 1st day (of lunar month)", tone: "huyen" }, { word: "chúc Tết", pronunciation: "chúc Tết", meaning: "give Tết wishes", tone: "sac" }] },
          { speaker: "You", speakerLabel: "Bạn", vi: "Mình nên nói gì để chúc Tết hai bác?", en: "What should I say to greet your parents for Tết?", literal: "Self should say what for wish Tết two uncle-aunt?" },
          { speaker: "Partner", speakerLabel: "Người yêu", vi: "Câu kinh điển: 'Chúc hai bác năm mới sức khỏe dồi dào, an khang thịnh vượng, vạn sự như ý!'", en: "The classic: 'Wishing you abundant health, peace and prosperity, all wishes coming true!'", literal: "Sentence classic: 'Wish two uncle-aunt year new health abundant, peace prosperity, ten-thousand thing as wish!'", keyWords: [{ word: "dồi dào", pronunciation: "dồi dào", meaning: "abundant", tone: "huyen" }, { word: "an khang thịnh vượng", pronunciation: "an khang thịnh vượng", meaning: "peace and prosperity", tone: "ngang" }, { word: "vạn sự như ý", pronunciation: "vạn sự như ý", meaning: "may all things go as you wish", tone: "nang" }] },
          { speaker: "You", speakerLabel: "Bạn", vi: "(Tại nhà ông bà) Cháu chúc ông bà năm mới sức khỏe dồi dào, vạn sự như ý ạ!", en: "(At grandparents' home) Wishing you grandpa and grandma a new year of abundant health, all wishes coming true!", literal: "(At house grandfather grandmother) Grandchild wish grandfather grandmother year new health abundant, ten-thousand thing as wish polite!" },
          { speaker: "Grandma", speakerLabel: "Bà", vi: "Ôi cháu giỏi quá! Bà chúc cháu năm mới làm ăn phát đạt, sớm cưới vợ nhé! Đây, bà lì xì cho cháu.", en: "Oh, you speak so well! I wish you a prosperous new year and an early marriage! Here's your lucky money.", literal: "Oh grandchild talented too-much! Grandmother wish grandchild year new do business prosper, early marry wife ok! Here, grandmother lucky-money give grandchild.", keyWords: [{ word: "lì xì", pronunciation: "lì xì", meaning: "lucky money in a red envelope", tone: "huyen" }, { word: "phát đạt", pronunciation: "phát đạt", meaning: "prosperous/thriving", tone: "sac" }] },
          { speaker: "You", speakerLabel: "Bạn", vi: "(Nhận bằng hai tay) Cháu cảm ơn bà nhiều ạ! Cháu cũng có lì xì cho các em nhỏ đây.", en: "(Receives with both hands) Thank you so much, grandma! I also have lucky money for the little ones.", literal: "(Receive with two hand) Grandchild feel-grace grandmother much polite! Grandchild also have lucky-money for plural younger small here.", keyWords: [{ word: "bằng hai tay", pronunciation: "bằng hai tay", meaning: "with both hands (polite)", tone: "ngang" }] },
          { speaker: "Kid", speakerLabel: "Em nhỏ", vi: "Cháu chúc chú năm mới hay ăn chóng lớn... À nhầm! Chúc chú vui vẻ ạ!", en: "I wish uncle a new year to eat well and grow fast... oops, wrong! Wishing uncle happiness!", literal: "Grandchild wish uncle year new much eat fast big... oh wrong! Wish uncle joyful polite!" },
          { speaker: "You", speakerLabel: "Bạn", vi: "(Cười) Cảm ơn cháu nhé! Chú lì xì cho cháu đây.", en: "(Laughs) Thank you! Here's lucky money for you.", literal: "(Laugh) Feel-grace grandchild ok! Uncle lucky-money for grandchild here." },
          { speaker: "Mom", speakerLabel: "Mẹ", vi: "Mời mọi người ăn bánh chưng và uống trà nhé. Hôm nay phải kiêng quét nhà đấy!", en: "Everyone, please have bánh chưng and tea. Today we must avoid sweeping the floor!", literal: "Invite every person eat cake square and drink tea ok. Today must avoid sweep house emphasis!", keyWords: [{ word: "bánh chưng", pronunciation: "bánh chưng", meaning: "square sticky rice cake (Tết specialty)", tone: "sac" }] },
        ],
        grammarPoints: [
          {
            pattern: "Chúc + [person] + [wish]",
            patternEn: "'Chúc... + wish' - Giving New Year greetings",
            explanation: "Cấu trúc cố định cho mọi lời chúc. Theo sau là các cụm Hán-Việt cố định mà người Việt ai cũng thuộc lòng.",
            explanationEn: "Fixed pattern for all greetings. Followed by Sino-Vietnamese set phrases every Vietnamese knows by heart.",
            examples: [
              { vi: "Chúc anh năm mới vui vẻ.", en: "Wishing you a happy new year.", literal: "Wish older-brother year new joyful." },
              { vi: "Chúc gia đình an khang thịnh vượng.", en: "Wishing your family peace and prosperity.", literal: "Wish family peace prosperity." },
              { vi: "Chúc bé hay ăn chóng lớn.", en: "Wishing the child to eat well and grow fast.", literal: "Wish little-one much eat fast big." },
            ],
          },
          {
            pattern: "Nhận bằng hai tay",
            patternEn: "'Receiving with both hands' - A non-verbal grammar",
            explanation: "Không phải ngữ pháp nói, nhưng là 'ngữ pháp văn hóa' bắt buộc: khi nhận lì xì, danh thiếp, quà từ người lớn, luôn dùng hai tay. Một tay = thiếu tôn trọng.",
            explanationEn: "Not spoken grammar, but mandatory 'cultural grammar': always receive lucky money, business cards, or gifts from elders with both hands. One hand = disrespectful.",
            examples: [
              { vi: "Cháu nhận lì xì bằng hai tay ạ.", en: "I receive lucky money with both hands.", literal: "Grandchild receive lucky-money with two hand polite." },
              { vi: "Đưa danh thiếp bằng hai tay.", en: "Hand a business card with both hands.", literal: "Give name-card with two hand." },
            ],
          },
        ],
        culturalNotes: [
          {
            title: "3 ngày Tết & các điều kiêng kỵ",
            titleEn: "The first 3 days of Tết & their taboos",
            content: "Mùng 1 thăm họ nội (cha), Mùng 2 thăm họ ngoại (mẹ), Mùng 3 thăm thầy cô. Trong 3 ngày này phải KIÊNG: quét nhà (quét đi tài lộc), làm vỡ chén bát (xui xẻo), cãi nhau (cả năm bất hòa), cho vay tiền (mất lộc), mặc đồ đen/trắng (màu tang). Nên: mặc đỏ/vàng, nói lời tốt đẹp, ăn bánh chưng và mứt Tết.",
            contentEn: "Day 1 visit father's family, Day 2 visit mother's family, Day 3 visit teachers. During these 3 days, AVOID: sweeping (sweeps away luck), breaking dishes (bad omen), arguing (whole year of discord), lending money (loses fortune), wearing black/white (mourning colors). Do: wear red/yellow, speak kind words, eat bánh chưng and Tết jam.",
          },
          {
