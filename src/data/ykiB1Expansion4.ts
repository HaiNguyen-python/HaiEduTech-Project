...
export const B1_READING_EXP4: B1ReadingPassage[] = [
  {
    ...
    timeMinutes: 7,
    textFi:
      "Uutinen: Lumen tulo viivästyy etelässä\n\nTänä vuonna talven alkaminen on ollut erilaista kuin aikaisemmin, sillä lunta on satanut Etelä-Suomessa huomattavasti odotettua vähemmän. Ilmatieteen laitoksen tilastojen mukaan keskilämpötila marraskuussa oli peräti kolme astetta tavallista korkeampi, mikä on estänyt pysyvän lumipeitteen muodostumisen. Lämpimän sään vuoksi luonnossa on edelleen märkää ja mustaa.\n\nTilanne on vaikuttanut moniin eri tavoin. Paikalliset hiihtokeskukset ovat olleet kiireisiä, ja ne ovat joutuneet käynnistämään lumitykit aikaisemmin kuin koskaan ennen, jotta rinteet saataisiin kuntoon matkailijoita varten. Toisaalta monet asukkaat valittavat, että pimeä syksy ilman valkoista lunta tuntuu henkisesti raskaalta ja masentavalta. Kun aurinko ei paista, lumi toisi kaivattua valoa ympäristöön.\n\nKaikki eivät kuitenkaan ole pettyneitä tilanteeseen. Kaupungin työntekijät iloitsevat, koska auraustyöt ovat vähentyneet merkittävästi viime vuosiin verrattuna. Tämän ansiosta kunta säästää rahaa, kun polttoainetta ja työtunteja kuluu vähemmän. Vaikka hiihtäjät odottavat pakkasta, talousarvion kannalta lumeton alkutalvi on ollut positiivinen asia.",
