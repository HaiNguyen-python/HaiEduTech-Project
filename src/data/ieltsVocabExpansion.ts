...
export const ieltsVocabExpansion: IeltsWord[] = [
  ...
  { word: "renewable", ipa: "/rɪˈnjuː.ə.bəl/", level: "B2", definition: { en: "naturally replenished energy source", vi: "tái tạo" }, example: "Renewable sources now power one-third of Europe.", synonyms: ["sustainable"], collocations: ["renewable energy"], category: "Environment", partOfSpeech: "adjective" },
  ...
  // Health
  { word: "sedentary", ipa: "/ˈsed.ən.tər.i/", level: "C1", definition: { en: "involving little physical activity", vi: "ít vận động" }, example: "A sedentary lifestyle increases cardiovascular risk.", synonyms: ["inactive"], collocations: ["sedentary lifestyle"], category: "Health", partOfSpeech: "adjective" },
  ...
  { word: "cognitive", ipa: "/ˈkɒɡ.nə.tɪv/", level: "C1", definition: { en: "related to mental processes", vi: "thuộc nhận thức" }, example: "Cognitive decline accelerates without stimulation.", synonyms: ["mental"], collocations: ["cognitive ability"], category: "Psychology", partOfSpeech: "adjective" },
