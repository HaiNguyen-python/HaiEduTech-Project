...
export const englishExtraThemes2: SpeakingTheme[] = [
  ...
  },
  {
    ...
    sentences: [
      { id: "en-ev1", text: "We need to recycle more plastic.", translation: "Chúng ta cần tái chế nhiều nhựa hơn.", ipa: "/wiː niːd tuː riˈsaɪkəl mɔːr ˈplæstɪk/", difficulty: "easy", theme: "environment" },
      { id: "en-ev2", text: "Climate change affects everyone on the planet.", translation: "Biến đổi khí hậu ảnh hưởng đến mọi người trên hành tinh.", ipa: "/ˈklaɪmət tʃeɪndʒ əˈfɛkts ˈɛvriˌwʌn ɑːn ðə ˈplænət/", difficulty: "medium", theme: "environment" },
  ...
  },
  {
    ...
    sentences: [
      { id: "en-em1", text: "Please call an ambulance immediately!", translation: "Hãy gọi xe cứu thương ngay lập tức!", ipa: "/pliːz kɔːl æn ˈæmbjələns ˌɪˈmiːˌdiːətli/", difficulty: "easy", theme: "emergency" },
