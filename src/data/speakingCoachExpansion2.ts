...
export const englishExtraThemes2: SpeakingTheme[] = [
  {
    ...
    sentences: [
      ...
      { id: "en-tc5", text: "Artificial intelligence is changing the way we work.", translation: "Trí tuệ nhân tạo đang thay đổi cách chúng ta làm việc.", ipa: "/ɑɹtəfɪʃəl ɪntɛləʤəns ɪz ʧeɪnʤɪŋ ðə weɪ wi wərk/", difficulty: "hard", theme: "tech" },
      ...
      { id: "en-tc7", text: "Online learning has become essential in modern education.", translation: "Học trực tuyến đã trở thành thiết yếu trong giáo dục hiện đại.", ipa: "/ɔnlaɪn lərnɪŋ hæz bɪkəm ɪsɛnʃəl ɪn mɑdərn ɛʤəkeɪʃən/", difficulty: "hard", theme: "tech" },
    ],
  },
  {
    ...
    sentences: [
      ...
      { id: "en-ev4", text: "Renewable energy sources will replace fossil fuels in the future.", translation: "Các nguồn năng lượng tái tạo sẽ thay thế nhiên liệu hóa thạch trong tương lai.", ipa: "/ɹinuʌbəl ɛnərʤi sɔɹsəz wɪl ɹipleɪs fɑsəl fjuʌlz ɪn ðə ˈfjuːtʃər/", difficulty: "hard", theme: "environment" },
      { id: "en-ev5", text: "Forests provide oxygen and protect biodiversity.", translation: "Rừng cung cấp oxy và bảo vệ đa dạng sinh học.", ipa: "/fɔɹəsts pɹəvaɪd ɑksəʤən ənd pɹətɛkt baɪoʊdaɪvərsəti/", difficulty: "hard", theme: "environment" },
  ...
  },
  {
    ...
    sentences: [
      { id: "en-ed1", text: "I am currently studying business administration.", translation: "Hiện tôi đang học quản trị kinh doanh.", ipa: "/aɪ æm kərʌntli stədiɪŋ bɪznəs ædmɪnɪstɹeɪʃən/", difficulty: "easy", theme: "education" },
      { id: "en-ed2", text: "Group projects help students learn teamwork.", translation: "Bài tập nhóm giúp sinh viên học làm việc nhóm.", ipa: "/gɹup pɹɑʤɛkts hɛlp studənts lərn timwərˌk/", difficulty: "medium", theme: "education" },
      { id: "en-ed3", text: "Studying abroad broadens your perspective on the world.", translation: "Du học mở rộng tầm nhìn về thế giới của bạn.", ipa: "/stədiɪŋ əbɹɔd bɹɔdənz jɔːr pərspɛktɪv ɑːn ðə wərld/", difficulty: "hard", theme: "education" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-em2", text: "Where is the nearest emergency exit?", translation: "Lối thoát hiểm gần nhất ở đâu?", ipa: "/wɛər ɪz ðə nɪɹəst ɪmərʤənsi ɛgzɪt/", difficulty: "easy", theme: "emergency" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-cu3", text: "I really enjoy visiting historical museums abroad.", translation: "Tôi rất thích đi thăm bảo tàng lịch sử ở nước ngoài.", ipa: "/aɪ ɹɪli ɛnʤɔj vɪzətɪŋ hɪstɔɹɪkəl mjuziʌmz əbɹɔd/", difficulty: "medium", theme: "culture" },
