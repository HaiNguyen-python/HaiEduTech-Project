...
export const englishExtraThemes2: SpeakingTheme[] = [
  {
    ...
    sentences: [
      { id: "en-tc1", text: "My phone battery is almost dead.", translation: "Điện thoại tôi sắp hết pin.", ipa: "/majˈ fowˈn bæˈtɚi ɪˈz ɔˈlmowˌst dɛˈd/", difficulty: "easy", theme: "tech" },
      { id: "en-tc2", text: "Could you send me the file by email?", translation: "Bạn gửi file qua email cho tôi nhé?", ipa: "/kʊˈd juˈ sɛˈnd miˈ ðʌ fajˈl bajˈ imejˈl/", difficulty: "easy", theme: "tech" },
      { id: "en-tc3", text: "The Wi-Fi connection here is really slow.", translation: "Wi-Fi ở đây thật sự rất chậm.", ipa: "/ðʌ wifajˈ kʌnɛˈkʃʌn hiˈɹ ɪˈz ɹɪˈli slowˈ/", difficulty: "medium", theme: "tech" },
      { id: "en-tc4", text: "I think we should back up our data regularly.", translation: "Tôi nghĩ chúng ta nên sao lưu dữ liệu thường xuyên.", ipa: "/ajˈ θɪˈŋk wiˈ ʃʊˈd bæˈk ʌˈp awˈɚ dejˈtʌ ɹɛˈgjʌlɚli/", difficulty: "medium", theme: "tech" },
      { id: "en-tc5", text: "Artificial intelligence is changing the way we work.", translation: "Trí tuệ nhân tạo đang thay đổi cách chúng ta làm việc.", ipa: "/ɑˌɹtʌfɪˈʃʌl ɪntɛˈlʌʤʌns ɪˈz ʧejˈnʤɪŋ ðʌ wejˈ wiˈ wɚˈk/", difficulty: "hard", theme: "tech" },
      { id: "en-tc6", text: "Have you tried the new update for this app?", translation: "Bạn đã thử bản cập nhật mới của ứng dụng này chưa?", ipa: "/hæˈv juˈ tɹajˈd ðʌ nuˈ ʌpdejˈt fɔˈɹ ðɪˈs æˈp/", difficulty: "medium", theme: "tech" },
      { id: "en-tc7", text: "Online learning has become essential in modern education.", translation: "Học trực tuyến đã trở thành thiết yếu trong giáo dục hiện đại.", ipa: "/ɔˈnlajˌn lɚˈnɪŋ hæˈz bɪkʌˈm ɪsɛˈnʃʌl ɪn mɑˈdɚn ɛˌʤʌkejˈʃʌn/", difficulty: "hard", theme: "tech" },
    ],
  },
  {
    id: "en-environment", name: "Environment & Nature", nameVi: "Môi trường & Thiên nhiên", icon: "🌳",
    sentences: [
      { id: "en-ev1", text: "We need to recycle more plastic.", translation: "Chúng ta cần tái chế nhiều nhựa hơn.", ipa: "/wiˈ niˈd tuˈ ɹisajˈkʌl mɔˈɹ plæˈstɪk/", difficulty: "easy", theme: "environment" },
      { id: "en-ev2", text: "Climate change affects everyone on the planet.", translation: "Biến đổi khí hậu ảnh hưởng đến mọi người trên hành tinh.", ipa: "/klajˈmʌt ʧejˈnʤ ʌfɛˈkts ɛˈvɹiwʌˌn ɑˈn ðʌ plæˈnʌt/", difficulty: "medium", theme: "environment" },
      { id: "en-ev3", text: "Riding a bike is a great way to reduce pollution.", translation: "Đi xe đạp là cách tuyệt vời để giảm ô nhiễm.", ipa: "/ɹajˈdɪŋ ʌ bajˈk ɪˈz ʌ gɹejˈt wejˈ tuˈ ɹʌduˈs pʌluˈʃʌn/", difficulty: "medium", theme: "environment" },
      { id: "en-ev4", text: "Renewable energy sources will replace fossil fuels in the future.", translation: "Các nguồn năng lượng tái tạo sẽ thay thế nhiên liệu hóa thạch trong tương lai.", ipa: "/ɹinuˈʌbʌl ɛˈnɚʤi sɔˈɹsʌz wɪˈl ɹiˌplejˈs fɑˈsʌl fjuˈʌlz ɪn ðʌ fjuˈʧɚ/", difficulty: "hard", theme: "environment" },
      { id: "en-ev5", text: "Forests provide oxygen and protect biodiversity.", translation: "Rừng cung cấp oxy và bảo vệ đa dạng sinh học.", ipa: "/fɔˈɹʌsts pɹʌvajˈd ɑˈksʌʤʌn ʌnd pɹʌtɛˈkt bajˌowdajvɚˈsʌti/", difficulty: "hard", theme: "environment" },
      { id: "en-ev6", text: "I always carry a reusable water bottle.", translation: "Tôi luôn mang theo bình nước có thể tái sử dụng.", ipa: "/ajˈ ɔˈlwejˌz kæˈɹi ʌ ɹiuˈzʌbʌl wɔˈtɚ bɑˈtʌl/", difficulty: "easy", theme: "environment" },
    ],
  },
  {
    id: "en-education", name: "Education & Study", nameVi: "Giáo dục & Học tập", icon: "🎓",
    sentences: [
      { id: "en-ed1", text: "I am currently studying business administration.", translation: "Hiện tôi đang học quản trị kinh doanh.", ipa: "/ajˈ æˈm kɚˈʌntli stʌˈdiɪŋ bɪˈznʌs ædmɪˌnɪstɹejˈʃʌn/", difficulty: "easy", theme: "education" },
      { id: "en-ed2", text: "Group projects help students learn teamwork.", translation: "Bài tập nhóm giúp sinh viên học làm việc nhóm.", ipa: "/gɹuˈp pɹɑˈʤɛkts hɛˈlp stuˈdʌnts lɚˈn tiˈmwɚˌk/", difficulty: "medium", theme: "education" },
      { id: "en-ed3", text: "Studying abroad broadens your perspective on the world.", translation: "Du học mở rộng tầm nhìn về thế giới của bạn.", ipa: "/stʌˈdiɪŋ ʌbɹɔˈd bɹɔˈdʌnz jɔˈɹ pɚspɛˈktɪv ɑˈn ðʌ wɚˈld/", difficulty: "hard", theme: "education" },
      { id: "en-ed4", text: "Critical thinking is a vital skill in higher education.", translation: "Tư duy phản biện là kỹ năng quan trọng trong giáo dục đại học.", ipa: "/kɹɪˈtɪkʌl θɪˈŋkɪŋ ɪˈz ʌ vajˈtʌl skɪˈl ɪn hajˈɚ ɛˌʤʌkejˈʃʌn/", difficulty: "hard", theme: "education" },
      { id: "en-ed5", text: "I prefer to study in the morning when I feel fresh.", translation: "Tôi thích học vào buổi sáng khi tỉnh táo.", ipa: "/ajˈ pɹʌfɚˈ tuˈ stʌˈdi ɪn ðʌ mɔˈɹnɪŋ wɛˈn ajˈ fiˈl fɹɛˈʃ/", difficulty: "medium", theme: "education" },
      { id: "en-ed6", text: "The library is open until midnight during exam week.", translation: "Thư viện mở cửa đến nửa đêm trong tuần thi.", ipa: "/ðʌ lajˈbɹɛˌɹi ɪˈz owˈpʌn ʌntɪˈl mɪˈdnajˌt dʊˈɹɪŋ ɪgzæˈm wiˈk/", difficulty: "medium", theme: "education" },
    ],
  },
  {
    id: "en-emergency", name: "Emergency & Safety", nameVi: "Khẩn cấp & An toàn", icon: "🚨",
    sentences: [
      { id: "en-em1", text: "Please call an ambulance immediately!", translation: "Hãy gọi xe cứu thương ngay lập tức!", ipa: "/pliˈz kɔˈl æˈn æˈmbjʌlʌns ɪmiˈdiʌtli/", difficulty: "easy", theme: "emergency" },
      { id: "en-em2", text: "Where is the nearest emergency exit?", translation: "Lối thoát hiểm gần nhất ở đâu?", ipa: "/wɛˈɹ ɪˈz ðʌ nɪˈɹʌst ɪmɚˈʤʌnsi ɛˈgzɪt/", difficulty: "easy", theme: "emergency" },
      { id: "en-em3", text: "I lost my passport and credit cards.", translation: "Tôi mất hộ chiếu và thẻ tín dụng.", ipa: "/ajˈ lɔˈst majˈ pæˈspɔˌɹt ʌnd kɹɛˈdʌt kɑˈɹdz/", difficulty: "medium", theme: "emergency" },
      { id: "en-em4", text: "There has been an accident, we need help.", translation: "Có một vụ tai nạn, chúng tôi cần giúp đỡ.", ipa: "/ðɛˈɹ hæˈz bɪˈn æˈn æˈksʌdʌnt wiˈ niˈd hɛˈlp/", difficulty: "medium", theme: "emergency" },
      { id: "en-em5", text: "Stay calm and follow the safety instructions carefully.", translation: "Hãy bình tĩnh và làm theo hướng dẫn an toàn cẩn thận.", ipa: "/stejˈ kɑˈm ʌnd fɑˈlow ðʌ sejˈfti ɪnstɹʌˈkʃʌnz kɛˈɹfʌli/", difficulty: "hard", theme: "emergency" },
    ],
  },
  {
    id: "en-culture", name: "Culture & Festivals", nameVi: "Văn hoá & Lễ hội", icon: "🎭",
    sentences: [
      { id: "en-cu1", text: "Tet is the most important holiday in Vietnam.", translation: "Tết là ngày lễ quan trọng nhất ở Việt Nam.", ipa: "/tɛˈt ɪˈz ðʌ mowˈst ɪmpɔˈɹtʌnt hɑˈlʌdejˌ ɪn viɛˌtnɑˈm/", difficulty: "easy", theme: "culture" },
      { id: "en-cu2", text: "Different cultures have different ways of greeting.", translation: "Các nền văn hoá khác nhau có cách chào khác nhau.", ipa: "/dɪˈfɚʌnt kʌˈlʧɚz hæˈv dɪˈfɚʌnt wejˈz ʌˈv gɹiˈtɪŋ/", difficulty: "medium", theme: "culture" },
      { id: "en-cu3", text: "I really enjoy visiting historical museums abroad.", translation: "Tôi rất thích đi thăm bảo tàng lịch sử ở nước ngoài.", ipa: "/ajˈ ɹɪˈli ɛnʤɔjˈ vɪˈzʌtɪŋ hɪstɔˈɹɪkʌl mjuziˈʌmz ʌbɹɔˈd/", difficulty: "medium", theme: "culture" },
      { id: "en-cu4", text: "Traditional music reflects the soul of a nation.", translation: "Âm nhạc truyền thống phản ánh tâm hồn của một dân tộc.", ipa: "/tɹʌdɪˈʃʌnʌl mjuˈzɪk ɹɪflɛˈkts ðʌ sowˈl ʌˈv ʌ nejˈʃʌn/", difficulty: "hard", theme: "culture" },
      { id: "en-cu5", text: "Respecting local customs is important when you travel.", translation: "Tôn trọng phong tục địa phương rất quan trọng khi du lịch.", ipa: "/ɹispɛˈktɪŋ lowˈkʌl kʌˈstʌmz ɪˈz ɪmpɔˈɹtʌnt wɛˈn juˈ tɹæˈvʌl/", difficulty: "hard", theme: "culture" },
    ],
  },
];
