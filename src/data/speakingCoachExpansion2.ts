...
export const englishExtraThemes2: SpeakingTheme[] = [
  {
    ...
    sentences: [
      { id: "en-tc1", text: "My phone battery is almost dead.", translation: "Điện thoại tôi sắp hết pin.", ipa: "/maɪ foʊn bætəri ɪz ɔlmoʊˌst dɛd/", difficulty: "easy", theme: "tech" },
      { id: "en-tc2", text: "Could you send me the file by email?", translation: "Bạn gửi file qua email cho tôi nhé?", ipa: "/kʊd ju sɛnd mi ðə faɪl baɪ imeɪl/", difficulty: "easy", theme: "tech" },
      { id: "en-tc3", text: "The Wi-Fi connection here is really slow.", translation: "Wi-Fi ở đây thật sự rất chậm.", ipa: "/ðə wifaɪ kʌnɛkʃʌn hiɹ ɪz ɹɪli sloʊ/", difficulty: "medium", theme: "tech" },
      { id: "en-tc4", text: "I think we should back up our data regularly.", translation: "Tôi nghĩ chúng ta nên sao lưu dữ liệu thường xuyên.", ipa: "/aɪ θɪŋk wi ʃʊd bæk ʌp aʊər deɪtʌ ɹɛgjʌlərli/", difficulty: "medium", theme: "tech" },
      { id: "en-tc5", text: "Artificial intelligence is changing the way we work.", translation: "Trí tuệ nhân tạo đang thay đổi cách chúng ta làm việc.", ipa: "/ɑˌɹtʌfɪʃʌl ɪntɛlʌʤʌns ɪz ʧeɪnʤɪŋ ðə weɪ wi wərˈk/", difficulty: "hard", theme: "tech" },
      { id: "en-tc6", text: "Have you tried the new update for this app?", translation: "Bạn đã thử bản cập nhật mới của ứng dụng này chưa?", ipa: "/hæv ju tɹaɪd ðə nu ʌpdeɪt fɔːr ðɪs æp/", difficulty: "medium", theme: "tech" },
      { id: "en-tc7", text: "Online learning has become essential in modern education.", translation: "Học trực tuyến đã trở thành thiết yếu trong giáo dục hiện đại.", ipa: "/ɔnlaɪˌn lərˈnɪŋ hæz bɪkʌm ɪsɛnʃʌl ɪn mɑdərn ɛˌʤʌkeɪʃʌn/", difficulty: "hard", theme: "tech" },
    ],
  },
  {
    id: "en-environment", name: "Environment & Nature", nameVi: "Môi trường & Thiên nhiên", icon: "🌳",
    sentences: [
      { id: "en-ev1", text: "We need to recycle more plastic.", translation: "Chúng ta cần tái chế nhiều nhựa hơn.", ipa: "/wi nid tə ɹisaɪkʌl mɔɹ plæstɪk/", difficulty: "easy", theme: "environment" },
      { id: "en-ev2", text: "Climate change affects everyone on the planet.", translation: "Biến đổi khí hậu ảnh hưởng đến mọi người trên hành tinh.", ipa: "/klaɪmʌt ʧeɪnʤ ʌfɛkts ɛvɹiwʌˌn ɑn ðə plænʌt/", difficulty: "medium", theme: "environment" },
      { id: "en-ev3", text: "Riding a bike is a great way to reduce pollution.", translation: "Đi xe đạp là cách tuyệt vời để giảm ô nhiễm.", ipa: "/ɹaɪdɪŋ ə baɪk ɪz ə gɹeɪt weɪ tə ɹʌdus pʌluʃʌn/", difficulty: "medium", theme: "environment" },
      { id: "en-ev4", text: "Renewable energy sources will replace fossil fuels in the future.", translation: "Các nguồn năng lượng tái tạo sẽ thay thế nhiên liệu hóa thạch trong tương lai.", ipa: "/ɹinuʌbʌl ɛnərʤi sɔɹsʌz wɪl ɹiˌpleɪs fɑsʌl fjuʌlz ɪn ðə fjuʧər/", difficulty: "hard", theme: "environment" },
      { id: "en-ev5", text: "Forests provide oxygen and protect biodiversity.", translation: "Rừng cung cấp oxy và bảo vệ đa dạng sinh học.", ipa: "/fɔɹʌsts pɹʌvaɪd ɑksʌʤʌn ənd pɹʌtɛkt baɪˌoʊdaɪvərˈsʌti/", difficulty: "hard", theme: "environment" },
      { id: "en-ev6", text: "I always carry a reusable water bottle.", translation: "Tôi luôn mang theo bình nước có thể tái sử dụng.", ipa: "/aɪ ɔlweɪˌz kæɹi ə ɹiuzʌbʌl wɔtər bɑtʌl/", difficulty: "easy", theme: "environment" },
    ],
  },
  {
    id: "en-education", name: "Education & Study", nameVi: "Giáo dục & Học tập", icon: "🎓",
    sentences: [
      { id: "en-ed1", text: "I am currently studying business administration.", translation: "Hiện tôi đang học quản trị kinh doanh.", ipa: "/aɪ eɪ ɛm kərˈʌntli stʌdiɪŋ bɪznʌs ædmɪˌnɪstɹeɪʃʌn/", difficulty: "easy", theme: "education" },
      { id: "en-ed2", text: "Group projects help students learn teamwork.", translation: "Bài tập nhóm giúp sinh viên học làm việc nhóm.", ipa: "/gɹup pɹɑʤɛkts hɛlp studʌnts lərˈn timwərˌk/", difficulty: "medium", theme: "education" },
      { id: "en-ed3", text: "Studying abroad broadens your perspective on the world.", translation: "Du học mở rộng tầm nhìn về thế giới của bạn.", ipa: "/stʌdiɪŋ ʌbɹɔd bɹɔdʌnz jɔɹ pərspɛktɪv ɑn ðə wərˈld/", difficulty: "hard", theme: "education" },
      { id: "en-ed4", text: "Critical thinking is a vital skill in higher education.", translation: "Tư duy phản biện là kỹ năng quan trọng trong giáo dục đại học.", ipa: "/kɹɪtɪkʌl θɪŋkɪŋ ɪz ə vaɪtʌl skɪl ɪn haɪər ɛˌʤʌkeɪʃʌn/", difficulty: "hard", theme: "education" },
      { id: "en-ed5", text: "I prefer to study in the morning when I feel fresh.", translation: "Tôi thích học vào buổi sáng khi tỉnh táo.", ipa: "/aɪ pɹʌfərˈ tə stʌdi ɪn ðə mɔɹnɪŋ wɛn aɪ fil fɹɛʃ/", difficulty: "medium", theme: "education" },
      { id: "en-ed6", text: "The library is open until midnight during exam week.", translation: "Thư viện mở cửa đến nửa đêm trong tuần thi.", ipa: "/ðə laɪbɹɛˌɹi ɪz oʊpʌn ʌntɪl mɪdnaɪˌt dʊɹɪŋ ɪgzæm wik/", difficulty: "medium", theme: "education" },
    ],
  },
  {
    id: "en-emergency", name: "Emergency & Safety", nameVi: "Khẩn cấp & An toàn", icon: "🚨",
    sentences: [
      { id: "en-em1", text: "Please call an ambulance immediately!", translation: "Hãy gọi xe cứu thương ngay lập tức!", ipa: "/pliz kɔl æn æmbjʌlʌns ɪmidiʌtli/", difficulty: "easy", theme: "emergency" },
      { id: "en-em2", text: "Where is the nearest emergency exit?", translation: "Lối thoát hiểm gần nhất ở đâu?", ipa: "/wɛɹ ɪz ðə nɪɹʌst ɪmərˈʤʌnsi ɛgzɪt/", difficulty: "easy", theme: "emergency" },
      { id: "en-em3", text: "I lost my passport and credit cards.", translation: "Tôi mất hộ chiếu và thẻ tín dụng.", ipa: "/aɪ lɔst maɪ pæspɔˌɹt ənd kɹɛdʌt kɑɹdz/", difficulty: "medium", theme: "emergency" },
      { id: "en-em4", text: "There has been an accident, we need help.", translation: "Có một vụ tai nạn, chúng tôi cần giúp đỡ.", ipa: "/ðɛɹ hæz bɪn æn æksʌdʌnt wi nid hɛlp/", difficulty: "medium", theme: "emergency" },
      { id: "en-em5", text: "Stay calm and follow the safety instructions carefully.", translation: "Hãy bình tĩnh và làm theo hướng dẫn an toàn cẩn thận.", ipa: "/steɪ kɑm ənd fɑloʊ ðə seɪfti ɪnstɹʌkʃʌnz kɛɹfʌli/", difficulty: "hard", theme: "emergency" },
    ],
  },
  {
    id: "en-culture", name: "Culture & Festivals", nameVi: "Văn hoá & Lễ hội", icon: "🎭",
    sentences: [
      { id: "en-cu1", text: "Tet is the most important holiday in Vietnam.", translation: "Tết là ngày lễ quan trọng nhất ở Việt Nam.", ipa: "/tɛt ɪz ðə moʊst ɪmpɔɹtʌnt hɑlʌdeɪˌ ɪn viɛˌtnɑm/", difficulty: "easy", theme: "culture" },
      { id: "en-cu2", text: "Different cultures have different ways of greeting.", translation: "Các nền văn hoá khác nhau có cách chào khác nhau.", ipa: "/dɪfərʌnt kʌlʧərz hæv dɪfərʌnt weɪz əv gɹitɪŋ/", difficulty: "medium", theme: "culture" },
      { id: "en-cu3", text: "I really enjoy visiting historical museums abroad.", translation: "Tôi rất thích đi thăm bảo tàng lịch sử ở nước ngoài.", ipa: "/aɪ ɹɪli ɛnʤɔjˈ vɪzʌtɪŋ hɪstɔɹɪkʌl mjuziʌmz ʌbɹɔd/", difficulty: "medium", theme: "culture" },
      { id: "en-cu4", text: "Traditional music reflects the soul of a nation.", translation: "Âm nhạc truyền thống phản ánh tâm hồn của một dân tộc.", ipa: "/tɹʌdɪʃʌnʌl mjuzɪk ɹɪflɛkts ðə soʊl əv ə neɪʃʌn/", difficulty: "hard", theme: "culture" },
      { id: "en-cu5", text: "Respecting local customs is important when you travel.", translation: "Tôn trọng phong tục địa phương rất quan trọng khi du lịch.", ipa: "/ɹispɛktɪŋ loʊkʌl kʌstʌmz ɪz ɪmpɔɹtʌnt wɛn ju tɹævʌl/", difficulty: "hard", theme: "culture" },
    ],
  },
];
