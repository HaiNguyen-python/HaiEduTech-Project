...
export const finnishExtraThemes2: SpeakingTheme[] = [
  {
    ...
    sentences: [
      { id: "fi-gr1", text: "Hei, mukava tavata sinut.", translation: "Chào bạn, rất vui được gặp bạn.", difficulty: "easy", theme: "greetings" },
      { id: "fi-gr2", text: "Mitä sinulle kuuluu tänään?", translation: "Hôm nay bạn thế nào?", difficulty: "easy", theme: "greetings" },
      { id: "fi-gr3", text: "Pitkästä aikaa!", translation: "Lâu rồi không gặp!", difficulty: "easy", theme: "greetings" },
      { id: "fi-gr4", text: "Saanko esittäytyä lyhyesti?", translation: "Tôi có thể tự giới thiệu ngắn gọn không?", difficulty: "medium", theme: "greetings" },
      { id: "fi-gr5", text: "Toivottavasti kaikki on hyvin perheessäsi.", translation: "Mong là mọi việc trong gia đình bạn đều ổn.", difficulty: "hard", theme: "greetings" },
    ],
  },
  {
    id: "fi-travel", name: "Matkustaminen", nameVi: "Du lịch", icon: "✈️",
    sentences: [
      { id: "fi-tr1", text: "Missä on rautatieasema?", translation: "Nhà ga tàu ở đâu?", difficulty: "easy", theme: "travel" },
      { id: "fi-tr2", text: "Haluaisin ostaa lipun Helsinkiin.", translation: "Tôi muốn mua vé đi Helsinki.", difficulty: "medium", theme: "travel" },
      { id: "fi-tr3", text: "Onko täällä lähellä hotellia?", translation: "Có khách sạn gần đây không?", difficulty: "medium", theme: "travel" },
      { id: "fi-tr4", text: "Olen kiinnostunut suomalaisesta kulttuurista.", translation: "Tôi quan tâm đến văn hoá Phần Lan.", difficulty: "hard", theme: "travel" },
      { id: "fi-tr5", text: "Millainen sää on huomenna?", translation: "Mai trời thế nào?", difficulty: "easy", theme: "travel" },
    ],
  },
  {
    id: "fi-work", name: "Työ", nameVi: "Công việc", icon: "💼",
    sentences: [
      { id: "fi-wk1", text: "Olen ohjelmistosuunnittelija.", translation: "Tôi là kỹ sư phần mềm.", difficulty: "easy", theme: "work" },
      { id: "fi-wk2", text: "Tänään meillä on kokous kello kaksi.", translation: "Hôm nay chúng tôi họp lúc 2 giờ.", difficulty: "easy", theme: "work" },
      { id: "fi-wk3", text: "Voitko lähettää raportin sähköpostilla?", translation: "Bạn gửi báo cáo qua email được không?", difficulty: "medium", theme: "work" },
      { id: "fi-wk4", text: "Tämän projektin määräaika on ensi viikolla.", translation: "Hạn của dự án này là tuần sau.", difficulty: "hard", theme: "work" },
    ],
  },
  {
    id: "fi-family", name: "Perhe", nameVi: "Gia đình", icon: "👨‍👩‍👧",
    sentences: [
      { id: "fi-fm1", text: "Perheessäni on neljä jäsentä.", translation: "Gia đình tôi có bốn người.", difficulty: "easy", theme: "family" },
      { id: "fi-fm2", text: "Minulla on yksi sisko ja yksi veli.", translation: "Tôi có một chị/em gái và một anh/em trai.", difficulty: "easy", theme: "family" },
      { id: "fi-fm3", text: "Vanhempani asuvat Tampereella.", translation: "Bố mẹ tôi sống ở Tampere.", difficulty: "medium", theme: "family" },
      { id: "fi-fm4", text: "Vietämme paljon aikaa yhdessä viikonloppuisin.", translation: "Chúng tôi dành nhiều thời gian bên nhau vào cuối tuần.", difficulty: "hard", theme: "family" },
    ],
  },
  {
    id: "fi-tech", name: "Teknologia", nameVi: "Công nghệ", icon: "💻",
    sentences: [
      { id: "fi-tc1", text: "Puhelimeni akku on melkein loppu.", translation: "Điện thoại tôi sắp hết pin.", difficulty: "easy", theme: "tech" },
      { id: "fi-tc2", text: "Wifi-yhteys on todella hidas täällä.", translation: "Wi-Fi ở đây rất chậm.", difficulty: "medium", theme: "tech" },
      { id: "fi-tc3", text: "Tekoäly muuttaa työelämää nopeasti.", translation: "AI đang thay đổi nhanh chóng đời sống công việc.", difficulty: "hard", theme: "tech" },
    ],
  },
  {
    id: "fi-culture", name: "Suomalainen kulttuuri", nameVi: "Văn hoá Phần Lan", icon: "🇫🇮",
    sentences: [
      { id: "fi-cu1", text: "Sauna on tärkeä osa suomalaista elämää.", translation: "Sauna là phần quan trọng của đời sống Phần Lan.", difficulty: "medium", theme: "culture" },
      { id: "fi-cu2", text: "Joulu on rauhallinen perhejuhla Suomessa.", translation: "Giáng sinh ở Phần Lan là dịp lễ gia đình yên bình.", difficulty: "medium", theme: "culture" },
      { id: "fi-cu3", text: "Kesäloma on monille suomalaisille tärkein hetki vuodessa.", translation: "Kỳ nghỉ hè là khoảnh khắc quan trọng nhất trong năm với nhiều người Phần Lan.", difficulty: "hard", theme: "culture" },
    ],
  },
];
