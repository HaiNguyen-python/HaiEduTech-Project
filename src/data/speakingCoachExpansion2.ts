...
export const englishExtraThemes2: SpeakingTheme[] = [
  {
    ...
    sentences: [
      { id: "en-tc1", text: "My phone battery is almost dead.", translation: "Điện thoại tôi sắp hết pin.", ipa: "/maɪ foʊn bætəri ɪz ɔlmoʊst dɛd/", difficulty: "easy", theme: "tech" },
      { id: "en-tc2", text: "Could you send me the file by email?", translation: "Bạn gửi file qua email cho tôi nhé?", ipa: "/kʊd juː sɛnd mi ðə faɪl baɪ imeɪl/", difficulty: "easy", theme: "tech" },
      { id: "en-tc3", text: "The Wi-Fi connection here is really slow.", translation: "Wi-Fi ở đây thật sự rất chậm.", ipa: "/ðə wifaɪ kənɛkʃən hɪər ɪz ɹɪli sloʊ/", difficulty: "medium", theme: "tech" },
      { id: "en-tc4", text: "I think we should back up our data regularly.", translation: "Tôi nghĩ chúng ta nên sao lưu dữ liệu thường xuyên.", ipa: "/aɪ θɪŋk wi ʃʊd bæk əp ˈaʊər deɪtə ɹɛgjələrli/", difficulty: "medium", theme: "tech" },
      { id: "en-tc5", text: "Artificial intelligence is changing the way we work.", translation: "Trí tuệ nhân tạo đang thay đổi cách chúng ta làm việc.", ipa: "/ɑɹtəfɪʃəl ɪntɛləʤəns ɪz ʧeɪnʤɪŋ ðə weɪ wi wərˈk/", difficulty: "hard", theme: "tech" },
      { id: "en-tc6", text: "Have you tried the new update for this app?", translation: "Bạn đã thử bản cập nhật mới của ứng dụng này chưa?", ipa: "/hæv juː tɹaɪd ðə nu əpdeɪt fɔːr ðɪs æp/", difficulty: "medium", theme: "tech" },
      { id: "en-tc7", text: "Online learning has become essential in modern education.", translation: "Học trực tuyến đã trở thành thiết yếu trong giáo dục hiện đại.", ipa: "/ɔnlaɪn lərˈnɪŋ hæz bɪkəm ɪsɛnʃəl ɪn mɑdərn ɛʤəkeɪʃən/", difficulty: "hard", theme: "tech" },
    ],
  },
  {
    id: "en-environment", name: "Environment & Nature", nameVi: "Môi trường & Thiên nhiên", icon: "🌳",
    sentences: [
      { id: "en-ev1", text: "We need to recycle more plastic.", translation: "Chúng ta cần tái chế nhiều nhựa hơn.", ipa: "/wi nid tə ɹisaɪkəl mɔɹ plæstɪk/", difficulty: "easy", theme: "environment" },
      { id: "en-ev2", text: "Climate change affects everyone on the planet.", translation: "Biến đổi khí hậu ảnh hưởng đến mọi người trên hành tinh.", ipa: "/klaɪmət ʧeɪnʤ əfɛkts ɛvɹiwən ɑːn ðə plænət/", difficulty: "medium", theme: "environment" },
      { id: "en-ev3", text: "Riding a bike is a great way to reduce pollution.", translation: "Đi xe đạp là cách tuyệt vời để giảm ô nhiễm.", ipa: "/ɹaɪdɪŋ ə baɪk ɪz ə gɹeɪt weɪ tə ɹədus pəluʃən/", difficulty: "medium", theme: "environment" },
      { id: "en-ev4", text: "Renewable energy sources will replace fossil fuels in the future.", translation: "Các nguồn năng lượng tái tạo sẽ thay thế nhiên liệu hóa thạch trong tương lai.", ipa: "/ɹinuˈʌbəl ɛnərʤi sɔɹsəz wɪl ɹipleɪs fɑsəl fjuˈʌlz ɪn ðə ˈfjuːtʃər/", difficulty: "hard", theme: "environment" },
      { id: "en-ev5", text: "Forests provide oxygen and protect biodiversity.", translation: "Rừng cung cấp oxy và bảo vệ đa dạng sinh học.", ipa: "/fɔɹəsts pɹəvaɪd ɑksəʤən ənd pɹətɛkt baɪoʊdaɪvərˈsəti/", difficulty: "hard", theme: "environment" },
      { id: "en-ev6", text: "I always carry a reusable water bottle.", translation: "Tôi luôn mang theo bình nước có thể tái sử dụng.", ipa: "/aɪ ɔlweɪz kæɹi ə ɹiuzəbəl wɔtər bɑtəl/", difficulty: "easy", theme: "environment" },
    ],
  },
  {
    id: "en-education", name: "Education & Study", nameVi: "Giáo dục & Học tập", icon: "🎓",
    sentences: [
      { id: "en-ed1", text: "I am currently studying business administration.", translation: "Hiện tôi đang học quản trị kinh doanh.", ipa: "/aɪ eɪ ɛm kərˈʌntli stədiɪŋ bɪznəs ædmɪnɪstɹeɪʃən/", difficulty: "easy", theme: "education" },
      { id: "en-ed2", text: "Group projects help students learn teamwork.", translation: "Bài tập nhóm giúp sinh viên học làm việc nhóm.", ipa: "/gɹup pɹɑʤɛkts hɛlp studənts lərˈn timwərˌk/", difficulty: "medium", theme: "education" },
      { id: "en-ed3", text: "Studying abroad broadens your perspective on the world.", translation: "Du học mở rộng tầm nhìn về thế giới của bạn.", ipa: "/stədiɪŋ əbɹɔd bɹɔdənz jɔːr pərspɛktɪv ɑːn ðə wərˈld/", difficulty: "hard", theme: "education" },
      { id: "en-ed4", text: "Critical thinking is a vital skill in higher education.", translation: "Tư duy phản biện là kỹ năng quan trọng trong giáo dục đại học.", ipa: "/kɹɪtɪkəl θɪŋkɪŋ ɪz ə vaɪtəl skɪl ɪn haɪər ɛʤəkeɪʃən/", difficulty: "hard", theme: "education" },
      { id: "en-ed5", text: "I prefer to study in the morning when I feel fresh.", translation: "Tôi thích học vào buổi sáng khi tỉnh táo.", ipa: "/aɪ prɪˈfɜːr tə stədi ɪn ðə mɔɹnɪŋ wɛn aɪ fil fɹɛʃ/", difficulty: "medium", theme: "education" },
      { id: "en-ed6", text: "The library is open until midnight during exam week.", translation: "Thư viện mở cửa đến nửa đêm trong tuần thi.", ipa: "/ðə laɪbɹɛɹi ɪz oʊpən əntɪl mɪdnaɪt dʊɹɪŋ ɪgzæm wik/", difficulty: "medium", theme: "education" },
    ],
  },
  {
    id: "en-emergency", name: "Emergency & Safety", nameVi: "Khẩn cấp & An toàn", icon: "🚨",
    sentences: [
      { id: "en-em1", text: "Please call an ambulance immediately!", translation: "Hãy gọi xe cứu thương ngay lập tức!", ipa: "/pliz kɔl ən æmbjələns ɪmidiətli/", difficulty: "easy", theme: "emergency" },
      { id: "en-em2", text: "Where is the nearest emergency exit?", translation: "Lối thoát hiểm gần nhất ở đâu?", ipa: "/wɛər ɪz ðə nɪɹəst ɪmərˈʤənsi ɛgzɪt/", difficulty: "easy", theme: "emergency" },
      { id: "en-em3", text: "I lost my passport and credit cards.", translation: "Tôi mất hộ chiếu và thẻ tín dụng.", ipa: "/aɪ lɔst maɪ pæspɔɹt ənd ˈkrɛdɪt kɑɹdz/", difficulty: "medium", theme: "emergency" },
      { id: "en-em4", text: "There has been an accident, we need help.", translation: "Có một vụ tai nạn, chúng tôi cần giúp đỡ.", ipa: "/ðɛər hæz bɪn ən æksədənt wi nid hɛlp/", difficulty: "medium", theme: "emergency" },
      { id: "en-em5", text: "Stay calm and follow the safety instructions carefully.", translation: "Hãy bình tĩnh và làm theo hướng dẫn an toàn cẩn thận.", ipa: "/steɪ kɑm ənd fɑloʊ ðə seɪfti ɪnstɹəkʃənz kɛɹfəli/", difficulty: "hard", theme: "emergency" },
    ],
  },
  {
    id: "en-culture", name: "Culture & Festivals", nameVi: "Văn hoá & Lễ hội", icon: "🎭",
    sentences: [
      { id: "en-cu1", text: "Tet is the most important holiday in Vietnam.", translation: "Tết là ngày lễ quan trọng nhất ở Việt Nam.", ipa: "/tɛt ɪz ðə moʊst ɪmpɔɹtənt hɑlədeɪ ɪn viɛtnɑm/", difficulty: "easy", theme: "culture" },
      { id: "en-cu2", text: "Different cultures have different ways of greeting.", translation: "Các nền văn hoá khác nhau có cách chào khác nhau.", ipa: "/dɪfərənt kəlʧərz hæv dɪfərənt weɪz əv gɹitɪŋ/", difficulty: "medium", theme: "culture" },
      { id: "en-cu3", text: "I really enjoy visiting historical museums abroad.", translation: "Tôi rất thích đi thăm bảo tàng lịch sử ở nước ngoài.", ipa: "/aɪ ɹɪli ɛnʤɔj vɪzətɪŋ hɪstɔɹɪkəl mjuziˈʌmz əbɹɔd/", difficulty: "medium", theme: "culture" },
      { id: "en-cu4", text: "Traditional music reflects the soul of a nation.", translation: "Âm nhạc truyền thống phản ánh tâm hồn của một dân tộc.", ipa: "/tɹədɪʃənəl mjuzɪk ɹɪflɛkts ðə soʊl əv ə neɪʃən/", difficulty: "hard", theme: "culture" },
      { id: "en-cu5", text: "Respecting local customs is important when you travel.", translation: "Tôn trọng phong tục địa phương rất quan trọng khi du lịch.", ipa: "/ɹispɛktɪŋ loʊkəl kəstəmz ɪz ɪmpɔɹtənt wɛn juː tɹævəl/", difficulty: "hard", theme: "culture" },
    ],
  },
];
