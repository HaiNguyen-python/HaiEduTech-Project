...
export const englishExtraThemes: SpeakingTheme[] = [
  {
    ...
    sentences: [
      ...
      { id: "en-rs4", text: "I am allergic to peanuts and shellfish.", translation: "Tôi bị dị ứng với đậu phộng và hải sản.", ipa: "/aɪ æm ələrʤɪk tə pinəts ənd ʃɛlfɪʃ/", difficulty: "medium", theme: "restaurant" },
      { id: "en-rs5", text: "The service here is excellent and the food tastes amazing.", translation: "Dịch vụ ở đây tuyệt vời và đồ ăn rất ngon.", ipa: "/ðə sərvəs hɪər ɪz ɛksələnt ənd ðə fud teɪsts əmeɪzɪŋ/", difficulty: "medium", theme: "restaurant" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-hl5", text: "Meditation has been shown to reduce anxiety and improve focus.", translation: "Thiền đã được chứng minh là giúp giảm lo âu và cải thiện sự tập trung.", ipa: "/mɛdəteɪʃən hæz bɪn ʃoʊn tə ɹədus æŋzaɪʌti ənd ɪmpɹuv foʊkəs/", difficulty: "medium", theme: "health" },
      { id: "en-hl6", text: "A balanced diet rich in vegetables strengthens the immune system.", translation: "Chế độ ăn cân bằng nhiều rau giúp tăng cường hệ miễn dịch.", ipa: "/ə bælənst daɪʌt ɹɪʧ ɪn vɛʤtəbəlz stɹɛŋθənz ðə ɪmjun sɪstəm/", difficulty: "medium", theme: "health" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-hb3", text: "I started learning photography last summer.", translation: "Tôi bắt đầu học chụp ảnh từ mùa hè năm ngoái.", ipa: "/aɪ stɑɹtəd lərnɪŋ fətɑgɹəfi læst səmər/", difficulty: "easy", theme: "hobbies" },
      ...
      { id: "en-hb7", text: "Learning a new language opens up many cultural opportunities.", translation: "Học một ngôn ngữ mới mở ra nhiều cơ hội văn hóa.", ipa: "/lərnɪŋ ə nu læŋgwəʤ oʊpənz əp mɛni kəlʧərəl ɑpərtunətiz/", difficulty: "hard", theme: "hobbies" },
    ],
  },
  {
    ...
    sentences: [
      ...
      { id: "en-fl2", text: "Honestly, I am not sure about that.", translation: "Thật ra tôi không chắc về điều đó.", ipa: "/ɑnəstli aɪ æm nɑt ʃʊɹ əbaʊt ðæt/", difficulty: "easy", theme: "feelings" },
