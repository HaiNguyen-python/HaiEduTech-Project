...
export const englishExtraThemes: SpeakingTheme[] = [
  {
    ...
    sentences: [
      { id: "en-rs1", text: "I would like to order the chef's special, please.", translation: "Tôi muốn gọi món đặc biệt của đầu bếp.", ipa: "/aɪ wʊd laɪk tə ɔɹdər ðə ʃɛfs spɛʃəl pliz/", difficulty: "easy", theme: "restaurant" },
      ...
      { id: "en-rs3", text: "Is this dish vegetarian or does it contain meat?", translation: "Món này chay hay có thịt?", ipa: "/ɪz ðɪs dɪʃ vɛʤətɛɹiən ɔːr dʌz ɪt kənteɪn mit/", difficulty: "easy", theme: "restaurant" },
      { id: "en-rs4", text: "I am allergic to peanuts and shellfish.", translation: "Tôi bị dị ứng với đậu phộng và hải sản.", ipa: "/aɪ eɪ ɛm ələrˈʤɪk tə pinəts ənd ʃɛlfɪʃ/", difficulty: "medium", theme: "restaurant" },
      { id: "en-rs5", text: "The service here is excellent and the food tastes amazing.", translation: "Dịch vụ ở đây tuyệt vời và đồ ăn rất ngon.", ipa: "/ðə sərˈvəs hɪər ɪz ɛksələnt ənd ðə fud teɪsts əmeɪzɪŋ/", difficulty: "medium", theme: "restaurant" },
      { id: "en-rs6", text: "Could you please recommend a good local wine to pair with this meal?", translation: "Bạn có thể gợi ý loại rượu địa phương hợp với bữa ăn này không?", ipa: "/kʊd juː pliz ɹɛkəmɛnd ə gʊd loʊkəl waɪn tə pɛɹ wɪð ðɪs mil/", difficulty: "hard", theme: "restaurant" },
      { id: "en-rs7", text: "We would like to make a reservation for four people at seven o'clock.", translation: "Chúng tôi muốn đặt bàn cho bốn người lúc bảy giờ.", ipa: "/wi wʊd laɪk tə meɪk ə ɹɛzərveɪʃən fɔːr fɔɹ ˈpiːpəl æt sɛvən əklɑk/", difficulty: "medium", theme: "restaurant" },
      { id: "en-rs8", text: "What is included in the breakfast buffet?", translation: "Bữa sáng buffet bao gồm những gì?", ipa: "/wʌt ɪz ɪnkludəd ɪn ðə bɹɛkfəst bəfət/", difficulty: "easy", theme: "restaurant" },
    ],
  },
  {
    id: "en-health", name: "Health & Wellness", nameVi: "Sức khỏe & Thể chất", icon: "💪",
    sentences: [
      { id: "en-hl1", text: "I try to exercise at least three times a week.", translation: "Tôi cố gắng tập thể dục ít nhất ba lần một tuần.", ipa: "/aɪ tɹaɪ tə ɛksərsaɪz æt list θɹi taɪmz ə wik/", difficulty: "easy", theme: "health" },
      { id: "en-hl2", text: "Drinking enough water is essential for good health.", translation: "Uống đủ nước rất quan trọng cho sức khỏe.", ipa: "/dɹɪŋkɪŋ ɪnəf wɔtər ɪz ɪsɛnʃəl fɔːr gʊd hɛlθ/", difficulty: "easy", theme: "health" },
      { id: "en-hl3", text: "I have a headache and a slight fever.", translation: "Tôi bị đau đầu và sốt nhẹ.", ipa: "/aɪ hæv ə hɛdeɪk ənd ə slaɪt fivər/", difficulty: "easy", theme: "health" },
      { id: "en-hl4", text: "Regular sleep helps the body recover from daily stress.", translation: "Ngủ đều đặn giúp cơ thể hồi phục sau căng thẳng hằng ngày.", ipa: "/ɹɛgjələr slip hɛlps ðə bɑdi ɹɪkəvər fɹəm deɪli stɹɛs/", difficulty: "medium", theme: "health" },
      { id: "en-hl5", text: "Meditation has been shown to reduce anxiety and improve focus.", translation: "Thiền đã được chứng minh là giúp giảm lo âu và cải thiện sự tập trung.", ipa: "/mɛdəteɪʃən hæz bɪn ʃoʊn tə ɹədus æŋzaɪˈʌti ənd ɪmpɹuv foʊkəs/", difficulty: "medium", theme: "health" },
      { id: "en-hl6", text: "A balanced diet rich in vegetables strengthens the immune system.", translation: "Chế độ ăn cân bằng nhiều rau giúp tăng cường hệ miễn dịch.", ipa: "/ə bælənst daɪˈʌt ɹɪʧ ɪn vɛʤtəbəlz stɹɛŋθənz ðə ɪmjun sɪstəm/", difficulty: "medium", theme: "health" },
      { id: "en-hl7", text: "Mental health is just as important as physical health.", translation: "Sức khỏe tinh thần cũng quan trọng như sức khỏe thể chất.", ipa: "/mɛntəl hɛlθ ɪz ʤəst æz ɪmpɔɹtənt æz fɪzɪkəl hɛlθ/", difficulty: "medium", theme: "health" },
      { id: "en-hl8", text: "Preventive checkups can detect problems before they become serious.", translation: "Khám định kỳ có thể phát hiện vấn đề trước khi nghiêm trọng.", ipa: "/pɹɪvɛntɪv ʧɛkəps kæn dɪtɛkt pɹɑbləmz bɪfɔɹ ðeɪ bɪkəm sɪɹiəs/", difficulty: "hard", theme: "health" },
    ],
  },
  {
    id: "en-hobbies", name: "Hobbies & Interests", nameVi: "Sở thích", icon: "🎨",
    sentences: [
      { id: "en-hb1", text: "I love painting in my free time.", translation: "Tôi thích vẽ tranh trong thời gian rảnh.", ipa: "/aɪ ləv peɪntɪŋ ɪn maɪ fɹi taɪm/", difficulty: "easy", theme: "hobbies" },
      { id: "en-hb2", text: "Do you play any musical instruments?", translation: "Bạn có chơi nhạc cụ nào không?", ipa: "/duː juː pleɪ ɛni mjuzɪkəl ɪnstɹəmənts/", difficulty: "easy", theme: "hobbies" },
      { id: "en-hb3", text: "I started learning photography last summer.", translation: "Tôi bắt đầu học chụp ảnh từ mùa hè năm ngoái.", ipa: "/aɪ stɑɹtəd lərˈnɪŋ fətɑgɹəfi læst səmər/", difficulty: "easy", theme: "hobbies" },
      { id: "en-hb4", text: "Reading novels helps me relax after a long day.", translation: "Đọc tiểu thuyết giúp tôi thư giãn sau một ngày dài.", ipa: "/ɹɛdɪŋ nɑvəlz hɛlps mi ɹɪlæks æftər ə lɔŋ deɪ/", difficulty: "medium", theme: "hobbies" },
      { id: "en-hb5", text: "Hiking in the mountains gives me a sense of freedom.", translation: "Đi bộ đường dài trên núi mang lại cho tôi cảm giác tự do.", ipa: "/haɪkɪŋ ɪn ðə maʊntənz gɪvz mi ə sɛns əv fɹidəm/", difficulty: "medium", theme: "hobbies" },
      { id: "en-hb6", text: "I find gardening therapeutic and very rewarding.", translation: "Tôi thấy làm vườn rất thư giãn và đáng giá.", ipa: "/aɪ faɪnd gɑɹdənɪŋ θɛɹəpjutɪk ənd vɛɹi ɹɪwɔɹdɪŋ/", difficulty: "medium", theme: "hobbies" },
      { id: "en-hb7", text: "Learning a new language opens up many cultural opportunities.", translation: "Học một ngôn ngữ mới mở ra nhiều cơ hội văn hóa.", ipa: "/lərˈnɪŋ ə nu læŋgwəʤ oʊpənz əp mɛni kəlʧərəl ɑpərtunətiz/", difficulty: "hard", theme: "hobbies" },
    ],
  },
  {
    id: "en-feelings", name: "Feelings & Opinions", nameVi: "Cảm xúc & Quan điểm", icon: "💬",
    sentences: [
      { id: "en-fl1", text: "I feel really happy today.", translation: "Hôm nay tôi cảm thấy rất vui.", ipa: "/aɪ fil ɹɪli hæpi tədeɪ/", difficulty: "easy", theme: "feelings" },
      { id: "en-fl2", text: "Honestly, I am not sure about that.", translation: "Thật ra tôi không chắc về điều đó.", ipa: "/ɑnəstli aɪ eɪ ɛm nɑt ʃʊɹ əbaʊt ðæt/", difficulty: "easy", theme: "feelings" },
      { id: "en-fl3", text: "In my opinion, education is the most important investment.", translation: "Theo tôi, giáo dục là khoản đầu tư quan trọng nhất.", ipa: "/ɪn maɪ əpɪnjən ɛʤəkeɪʃən ɪz ðə moʊst ɪmpɔɹtənt ɪnvɛstmənt/", difficulty: "medium", theme: "feelings" },
      { id: "en-fl4", text: "I completely agree with what you just said.", translation: "Tôi hoàn toàn đồng ý với điều bạn vừa nói.", ipa: "/aɪ kəmplitli əgɹi wɪð wʌt juː ʤəst sɛd/", difficulty: "medium", theme: "feelings" },
      { id: "en-fl5", text: "It seems to me that we need a different approach.", translation: "Tôi thấy chúng ta cần cách tiếp cận khác.", ipa: "/ɪt simz tə mi ðæt wi nid ə dɪfərənt əpɹoʊʧ/", difficulty: "medium", theme: "feelings" },
      { id: "en-fl6", text: "I appreciate your thoughtful feedback on this matter.", translation: "Tôi rất trân trọng phản hồi sâu sắc của bạn về vấn đề này.", ipa: "/aɪ əpɹiʃieɪt jɔːr θɔtfəl fidbæk ɑːn ðɪs mætər/", difficulty: "hard", theme: "feelings" },
    ],
  },
];
