...
export const englishExtraThemes: SpeakingTheme[] = [
  {
    ...
    sentences: [
      ...
      { id: "en-rs3", text: "Is this dish vegetarian or does it contain meat?", translation: "Món này chay hay có thịt?", ipa: "/ɪz ðɪs dɪʃ ˌvɛdʒəˈtɛˌriːən ɔːr dʌz ɪt kənˈteɪn miːt/", difficulty: "easy", theme: "restaurant" },
      { id: "en-rs4", text: "I am allergic to peanuts and shellfish.", translation: "Tôi bị dị ứng với đậu phộng và hải sản.", ipa: "/aɪ æm əˈlɜːrdʒɪk tuː ˈpiːnəts ənd ˈʃɛlˌfɪʃ/", difficulty: "medium", theme: "restaurant" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-hl5", text: "Meditation has been shown to reduce anxiety and improve focus.", translation: "Thiền đã được chứng minh là giúp giảm lo âu và cải thiện sự tập trung.", ipa: "/ˌmɛdəˈteɪʃən hæz bɪn ʃoʊn tuː rəˈduːs æŋˈzaɪəti ənd ˌɪmˈpruːv ˈfoʊkəs/", difficulty: "medium", theme: "health" },
      { id: "en-hl6", text: "A balanced diet rich in vegetables strengthens the immune system.", translation: "Chế độ ăn cân bằng nhiều rau giúp tăng cường hệ miễn dịch.", ipa: "/ə ˈbælənst ˈdaɪət rɪtʃ ɪn ˈvɛdʒtəbəlz ˈstrɛŋθənz ðə ˌɪˈmjuːn ˈsɪstəm/", difficulty: "medium", theme: "health" },
      { id: "en-hl7", text: "Mental health is just as important as physical health.", translation: "Sức khỏe tinh thần cũng quan trọng như sức khỏe thể chất.", ipa: "/ˈmɛntəl hɛlθ ɪz dʒʌst æz ˌɪmˈpɔːrtənt æz ˈfɪzɪkəl hɛlθ/", difficulty: "medium", theme: "health" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-fl3", text: "In my opinion, education is the most important investment.", translation: "Theo tôi, giáo dục là khoản đầu tư quan trọng nhất.", ipa: "/ɪn maɪ əˈpɪnjən ˌɛdʒəˈkeɪʃən ɪz ðə moʊst ˌɪmˈpɔːrtənt ˌɪnˈvɛstmənt/", difficulty: "medium", theme: "feelings" },
      ...
      { id: "en-fl6", text: "I appreciate your thoughtful feedback on this matter.", translation: "Tôi rất trân trọng phản hồi sâu sắc của bạn về vấn đề này.", ipa: "/aɪ əˈpriːʃiˌeɪt jɔːr ˈθɔːtfəl ˈfiːdˌbæk ɑːn ðɪs ˈmætər/", difficulty: "hard", theme: "feelings" },
    ],
  },
];
