...
export const englishExtraThemes: SpeakingTheme[] = [
  {
    ...
    sentences: [
      { id: "en-rs1", text: "I would like to order the chef's special, please.", translation: "Tôi muốn gọi món đặc biệt của đầu bếp.", ipa: "/aɪ wʊd laɪk tə ɔɹdər ðə ʃɛfs spɛʃʌl pliz/", difficulty: "easy", theme: "restaurant" },
      { id: "en-rs2", text: "Could we have the bill, please?", translation: "Cho chúng tôi thanh toán nhé?", ipa: "/kʊd wi hæv ðə bɪl pliz/", difficulty: "easy", theme: "restaurant" },
      { id: "en-rs3", text: "Is this dish vegetarian or does it contain meat?", translation: "Món này chay hay có thịt?", ipa: "/ɪz ðɪs dɪʃ vɛˌʤʌtɛɹiʌn ɔɹ dʌz ɪt kʌnteɪn mit/", difficulty: "easy", theme: "restaurant" },
      { id: "en-rs4", text: "I am allergic to peanuts and shellfish.", translation: "Tôi bị dị ứng với đậu phộng và hải sản.", ipa: "/aɪ eɪ ɛm ʌlərˈʤɪk tə pinʌts ənd ʃɛlfɪˌʃ/", difficulty: "medium", theme: "restaurant" },
      { id: "en-rs5", text: "The service here is excellent and the food tastes amazing.", translation: "Dịch vụ ở đây tuyệt vời và đồ ăn rất ngon.", ipa: "/ðə sərˈvʌs hiɹ ɪz ɛksʌlʌnt ənd ðə fud teɪsts ʌmeɪzɪŋ/", difficulty: "medium", theme: "restaurant" },
      { id: "en-rs6", text: "Could you please recommend a good local wine to pair with this meal?", translation: "Bạn có thể gợi ý loại rượu địa phương hợp với bữa ăn này không?", ipa: "/kʊd ju pliz ɹɛˌkʌmɛnd ə gʊd loʊkʌl waɪn tə pɛɹ wɪð ðɪs mil/", difficulty: "hard", theme: "restaurant" },
      { id: "en-rs7", text: "We would like to make a reservation for four people at seven o'clock.", translation: "Chúng tôi muốn đặt bàn cho bốn người lúc bảy giờ.", ipa: "/wi wʊd laɪk tə meɪk ə ɹɛˌzərveɪʃʌn fɔːr fɔɹ pipʌl æt sɛvʌn ʌklɑk/", difficulty: "medium", theme: "restaurant" },
      { id: "en-rs8", text: "What is included in the breakfast buffet?", translation: "Bữa sáng buffet bao gồm những gì?", ipa: "/wʌt ɪz ɪnkludʌd ɪn ðə bɹɛkfʌst bʌfʌt/", difficulty: "easy", theme: "restaurant" },
    ],
  },
  {
    id: "en-health", name: "Health & Wellness", nameVi: "Sức khỏe & Thể chất", icon: "💪",
    sentences: [
      { id: "en-hl1", text: "I try to exercise at least three times a week.", translation: "Tôi cố gắng tập thể dục ít nhất ba lần một tuần.", ipa: "/aɪ tɹaɪ tə ɛksərsaɪˌz æt list θɹi taɪmz ə wik/", difficulty: "easy", theme: "health" },
      { id: "en-hl2", text: "Drinking enough water is essential for good health.", translation: "Uống đủ nước rất quan trọng cho sức khỏe.", ipa: "/dɹɪŋkɪŋ ɪnʌf wɔtər ɪz ɪsɛnʃʌl fɔːr gʊd hɛlθ/", difficulty: "easy", theme: "health" },
      { id: "en-hl3", text: "I have a headache and a slight fever.", translation: "Tôi bị đau đầu và sốt nhẹ.", ipa: "/aɪ hæv ə hɛdeɪˌk ənd ə slaɪt fivər/", difficulty: "easy", theme: "health" },
      { id: "en-hl4", text: "Regular sleep helps the body recover from daily stress.", translation: "Ngủ đều đặn giúp cơ thể hồi phục sau căng thẳng hằng ngày.", ipa: "/ɹɛgjʌlər slip hɛlps ðə bɑdi ɹɪkʌvər fɹʌm deɪli stɹɛs/", difficulty: "medium", theme: "health" },
      { id: "en-hl5", text: "Meditation has been shown to reduce anxiety and improve focus.", translation: "Thiền đã được chứng minh là giúp giảm lo âu và cải thiện sự tập trung.", ipa: "/mɛˌdʌteɪʃʌn hæz bɪn ʃoʊn tə ɹʌdus æŋzaɪʌti ənd ɪmpɹuv foʊkʌs/", difficulty: "medium", theme: "health" },
      { id: "en-hl6", text: "A balanced diet rich in vegetables strengthens the immune system.", translation: "Chế độ ăn cân bằng nhiều rau giúp tăng cường hệ miễn dịch.", ipa: "/ə bælʌnst daɪʌt ɹɪʧ ɪn vɛʤtʌbʌlz stɹɛŋθʌnz ðə ɪmjun sɪstʌm/", difficulty: "medium", theme: "health" },
      { id: "en-hl7", text: "Mental health is just as important as physical health.", translation: "Sức khỏe tinh thần cũng quan trọng như sức khỏe thể chất.", ipa: "/mɛntʌl hɛlθ ɪz ʤʌst æz ɪmpɔɹtʌnt æz fɪzɪkʌl hɛlθ/", difficulty: "medium", theme: "health" },
      { id: "en-hl8", text: "Preventive checkups can detect problems before they become serious.", translation: "Khám định kỳ có thể phát hiện vấn đề trước khi nghiêm trọng.", ipa: "/pɹɪvɛntɪv ʧɛkʌˌps kæn dɪtɛkt pɹɑblʌmz bɪfɔɹ ðeɪ bɪkʌm sɪɹiʌs/", difficulty: "hard", theme: "health" },
    ],
  },
  {
    id: "en-hobbies", name: "Hobbies & Interests", nameVi: "Sở thích", icon: "🎨",
    sentences: [
      { id: "en-hb1", text: "I love painting in my free time.", translation: "Tôi thích vẽ tranh trong thời gian rảnh.", ipa: "/aɪ lʌv peɪntɪŋ ɪn maɪ fɹi taɪm/", difficulty: "easy", theme: "hobbies" },
      { id: "en-hb2", text: "Do you play any musical instruments?", translation: "Bạn có chơi nhạc cụ nào không?", ipa: "/du ju pleɪ ɛni mjuzɪkʌl ɪnstɹʌmʌnts/", difficulty: "easy", theme: "hobbies" },
      { id: "en-hb3", text: "I started learning photography last summer.", translation: "Tôi bắt đầu học chụp ảnh từ mùa hè năm ngoái.", ipa: "/aɪ stɑɹtʌd lərˈnɪŋ fʌtɑgɹʌfi læst sʌmər/", difficulty: "easy", theme: "hobbies" },
      { id: "en-hb4", text: "Reading novels helps me relax after a long day.", translation: "Đọc tiểu thuyết giúp tôi thư giãn sau một ngày dài.", ipa: "/ɹɛdɪŋ nɑvʌlz hɛlps mi ɹɪlæks æftər ə lɔŋ deɪ/", difficulty: "medium", theme: "hobbies" },
      { id: "en-hb5", text: "Hiking in the mountains gives me a sense of freedom.", translation: "Đi bộ đường dài trên núi mang lại cho tôi cảm giác tự do.", ipa: "/haɪkɪŋ ɪn ðə maʊntʌnz gɪvz mi ə sɛns əv fɹidʌm/", difficulty: "medium", theme: "hobbies" },
      { id: "en-hb6", text: "I find gardening therapeutic and very rewarding.", translation: "Tôi thấy làm vườn rất thư giãn và đáng giá.", ipa: "/aɪ faɪnd gɑɹdʌnɪŋ θɛˌɹʌpjutɪk ənd vɛɹi ɹɪwɔɹdɪŋ/", difficulty: "medium", theme: "hobbies" },
      { id: "en-hb7", text: "Learning a new language opens up many cultural opportunities.", translation: "Học một ngôn ngữ mới mở ra nhiều cơ hội văn hóa.", ipa: "/lərˈnɪŋ ə nu læŋgwʌʤ oʊpʌnz ʌp mɛni kʌlʧərʌl ɑˌpərtunʌtiz/", difficulty: "hard", theme: "hobbies" },
    ],
  },
  {
    id: "en-feelings", name: "Feelings & Opinions", nameVi: "Cảm xúc & Quan điểm", icon: "💬",
    sentences: [
      { id: "en-fl1", text: "I feel really happy today.", translation: "Hôm nay tôi cảm thấy rất vui.", ipa: "/aɪ fil ɹɪli hæpi tʌdeɪ/", difficulty: "easy", theme: "feelings" },
      { id: "en-fl2", text: "Honestly, I am not sure about that.", translation: "Thật ra tôi không chắc về điều đó.", ipa: "/ɑnʌstli aɪ eɪ ɛm nɑt ʃʊɹ ʌbaʊt ðæt/", difficulty: "easy", theme: "feelings" },
      { id: "en-fl3", text: "In my opinion, education is the most important investment.", translation: "Theo tôi, giáo dục là khoản đầu tư quan trọng nhất.", ipa: "/ɪn maɪ ʌpɪnjʌn ɛˌʤʌkeɪʃʌn ɪz ðə moʊst ɪmpɔɹtʌnt ɪnvɛstmʌnt/", difficulty: "medium", theme: "feelings" },
      { id: "en-fl4", text: "I completely agree with what you just said.", translation: "Tôi hoàn toàn đồng ý với điều bạn vừa nói.", ipa: "/aɪ kʌmplitli ʌgɹi wɪð wʌt ju ʤʌst sɛd/", difficulty: "medium", theme: "feelings" },
      { id: "en-fl5", text: "It seems to me that we need a different approach.", translation: "Tôi thấy chúng ta cần cách tiếp cận khác.", ipa: "/ɪt simz tə mi ðæt wi nid ə dɪfərʌnt ʌpɹoʊʧ/", difficulty: "medium", theme: "feelings" },
      { id: "en-fl6", text: "I appreciate your thoughtful feedback on this matter.", translation: "Tôi rất trân trọng phản hồi sâu sắc của bạn về vấn đề này.", ipa: "/aɪ ʌpɹiʃieɪˌt jɔɹ θɔtfʌl fidbæˌk ɑn ðɪs mætər/", difficulty: "hard", theme: "feelings" },
    ],
  },
];
