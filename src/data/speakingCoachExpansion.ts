...
export const englishExtraThemes: SpeakingTheme[] = [
  {
    ...
    sentences: [
      { id: "en-rs1", text: "I would like to order the chef's special, please.", translation: "Tôi muốn gọi món đặc biệt của đầu bếp.", ipa: "/ajˈ wʊˈd lajˈk tuˈ ɔˈɹdɚ ðʌ ʃɛˈfs spɛˈʃʌl pliˈz/", difficulty: "easy", theme: "restaurant" },
      { id: "en-rs2", text: "Could we have the bill, please?", translation: "Cho chúng tôi thanh toán nhé?", ipa: "/kʊˈd wiˈ hæˈv ðʌ bɪˈl pliˈz/", difficulty: "easy", theme: "restaurant" },
      { id: "en-rs3", text: "Is this dish vegetarian or does it contain meat?", translation: "Món này chay hay có thịt?", ipa: "/ɪˈz ðɪˈs dɪˈʃ vɛˌʤʌtɛˈɹiʌn ɔˈɹ dʌˈz ɪˈt kʌntejˈn miˈt/", difficulty: "easy", theme: "restaurant" },
      { id: "en-rs4", text: "I am allergic to peanuts and shellfish.", translation: "Tôi bị dị ứng với đậu phộng và hải sản.", ipa: "/ajˈ æˈm ʌlɚˈʤɪk tuˈ piˈnʌts ʌnd ʃɛˈlfɪˌʃ/", difficulty: "medium", theme: "restaurant" },
      { id: "en-rs5", text: "The service here is excellent and the food tastes amazing.", translation: "Dịch vụ ở đây tuyệt vời và đồ ăn rất ngon.", ipa: "/ðʌ sɚˈvʌs hiˈɹ ɪˈz ɛˈksʌlʌnt ʌnd ðʌ fuˈd tejˈsts ʌmejˈzɪŋ/", difficulty: "medium", theme: "restaurant" },
      { id: "en-rs6", text: "Could you please recommend a good local wine to pair with this meal?", translation: "Bạn có thể gợi ý loại rượu địa phương hợp với bữa ăn này không?", ipa: "/kʊˈd juˈ pliˈz ɹɛˌkʌmɛˈnd ʌ gʊˈd lowˈkʌl wajˈn tuˈ pɛˈɹ wɪˈð ðɪˈs miˈl/", difficulty: "hard", theme: "restaurant" },
      { id: "en-rs7", text: "We would like to make a reservation for four people at seven o'clock.", translation: "Chúng tôi muốn đặt bàn cho bốn người lúc bảy giờ.", ipa: "/wiˈ wʊˈd lajˈk tuˈ mejˈk ʌ ɹɛˌzɚvejˈʃʌn fɔˈɹ fɔˈɹ piˈpʌl æˈt sɛˈvʌn ʌklɑˈk/", difficulty: "medium", theme: "restaurant" },
      { id: "en-rs8", text: "What is included in the breakfast buffet?", translation: "Bữa sáng buffet bao gồm những gì?", ipa: "/wʌˈt ɪˈz ɪnkluˈdʌd ɪn ðʌ bɹɛˈkfʌst bʌˈfʌt/", difficulty: "easy", theme: "restaurant" },
    ],
  },
  {
    id: "en-health", name: "Health & Wellness", nameVi: "Sức khỏe & Thể chất", icon: "💪",
    sentences: [
      { id: "en-hl1", text: "I try to exercise at least three times a week.", translation: "Tôi cố gắng tập thể dục ít nhất ba lần một tuần.", ipa: "/ajˈ tɹajˈ tuˈ ɛˈksɚsajˌz æˈt liˈst θɹiˈ tajˈmz ʌ wiˈk/", difficulty: "easy", theme: "health" },
      { id: "en-hl2", text: "Drinking enough water is essential for good health.", translation: "Uống đủ nước rất quan trọng cho sức khỏe.", ipa: "/dɹɪˈŋkɪŋ ɪnʌˈf wɔˈtɚ ɪˈz ɪsɛˈnʃʌl fɔˈɹ gʊˈd hɛˈlθ/", difficulty: "easy", theme: "health" },
      { id: "en-hl3", text: "I have a headache and a slight fever.", translation: "Tôi bị đau đầu và sốt nhẹ.", ipa: "/ajˈ hæˈv ʌ hɛˈdejˌk ʌnd ʌ slajˈt fiˈvɚ/", difficulty: "easy", theme: "health" },
      { id: "en-hl4", text: "Regular sleep helps the body recover from daily stress.", translation: "Ngủ đều đặn giúp cơ thể hồi phục sau căng thẳng hằng ngày.", ipa: "/ɹɛˈgjʌlɚ sliˈp hɛˈlps ðʌ bɑˈdi ɹɪkʌˈvɚ fɹʌˈm dejˈli stɹɛˈs/", difficulty: "medium", theme: "health" },
      { id: "en-hl5", text: "Meditation has been shown to reduce anxiety and improve focus.", translation: "Thiền đã được chứng minh là giúp giảm lo âu và cải thiện sự tập trung.", ipa: "/mɛˌdʌtejˈʃʌn hæˈz bɪˈn ʃowˈn tuˈ ɹʌduˈs æŋzajˈʌti ʌnd ɪmpɹuˈv fowˈkʌs/", difficulty: "medium", theme: "health" },
      { id: "en-hl6", text: "A balanced diet rich in vegetables strengthens the immune system.", translation: "Chế độ ăn cân bằng nhiều rau giúp tăng cường hệ miễn dịch.", ipa: "/ʌ bæˈlʌnst dajˈʌt ɹɪˈʧ ɪn vɛˈʤtʌbʌlz stɹɛˈŋθʌnz ðʌ ɪmjuˈn sɪˈstʌm/", difficulty: "medium", theme: "health" },
      { id: "en-hl7", text: "Mental health is just as important as physical health.", translation: "Sức khỏe tinh thần cũng quan trọng như sức khỏe thể chất.", ipa: "/mɛˈntʌl hɛˈlθ ɪˈz ʤʌˈst æˈz ɪmpɔˈɹtʌnt æˈz fɪˈzɪkʌl hɛˈlθ/", difficulty: "medium", theme: "health" },
      { id: "en-hl8", text: "Preventive checkups can detect problems before they become serious.", translation: "Khám định kỳ có thể phát hiện vấn đề trước khi nghiêm trọng.", ipa: "/pɹɪvɛˈntɪv ʧɛˈkʌˌps kæˈn dɪtɛˈkt pɹɑˈblʌmz bɪfɔˈɹ ðejˈ bɪkʌˈm sɪˈɹiʌs/", difficulty: "hard", theme: "health" },
    ],
  },
  {
    id: "en-hobbies", name: "Hobbies & Interests", nameVi: "Sở thích", icon: "🎨",
    sentences: [
      { id: "en-hb1", text: "I love painting in my free time.", translation: "Tôi thích vẽ tranh trong thời gian rảnh.", ipa: "/ajˈ lʌˈv pejˈntɪŋ ɪn majˈ fɹiˈ tajˈm/", difficulty: "easy", theme: "hobbies" },
      { id: "en-hb2", text: "Do you play any musical instruments?", translation: "Bạn có chơi nhạc cụ nào không?", ipa: "/duˈ juˈ plejˈ ɛˈni mjuˈzɪkʌl ɪˈnstɹʌmʌnts/", difficulty: "easy", theme: "hobbies" },
      { id: "en-hb3", text: "I started learning photography last summer.", translation: "Tôi bắt đầu học chụp ảnh từ mùa hè năm ngoái.", ipa: "/ajˈ stɑˈɹtʌd lɚˈnɪŋ fʌtɑˈgɹʌfi læˈst sʌˈmɚ/", difficulty: "easy", theme: "hobbies" },
      { id: "en-hb4", text: "Reading novels helps me relax after a long day.", translation: "Đọc tiểu thuyết giúp tôi thư giãn sau một ngày dài.", ipa: "/ɹɛˈdɪŋ nɑˈvʌlz hɛˈlps miˈ ɹɪlæˈks æˈftɚ ʌ lɔˈŋ dejˈ/", difficulty: "medium", theme: "hobbies" },
      { id: "en-hb5", text: "Hiking in the mountains gives me a sense of freedom.", translation: "Đi bộ đường dài trên núi mang lại cho tôi cảm giác tự do.", ipa: "/hajˈkɪŋ ɪn ðʌ mawˈntʌnz gɪˈvz miˈ ʌ sɛˈns ʌˈv fɹiˈdʌm/", difficulty: "medium", theme: "hobbies" },
      { id: "en-hb6", text: "I find gardening therapeutic and very rewarding.", translation: "Tôi thấy làm vườn rất thư giãn và đáng giá.", ipa: "/ajˈ fajˈnd gɑˈɹdʌnɪŋ θɛˌɹʌpjuˈtɪk ʌnd vɛˈɹi ɹɪwɔˈɹdɪŋ/", difficulty: "medium", theme: "hobbies" },
      { id: "en-hb7", text: "Learning a new language opens up many cultural opportunities.", translation: "Học một ngôn ngữ mới mở ra nhiều cơ hội văn hóa.", ipa: "/lɚˈnɪŋ ʌ nuˈ læˈŋgwʌʤ owˈpʌnz ʌˈp mɛˈni kʌˈlʧɚʌl ɑˌpɚtuˈnʌtiz/", difficulty: "hard", theme: "hobbies" },
    ],
  },
  {
    id: "en-feelings", name: "Feelings & Opinions", nameVi: "Cảm xúc & Quan điểm", icon: "💬",
    sentences: [
      { id: "en-fl1", text: "I feel really happy today.", translation: "Hôm nay tôi cảm thấy rất vui.", ipa: "/ajˈ fiˈl ɹɪˈli hæˈpi tʌdejˈ/", difficulty: "easy", theme: "feelings" },
      { id: "en-fl2", text: "Honestly, I am not sure about that.", translation: "Thật ra tôi không chắc về điều đó.", ipa: "/ɑˈnʌstli ajˈ æˈm nɑˈt ʃʊˈɹ ʌbawˈt ðæˈt/", difficulty: "easy", theme: "feelings" },
      { id: "en-fl3", text: "In my opinion, education is the most important investment.", translation: "Theo tôi, giáo dục là khoản đầu tư quan trọng nhất.", ipa: "/ɪn majˈ ʌpɪˈnjʌn ɛˌʤʌkejˈʃʌn ɪˈz ðʌ mowˈst ɪmpɔˈɹtʌnt ɪnvɛˈstmʌnt/", difficulty: "medium", theme: "feelings" },
      { id: "en-fl4", text: "I completely agree with what you just said.", translation: "Tôi hoàn toàn đồng ý với điều bạn vừa nói.", ipa: "/ajˈ kʌmpliˈtli ʌgɹiˈ wɪˈð wʌˈt juˈ ʤʌˈst sɛˈd/", difficulty: "medium", theme: "feelings" },
      { id: "en-fl5", text: "It seems to me that we need a different approach.", translation: "Tôi thấy chúng ta cần cách tiếp cận khác.", ipa: "/ɪˈt siˈmz tuˈ miˈ ðæˈt wiˈ niˈd ʌ dɪˈfɚʌnt ʌpɹowˈʧ/", difficulty: "medium", theme: "feelings" },
      { id: "en-fl6", text: "I appreciate your thoughtful feedback on this matter.", translation: "Tôi rất trân trọng phản hồi sâu sắc của bạn về vấn đề này.", ipa: "/ajˈ ʌpɹiˈʃiejˌt jɔˈɹ θɔˈtfʌl fiˈdbæˌk ɑˈn ðɪˈs mæˈtɚ/", difficulty: "hard", theme: "feelings" },
    ],
  },
];
