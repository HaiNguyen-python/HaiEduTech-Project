...
export function normalizeSwedishWordExamples(word: SwedishWord): SwedishWord {
  ...
  // 0) Semantic fixes: words whose auto-generated frame was semantically wrong
  //    (drinks eaten, materials used at home, countries planned as activities).
  const semanticFix = getSwedishSemanticFix(word.sv);
  if (semanticFix) {
    return {
      ...word,
      example: semanticFix.sv,
      exampleVi: semanticFix.vi,
      exampleEn: semanticFix.en,
    };
  }
