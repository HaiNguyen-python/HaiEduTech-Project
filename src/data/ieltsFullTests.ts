...
export const IELTS_FULL_TESTS: FullTest[] = [
  ...
  },
  {
    ...
    durationMinutes: 60,
    passageIds: ["rx-4", "rx-5", "rx-hard-1"],
  },
  {
    id: "ft-3",
  ...
  },
  {
    ...
    durationMinutes: 60,
    passageIds: ["rx-cam-7", "rx-cam-3", "rx-hard-2"],
  },
  {
    id: "ft-5",
    title: "Full Test 5 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-9", "rx-cam-4", "rx-hard-3"],
  },
  {
    id: "ft-6",
    title: "Full Test 6 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-11", "rx-cam-5", "rx-hard-4"],
  },
  {
    id: "ft-7",
    title: "Full Test 7 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-8", "rx-cam-10", "rx-hard-5"],
  },
  {
    id: "ft-8",
  ...
  // ============ Wave 5 - 10 new full tests ============
  {
    ...
    durationMinutes: 60,
    passageIds: ["rx-cam-12", "rx-cam-13", "rx-hard-6"],
  },
  {
    id: "ft-10",
    title: "Full Test 10 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-15", "rx-cam-16", "rx-hard-7"],
  },
  {
    id: "ft-11",
    title: "Full Test 11 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-18", "rx-cam-19", "rx-hard-8"],
  },
  {
    id: "ft-12",
    title: "Full Test 12 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-21", "rx-cam-22", "rx-hard-9"],
  },
  {
    id: "ft-13",
    title: "Full Test 13 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-24", "rx-cam-25", "rx-hard-10"],
  },
  {
    id: "ft-14",
    title: "Full Test 14 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-12", "rx-cam-15", "rx-hard-11"],
  },
  {
    id: "ft-15",
    title: "Full Test 15 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-13", "rx-cam-16", "rx-hard-12"],
  },
  {
    id: "ft-16",
    title: "Full Test 16 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-14", "rx-cam-17", "rx-hard-13"],
  },
  {
    id: "ft-17",
    title: "Full Test 17 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-19", "rx-cam-23", "rx-hard-14"],
  },
  {
    id: "ft-18",
    title: "Full Test 18 - Academic (60 minutes)",
    durationMinutes: 60,
    passageIds: ["rx-cam-20", "rx-cam-21", "rx-2"],
  },
