    ...
    questions: [
      {
        ...
        options: ["The main hall", "The East Wing", "The lighthouse exhibition", "The gift shop"],
        answer: 2,
      },
      {
        type: "mcq",
        prompt: "What time does the café stop serving hot meals?",
        options: ["2 pm", "4 pm", "5 pm", "3 pm"],
        answer: 3,
      },
      {
        type: "mcq",
        prompt: "Where are the toilets located?",
        options: ["Lower level", "First floor", "Ground floor", "East Wing"],
        answer: 0,
      },
      {
        type: "mcq",
        prompt: "Today's special talk is about a ship rescue in:",
        options: ["1923", "1953", "1933", "1973"],
        answer: 1,
      },
      {
        type: "mcq",
      ...
      { type: "mcq", prompt: "A ticket allows a free second visit within:", options: ["one week", "three months", "one year", "one month"], answer: 3 },
      { type: "mcq", prompt: "Today the upper gallery must be reached by:", options: ["the main staircase", "the lift", "the ramp", "the side entrance"], answer: 0 },
      { type: "mcq", prompt: "The most popular souvenir is a replica:", options: ["ship model", "navigation chart", "poster", "medal"], answer: 1 },
      { type: "mcq", prompt: "Lost property is kept at the:", options: ["café", "gift shop", "ticket desk", "East Wing"], answer: 2 },
      { type: "mcq", prompt: "The model-boat workshop starts:", options: ["twice a day", "at two thirty", "on request", "every hour"], answer: 3 },
    ],
  },
  {
