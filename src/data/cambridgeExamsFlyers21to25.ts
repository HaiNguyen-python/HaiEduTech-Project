...
const f21Rw: Tuple[] = [
  ...
  ["Our planet ___ around the Sun once a year.", ["move", "moves", "moving", "moved next year"], 1, "'The Earth' is singular, so we use 'moves'.", "'The Earth' số ít nên dùng 'moves'.", undefined],
  ...
  ["Which planet has the shortest journey around the Sun?", ["Mercury", "Mars", "Jupiter", "Saturn"], 0, "Mercury is the closest planet to the Sun.", "Sao Thủy gần Mặt Trời nhất.", undefined],
...
const f22Rw: Tuple[] = [
  ...
  ["Our class team ___ the volleyball match last Saturday.", ["win", "wins", "won", "winning"], 2, "'Last Saturday' needs the past simple 'won'.", "'Last Saturday' dùng quá khứ 'won'.", undefined],
...
const f24Rw: Tuple[] = [
  ...
  ["Which dish did the writer's class cook last year?", ["Noodles", "Rice balls", "Pancakes", "Bread"], 1, "Last year they made Japanese rice balls.", "Năm ngoái lớp làm cơm nắm Nhật Bản.", f24pA],
