...
export const ieltsListeningPracticeSetsExpansion6: ListeningPracticeSet[] = [
  ...
  // ============================================================
  {
    ...
    questions: [
      ...
      { type: "mcq", prompt: "The current exhibition focuses on:", options: ["sculpture", "oil paintings", "ceramics", "modern photography"], answer: 3 },
      { type: "mcq", prompt: "The exhibition title is:", options: ["Light and Shadow", "War and Peace", "Faces of Asia", "Sea and Sky"], answer: 0 },
      ...
      { type: "mcq", prompt: "Audio guides at reception cost:", options: ["free", "£2", "£5", "£3"], answer: 3 },
      { type: "mcq", prompt: "Family workshops are held on:", options: ["Sundays", "Saturdays", "weekdays", "Fridays"], answer: 0 },
      { type: "mcq", prompt: "The gallery is closed to the public every:", options: ["Tuesday", "Monday", "Wednesday", "Sunday"], answer: 1 },
