    ...
    lessons: [
      ...
      },
      {
        ...
        exercises: [
          {
            type: "fill-in-blank",
            instruction: "Dựa trên đoạn văn, xác định TRUE, FALSE hoặc NOT GIVEN:\n\nPassage: 'Global temperatures have risen by approximately 1.1°C since the pre-industrial era, a change that may sound small but is already producing more intense heatwaves, longer droughts and stronger tropical storms in many parts of the world. Scientists believe this warming is primarily caused by human activities, particularly the burning of fossil fuels such as coal, oil and natural gas for electricity, transport and heavy industry. Deforestation, large-scale agriculture and certain industrial processes have added further greenhouse gases to the atmosphere, where they trap heat that would otherwise escape into space. International bodies such as the Intergovernmental Panel on Climate Change have repeatedly warned that limiting warming to 1.5°C, the target agreed in the 2015 Paris Agreement, will require rapid cuts in emissions across every major economy within the next two decades.'",
