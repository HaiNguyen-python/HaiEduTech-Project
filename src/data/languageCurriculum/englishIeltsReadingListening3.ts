...
4. **Implicit vs explicit**: if you need too much inference → likely NOT GIVEN`,
    ...
    exercises: [
      {
        type: "fill-in-blank" as const,
        instruction: "Dựa trên đoạn văn, xác định YES, NO hoặc NOT GIVEN:\n\nPassage: 'Recent studies have shown that bilingual children tend to perform better in problem-solving tasks compared to monolingual peers. Researchers at the University of Edinburgh found that learning a second language before the age of seven significantly improves cognitive flexibility. However, no evidence was found to suggest that bilingualism affects mathematical ability.'",
