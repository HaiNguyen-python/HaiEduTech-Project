    ...
    exercises: [
      {
        ...
        sentences: [
          { text: "The author's ___ is to inform readers about climate change effects.", textEn: "The author's ___ is to inform readers about climate change effects.", answer: "purpose", hint: "mục đích" },
          { text: "Words like 'surprisingly' and 'remarkably' indicate the author's ___.", textEn: "Words like 'surprisingly' and 'remarkably' indicate the author's ___.", answer: "attitude", hint: "thái độ" },
          { text: "When an author uses data and research, the purpose is usually to ___ an argument.", textEn: "When an author uses data and research, the purpose is usually to ___ an argument.", answer: "support", hint: "hỗ trợ" },
        ],
      },
    ],
    quiz: [
    ...
    exercises: [
      {
        ...
        instructionEn: "Fill in the appropriate word",
        sentences: [
          { text: "In Paragraph Information Matching, a paragraph may be used ___ than once.", textEn: "In Paragraph Information Matching, a paragraph may be used ___ than once.", answer: "more", hint: "nhiều hơn" },
          { text: "Instead of looking for exact words, look for ___ (synonyms).", textEn: "Instead of looking for exact words, look for ___ (synonyms).", answer: "paraphrases", hint: "cách diễn đạt khác" },
          { text: "Start with questions that have the most ___ keywords.", textEn: "Start with questions that have the most ___ keywords.", answer: "distinctive", hint: "đặc biệt" },
        ],
      },
    ],
    quiz: [
...
4. **Answer grammatically** - if a noun is needed, write a noun`,
    ...
    exercises: [
      {
        type: "fill-in-blank" as const,
        instruction: "Đọc đoạn văn và trả lời bằng TỐI ĐA BA TỪ:\n\nPassage: 'The Great Barrier Reef, located off the coast of Queensland, Australia, is the world's largest coral reef system and one of the planet's most studied marine ecosystems. It stretches over 2,300 kilometres along the north-eastern coast and is home to approximately 1,500 species of fish, as well as more than 400 types of coral, six of the world's seven species of sea turtle, and around 30 species of whales and dolphins. The reef was inscribed as a UNESCO World Heritage Site in 1981 and supports a tourism industry worth more than AUD 6 billion each year. Marine biologist Dr. Sarah Chen, leading a long-term monitoring programme based in Townsville, has warned that rising ocean temperatures could destroy up to 90% of the reef by 2050 if global greenhouse-gas emissions are not sharply reduced. Her team is now testing heat-tolerant coral varieties, large-scale nurseries and underwater shading techniques in the hope of slowing the damage, but she stresses that even the most ambitious local interventions will not be enough without urgent international action on climate change.'",
        instructionEn: "Read the passage and answer in NO MORE THAN THREE WORDS:\n\nPassage: 'The Great Barrier Reef, located off the coast of Queensland, Australia, is the world's largest coral reef system and one of the planet's most studied marine ecosystems. It stretches over 2,300 kilometres along the north-eastern coast and is home to approximately 1,500 species of fish, as well as more than 400 types of coral, six of the world's seven species of sea turtle, and around 30 species of whales and dolphins. The reef was inscribed as a UNESCO World Heritage Site in 1981 and supports a tourism industry worth more than AUD 6 billion each year. Marine biologist Dr. Sarah Chen, leading a long-term monitoring programme based in Townsville, has warned that rising ocean temperatures could destroy up to 90% of the reef by 2050 if global greenhouse-gas emissions are not sharply reduced. Her team is now testing heat-tolerant coral varieties, large-scale nurseries and underwater shading techniques in the hope of slowing the damage, but she stresses that even the most ambitious local interventions will not be enough without urgent international action on climate change.'",
        sentences: [
          { text: "Where is the Great Barrier Reef located? → off the coast of ___", textEn: "Where is the Great Barrier Reef located? → off the coast of ___", answer: "Queensland", hint: "tên bang" },
          { text: "How many species of fish live in the reef? → approximately ___", textEn: "How many species of fish live in the reef? → approximately ___", answer: "1,500", hint: "một con số" },
          { text: "Who warned about the reef's future? → ___", textEn: "Who warned about the reef's future? → ___", answer: "Dr. Sarah Chen", hint: "tên nhà khoa học" },
        ],
      },
    ],
    quiz: [
    ...
    exercises: [
      {
        ...
        sentences: [
          { text: "Reading quickly for the main idea is called ___.", textEn: "Reading quickly for the main idea is called ___.", answer: "skimming", hint: "" },
          { text: "Looking for a specific name or number is called ___.", textEn: "Looking for a specific name or number is called ___.", answer: "scanning", hint: "" },
          { text: "___ is best for Matching Headings questions.", textEn: "___ is best for Matching Headings questions.", answer: "Skimming", hint: "" },
        ],
      },
    ],
    quiz: [
    ...
    exercises: [
      {
        ...
        instructionEn: "Fill in the appropriate word",
        sentences: [
          { text: "Classification questions require you to ___ information into groups.", textEn: "Classification questions require you to ___ information into groups.", answer: "categorise", hint: "phân loại" },
          { text: "Categories are often names of ___, theories, or time periods.", textEn: "Categories are often names of ___, theories, or time periods.", answer: "people", hint: "người" },
          { text: "Always base your answer on the ___, not your own knowledge.", textEn: "Always base your answer on the ___, not your own knowledge.", answer: "passage", hint: "đoạn văn" },
        ],
      },
    ],
    quiz: [
    ...
    exercises: [
      {
        ...
        sentences: [
          { text: "The café is ___ the library (= facing it across the path).", textEn: "The café is ___ the library (= facing it across the path).", answer: "opposite", hint: "đối diện" },
          { text: "The shop is ___ the bank and the post office.", textEn: "The shop is ___ the bank and the post office.", answer: "between", hint: "giữa" },
          { text: "Turn right and the exit is at the ___ of the corridor.", textEn: "Turn right and the exit is at the ___ of the corridor.", answer: "end", hint: "cuối" },
        ],
      },
    ],
    quiz: [
    ...
    exercises: [
      {
        ...
        instructionEn: "Fill in the appropriate word",
        sentences: [
          { text: "Section 3 involves a conversation in an ___ context.", textEn: "Section 3 involves a conversation in an ___ context.", answer: "academic", hint: "học thuật" },
          { text: "'I'm not sure about that' is an opinion ___ showing uncertainty.", textEn: "'I'm not sure about that' is an opinion ___ showing uncertainty.", answer: "marker", hint: "dấu hiệu" },
          { text: "When speakers change their mind, focus on their ___ opinion.", textEn: "When speakers change their mind, focus on their ___ opinion.", answer: "final", hint: "cuối cùng" },
        ],
      },
    ],
    quiz: [
    ...
    exercises: [
      {
        ...
        instructionEn: "Fill in the appropriate word",
        sentences: [
          { text: "A distractor is wrong information designed to ___ you.", textEn: "A distractor is wrong information designed to ___ you.", answer: "trick", hint: "đánh lừa" },
          { text: "After 'actually' or 'I mean', the ___ answer usually follows.", textEn: "After 'actually' or 'I mean', the ___ answer usually follows.", answer: "correct", hint: "đúng" },
          { text: "Self-correction happens when a speaker ___ what they just said.", textEn: "Self-correction happens when a speaker ___ what they just said.", answer: "changes", hint: "thay đổi" },
        ],
      },
    ],
    quiz: [
    ...
    exercises: [
      {
        ...
        sentences: [
          { text: "The results were positive. ___, more research is needed.", textEn: "The results were positive. ___, more research is needed.", answer: "However", hint: "tuy nhiên" },
          { text: "The population grew rapidly. ___, housing demand increased.", textEn: "The population grew rapidly. ___, housing demand increased.", answer: "Therefore", hint: "do đó" },
          { text: "There are many benefits. ___, it improves concentration.", textEn: "There are many benefits. ___, it improves concentration.", answer: "For instance", hint: "ví dụ" },
        ],
      },
    ],
    quiz: [
