        ...
        exercises: [
          {
            ...
            sentences: [
              { text: "The woman ___ lives next door is a teacher.", textEn: "The woman ___ lives next door is a teacher.", answer: "who", hint: "Người — chủ ngữ" },
              { text: "The movie ___ we watched was boring.", textEn: "The movie ___ we watched was boring.", answer: "which", hint: "Vật — tân ngữ (hoặc that)" },
              { text: "The man ___ car is red is my uncle.", textEn: "The man ___ car is red is my uncle.", answer: "whose", hint: "Sở hữu" },
              { text: "The restaurant ___ we had dinner was expensive.", textEn: "The restaurant ___ we had dinner was expensive.", answer: "where", hint: "Nơi chốn" },
            ],
          },
        ],
        quiz: [
        ...
        exercises: [
          {
            ...
            sentences: [
              { text: "My brother, ___ is 25, works at Google.", textEn: "My brother, ___ is 25, works at Google.", answer: "who", hint: "Người" },
              { text: "The Eiffel Tower, ___ is in Paris, attracts millions of visitors.", textEn: "The Eiffel Tower, ___ is in Paris, attracts millions of visitors.", answer: "which", hint: "Vật — không dùng that" },
            ],
          },
        ],
        quiz: [
          { question: "'Paris, ___ is the capital of France, is beautiful.'", options: ["that", "which", "where", "whom"], answer: 1, explanation: "Non-defining → dùng which, KHÔNG dùng that" },
          { question: "Câu nào là non-defining clause?", options: ["The man who called is my boss.", "My father, who is 60, still works.", "I know the girl that sings.", "Anyone who is late will be punished."], answer: 1, explanation: "Có dấu phẩy → non-defining" },
          { question: "Non-defining clause có thể dùng 'that' không?", options: ["Có", "Không", "Chỉ khi thay cho vật", "Chỉ khi thay cho người"], answer: 1, explanation: "KHÔNG BAO GIỜ dùng that trong non-defining clause" },
        ],
      },
      {
        id: "relative-reduced",
