...
- **Range**: Set of y values (output)`,
        ...
        quiz: [
          { question: "'Coefficient' trong 4x³ là gì?", options: ["x", "3", "4", "4x"], answer: 2, explanation: "Coefficient là số nhân trước biến. Trong 4x³, coefficient = 4." },
          { question: "'At most 10' nghĩa là gì trong toán?", options: ["x > 10", "x ≤ 10", "x = 10", "x ≥ 10"], answer: 1, explanation: "'At most 10' = 'không quá 10' = x ≤ 10." },
          { question: "'Y-intercept' là gì?", options: ["Giao điểm với trục x", "Giao điểm với trục y", "Hệ số góc", "Giá trị lớn nhất"], answer: 1, explanation: "Y-intercept là điểm mà đồ thị cắt trục y (khi x = 0)." },
          { question: "'Polynomial' nghĩa là gì?", options: ["Phân số", "Đa thức", "Số nguyên tố", "Phương trình"], answer: 1, explanation: "Polynomial (đa thức) là biểu thức có nhiều hạng tử với biến và số mũ nguyên." },
          { question: "'Solve for x' có nghĩa là gì?", options: ["Tìm giá trị x", "Thay x bằng 0", "Loại bỏ x", "Đoán x"], answer: 0, explanation: "'Solve for x' nghĩa là tìm giá trị của x thỏa mãn phương trình." },
        ],
      },
      {
...
- **Similar**: Same shape, different size`,
        ...
        quiz: [
          { question: "'Perpendicular' có nghĩa là gì?", options: ["Song song", "Vuông góc", "Cắt nhau", "Trùng nhau"], answer: 1, explanation: "'Perpendicular' nghĩa là vuông góc — hai đường thẳng tạo góc 90°." },
          { question: "'Congruent triangles' là gì?", options: ["Tam giác đồng dạng", "Tam giác bằng nhau", "Tam giác vuông", "Tam giác cân"], answer: 1, explanation: "'Congruent' = bằng nhau về cả kích thước và hình dạng." },
          { question: "'Vertex' (số nhiều: vertices) là gì?", options: ["Cạnh", "Đỉnh", "Góc", "Đường chéo"], answer: 1, explanation: "'Vertex' là đỉnh — điểm giao của hai cạnh." },
          { question: "Công thức circumference là gì?", options: ["πr²", "2πr", "πd²", "4πr"], answer: 1, explanation: "Circumference = 2πr hoặc πd (d = đường kính = 2r)." },
          { question: "'Arc' trong hình tròn là gì?", options: ["Bán kính", "Đường kính", "Cung", "Dây cung"], answer: 2, explanation: "'Arc' là cung — một phần của đường tròn giữa hai điểm." },
        ],
      },
      {
...
- **Scatter plot**: Chart showing relationship between 2 variables`,
        ...
        quiz: [
          { question: "Khi dataset có outlier, nên dùng measure of center nào?", options: ["Mean", "Median", "Mode", "Range"], answer: 1, explanation: "Median không bị ảnh hưởng bởi outlier, nên phù hợp hơn mean khi có giá trị ngoại lai." },
          { question: "'Standard deviation' đo gì?", options: ["Giá trị trung bình", "Mức phân tán dữ liệu", "Giá trị lớn nhất", "Số lượng dữ liệu"], answer: 1, explanation: "Standard deviation đo mức độ phân tán (spread) của dữ liệu quanh giá trị trung bình." },
          { question: "'Positive correlation' có nghĩa gì?", options: ["Biến x tăng, biến y giảm", "Biến x tăng, biến y cũng tăng", "Không có mối liên hệ", "Biến y không đổi"], answer: 1, explanation: "Positive correlation: khi x tăng thì y cũng tăng (và ngược lại)." },
          { question: "Tại sao 'random sample' quan trọng?", options: ["Để có kết quả nhanh hơn", "Để kết quả có tính đại diện cho tổng thể", "Để giảm chi phí", "Không quan trọng"], answer: 1, explanation: "Random sample đảm bảo mọi cá thể có cơ hội ngang nhau được chọn → kết quả đại diện." },
          { question: "'Proportion' trong câu 'What proportion passed?' nghĩa là gì?", options: ["Số lượng", "Tỷ lệ / phần trăm", "Điểm số", "Thứ hạng"], answer: 1, explanation: "'Proportion' = tỷ lệ, phần trăm so với tổng thể." },
        ],
      },
      {
...
| "ratio of A to B" | A/B |`,
        ...
        quiz: [
          { question: "'The sum of x and 12 is 30' dịch sang phương trình nào?", options: ["x - 12 = 30", "x + 12 = 30", "12x = 30", "x/12 = 30"], answer: 1, explanation: "'Sum of' = phép cộng, 'is' = dấu bằng → x + 12 = 30." },
          { question: "'Remainder' khi 23 chia cho 5 là bao nhiêu?", options: ["4", "3", "5", "2"], answer: 1, explanation: "23 ÷ 5 = 4 dư 3. Remainder = 3." },
          { question: "'The car depreciates by 20% annually' nghĩa là gì?", options: ["Xe tăng giá 20%/năm", "Xe giảm 20% giá trị mỗi năm", "Xe mất 20% nhiên liệu", "Xe chạy nhanh hơn 20%"], answer: 1, explanation: "'Depreciate' = giảm giá trị. 20% annually = giảm 20% mỗi năm." },
          { question: "'No fewer than 15' nghĩa là gì?", options: ["x < 15", "x ≤ 15", "x ≥ 15", "x > 15"], answer: 2, explanation: "'No fewer than 15' = 'ít nhất 15' = x ≥ 15." },
          { question: "Khi đề SAT hỏi 'What is the value of 3x?', bạn nên làm gì?", options: ["Tìm x rồi dừng", "Tìm x rồi nhân 3", "Chia đáp án cho 3", "Bỏ qua số 3"], answer: 1, explanation: "SAT thường hỏi biểu thức chứ không phải biến đơn lẻ — phải tính đến bước cuối!" },
        ],
      },
    ],
  },
...
5. **Find signal words**: "suggests", "indicates", "demonstrates"`,
        ...
        quiz: [
          { question: "Tại sao 'correlation does not imply causation' quan trọng trong SAT?", options: ["Không liên quan", "Vì SAT hay bẫy bằng cách gợi ý A gây ra B khi chỉ có tương quan", "Vì correlation không tồn tại", "Vì SAT không hỏi về khoa học"], answer: 1, explanation: "SAT thường đưa đáp án bẫy gợi ý quan hệ nhân quả khi chỉ có tương quan (correlation)." },
          { question: "Khi đọc science passage, bước đầu tiên là gì?", options: ["Đọc từ đầu đến cuối", "Đọc introduction và conclusion trước", "Bỏ qua biểu đồ", "Đọc câu hỏi sau cùng"], answer: 1, explanation: "Introduction/conclusion cho bạn ý chính — tiết kiệm thời gian so với đọc toàn bộ." },
          { question: "'Replicate an experiment' có nghĩa gì?", options: ["Hủy thí nghiệm", "Lặp lại thí nghiệm để xác nhận kết quả", "Thay đổi thí nghiệm", "Phê phán thí nghiệm"], answer: 1, explanation: "Replicate = lặp lại thí nghiệm với cùng điều kiện để xác nhận tính chính xác." },
          { question: "'Equilibrium' trong khoa học là gì?", options: ["Sự mất cân bằng", "Trạng thái cân bằng ổn định", "Phản ứng nhanh", "Kết thúc thí nghiệm"], answer: 1, explanation: "Equilibrium = trạng thái cân bằng — các lực/phản ứng đối lập bằng nhau." },
          { question: "Trong thí nghiệm, 'independent variable' là gì?", options: ["Biến bị ảnh hưởng", "Biến được thay đổi có chủ đích", "Biến không đổi", "Kết quả thí nghiệm"], answer: 1, explanation: "Independent variable = biến được nhà nghiên cứu thay đổi để xem ảnh hưởng." },
        ],
      },
      {
...
3. Finally answer **comparison questions**`,
        ...
        quiz: [
          { question: "Chiến lược tốt nhất cho paired passages là gì?", options: ["Đọc cả 2 cùng lúc", "Đọc P1 → trả lời P1, đọc P2 → trả lời P2, rồi so sánh", "Chỉ đọc P2", "Đọc câu hỏi trước, bỏ qua passages"], answer: 1, explanation: "Xử lý từng passage riêng trước, rồi mới trả lời câu hỏi so sánh — tránh nhầm lẫn." },
          { question: "'Suffrage' có nghĩa là gì?", options: ["Sự đau khổ", "Quyền bầu cử", "Sự tự do", "Sự bình đẳng"], answer: 1, explanation: "'Suffrage' = quyền bầu cử. Lưu ý: KHÔNG liên quan đến 'suffering' (đau khổ)." },
          { question: "'Dissent' trong chính trị có nghĩa gì?", options: ["Đồng ý", "Bất đồng, phản đối", "Bỏ phiếu", "Biểu tình bạo lực"], answer: 1, explanation: "'Dissent' = sự bất đồng quan điểm, phản đối — một quyền được bảo vệ." },
          { question: "Khi đọc Founding Documents, nên tập trung vào gì?", options: ["Nghĩa từng từ cổ", "Lập luận và ý chính của tác giả", "Ngữ pháp cổ", "Số liệu và dữ liệu"], answer: 1, explanation: "Tập trung vào ARGUMENT — lập luận chính — chứ không cố hiểu từng từ cổ." },
          { question: "'Rhetoric' là gì?", options: ["Luật pháp", "Thuật hùng biện, nghệ thuật thuyết phục", "Lịch sử", "Khoa học"], answer: 1, explanation: "'Rhetoric' = nghệ thuật sử dụng ngôn ngữ để thuyết phục, vận động." },
        ],
      },
      {
...
4. Don't over-read — grasp the **arc** (main progression)`,
        ...
        quiz: [
          { question: "'Irony' trong văn học là gì?", options: ["Sự lặp lại", "Khi thực tế trái ngược với kỳ vọng", "Sự so sánh trực tiếp", "Sự miêu tả chi tiết"], answer: 1, explanation: "Irony = khi kết quả hoặc tình huống ngược lại với điều người đọc/nhân vật mong đợi." },
          { question: "Cách tốt nhất để xác định 'tone' của đoạn văn?", options: ["Đọc tiêu đề", "Phân tích word choice (cách chọn từ) của tác giả", "Đếm số câu", "Tìm nhân vật chính"], answer: 1, explanation: "Tone được thể hiện qua word choice — từ ngữ tác giả sử dụng cho thấy thái độ." },
          { question: "'Foreshadowing' có tác dụng gì?", options: ["Kết thúc câu chuyện", "Báo hiệu trước sự kiện sắp xảy ra", "Giải thích quá khứ", "Mô tả nhân vật"], answer: 1, explanation: "Foreshadowing tạo gợi ý sớm về những gì sẽ xảy ra — tạo kịch tính cho câu chuyện." },
          { question: "'Nostalgic' mô tả cảm xúc gì?", options: ["Tức giận", "Hoài niệm về quá khứ", "Lo lắng", "Phấn khích"], answer: 1, explanation: "'Nostalgic' = cảm giác hoài niệm, nhớ nhung về quá khứ đã qua." },
          { question: "Đoạn văn văn học SAT thường hỏi gì?", options: ["Kiến thức lịch sử văn học", "Cảm xúc, động cơ nhân vật và kỹ thuật viết", "Tiểu sử tác giả", "Ngữ pháp trong đoạn văn"], answer: 1, explanation: "SAT tập trung vào phân tích nhân vật, tone, imagery — không hỏi kiến thức văn học." },
        ],
      },
      {
