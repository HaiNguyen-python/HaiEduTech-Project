...
export const ieltsListeningPracticeSetsExpansion: ListeningPracticeSet[] = [
  ...
  },
  {
    ...
    questions: [
      { type: "mcq", prompt: "When did the museum move to its current building?",
        options: ["1923", "2008", "1998", "2018"], answer: 1 },
      { type: "mcq", prompt: "What is displayed on the top floor?",
        options: ["Fishing history", "Steam-age exhibits", "Navigational instruments", "Ocean plastics"], answer: 2 },
      { type: "mcq", prompt: "Where is photography NOT allowed?",
        options: ["The ground floor", "The first floor", "The temporary exhibition", "The café"], answer: 2 },
      { type: "mcq", prompt: "The café closes at:",
        options: ["3:30 p.m.", "4:00 p.m.", "4:30 p.m.", "5:00 p.m."], answer: 2 },
      { type: "mcq", prompt: "What service is currently unavailable?",
        options: ["The café", "The shop", "The lift to the top floor", "The audio guide"], answer: 2 },
      { type: "mcq", prompt: "How long does the 'Ocean Plastics' exhibition run?",
        options: ["Until end of September", "Until end of October", "Until end of November", "All year"], answer: 1 },
    ],
  },
  {
