...
export const ieltsListeningPracticeSetsExpansion: ListeningPracticeSet[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { type: "mcq", prompt: "How many permanent galleries are there?", options: ["2", "4", "3", "5"], answer: 2 },
      { type: "mcq", prompt: "The ground floor focuses on:", options: ["The age of steam", "Navigational instruments", "Ocean plastics", "Fishing history"], answer: 3 },
      { type: "mcq", prompt: "What is displayed on the top floor?", options: ["Navigational instruments", "Fishing history", "Steam-age exhibits", "Ocean plastics"], answer: 0 },
      { type: "mcq", prompt: "Where is photography NOT allowed?", options: ["The ground floor", "The temporary exhibition", "The first floor", "The café"], answer: 1 },
      { type: "mcq", prompt: "The café opens at:", options: ["9:00 a.m.", "9:30 a.m.", "10:00 a.m.", "10:30 a.m."], answer: 2 },
      { type: "mcq", prompt: "The café closes at:", options: ["3:30 p.m.", "4:00 p.m.", "5:00 p.m.", "4:30 p.m."], answer: 3 },
      { type: "mcq", prompt: "What service is currently unavailable?", options: ["The lift to the top floor", "The café", "The shop", "The audio guide"], answer: 0 },
