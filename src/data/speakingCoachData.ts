...
const englishThemes: SpeakingTheme[] = [
  ...
  },
  {
    ...
    sentences: [
      { id: "en-ho1", text: "I live in a small apartment near the city center.", translation: "Tôi sống trong một căn hộ nhỏ gần trung tâm thành phố.", difficulty: "easy", theme: "housing" },
      { id: "en-ho2", text: "How much is the rent per month?", translation: "Tiền thuê mỗi tháng bao nhiêu?", difficulty: "easy", theme: "housing" },
      { id: "en-ho3", text: "The living room is spacious and well-lit.", translation: "Phòng khách rộng rãi và đầy ánh sáng.", difficulty: "easy", theme: "housing" },
      { id: "en-ho4", text: "I need to fix the leaking faucet in the kitchen.", translation: "Tôi cần sửa vòi nước bị rỉ trong bếp.", difficulty: "medium", theme: "housing" },
      { id: "en-ho5", text: "We are looking for a house with a garden for our children.", translation: "Chúng tôi đang tìm một ngôi nhà có vườn cho con cái.", difficulty: "medium", theme: "housing" },
      { id: "en-ho6", text: "The neighborhood is quiet and safe, perfect for families.", translation: "Khu phố yên tĩnh và an toàn, hoàn hảo cho các gia đình.", difficulty: "medium", theme: "housing" },
      { id: "en-ho7", text: "I would like to schedule a viewing for the property listed online.", translation: "Tôi muốn đặt lịch xem bất động sản được đăng trực tuyến.", difficulty: "medium", theme: "housing" },
      { id: "en-ho8", text: "The landlord requires a two-month deposit before moving in.", translation: "Chủ nhà yêu cầu đặt cọc hai tháng trước khi dọn vào.", difficulty: "medium", theme: "housing" },
      { id: "en-ho9", text: "Energy-efficient homes are becoming increasingly popular due to rising utility costs and environmental awareness.", translation: "Nhà tiết kiệm năng lượng ngày càng phổ biến do chi phí tiện ích tăng và nhận thức về môi trường.", difficulty: "hard", theme: "housing" },
      { id: "en-ho10", text: "The process of buying a home involves multiple steps including mortgage approval, property inspection, and legal documentation.", translation: "Quá trình mua nhà bao gồm nhiều bước như phê duyệt thế chấp, kiểm tra tài sản và giấy tờ pháp lý.", difficulty: "hard", theme: "housing" },
    ],
  },
  {
    id: "en-shopping-services", name: "Shopping & Services", nameVi: "Mua sắm & Dịch vụ", icon: "🛒",
    sentences: [
      { id: "en-ss1", text: "Where can I find the dairy section?", translation: "Tôi có thể tìm khu vực sữa ở đâu?", difficulty: "easy", theme: "shopping-services" },
      { id: "en-ss2", text: "I would like to return this item, please.", translation: "Tôi muốn trả lại sản phẩm này.", difficulty: "easy", theme: "shopping-services" },
      { id: "en-ss3", text: "Do you accept credit cards?", translation: "Bạn có chấp nhận thẻ tín dụng không?", difficulty: "easy", theme: "shopping-services" },
      { id: "en-ss4", text: "Is there a warranty on this product?", translation: "Sản phẩm này có bảo hành không?", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss5", text: "I need to make an appointment at the bank to open a new account.", translation: "Tôi cần đặt lịch hẹn ở ngân hàng để mở tài khoản mới.", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss6", text: "The customer service representative was very helpful and resolved my issue quickly.", translation: "Nhân viên dịch vụ khách hàng rất hữu ích và giải quyết vấn đề của tôi nhanh chóng.", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss7", text: "Could you recommend the best deal on smartphones currently available?", translation: "Bạn có thể gợi ý ưu đãi tốt nhất cho điện thoại thông minh hiện có không?", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss8", text: "I would like to compare the features and prices of these two laptops before making a decision.", translation: "Tôi muốn so sánh tính năng và giá của hai chiếc laptop này trước khi quyết định.", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss9", text: "Consumer protection laws ensure that buyers have the right to refunds for defective products within a specified period.", translation: "Luật bảo vệ người tiêu dùng đảm bảo người mua có quyền hoàn tiền cho sản phẩm lỗi trong thời hạn nhất định.", difficulty: "hard", theme: "shopping-services" },
      { id: "en-ss10", text: "The rise of subscription-based services has fundamentally changed how consumers access and pay for products ranging from software to groceries.", translation: "Sự phát triển của dịch vụ theo thuê bao đã thay đổi căn bản cách người tiêu dùng truy cập và thanh toán cho sản phẩm từ phần mềm đến tạp hóa.", difficulty: "hard", theme: "shopping-services" },
    ],
  },
  {
    id: "en-academic", name: "Academic English", nameVi: "Tiếng Anh học thuật", icon: "🎓",
    sentences: [
      { id: "en-ac1", text: "The thesis statement should clearly present your argument.", translation: "Câu luận điểm nên trình bày rõ ràng lập luận của bạn.", difficulty: "easy", theme: "academic" },
      { id: "en-ac2", text: "Please cite your sources properly in the bibliography.", translation: "Vui lòng trích dẫn nguồn đúng cách trong danh mục tài liệu.", difficulty: "medium", theme: "academic" },
      { id: "en-ac3", text: "The experiment yielded unexpected results that challenged our hypothesis.", translation: "Thí nghiệm cho ra kết quả bất ngờ thách thức giả thuyết của chúng tôi.", difficulty: "medium", theme: "academic" },
      { id: "en-ac4", text: "Peer review is an essential part of the academic publishing process.", translation: "Đánh giá ngang hàng là phần thiết yếu của quy trình xuất bản học thuật.", difficulty: "medium", theme: "academic" },
      { id: "en-ac5", text: "The professor's lecture on quantum physics was both challenging and fascinating.", translation: "Bài giảng của giáo sư về vật lý lượng tử vừa thách thức vừa hấp dẫn.", difficulty: "medium", theme: "academic" },
      { id: "en-ac6", text: "A well-structured essay includes an introduction, body paragraphs, and a conclusion.", translation: "Một bài luận có cấu trúc tốt bao gồm phần mở đầu, các đoạn thân bài và kết luận.", difficulty: "medium", theme: "academic" },
      { id: "en-ac7", text: "The research methodology must be transparent and reproducible to ensure scientific validity.", translation: "Phương pháp nghiên cứu phải minh bạch và có thể tái tạo để đảm bảo tính khoa học.", difficulty: "hard", theme: "academic" },
      { id: "en-ac8", text: "Interdisciplinary collaboration between departments often leads to groundbreaking discoveries.", translation: "Sự hợp tác liên ngành giữa các khoa thường dẫn đến những khám phá đột phá.", difficulty: "hard", theme: "academic" },
      { id: "en-ac9", text: "The doctoral dissertation required three years of intensive research and data analysis across multiple case studies.", translation: "Luận án tiến sĩ đòi hỏi ba năm nghiên cứu chuyên sâu và phân tích dữ liệu qua nhiều nghiên cứu trường hợp.", difficulty: "hard", theme: "academic" },
      { id: "en-ac10", text: "Academic integrity demands that all intellectual contributions be properly attributed to their original authors through rigorous citation practices.", translation: "Liêm chính học thuật đòi hỏi tất cả đóng góp trí tuệ phải được ghi nhận đúng tác giả gốc thông qua trích dẫn nghiêm ngặt.", difficulty: "hard", theme: "academic" },
    ],
  },
  {
    id: "en-social-digital", name: "Social Media & Digital", nameVi: "Mạng xã hội & Kỹ thuật số", icon: "📱",
    sentences: [
      { id: "en-sd1", text: "I check my social media every morning.", translation: "Tôi kiểm tra mạng xã hội mỗi sáng.", difficulty: "easy", theme: "social-digital" },
      { id: "en-sd2", text: "How many followers do you have on Instagram?", translation: "Bạn có bao nhiêu người theo dõi trên Instagram?", difficulty: "easy", theme: "social-digital" },
      { id: "en-sd3", text: "I prefer watching short videos over reading long articles online.", translation: "Tôi thích xem video ngắn hơn là đọc bài viết dài trực tuyến.", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd4", text: "Online privacy settings should be reviewed regularly to protect personal data.", translation: "Cài đặt quyền riêng tư trực tuyến nên được xem xét thường xuyên để bảo vệ dữ liệu cá nhân.", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd5", text: "Influencer marketing has become a major advertising strategy for many brands.", translation: "Tiếp thị qua người có ảnh hưởng đã trở thành chiến lược quảng cáo chính của nhiều thương hiệu.", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd6", text: "It is important to verify information before sharing it on social media.", translation: "Điều quan trọng là xác minh thông tin trước khi chia sẻ trên mạng xã hội.", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd7", text: "Digital literacy is becoming as important as traditional literacy in the modern world.", translation: "Hiểu biết kỹ thuật số đang trở nên quan trọng như khả năng đọc viết truyền thống.", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd8", text: "The algorithm determines which content appears on your feed based on your browsing history and interactions.", translation: "Thuật toán quyết định nội dung nào xuất hiện trên bảng tin dựa trên lịch sử duyệt web và tương tác của bạn.", difficulty: "hard", theme: "social-digital" },
      { id: "en-sd9", text: "Cyberbullying and misinformation are serious challenges that social media platforms must address through better moderation policies.", translation: "Bắt nạt trực tuyến và thông tin sai lệch là những thách thức nghiêm trọng mà các nền tảng mạng xã hội phải giải quyết qua chính sách kiểm duyệt tốt hơn.", difficulty: "hard", theme: "social-digital" },
      { id: "en-sd10", text: "The intersection of social media and mental health has prompted extensive research into how excessive screen time affects cognitive development and emotional well-being.", translation: "Sự giao thoa giữa mạng xã hội và sức khỏe tâm thần đã thúc đẩy nghiên cứu sâu rộng về cách thời gian sử dụng màn hình quá mức ảnh hưởng đến phát triển nhận thức và sức khỏe cảm xúc.", difficulty: "hard", theme: "social-digital" },
    ],
  },
];
