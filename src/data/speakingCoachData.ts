...
const englishThemes: SpeakingTheme[] = [
  {
    ...
    sentences: [
      { id: "en-g1", text: "Hello, my name is Anna and I am a student.", translation: "Xin chào, tên tôi là Anna và tôi là sinh viên.", ipa: "/həˈloʊ maɪ neɪm ɪz ˈænə ənd aɪ æm ə ˈstuːdənt/", difficulty: "easy", theme: "greetings" },
      { id: "en-g2", text: "Nice to meet you. Where are you from?", translation: "Rất vui được gặp bạn. Bạn đến từ đâu?", ipa: "/naɪs tuː miːt juː wɛr ɑːr juː frʌm/", difficulty: "easy", theme: "greetings" },
      { id: "en-g3", text: "I have been living in this city for three years.", translation: "Tôi đã sống ở thành phố này được ba năm.", ipa: "/aɪ hæv bɪn ˈlɪvɪŋ ɪn ðɪs ˈsɪti fɔːr θriː jɪrz/", difficulty: "medium", theme: "greetings" },
      { id: "en-g4", text: "Could you please introduce yourself briefly?", translation: "Bạn có thể giới thiệu ngắn gọn về bản thân không?", ipa: "/kʊd juː pliːz ˌɪntrəˈduːs jərˈsɛlf ˈbriːfli/", difficulty: "medium", theme: "greetings" },
      { id: "en-g5", text: "It is a pleasure to make your acquaintance.", translation: "Thật vinh hạnh được làm quen với bạn.", ipa: "/ɪt ɪz ə ˈplɛʒər tuː meɪk jɔːr əˈkweɪntəns/", difficulty: "hard", theme: "greetings" },
      { id: "en-g6", text: "It's a pleasure to meet you.", translation: "Rất hân hạnh được gặp bạn.", ipa: "/ɪts ə ˈplɛʒər tuː miːt juː/", difficulty: "easy", theme: "greetings" },
      { id: "en-g7", text: "How have you been doing lately?", translation: "Dạo này bạn thế nào?", ipa: "/haʊ hæv juː bɪn ˈduːɪŋ ˈleɪtli/", difficulty: "medium", theme: "greetings" },
      { id: "en-g8", text: "I haven't seen you in ages!", translation: "Lâu lắm rồi không gặp bạn!", ipa: "/aɪ ˈhævənt siːn juː ɪn ˈeɪdʒəz/", difficulty: "medium", theme: "greetings" },
      { id: "en-g9", text: "My name is John, and I'm from Canada. What about you?", translation: "Tên tôi là John, tôi đến từ Canada. Còn bạn?", ipa: "/maɪ neɪm ɪz dʒɑːn ənd aɪm frʌm ˈkænədə wʌt əˈbaʊt juː/", difficulty: "hard", theme: "greetings" },
      { id: "en-g10", text: "Good to see you again.", translation: "Rất vui được gặp lại bạn.", ipa: "/ɡʊd tuː siː juː əˈɡɛn/", difficulty: "easy", theme: "greetings" },
    ],
  },
  {
    id: "en-daily", name: "Daily Life", nameVi: "Cuộc sống hàng ngày", icon: "🏠",
    sentences: [
      { id: "en-d1", text: "I usually wake up at seven in the morning.", translation: "Tôi thường thức dậy lúc bảy giờ sáng.", ipa: "/aɪ ˈjuːʒəwəli weɪk ʌp æt ˈsɛvən ɪn ðə ˈmɔːrnɪŋ/", difficulty: "easy", theme: "daily" },
      { id: "en-d2", text: "What do you like to do in your free time?", translation: "Bạn thích làm gì trong thời gian rảnh?", ipa: "/wʌt duː juː laɪk tuː duː ɪn jɔːr friː taɪm/", difficulty: "easy", theme: "daily" },
      { id: "en-d3", text: "I prefer reading books rather than watching television.", translation: "Tôi thích đọc sách hơn là xem tivi.", ipa: "/aɪ prəˈfɜːr ˈriːdɪŋ bʊks ˈræðər ðæn ˈwɑːtʃɪŋ ˈtɛləˌvɪʒən/", difficulty: "medium", theme: "daily" },
      { id: "en-d4", text: "She has been working on this project since last Monday.", translation: "Cô ấy đã làm việc trong dự án này từ thứ Hai tuần trước.", ipa: "/ʃiː hæz bɪn ˈwɜːrkɪŋ ɑːn ðɪs ˈprɑːdʒɛkt sɪns læst ˈmʌndi/", difficulty: "medium", theme: "daily" },
      { id: "en-d5", text: "The weather forecast says it will rain throughout the weekend.", translation: "Dự báo thời tiết nói trời sẽ mưa suốt cuối tuần.", ipa: "/ðə ˈwɛðər ˈfɔːˌrkæst sɛz ɪt wɪl reɪn θruˈaʊt ðə ˈwiːˌkɛnd/", difficulty: "hard", theme: "daily" },
      { id: "en-d6", text: "What are your plans for the weekend?", translation: "Kế hoạch cuối tuần của bạn là gì?", ipa: "/wʌt ɑːr jɔːr plænz fɔːr ðə ˈwiːˌkɛnd/", difficulty: "easy", theme: "daily" },
      { id: "en-d7", text: "I usually wake up around 7 AM.", translation: "Tôi thường thức dậy vào khoảng 7 giờ sáng.", ipa: "/aɪ ˈjuːʒəwəli weɪk ʌp ərˈaʊnd æm/", difficulty: "easy", theme: "daily" },
      { id: "en-d8", text: "Do you prefer cooking at home or eating out?", translation: "Bạn thích nấu ăn ở nhà hay ăn ngoài hơn?", ipa: "/duː juː prəˈfɜːr ˈkʊkɪŋ æt hoʊm ɔːr ˈiːtɪŋ aʊt/", difficulty: "medium", theme: "daily" },
      { id: "en-d9", text: "It's important to balance work and leisure for a healthy lifestyle.", translation: "Điều quan trọng là phải cân bằng công việc và giải trí để có một lối sống lành mạnh.", ipa: "/ɪts ˌɪˈmpɔːrtənt tuː ˈbæləns wɜːrk ənd ˈlɛʒər fɔːr ə ˈhɛlθi ˈlaɪfˌstaɪl/", difficulty: "hard", theme: "daily" },
      { id: "en-d10", text: "I need to do some grocery shopping later.", translation: "Lát nữa tôi cần đi mua đồ tạp hóa.", ipa: "/aɪ niːd tuː duː sʌm ˈɡroʊsəri ˈʃɑːpɪŋ ˈleɪtər/", difficulty: "medium", theme: "daily" },
    ],
  },
  {
    id: "en-travel", name: "Travel & Transport", nameVi: "Du lịch & Giao thông", icon: "✈️",
    sentences: [
      { id: "en-t1", text: "Excuse me, where is the train station?", translation: "Xin lỗi, ga tàu ở đâu?", ipa: "/ɪksˈkjuːs miː wɛr ɪz ðə treɪn ˈsteɪʃən/", difficulty: "easy", theme: "travel" },
      { id: "en-t2", text: "I would like to book a round trip ticket to London.", translation: "Tôi muốn đặt vé khứ hồi đến London.", ipa: "/aɪ wʊd laɪk tuː bʊk ə raʊnd trɪp ˈtɪkət tuː ˈlʌndən/", difficulty: "medium", theme: "travel" },
      { id: "en-t3", text: "Could you recommend a good restaurant near the hotel?", translation: "Bạn có thể gợi ý nhà hàng ngon gần khách sạn không?", ipa: "/kʊd juː ˌrɛkəˈmɛnd ə ɡʊd ˈrɛstərˌɑːnt nɪr ðə hoʊˈtɛl/", difficulty: "medium", theme: "travel" },
      { id: "en-t4", text: "The flight has been delayed due to severe weather conditions.", translation: "Chuyến bay đã bị hoãn do điều kiện thời tiết khắc nghiệt.", ipa: "/ðə flaɪt hæz bɪn dɪˈleɪd duː tuː səˈvɪr ˈwɛðər kəˈndɪʃənz/", difficulty: "hard", theme: "travel" },
      { id: "en-t5", text: "I need to check in my luggage before going through security.", translation: "Tôi cần gửi hành lý trước khi qua cổng an ninh.", ipa: "/aɪ niːd tuː tʃɛk ɪn maɪ ˈlʌɡədʒ bɪˈfɔːr ˈɡoʊɪŋ θruː sɪˈkjʊrəti/", difficulty: "medium", theme: "travel" },
      { id: "en-t6", text: "How do I get to the city center from here?", translation: "Làm thế nào để tôi đến trung tâm thành phố từ đây?", ipa: "/haʊ duː aɪ ɡɛt tuː ðə ˈsɪti ˈsɛntər frʌm hiːr/", difficulty: "easy", theme: "travel" },
      { id: "en-t7", text: "Is there a direct bus to the airport?", translation: "Có xe buýt trực tiếp đến sân bay không?", ipa: "/ɪz ðɛr ə dərˈɛkt bʌs tuː ðə ˈɛˌrpɔːrt/", difficulty: "easy", theme: "travel" },
      { id: "en-t8", text: "Could you recommend a good local restaurant?", translation: "Bạn có thể giới thiệu một nhà hàng địa phương ngon không?", ipa: "/kʊd juː ˌrɛkəˈmɛnd ə ɡʊd ˈloʊkəl ˈrɛstərˌɑːnt/", difficulty: "medium", theme: "travel" },
      { id: "en-t9", text: "We booked a round-trip ticket for our vacation to Japan.", translation: "Chúng tôi đã đặt vé khứ hồi cho kỳ nghỉ của mình ở Nhật Bản.", ipa: "/wiː bʊkt ə raʊndtrɪp ˈtɪkət fɔːr aʊər veɪˈkeɪʃən tuː dʒəˈpæn/", difficulty: "medium", theme: "travel" },
      { id: "en-t10", text: "Exploring new cultures and historical sites is the best part of traveling.", translation: "Khám phá các nền văn hóa mới và các di tích lịch sử là phần thú vị nhất của việc đi du lịch.", ipa: "/ɪksˈplɔːrɪŋ nuː ˈkʌltʃərz ənd hɪˈstɔːrɪkəl saɪts ɪz ðə bɛst pɑːrt ʌv ˈtrævəlɪŋ/", difficulty: "hard", theme: "travel" },
    ],
  },
  {
    id: "en-work", name: "Work & Business", nameVi: "Công việc & Kinh doanh", icon: "💼",
    sentences: [
      { id: "en-w1", text: "I work as a software engineer at a technology company.", translation: "Tôi làm kỹ sư phần mềm tại một công ty công nghệ.", ipa: "/aɪ wɜːrk æz ə ˈsɔːfˌtwɛr ˈɛndʒəˈnɪr æt ə tɛˈknɑːlədʒi ˈkʌmpəˌniː/", difficulty: "easy", theme: "work" },
      { id: "en-w2", text: "We need to schedule a meeting for next Wednesday.", translation: "Chúng ta cần lên lịch cuộc họp vào thứ Tư tuần tới.", ipa: "/wiː niːd tuː ˈskɛdʒʊl ə ˈmiːtɪŋ fɔːr nɛkst ˈwɛnzdi/", difficulty: "medium", theme: "work" },
      { id: "en-w3", text: "The deadline for this project has been extended by two weeks.", translation: "Hạn chót cho dự án này đã được gia hạn thêm hai tuần.", ipa: "/ðə ˈdɛˌdlaɪn fɔːr ðɪs ˈprɑːdʒɛkt hæz bɪn ɪkˈstɛndəd baɪ tuː wiːks/", difficulty: "medium", theme: "work" },
      { id: "en-w4", text: "I am confident that our team can deliver excellent results.", translation: "Tôi tự tin rằng đội của chúng tôi có thể mang lại kết quả xuất sắc.", ipa: "/aɪ æm ˈkɑːnfədənt ðæt aʊər tiːm kæn dɪˈlɪvər ˈɛksələnt rɪˈzʌlts/", difficulty: "hard", theme: "work" },
      { id: "en-w5", text: "Could we discuss the quarterly financial report in detail?", translation: "Chúng ta có thể thảo luận chi tiết báo cáo tài chính quý không?", ipa: "/kʊd wiː dɪˈskʌs ðə ˈkwɔːrtərli fəˈnænʃəl riˈpɔːrt ɪn dɪˈteɪl/", difficulty: "hard", theme: "work" },
      { id: "en-w6", text: "What is your typical workday like?", translation: "Một ngày làm việc điển hình của bạn như thế nào?", ipa: "/wʌt ɪz jɔːr ˈtɪpəkəl ˈwɜːrˌkdeɪ laɪk/", difficulty: "easy", theme: "work" },
      { id: "en-w7", text: "I have a meeting at 10 AM.", translation: "Tôi có một cuộc họp lúc 10 giờ sáng.", ipa: "/aɪ hæv ə ˈmiːtɪŋ æt æm/", difficulty: "easy", theme: "work" },
      { id: "en-w8", text: "Could you please send me the report by Friday?", translation: "Bạn vui lòng gửi báo cáo cho tôi trước thứ Sáu được không?", ipa: "/kʊd juː pliːz sɛnd miː ðə riˈpɔːrt baɪ ˈfraɪdi/", difficulty: "medium", theme: "work" },
      { id: "en-w9", text: "Our company is looking to expand into new markets next year.", translation: "Công ty chúng tôi đang tìm cách mở rộng sang các thị trường mới vào năm tới.", ipa: "/aʊər ˈkʌmpəˌniː ɪz ˈlʊkɪŋ tuː ɪkˈspænd ˈɪntu nuː ˈmɑːrkəts nɛkst jɪr/", difficulty: "medium", theme: "work" },
      { id: "en-w10", text: "Effective collaboration and communication are crucial for team success.", translation: "Sự hợp tác và giao tiếp hiệu quả là rất quan trọng để đội nhóm thành công.", ipa: "/ɪˈfɛktɪv kəˌlæbərˈeɪʃən ənd kəˌmjuːnəˈkeɪʃən ɑːr ˈkruːʃəl fɔːr tiːm səˈksɛs/", difficulty: "hard", theme: "work" },
    ],
  },
  {
    id: "en-education", name: "Education", nameVi: "Giáo dục", icon: "📚",
    sentences: [
      { id: "en-e1", text: "I am studying English to improve my communication skills.", translation: "Tôi đang học tiếng Anh để cải thiện kỹ năng giao tiếp.", ipa: "/aɪ æm ˈstʌdiɪŋ ˈɪŋɡlɪʃ tuː ˌɪmˈpruːv maɪ kəˌmjuːnəˈkeɪʃən skɪlz/", difficulty: "easy", theme: "education" },
      { id: "en-e2", text: "The university offers a wide range of courses for international students.", translation: "Trường đại học cung cấp nhiều khóa học cho sinh viên quốc tế.", ipa: "/ðə ˌjuːnəˈvɜːrsəti ˈɔːfərz ə waɪd reɪndʒ ʌv ˈkɔːrsəz fɔːr ˌɪntərˈnæʃənəl ˈstuːdənts/", difficulty: "medium", theme: "education" },
      { id: "en-e3", text: "Critical thinking is one of the most important skills in education.", translation: "Tư duy phản biện là một trong những kỹ năng quan trọng nhất trong giáo dục.", ipa: "/ˈkrɪtɪkəl ˈθɪŋkɪŋ ɪz wʌn ʌv ðə moʊst ˌɪˈmpɔːrtənt skɪlz ɪn ˌɛdʒəˈkeɪʃən/", difficulty: "hard", theme: "education" },
      { id: "en-e4", text: "She graduated with honors from a prestigious university.", translation: "Cô ấy tốt nghiệp loại giỏi từ một trường đại học danh tiếng.", ipa: "/ʃiː ˈɡrædʒuˌeɪtɪd wɪð ˈɑːnərz frʌm ə prɛˈstɪdʒəs ˌjuːnəˈvɜːrsəti/", difficulty: "medium", theme: "education" },
      { id: "en-e5", text: "Technology has transformed the way we learn and teach.", translation: "Công nghệ đã thay đổi cách chúng ta học và dạy.", ipa: "/tɛˈknɑːlədʒi hæz trænˈsfɔːrmd ðə weɪ wiː lɜːrn ənd tiːtʃ/", difficulty: "medium", theme: "education" },
      { id: "en-e6", text: "What subject are you studying?", translation: "Bạn đang học môn gì?", ipa: "/wʌt səˈbdʒɛkt ɑːr juː ˈstʌdiɪŋ/", difficulty: "easy", theme: "education" },
      { id: "en-e7", text: "I need to prepare for my exams next week.", translation: "Tôi cần chuẩn bị cho các kỳ thi vào tuần tới.", ipa: "/aɪ niːd tuː priˈpɛr fɔːr maɪ ɪˈɡzæmz nɛkst wiːk/", difficulty: "easy", theme: "education" },
      { id: "en-e8", text: "The professor assigned a lot of reading for this course.", translation: "Giáo sư đã giao rất nhiều bài đọc cho khóa học này.", ipa: "/ðə prəˈfɛsər əˈsaɪnd ə lɑːt ʌv ˈriːdɪŋ fɔːr ðɪs kɔːrs/", difficulty: "medium", theme: "education" },
      { id: "en-e9", text: "I'm considering pursuing a master's degree in linguistics.", translation: "Tôi đang cân nhắc theo học bằng thạc sĩ về ngôn ngữ học.", ipa: "/aɪm kəˈnsɪdərɪŋ pərˈsuːɪŋ ə ˈmæstərz dɪˈɡriː ɪn lɪŋˈɡwɪstɪks/", difficulty: "medium", theme: "education" },
      { id: "en-e10", text: "Lifelong learning is essential for personal and professional development in today's world.", translation: "Học tập suốt đời là điều cần thiết cho sự phát triển cá nhân và nghề nghiệp trong thế giới ngày nay.", ipa: "/ˈlaɪˈflɔːŋ ˈlɜːrnɪŋ ɪz ɛˈsɛnʃəl fɔːr ˈpɜːrsɪnəl ənd prəˈfɛʃənəl dɪˈvɛləpmənt ɪn təˈdeɪz wɜːrld/", difficulty: "hard", theme: "education" },
    ],
  },
  {
    ...
    sentences: [
      ...
      { id: "en-h5", text: "Regular exercise is crucial for maintaining good physical and mental health.", translation: "Tập thể dục thường xuyên rất quan trọng để duy trì sức khỏe thể chất và tinh thần tốt.", ipa: "/ˈrɛɡjələr ˈɛksərˌsaɪz ɪz ˈkruːʃəl fɔːr meɪˈnteɪnɪŋ ɡʊd ˈfɪzɪkəl ənd ˈmɛntəl hɛlθ/", difficulty: "medium", theme: "health" },
      { id: "en-h6", text: "Eating a balanced diet, which includes plenty of fruits and vegetables, helps prevent many diseases.", translation: "Ăn một chế độ ăn uống cân bằng, bao gồm nhiều trái cây và rau củ, giúp ngăn ngừa nhiều bệnh tật.", ipa: "/ˈiːtɪŋ ə ˈbælənst ˈdaɪət wɪtʃ ˌɪnˈkluːdz ˈplɛnti ʌv fruːts ənd ˈvɛdʒtəbəlz hɛlps prɪˈvɛnt ˈmɛni dɪˈziːzəz/", difficulty: "medium", theme: "health" },
      { id: "en-h7", text: "It\'s important to consult a doctor if you experience persistent symptoms or unusual pain.", translation: "Điều quan trọng là phải hỏi ý kiến bác sĩ nếu bạn gặp các triệu chứng dai dẳng hoặc đau bất thường.", ipa: "/ɪts ɪmpɔɹtənt tə kənsəlt ə dɑktər ɪf juː ɪkˈspɪəriəns pərsɪstənt sɪmptəmz ɔːr ənjuʒuəl peɪn/", difficulty: "medium", theme: "health" },
      { id: "en-h8", text: "Proper hydration and sufficient sleep are fundamental to boosting your immune system and overall well-being.", translation: "Việc giữ nước đúng cách và ngủ đủ giấc là nền tảng để tăng cường hệ miễn dịch và sức khỏe tổng thể của bạn.", ipa: "/ˈprɑːpər haɪˈdreɪʃən ənd səˈfɪʃənt sliːp ɑːr ˌfʌndəˈmɛntəl tuː ˈbuːstɪŋ jɔːr ˌɪˈmjuːn ˈsɪstəm ənd ˈoʊvərˌɔːl ˌwɛˈlbiːɪŋ/", difficulty: "medium", theme: "health" },
      { id: "en-h9", text: "Adopting a holistic approach to health, encompassing nutrition, physical activity, mental wellness, and stress management, is vital for long-term vitality.", translation: "Áp dụng một phương pháp tiếp cận toàn diện đối với sức khỏe, bao gồm dinh dưỡng, hoạt động thể chất, sức khỏe tâm thần và quản lý căng thẳng, là rất quan trọng cho sức sống lâu dài.", ipa: "/əˈdɑːptɪŋ ə hoʊˈlɪstɪk əˈproʊtʃ tuː hɛlθ ɛˈnkʌmpəsɪŋ nuˈtrɪʃən ˈfɪzɪkəl æˈktɪvəti ˈmɛntəl ˈwɛlnəs ənd strɛs ˈmænədʒmənt ɪz ˈvaɪtəl fɔːr ˈlɔːˈŋtɜːrm vaɪˈtæləti/", difficulty: "hard", theme: "health" },
      { id: "en-h10", text: "Many people find that integrating mindfulness practices and gratitude into their daily routines significantly enhances their psychological resilience and overall life satisfaction.", translation: "Nhiều người thấy rằng việc tích hợp các thực hành chánh niệm và lòng biết ơn vào thói quen hàng ngày của họ làm tăng đáng kể khả năng phục hồi tâm lý và sự hài lòng với cuộc sống nói chung.", ipa: "/mɛni ˈpiːpəl faɪnd ðæt ɪntəgɹeɪtɪŋ mindfulness pɹæktəsəz ənd ˈɡrætɪtuːd ɪntu ðɛər deɪli ɹutinz sɪgnɪfɪkəntli ɛnhænsɪz ðɛər saɪkəlɑʤɪkəl ɹɪzɪliəns ənd oʊvərɔl laɪf sætəsfækʃən/", difficulty: "hard", theme: "health" },
    ],
  },
  {
    id: "en-tech", name: "Technology & Internet", nameVi: "Công nghệ & Internet", icon: "💻",
    sentences: [
      { id: "en-tech1", text: "I use my phone daily.", translation: "Tôi dùng điện thoại hàng ngày.", ipa: "/aɪ juːs maɪ foʊn ˈdeɪli/", difficulty: "easy", theme: "tech" },
      { id: "en-tech2", text: "The internet is fast.", translation: "Mạng internet nhanh.", ipa: "/ðə ˈɪntərˌnɛt ɪz fæst/", difficulty: "easy", theme: "tech" },
      { id: "en-tech3", text: "This app is useful.", translation: "Ứng dụng này hữu ích.", ipa: "/ðɪs æp ɪz ˈjuːsfəl/", difficulty: "easy", theme: "tech" },
      ...
      { id: "en-tech5", text: "Many people rely on smartphones for communication, work, and entertainment purposes.", translation: "Nhiều người phụ thuộc vào điện thoại thông minh cho mục đích giao tiếp, công việc và giải trí.", ipa: "/ˈmɛni ˈpiːpəl rɪˈlaɪ ɑːn ˈsmɑːrˌtfoʊnz fɔːr kəˌmjuːnəˈkeɪʃən wɜːrk ənd ˌɛntərˈteɪnmənt ˈpɜːrpəsəz/", difficulty: "medium", theme: "tech" },
      { id: "en-tech6", text: "The development of artificial intelligence is rapidly transforming various industries and aspects of daily life.", translation: "Sự phát triển của trí tuệ nhân tạo đang nhanh chóng biến đổi nhiều ngành công nghiệp và các khía cạnh của cuộc sống hàng ngày.", ipa: "/ðə dɪˈvɛləpmənt ʌv ˌɑːrtəˈfɪʃəl ˌɪˈntɛlədʒəns ɪz ˈræpədli trænˈsfɔːrmɪŋ ˈvɛriəs ˈɪndəstriz ənd ˈæˌspɛkts ʌv ˈdeɪli laɪf/", difficulty: "medium", theme: "tech" },
      { id: "en-tech7", text: "Cloud computing allows users to access their files and applications from any device with an internet connection.", translation: "Điện toán đám mây cho phép người dùng truy cập các tệp và ứng dụng của họ từ mọi thiết bị có kết nối internet.", ipa: "/klaʊd kəmˈpjuːtɪŋ əˈlaʊz ˈjuːzərz tuː ˈæˌksɛs ðɛr faɪlz ənd ˌæpləˈkeɪʃənz frʌm ˈɛni dɪˈvaɪs wɪð æn ˈɪntərˌnɛt kəˈnɛkʃən/", difficulty: "medium", theme: "tech" },
      { id: "en-tech8", text: "Cybersecurity measures are essential to protect personal data and private information from potential online threats.", translation: "Các biện pháp an ninh mạng là điều cần thiết để bảo vệ dữ liệu cá nhân và thông tin riêng tư khỏi các mối đe dọa trực tuyến tiềm ẩn.", ipa: "/saɪbərsɪkjʊrəti mɛʒərz ɑːr ɪsɛnʃəl tə pɹətɛkt pɜrsənəl deɪtə ənd pɹaɪvət ɪnfərmeɪʃən fɹəm pətɛnʃəl ɔnlaɪn θɹɛts/", difficulty: "medium", theme: "tech" },
      { id: "en-tech9", text: "The rapid advancement of quantum computing promises to revolutionize fields like cryptography and drug discovery, albeit facing significant engineering challenges.", translation: "Sự tiến bộ nhanh chóng của điện toán lượng tử hứa hẹn sẽ cách mạng hóa các lĩnh vực như mã hóa và khám phá thuốc, mặc dù phải đối mặt với những thách thức kỹ thuật đáng kể.", ipa: "/ðə ɹæpəd ədvænsmənt əv kwɑntəm kəmpjutɪŋ pɹɑməsəz tə ɹɛvəluʃənaɪz fildz laɪk cryptography ənd dɹəg dɪskəvəri ɔlbiɪt feɪsɪŋ səgnɪfɪkənt ɛnʤənɪɹɪŋ ʧælənʤɪz/", difficulty: "hard", theme: "tech" },
      { id: "en-tech10", text: "As the Internet of Things expands, the integration of smart devices into our homes and cities raises new questions about privacy, data security, and ethical implications.", translation: "Khi Internet Vạn Vật mở rộng, việc tích hợp các thiết bị thông minh vào nhà cửa và thành phố của chúng ta đặt ra những câu hỏi mới về quyền riêng tư, bảo mật dữ liệu và các hàm ý đạo đức.", ipa: "/æz ðə ˈɪntərˌnɛt ʌv θɪŋz ɪkˈspændz ðə ˌɪntəˈɡreɪʃən ʌv smɑːrt dɪˈvaɪsəz ˈɪntu aʊər hoʊmz ənd ˈsɪtiz ˈreɪzəz nuː ˈkwɛstʃənz əˈbaʊt ˈpraɪvəsi ˈdeɪtə sɪˈkjʊrəti ənd ˈɛθɪkəl ˌɪmpləˈkeɪʃənz/", difficulty: "hard", theme: "tech" },
    ],
  },
  {
    ...
    sentences: [
      ...
      { id: "en-environment2", text: "Flowers are beautiful.", translation: "Những bông hoa thật đẹp.", ipa: "/ˈflaʊərz ɑːr ˈbjuːtəfəl/", difficulty: "easy", theme: "environment" },
      { id: "en-environment3", text: "Save our planet.", translation: "Hãy cứu hành tinh của chúng ta.", ipa: "/seɪv aʊər ˈplænət/", difficulty: "easy", theme: "environment" },
      { id: "en-environment4", text: "Recycle plastic bottles.", translation: "Hãy tái chế chai nhựa.", ipa: "/riˈsaɪkəl ˈplæstɪk ˈbɑːtəlz/", difficulty: "easy", theme: "environment" },
      { id: "en-environment5", text: "Climate change is a global issue that requires urgent attention and collective action.", translation: "Biến đổi khí hậu là một vấn đề toàn cầu đòi hỏi sự chú ý khẩn cấp và hành động tập thể.", ipa: "/ˈklaɪmət tʃeɪndʒ ɪz ə ˈɡloʊbəl ˈɪʃu ðæt riˈkwaɪərz ˈɜːrdʒənt əˈtɛnʃən ənd kəˈlɛktɪv ˈækʃən/", difficulty: "medium", theme: "environment" },
      { id: "en-environment6", text: "Deforestation contributes to habitat loss and exacerbates the effects of global warming.", translation: "Nạn phá rừng góp phần gây mất môi trường sống và làm trầm trọng thêm tác động của sự nóng lên toàn cầu.", ipa: "/dɪˌfɔːrɪˈsteɪʃən kənˈtrɪbjuts tuː ˈhæbəˌtæt lɔːs ənd ɪˈɡzæsərˌbeɪts ðə ɪˈfɛkts ʌv ˈɡloʊbəl ˈwɔːrmɪŋ/", difficulty: "medium", theme: "environment" },
      { id: "en-environment7", text: "Renewable energy sources like solar and wind power are becoming increasingly important for a sustainable future.", translation: "Các nguồn năng lượng tái tạo như năng lượng mặt trời và gió đang trở nên ngày càng quan trọng cho một tương lai bền vững.", ipa: "/riˈnuːəbəl ˈɛnərdʒi ˈsɔːrsəz laɪk ˈsoʊlər ənd waɪnd ˈpaʊər ɑːr bɪˈkʌmɪŋ ɪnˈkriːsɪŋli ˌɪˈmpɔːrtənt fɔːr ə səˈsteɪnəbəl ˈfjuːtʃər/", difficulty: "medium", theme: "environment" },
      { id: "en-environment8", text: "Protecting endangered species and preserving biodiversity are crucial for maintaining the balance of ecosystems.", translation: "Bảo vệ các loài có nguy cơ tuyệt chủng và bảo tồn đa dạng sinh học là rất quan trọng để duy trì sự cân bằng của các hệ sinh thái.", ipa: "/prəˈtɛktɪŋ ɛˈndeɪndʒərd ˈspiːʃiz ənd prəˈzɜːrvɪŋ ˌbaɪoʊdaɪˈvɜːrsəti ɑːr ˈkruːʃəl fɔːr meɪˈnteɪnɪŋ ðə ˈbæləns ʌv ˈiːkoʊˌsɪstəmz/", difficulty: "medium", theme: "environment" },
      { id: "en-environment9", text: "Addressing the complex challenges of environmental degradation necessitates international cooperation, innovative policies, and a fundamental shift in human consumption patterns.", translation: "Giải quyết những thách thức phức tạp của suy thoái môi trường đòi hỏi sự hợp tác quốc tế, các chính sách đổi mới và sự thay đổi cơ bản trong các mô hình tiêu dùng của con người.", ipa: "/əˈdrɛsɪŋ ðə ˈkɑːmplɛks ˈtʃæləndʒɪz ʌv ɪˌnvaɪrəˈnmɛntəl ˌdɛɡrəˈdeɪʃən nəˈsɛsəˌteɪts ˌɪntərˈnæʃənəl koʊˌɑːpərˈeɪʃən ˈɪnəˌveɪtɪv ˈpɑːləsiz ənd ə ˌfʌndəˈmɛntəl ʃɪft ɪn ˈhjuːmən kəˈnsʌmpʃən ˈpætərnz/", difficulty: "hard", theme: "environment" },
      { id: "en-environment10", text: "The long-term viability of our planet hinges on our collective ability to transition towards a circular economy, reduce waste, and invest in sustainable infrastructure globally.", translation: "Khả năng tồn tại lâu dài của hành tinh chúng ta phụ thuộc vào khả năng tập thể của chúng ta trong việc chuyển đổi sang nền kinh tế tuần hoàn, giảm thiểu chất thải và đầu tư vào cơ sở hạ tầng bền vững trên toàn cầu.", ipa: "/ðə ˈlɔːˈŋtɜːrm vaɪəˈbɪləti ʌv aʊər ˈplænət ˈhɪndʒɪz ɑːn aʊər kəˈlɛktɪv əˈbɪləˌtiː tuː træˈnzɪʃən təˈwɔːrdz ə ˈsɜːrkjələr ɪˈkɑːnəmi rəˈduːs weɪst ənd ˌɪˈnvɛst ɪn səˈsteɪnəbəl ˌɪnfrəsˈtrʌktʃər ˈɡloʊbəli/", difficulty: "hard", theme: "environment" },
    ],
  },
  {
    id: "en-food", name: "Food & Cooking", nameVi: "Ẩm thực & Nấu ăn", icon: "🍳",
    sentences: [
      { id: "en-food1", text: "I like to cook.", translation: "Tôi thích nấu ăn.", ipa: "/aɪ laɪk tuː kʊk/", difficulty: "easy", theme: "food" },
      { id: "en-food2", text: "This soup is hot.", translation: "Món súp này nóng.", ipa: "/ðɪs suːp ɪz hɑːt/", difficulty: "easy", theme: "food" },
      { id: "en-food3", text: "What\'s for dinner?", translation: "Tối nay ăn gì?", ipa: "/wʌts fɔːr dɪnər/", difficulty: "easy", theme: "food" },
      { id: "en-food4", text: "I want some rice.", translation: "Tôi muốn một ít cơm.", ipa: "/aɪ wɑːnt sʌm raɪs/", difficulty: "easy", theme: "food" },
      { id: "en-food5", text: "Learning to cook diverse cuisines can be a rewarding and enjoyable experience for anyone.", translation: "Học cách nấu các món ăn đa dạng có thể là một trải nghiệm bổ ích và thú vị cho bất kỳ ai.", ipa: "/ˈlɜːrnɪŋ tuː kʊk daɪˈvɜːrs kwɪˈziːnz kæn biː ə rɪˈwɔːrdɪŋ ənd ˌɛˈndʒɔɪəbəl ɪkˈspɪriəns fɔːr ˈɛniˌwʌn/", difficulty: "medium", theme: "food" },
      { id: "en-food6", text: "Fresh ingredients are key to preparing delicious and nutritious meals at home.", translation: "Nguyên liệu tươi là chìa khóa để chuẩn bị những bữa ăn ngon và bổ dưỡng tại nhà.", ipa: "/frɛʃ ˌɪnˈɡriːdiənts ɑːr kiː tuː priˈpɛrɪŋ dɪˈlɪʃəs ənd nuˈtrɪʃəs miːlz æt hoʊm/", difficulty: "medium", theme: "food" },
      { id: "en-food7", text: "Many cultures have unique culinary traditions that reflect their history and local produce.", translation: "Nhiều nền văn hóa có những truyền thống ẩm thực độc đáo phản ánh lịch sử và sản vật địa phương của họ.", ipa: "/ˈmɛni ˈkʌltʃərz hæv juˈniːk ˈkjuːlɪˌnɛri trəˈdɪʃənz ðæt rɪˈflɛkt ðɛr ˈhɪstəri ənd ˈloʊkəl prəˈduːs/", difficulty: "medium", theme: "food" },
      { id: "en-food8", text: "Experimenting with different spices and herbs can elevate the flavors of even simple dishes.", translation: "Thử nghiệm với các loại gia vị và thảo mộc khác nhau có thể nâng tầm hương vị của ngay cả những món ăn đơn giản.", ipa: "/ɛkˈspɛrəˌmɛntɪŋ wɪð ˈdɪfərənt ˈspaɪsəz ənd ɜːrbz kæn ˈɛləˌveɪt ðə ˈfleɪvərz ʌv ˈiːvɪn ˈsɪmpəl ˈdɪʃəz/", difficulty: "medium", theme: "food" },
      { id: "en-food9", text: "The burgeoning farm-to-table movement emphasizes locally sourced, seasonal produce, fostering sustainability and supporting small agricultural communities.", translation: "Phong trào trang trại đến bàn ăn đang phát triển mạnh mẽ nhấn mạnh sản phẩm địa phương, theo mùa, thúc đẩy tính bền vững và hỗ trợ các cộng đồng nông nghiệp nhỏ.", ipa: "/ðə bərʤənɪŋ fɑɹmtəteɪbəl muvmənt ɛmfəsaɪzəz loʊkəli sourced sizənəl pɹədus fɑstərɪŋ səsteɪnəbɪlɪti ənd səpɔɹtɪŋ smɔl ægɹəkəlʧərəl kəmjunətiz/", difficulty: "hard", theme: "food" },
      { id: "en-food10", text: "Molecular gastronomy, a culinary discipline, explores the physical and chemical transformations of ingredients during cooking, often resulting in innovative and surprising dishes.", translation: "Ẩm thực phân tử, một ngành ẩm thực, khám phá các biến đổi vật lý và hóa học của nguyên liệu trong quá trình nấu ăn, thường dẫn đến những món ăn sáng tạo và bất ngờ.", ipa: "/məˈlɛkjələr ɡæsˈtrɑːnəmi ə ˈkjuːlɪˌnɛri ˈdɪsəplən ɪksˈplɔːrz ðə ˈfɪzɪkəl ənd ˈkɛməkəl ˌtrænsfərˈmeɪʃənz ʌv ˌɪnˈɡriːdiənts ˈdʊrɪŋ ˈkʊkɪŋ ˈɔːfən rɪˈzʌltɪŋ ɪn ˈɪnəˌveɪtɪv ənd sərˈpraɪzɪŋ ˈdɪʃəz/", difficulty: "hard", theme: "food" },
    ],
  },
  {
    id: "en-culture", name: "Culture & Entertainment", nameVi: "Văn hóa & Giải trí", icon: "🎭",
    sentences: [
      { id: "en-culture1", text: "I like to watch movies.", translation: "Tôi thích xem phim.", ipa: "/aɪ laɪk tuː wɑːtʃ ˈmuːviz/", difficulty: "easy", theme: "culture" },
      { id: "en-culture2", text: "Music makes me happy.", translation: "Âm nhạc làm tôi vui.", ipa: "/ˈmjuːzɪk meɪks miː ˈhæpi/", difficulty: "easy", theme: "culture" },
      { id: "en-culture3", text: "Art is interesting.", translation: "Nghệ thuật thật thú vị.", ipa: "/ɑːrt ɪz ˈɪntrəstɪŋ/", difficulty: "easy", theme: "culture" },
      { id: "en-culture4", text: "I read a lot of books.", translation: "Tôi đọc rất nhiều sách.", ipa: "/aɪ rɛd ə lɑːt ʌv bʊks/", difficulty: "easy", theme: "culture" },
      { id: "en-culture5", text: "Visiting museums and art galleries is a wonderful way to experience different cultures.", translation: "Tham quan bảo tàng và phòng trưng bày nghệ thuật là một cách tuyệt vời để trải nghiệm các nền văn hóa khác nhau.", ipa: "/ˈvɪzɪtɪŋ mjuˈziːəmz ənd ɑːrt ˈɡæləriz ɪz ə ˈwʌndərfəl weɪ tuː ɪkˈspɪriəns ˈdɪfərənt ˈkʌltʃərz/", difficulty: "medium", theme: "culture" },
      { id: "en-culture6", text: "Attending live concerts or theater performances offers a unique and engaging form of entertainment.", translation: "Tham dự các buổi hòa nhạc trực tiếp hoặc biểu diễn sân khấu mang đến một hình thức giải trí độc đáo và hấp dẫn.", ipa: "/əˈtɛndɪŋ laɪv ˈkɑːnsərts ɔːr ˈθiːətər pərˈfɔːrmənsəz ˈɔːfərz ə juˈniːk ənd ɛˈnɡeɪdʒɪŋ fɔːrm ʌv ˌɛntərˈteɪnmənt/", difficulty: "medium", theme: "culture" },
      { id: "en-culture7", text: "Literature across various languages provides profound insights into human experiences and societal values.", translation: "Văn học ở nhiều ngôn ngữ khác nhau cung cấp những hiểu biết sâu sắc về trải nghiệm con người và giá trị xã hội.", ipa: "/ˈlɪtərətʃər əˈkrɔːs ˈvɛriəs ˈlæŋɡwədʒəz prəˈvaɪdz proʊˈfaʊnd ˈɪˌnsaɪts ˈɪntu ˈhjuːmən ɪkˈspɪriənsɪz ənd səˈsaɪɪtəl ˈvæljuz/", difficulty: "medium", theme: "culture" },
      { id: "en-culture8", text: "Cultural exchange programs facilitate understanding and appreciation between people from different backgrounds.", translation: "Các chương trình giao lưu văn hóa tạo điều kiện thuận lợi cho sự hiểu biết và đánh giá cao giữa những người có hoàn cảnh khác nhau.", ipa: "/ˈkʌltʃərəl ɪkˈstʃeɪndʒ ˈproʊˌɡræmz fəˈsɪləˌteɪt ˌʌndərˈstændɪŋ ənd əˌpriːʃiˈeɪʃən bɪˈtwiːn ˈpiːpəl frʌm ˈdɪfərənt ˈbækˌɡraʊndz/", difficulty: "medium", theme: "culture" },
      { id: "en-culture9", text: "The proliferation of digital media platforms has democratized access to diverse artistic expressions, allowing independent creators to reach global audiences unprecedentedly.", translation: "Sự phát triển của các nền tảng truyền thông kỹ thuật số đã dân chủ hóa quyền truy cập vào các biểu hiện nghệ thuật đa dạng, cho phép những người sáng tạo độc lập tiếp cận khán giả toàn cầu một cách chưa từng có.", ipa: "/ðə ˌproʊlɪfərˈeɪʃən ʌv ˈdɪdʒətəl ˈmiːdiə ˈplæˌtfɔːrmz hæz dɪˈmɑːkrəˌtaɪzd ˈæˌksɛs tuː daɪˈvɜːrs ɑːˈrtɪstɪk ɪksˈprɛʃənz əˈlaʊɪŋ ˌɪndɪˈpɛndənt kriˈeɪtərz tuː riːtʃ ˈɡloʊbəl ˈɑːdiənsəz ənˈprɛsəˌdɛntɪdli/", difficulty: "hard", theme: "culture" },
      { id: "en-culture10", text: "Understanding the intricate interplay between historical contexts, societal norms, and individual creativity is fundamental to appreciating the depth and evolution of cultural phenomena worldwide.", translation: "Hiểu được sự tương tác phức tạp giữa bối cảnh lịch sử, chuẩn mực xã hội và sự sáng tạo cá nhân là điều cơ bản để đánh giá chiều sâu và sự phát triển của các hiện tượng văn hóa trên toàn thế giới.", ipa: "/ˌʌndərˈstændɪŋ ðə ˈɪntrəkət ˈɪntərˌpleɪ bɪˈtwiːn hɪˈstɔːrɪkəl ˈkɑːˌntɛksts səˈsaɪɪtəl nɔːrmz ənd ˌɪndəˈvɪdʒəwəl ˌkriːeɪˈtɪvəti ɪz ˌfʌndəˈmɛntəl tuː əˈpriːʃiˌeɪtɪŋ ðə dɛpθ ənd ˌɛvəˈluːʃən ʌv ˈkʌltʃərəl fəˈnɑːmənə ˈwɜːrlˈdwaɪd/", difficulty: "hard", theme: "culture" },
    ],
  },
  {
    id: "en-technology", name: "Technology", nameVi: "Công nghệ", icon: "💻",
    sentences: [
      { id: "en-tech1", text: "Technology has transformed the way we communicate with each other.", translation: "Công nghệ đã thay đổi cách chúng ta giao tiếp với nhau.", ipa: "/tɛˈknɑːlədʒi hæz trænˈsfɔːrmd ðə weɪ wiː kəˈmjuːnəˌkeɪt wɪð iːtʃ ˈʌðər/", difficulty: "easy", theme: "technology" },
      { id: "en-tech2", text: "I use my smartphone for almost everything, from banking to shopping.", translation: "Tôi dùng điện thoại thông minh cho hầu hết mọi thứ, từ ngân hàng đến mua sắm.", ipa: "/aɪ juːs maɪ ˈsmɑːrˌtfoʊn fɔːr ˈɔːˌlmoʊst ˈɛvriˌθɪŋ frʌm ˈbæŋkɪŋ tuː ˈʃɑːpɪŋ/", difficulty: "easy", theme: "technology" },
      { id: "en-tech3", text: "Artificial intelligence is becoming increasingly important in everyday life.", translation: "Trí tuệ nhân tạo ngày càng trở nên quan trọng trong cuộc sống hàng ngày.", ipa: "/ˌɑːrtəˈfɪʃəl ˌɪˈntɛlədʒəns ɪz bɪˈkʌmɪŋ ɪnˈkriːsɪŋli ˌɪˈmpɔːrtənt ɪn ˈɛvriˈdeɪ laɪf/", difficulty: "medium", theme: "technology" },
      { id: "en-tech4", text: "Social media platforms have changed the way people share information.", translation: "Các nền tảng mạng xã hội đã thay đổi cách mọi người chia sẻ thông tin.", ipa: "/ˈsoʊʃəl ˈmiːdiə ˈplæˌtfɔːrmz hæv tʃeɪndʒd ðə weɪ ˈpiːpəl ʃɛr ˌɪnfərˈmeɪʃən/", difficulty: "medium", theme: "technology" },
      { id: "en-tech5", text: "Online learning has made education accessible to people around the world.", translation: "Học trực tuyến đã giúp giáo dục tiếp cận được với mọi người trên thế giới.", ipa: "/ˈɔːˌnlaɪn ˈlɜːrnɪŋ hæz meɪd ˌɛdʒəˈkeɪʃən æˈksɛsəbəl tuː ˈpiːpəl ərˈaʊnd ðə wɜːrld/", difficulty: "medium", theme: "technology" },
      { id: "en-tech6", text: "Cybersecurity is a growing concern as more data is stored online.", translation: "An ninh mạng là mối lo ngại ngày càng tăng khi nhiều dữ liệu được lưu trữ trực tuyến.", ipa: "/saɪbərsɪkjʊrəti ɪz ə gɹoʊɪŋ kənsərn æz mɔɹ deɪtə ɪz stɔɹd ɔnlaɪn/", difficulty: "medium", theme: "technology" },
      { id: "en-tech7", text: "Electric vehicles are expected to replace traditional cars in the near future.", translation: "Xe điện được kỳ vọng sẽ thay thế ô tô truyền thống trong tương lai gần.", ipa: "/ɪˈlɛktrɪk ˈviːhɪkəlz ɑːr ɪkˈspɛktəd tuː ˌriːˈpleɪs trəˈdɪʃənəl kɑːrz ɪn ðə nɪr ˈfjuːtʃər/", difficulty: "medium", theme: "technology" },
      { id: "en-tech8", text: "The rapid advancement of technology presents both opportunities and challenges for society.", translation: "Sự phát triển nhanh chóng của công nghệ mang lại cả cơ hội lẫn thách thức cho xã hội.", ipa: "/ðə ˈræpəd əˈdvænsmənt ʌv tɛˈknɑːlədʒi ˈprɛzənts boʊθ ˌɑːpərˈtuːnətiz ənd ˈtʃæləndʒɪz fɔːr səˈsaɪəti/", difficulty: "hard", theme: "technology" },
      { id: "en-tech9", text: "Cloud computing allows businesses to store and access data remotely without physical servers.", translation: "Điện toán đám mây cho phép doanh nghiệp lưu trữ và truy cập dữ liệu từ xa mà không cần máy chủ vật lý.", ipa: "/klaʊd kəmˈpjuːtɪŋ əˈlaʊz ˈbɪznəsəz tuː stɔːr ənd ˈæˌksɛs ˈdeɪtə riˈmoʊtli wɪˈθaʊt ˈfɪzɪkəl ˈsɜːrvərz/", difficulty: "hard", theme: "technology" },
      { id: "en-tech10", text: "The ethical implications of artificial intelligence require careful consideration by policymakers and technologists alike.", translation: "Những hệ quả đạo đức của trí tuệ nhân tạo đòi hỏi sự cân nhắc cẩn thận từ cả các nhà hoạch định chính sách và nhà công nghệ.", ipa: "/ðə ˈɛθɪkəl ˌɪmpləˈkeɪʃənz ʌv ˌɑːrtəˈfɪʃəl ˌɪˈntɛlədʒəns ˌriːˈkwaɪər ˈkɛrfəl kəˌnsɪdərˈeɪʃən baɪ ˈpɑːləsiˌmeɪkərz ənd ˌtɛˈknɑːlədʒɪsts əˈlaɪk/", difficulty: "hard", theme: "technology" },
    ],
  },
  {
    id: "en-environment", name: "Environment", nameVi: "Môi trường", icon: "🌍",
    sentences: [
      { id: "en-env1", text: "We should recycle more to protect the environment.", translation: "Chúng ta nên tái chế nhiều hơn để bảo vệ môi trường.", ipa: "/wiː ʃʊd riˈsaɪkəl mɔːr tuː prəˈtɛkt ðə ɪˈnvaɪrənmənt/", difficulty: "easy", theme: "environment" },
      { id: "en-env2", text: "Climate change is one of the biggest challenges facing our planet.", translation: "Biến đổi khí hậu là một trong những thách thức lớn nhất mà hành tinh chúng ta đang đối mặt.", ipa: "/ˈklaɪmət tʃeɪndʒ ɪz wʌn ʌv ðə ˈbɪɡəst ˈtʃæləndʒɪz ˈfeɪsɪŋ aʊər ˈplænət/", difficulty: "easy", theme: "environment" },
      { id: "en-env3", text: "Renewable energy sources like solar and wind power are becoming more affordable.", translation: "Các nguồn năng lượng tái tạo như năng lượng mặt trời và gió ngày càng trở nên hợp lý hơn.", ipa: "/riˈnuːəbəl ˈɛnərdʒi ˈsɔːrsəz laɪk ˈsoʊlər ənd waɪnd ˈpaʊər ɑːr bɪˈkʌmɪŋ mɔːr əˈfɔːrdəbəl/", difficulty: "medium", theme: "environment" },
      { id: "en-env4", text: "Deforestation has a devastating impact on biodiversity and local communities.", translation: "Phá rừng có tác động tàn khốc đến đa dạng sinh học và cộng đồng địa phương.", ipa: "/dɪˌfɔːrɪˈsteɪʃən hæz ə ˈdɛvəˌsteɪtɪŋ ˌɪˈmpækt ɑːn ˌbaɪoʊdaɪˈvɜːrsəti ənd ˈloʊkəl kəˈmjuːnətiz/", difficulty: "medium", theme: "environment" },
      { id: "en-env5", text: "Reducing plastic waste is essential for protecting marine ecosystems.", translation: "Giảm thiểu rác thải nhựa là điều cần thiết để bảo vệ hệ sinh thái biển.", ipa: "/rəˈduːsɪŋ ˈplæstɪk weɪst ɪz ɛˈsɛnʃəl fɔːr prəˈtɛktɪŋ mərˈiːn ˈiːkoʊˌsɪstəmz/", difficulty: "medium", theme: "environment" },
      { id: "en-env6", text: "Many countries are investing in green technology to reduce carbon emissions.", translation: "Nhiều quốc gia đang đầu tư vào công nghệ xanh để giảm lượng khí thải carbon.", ipa: "/ˈmɛni ˈkʌntriz ɑːr ˌɪˈnvɛstɪŋ ɪn ɡriːn tɛˈknɑːlədʒi tuː rəˈduːs ˈkɑːrbən ɪˈmɪʃənz/", difficulty: "medium", theme: "environment" },
      { id: "en-env7", text: "Sustainable agriculture practices help preserve soil quality and water resources.", translation: "Các phương pháp nông nghiệp bền vững giúp bảo tồn chất lượng đất và tài nguyên nước.", ipa: "/səˈsteɪnəbəl ˈæɡrɪˌkʌltʃər ˈpræktəsəz hɛlp prəˈzɜːrv sɔɪl ˈkwɑːləti ənd ˈwɔːtər ˈriːsɔːrsɪz/", difficulty: "medium", theme: "environment" },
      { id: "en-env8", text: "The Paris Agreement aims to limit global warming to well below two degrees Celsius.", translation: "Hiệp định Paris nhằm hạn chế sự nóng lên toàn cầu dưới hai độ C.", ipa: "/ðə ˈpɛrɪs əˈɡriːmənt eɪmz tuː ˈlɪmət ˈɡloʊbəl ˈwɔːrmɪŋ tuː wɛl bɪˈloʊ tuː dɪˈɡriːz ˈsɛlsiəs/", difficulty: "hard", theme: "environment" },
      { id: "en-env9", text: "Urban planning that prioritizes green spaces and public transportation can significantly reduce pollution.", translation: "Quy hoạch đô thị ưu tiên không gian xanh và giao thông công cộng có thể giảm đáng kể ô nhiễm.", ipa: "/ˈɜːrbən ˈplænɪŋ ðæt praɪˈɔːrəˌtaɪzɪz ɡriːn ˈspeɪsəz ənd ˈpʌblɪk ˌtrænspərˈteɪʃən kæn sɪˈɡnɪfɪkəntli rəˈduːs pəˈluːʃən/", difficulty: "hard", theme: "environment" },
      { id: "en-env10", text: "The interconnected nature of environmental challenges necessitates a collaborative, multi-disciplinary approach to developing effective and equitable solutions.", translation: "Bản chất liên kết của các thách thức môi trường đòi hỏi một cách tiếp cận hợp tác, đa ngành để phát triển các giải pháp hiệu quả và công bằng.", ipa: "/ðə ˌɪntərkəˈnɛktɪd ˈneɪtʃər ʌv ɪˌnvaɪrəˈnmɛntəl ˈtʃæləndʒɪz nəˈsɛsəˌteɪts ə kəˈlæbərˌeɪtɪv ˈmʌltiˈdɪsəpləˌnɛri əˈproʊtʃ tuː dɪˈvɛləpɪŋ ɪˈfɛktɪv ənd ˈɛkwətəbəl səˈluːʃənz/", difficulty: "hard", theme: "environment" },
    ],
  },
  {
    id: "en-housing", name: "Housing & Home", nameVi: "Nhà cửa & Gia đình", icon: "🏠",
    sentences: [
      { id: "en-ho1", text: "I live in a small apartment near the city center.", translation: "Tôi sống trong một căn hộ nhỏ gần trung tâm thành phố.", ipa: "/aɪ laɪv ɪn ə smɔːl əˈpɑːrtmənt nɪr ðə ˈsɪti ˈsɛntər/", difficulty: "easy", theme: "housing" },
      { id: "en-ho2", text: "How much is the rent per month?", translation: "Tiền thuê mỗi tháng bao nhiêu?", ipa: "/haʊ mʌtʃ ɪz ðə rɛnt pɜːr mʌnθ/", difficulty: "easy", theme: "housing" },
      { id: "en-ho3", text: "The living room is spacious and well-lit.", translation: "Phòng khách rộng rãi và đầy ánh sáng.", ipa: "/ðə ˈlɪvɪŋ ruːm ɪz ˈspeɪʃəs ənd wɛllɪt/", difficulty: "easy", theme: "housing" },
      { id: "en-ho4", text: "I need to fix the leaking faucet in the kitchen.", translation: "Tôi cần sửa vòi nước bị rỉ trong bếp.", ipa: "/aɪ niːd tuː fɪks ðə ˈliːkɪŋ ˈfɔːsət ɪn ðə ˈkɪtʃən/", difficulty: "medium", theme: "housing" },
      { id: "en-ho5", text: "We are looking for a house with a garden for our children.", translation: "Chúng tôi đang tìm một ngôi nhà có vườn cho con cái.", ipa: "/wiː ɑːr ˈlʊkɪŋ fɔːr ə haʊs wɪð ə ˈɡɑːrdən fɔːr aʊər ˈtʃɪldrən/", difficulty: "medium", theme: "housing" },
      { id: "en-ho6", text: "The neighborhood is quiet and safe, perfect for families.", translation: "Khu phố yên tĩnh và an toàn, hoàn hảo cho các gia đình.", ipa: "/ðə ˈneɪbərˌhʊd ɪz ˈkwaɪət ənd seɪf pərˈfɛkt fɔːr ˈfæməliz/", difficulty: "medium", theme: "housing" },
      { id: "en-ho7", text: "I would like to schedule a viewing for the property listed online.", translation: "Tôi muốn đặt lịch xem bất động sản được đăng trực tuyến.", ipa: "/aɪ wʊd laɪk tuː ˈskɛdʒʊl ə ˈvjuːɪŋ fɔːr ðə ˈprɑːpərti ˈlɪstəd ˈɔːˌnlaɪn/", difficulty: "medium", theme: "housing" },
      { id: "en-ho8", text: "The landlord requires a two-month deposit before moving in.", translation: "Chủ nhà yêu cầu đặt cọc hai tháng trước khi dọn vào.", ipa: "/ðə ˈlænˌdlɔːrd riˈkwaɪərz ə tuːmʌnθ dəˈpɑːzɪt bɪˈfɔːr ˈmuːvɪŋ ɪn/", difficulty: "medium", theme: "housing" },
      { id: "en-ho9", text: "Energy-efficient homes are becoming increasingly popular due to rising utility costs and environmental awareness.", translation: "Nhà tiết kiệm năng lượng ngày càng phổ biến do chi phí tiện ích tăng và nhận thức về môi trường.", ipa: "/ˈɛnərdʒiɪˈfɪʃənt hoʊmz ɑːr bɪˈkʌmɪŋ ɪnˈkriːsɪŋli ˈpɑːpjələr duː tuː ˈraɪzɪŋ juˈtɪləti kɑːsts ənd ɪˌnvaɪrəˈnmɛntəl əˈwɛrnəs/", difficulty: "hard", theme: "housing" },
      { id: "en-ho10", text: "The process of buying a home involves multiple steps including mortgage approval, property inspection, and legal documentation.", translation: "Quá trình mua nhà bao gồm nhiều bước như phê duyệt thế chấp, kiểm tra tài sản và giấy tờ pháp lý.", ipa: "/ðə ˈprɑːˌsɛs ʌv ˈbaɪɪŋ ə hoʊm ˌɪˈnvɑːlvz ˈmʌltəpəl stɛps ˌɪnˈkluːdɪŋ ˈmɔːrɡədʒ əˈpruːvəl ˈprɑːpərti ˌɪnˈspɛkʃən ənd ˈliːɡəl ˌdɑːkjəmɛˈnteɪʃən/", difficulty: "hard", theme: "housing" },
    ],
  },
  {
    ...
    sentences: [
      ...
      { id: "en-ss2", text: "I would like to return this item, please.", translation: "Tôi muốn trả lại sản phẩm này.", ipa: "/aɪ wʊd laɪk tuː rɪˈtɜːrn ðɪs ˈaɪtəm pliːz/", difficulty: "easy", theme: "shopping-services" },
      { id: "en-ss3", text: "Do you accept credit cards?", translation: "Bạn có chấp nhận thẻ tín dụng không?", ipa: "/duː juː æˈksɛpt ˈkrɛdət kɑːrdz/", difficulty: "easy", theme: "shopping-services" },
      { id: "en-ss4", text: "Is there a warranty on this product?", translation: "Sản phẩm này có bảo hành không?", ipa: "/ɪz ðɛr ə ˈwɔːrənti ɑːn ðɪs ˈprɑːdəkt/", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss5", text: "I need to make an appointment at the bank to open a new account.", translation: "Tôi cần đặt lịch hẹn ở ngân hàng để mở tài khoản mới.", ipa: "/aɪ niːd tuː meɪk æn əˈpɔɪntmənt æt ðə bæŋk tuː ˈoʊpən ə nuː əˈkaʊnt/", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss6", text: "The customer service representative was very helpful and resolved my issue quickly.", translation: "Nhân viên dịch vụ khách hàng rất hữu ích và giải quyết vấn đề của tôi nhanh chóng.", ipa: "/ðə ˈkʌstəmər ˈsɜːrvəs ˌrɛprəˈzɛntətɪv wɑːz ˈvɛri ˈhɛlpfəl ənd riˈzɑːlvd maɪ ˈɪʃu ˈkwɪkli/", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss7", text: "Could you recommend the best deal on smartphones currently available?", translation: "Bạn có thể gợi ý ưu đãi tốt nhất cho điện thoại thông minh hiện có không?", ipa: "/kʊd juː ˌrɛkəˈmɛnd ðə bɛst diːl ɑːn ˈsmɑːrˌtfoʊnz ˈkɜːrəntli əˈveɪləbəl/", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss8", text: "I would like to compare the features and prices of these two laptops before making a decision.", translation: "Tôi muốn so sánh tính năng và giá của hai chiếc laptop này trước khi quyết định.", ipa: "/aɪ wʊd laɪk tuː kəˈmpɛr ðə ˈfiːtʃərz ənd ˈpraɪsəz ʌv ðiːz tuː ˈlæˌptɑːps bɪˈfɔːr ˈmeɪkɪŋ ə dɪˈsɪʒən/", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss9", text: "Consumer protection laws ensure that buyers have the right to refunds for defective products within a specified period.", translation: "Luật bảo vệ người tiêu dùng đảm bảo người mua có quyền hoàn tiền cho sản phẩm lỗi trong thời hạn nhất định.", ipa: "/kəˈnsuːmər prəˈtɛkʃən lɔːz ɛˈnʃʊr ðæt ˈbaɪərz hæv ðə raɪt tuː rɪˈfʌndz fɔːr dɪˈfɛktɪv ˈprɑːdəkts wɪˈðɪn ə ˈspɛsəˌfaɪd ˈpɪriəd/", difficulty: "hard", theme: "shopping-services" },
      { id: "en-ss10", text: "The rise of subscription-based services has fundamentally changed how consumers access and pay for products ranging from software to groceries.", translation: "Sự phát triển của dịch vụ theo thuê bao đã thay đổi căn bản cách người tiêu dùng truy cập và thanh toán cho sản phẩm từ phần mềm đến tạp hóa.", ipa: "/ðə raɪz ʌv səbsˈkrɪpʃənbeɪst ˈsɜːrvəsəz hæz ˌfʌndəˈmɛntəli tʃeɪndʒd haʊ kəˈnsuːmərz ˈæˌksɛs ənd peɪ fɔːr ˈprɑːdəkts ˈreɪndʒɪŋ frʌm ˈsɔːfˌtwɛr tuː ˈɡroʊsəriz/", difficulty: "hard", theme: "shopping-services" },
    ],
  },
  {
    id: "en-academic", name: "Academic English", nameVi: "Tiếng Anh học thuật", icon: "🎓",
    sentences: [
      { id: "en-ac1", text: "The thesis statement should clearly present your argument.", translation: "Câu luận điểm nên trình bày rõ ràng lập luận của bạn.", ipa: "/ðə ˈθiːsəs ˈsteɪtmənt ʃʊd ˈklɪrli ˈprɛzənt jɔːr ˈɑːrɡjəmənt/", difficulty: "easy", theme: "academic" },
      { id: "en-ac2", text: "Please cite your sources properly in the bibliography.", translation: "Vui lòng trích dẫn nguồn đúng cách trong danh mục tài liệu.", ipa: "/pliːz saɪt jɔːr ˈsɔːrsəz ˈprɑːpərli ɪn ðə ˌbɪbliˈɑːɡrəfi/", difficulty: "medium", theme: "academic" },
      { id: "en-ac3", text: "The experiment yielded unexpected results that challenged our hypothesis.", translation: "Thí nghiệm cho ra kết quả bất ngờ thách thức giả thuyết của chúng tôi.", ipa: "/ðə ɪkˈspɛrəmənt ˈjiːldɪd ˌʌnɪkˈspɛktɪd rɪˈzʌlts ðæt ˈtʃæləndʒd aʊər haɪˈpɑːθəsəs/", difficulty: "medium", theme: "academic" },
      { id: "en-ac4", text: "Peer review is an essential part of the academic publishing process.", translation: "Đánh giá ngang hàng là phần thiết yếu của quy trình xuất bản học thuật.", ipa: "/pɪr ˌriːˈvjuː ɪz æn ɛˈsɛnʃəl pɑːrt ʌv ðə ˌækəˈdɛmɪk ˈpʌblɪʃɪŋ ˈprɑːˌsɛs/", difficulty: "medium", theme: "academic" },
      { id: "en-ac5", text: "The professor's lecture on quantum physics was both challenging and fascinating.", translation: "Bài giảng của giáo sư về vật lý lượng tử vừa thách thức vừa hấp dẫn.", ipa: "/ðə prəˈfɛsərz ˈlɛktʃər ɑːn ˈkwɑːntəm ˈfɪzɪks wɑːz boʊθ ˈtʃæləndʒɪŋ ənd ˈfæsəˌneɪtɪŋ/", difficulty: "medium", theme: "academic" },
      { id: "en-ac6", text: "A well-structured essay includes an introduction, body paragraphs, and a conclusion.", translation: "Một bài luận có cấu trúc tốt bao gồm phần mở đầu, các đoạn thân bài và kết luận.", ipa: "/ə wɛlsˈtrʌktʃərd ɛˈseɪ ˌɪnˈkluːdz æn ˌɪntrəˈdʌkʃən ˈbɑːdi ˈpærəˌɡræfs ənd ə kənˈkluːʒən/", difficulty: "medium", theme: "academic" },
      { id: "en-ac7", text: "The research methodology must be transparent and reproducible to ensure scientific validity.", translation: "Phương pháp nghiên cứu phải minh bạch và có thể tái tạo để đảm bảo tính khoa học.", ipa: "/ðə ɹisərʧ mɛθədɑləʤi məst bi tɹænspɛɹənt ənd reproducible tə ɛnʃʊɹ saɪəntɪfɪk vəlɪdəti/", difficulty: "hard", theme: "academic" },
      { id: "en-ac8", text: "Interdisciplinary collaboration between departments often leads to groundbreaking discoveries.", translation: "Sự hợp tác liên ngành giữa các khoa thường dẫn đến những khám phá đột phá.", ipa: "/ˌɪntərˈdɪsəpləˌnɛri kəˌlæbərˈeɪʃən bɪˈtwiːn dɪˈpɑːrtmənts ˈɔːfən liːdz tuː ˈɡraʊndˌbreɪkɪŋ dɪˈskʌvəriz/", difficulty: "hard", theme: "academic" },
      { id: "en-ac9", text: "The doctoral dissertation required three years of intensive research and data analysis across multiple case studies.", translation: "Luận án tiến sĩ đòi hỏi ba năm nghiên cứu chuyên sâu và phân tích dữ liệu qua nhiều nghiên cứu trường hợp.", ipa: "/ðə ˈdɑːktərəl ˌdɪsərˈteɪʃən riˈkwaɪərd θriː jɪrz ʌv ˌɪˈntɛnsɪv riˈsɜːrtʃ ənd ˈdeɪtə əˈnæləsəs əˈkrɔːs ˈmʌltəpəl keɪs ˈstʌdiz/", difficulty: "hard", theme: "academic" },
      { id: "en-ac10", text: "Academic integrity demands that all intellectual contributions be properly attributed to their original authors through rigorous citation practices.", translation: "Liêm chính học thuật đòi hỏi tất cả đóng góp trí tuệ phải được ghi nhận đúng tác giả gốc thông qua trích dẫn nghiêm ngặt.", ipa: "/ˌækəˈdɛmɪk ˌɪˈntɛɡrəti dɪˈmændz ðæt ɔːl ˌɪntəˈlɛktʃuəl ˌkɑːntrəˈbjuːʃənz biː ˈprɑːpərli əˈtrɪbjətɪd tuː ðɛr ərˈɪdʒənəl ˈɔːθərz θruː ˈrɪɡərəs saɪˈteɪʃən ˈpræktəsəz/", difficulty: "hard", theme: "academic" },
    ],
  },
  {
    id: "en-social-digital", name: "Social Media & Digital", nameVi: "Mạng xã hội & Kỹ thuật số", icon: "📱",
    sentences: [
      { id: "en-sd1", text: "I check my social media every morning.", translation: "Tôi kiểm tra mạng xã hội mỗi sáng.", ipa: "/aɪ tʃɛk maɪ ˈsoʊʃəl ˈmiːdiə ˈɛvəri ˈmɔːrnɪŋ/", difficulty: "easy", theme: "social-digital" },
      { id: "en-sd2", text: "How many followers do you have on Instagram?", translation: "Bạn có bao nhiêu người theo dõi trên Instagram?", ipa: "/haʊ ˈmɛni ˈfɑːloʊərz duː juː hæv ɑːn ˌɪnstəˌɡræm/", difficulty: "easy", theme: "social-digital" },
      { id: "en-sd3", text: "I prefer watching short videos over reading long articles online.", translation: "Tôi thích xem video ngắn hơn là đọc bài viết dài trực tuyến.", ipa: "/aɪ prəˈfɜːr ˈwɑːtʃɪŋ ʃɔːrt ˈvɪdioʊz ˈoʊvər ˈriːdɪŋ lɔːŋ ˈɑːrtəkəlz ˈɔːˌnlaɪn/", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd4", text: "Online privacy settings should be reviewed regularly to protect personal data.", translation: "Cài đặt quyền riêng tư trực tuyến nên được xem xét thường xuyên để bảo vệ dữ liệu cá nhân.", ipa: "/ˈɔːˌnlaɪn ˈpraɪvəsi ˈsɛtɪŋz ʃʊd biː riˈvjuːd ˈrɛɡjələrli tuː prəˈtɛkt ˈpɜːrsɪnəl ˈdeɪtə/", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd5", text: "Influencer marketing has become a major advertising strategy for many brands.", translation: "Tiếp thị qua người có ảnh hưởng đã trở thành chiến lược quảng cáo chính của nhiều thương hiệu.", ipa: "/influencer ˈmɑːrkɪtɪŋ hæz bɪkəm ə meɪʤər ædvərtaɪzɪŋ stɹætəʤi fɔːr mɛni bɹændz/", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd6", text: "It is important to verify information before sharing it on social media.", translation: "Điều quan trọng là xác minh thông tin trước khi chia sẻ trên mạng xã hội.", ipa: "/ɪt ɪz ˌɪˈmpɔːrtənt tuː ˈvɛrəˌfaɪ ˌɪnfərˈmeɪʃən bɪˈfɔːr ˈʃɛrɪŋ ɪt ɑːn ˈsoʊʃəl ˈmiːdiə/", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd7", text: "Digital literacy is becoming as important as traditional literacy in the modern world.", translation: "Hiểu biết kỹ thuật số đang trở nên quan trọng như khả năng đọc viết truyền thống.", ipa: "/ˈdɪdʒətəl ˈlɪtərəsi ɪz bɪˈkʌmɪŋ æz ˌɪˈmpɔːrtənt æz trəˈdɪʃənəl ˈlɪtərəsi ɪn ðə ˈmɑːdərn wɜːrld/", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd8", text: "The algorithm determines which content appears on your feed based on your browsing history and interactions.", translation: "Thuật toán quyết định nội dung nào xuất hiện trên bảng tin dựa trên lịch sử duyệt web và tương tác của bạn.", ipa: "/ðə ˈælɡərˌɪðəm dəˈtɜːrmənz wɪtʃ ˈkɑːntɛnt əˈpɪrz ɑːn jɔːr fiːd beɪst ɑːn jɔːr ˈbraʊzɪŋ ˈhɪstəri ənd ˌɪntərˈækʃənz/", difficulty: "hard", theme: "social-digital" },
      { id: "en-sd9", text: "Cyberbullying and misinformation are serious challenges that social media platforms must address through better moderation policies.", translation: "Bắt nạt trực tuyến và thông tin sai lệch là những thách thức nghiêm trọng mà các nền tảng mạng xã hội phải giải quyết qua chính sách kiểm duyệt tốt hơn.", ipa: "/cyberbullying ənd mɪsɪnfərmeɪʃən ɑːr sɪɹiəs ʧælənʤɪz ðæt soʊʃəl midiə plætfɔɹmz məst ædɹɛs θɹu bɛtər mɑdəreɪʃən pɑləsiz/", difficulty: "hard", theme: "social-digital" },
      { id: "en-sd10", text: "The intersection of social media and mental health has prompted extensive research into how excessive screen time affects cognitive development and emotional well-being.", translation: "Sự giao thoa giữa mạng xã hội và sức khỏe tâm thần đã thúc đẩy nghiên cứu sâu rộng về cách thời gian sử dụng màn hình quá mức ảnh hưởng đến phát triển nhận thức và sức khỏe cảm xúc.", ipa: "/ðə ˌɪntərˈsɛkʃən ʌv ˈsoʊʃəl ˈmiːdiə ənd ˈmɛntəl hɛlθ hæz ˈprɑːmptɪd ɪkˈstɛnsɪv riˈsɜːrtʃ ˈɪntu haʊ ɪˈksɛsɪv skriːn taɪm əˈfɛkts ˈkɑːɡnɪtɪv dɪˈvɛləpmənt ənd ɪˈmoʊʃənəl ˌwɛˈlbiːɪŋ/", difficulty: "hard", theme: "social-digital" },
    ],
  },
];
...
const chineseThemes: SpeakingTheme[] = [
  ...
  },
  {
    ...
    sentences: [
      { id: "zh-d1", text: "我每天早上七点起床。", translation: "Tôi thức dậy lúc 7 giờ sáng mỗi ngày.", ipa: "Wǒ měitiān zǎoshang qī diǎn qǐchuáng.", difficulty: "easy", theme: "daily" },
      { id: "zh-d2", text: "你喜欢做什么？", translation: "Bạn thích làm gì?", ipa: "Nǐ xǐhuān zuò shénme?", difficulty: "easy", theme: "daily" },
      { id: "zh-d3", text: "我喜欢看书，不太喜欢看电视。", translation: "Tôi thích đọc sách, không thích xem tivi lắm.", ipa: "Wǒ xǐhuān kàn shū, bú tài xǐhuān kàn diànshì.", difficulty: "medium", theme: "daily" },
      { id: "zh-d4", text: "今天天气很好，我们去公园吧。", translation: "Hôm nay thời tiết rất đẹp, chúng ta đi công viên nhé.", ipa: "Jīntiān tiānqì hěn hǎo, wǒmen qù gōngyuán ba.", difficulty: "medium", theme: "daily" },
      { id: "zh-d5", text: "周末我通常和家人一起吃饭。", translation: "Cuối tuần tôi thường ăn cơm cùng gia đình.", ipa: "Zhōumò wǒ tōngcháng hé jiārén yìqǐ chīfàn.", difficulty: "medium", theme: "daily" },
  ...
  },
  {
    ...
    sentences: [
      { id: "zh-f1", text: "我想点一碗牛肉面。", translation: "Tôi muốn gọi một bát mì bò.", ipa: "Wǒ xiǎng diǎn yì wǎn niúròu miàn.", difficulty: "easy", theme: "food" },
      { id: "zh-f2", text: "这个菜太辣了，有没有不辣的？", translation: "Món này cay quá, có món nào không cay không?", ipa: "Zhège cài tài là le, yǒu méiyǒu bú là de?", difficulty: "medium", theme: "food" },
      { id: "zh-f3", text: "请问可以用微信支付吗？", translation: "Xin hỏi có thể thanh toán bằng WeChat không?", ipa: "Qǐngwèn kěyǐ yòng Wēixìn zhīfù ma?", difficulty: "medium", theme: "food" },
      { id: "zh-f4", text: "中国菜非常好吃，我最喜欢饺子。", translation: "Món ăn Trung Quốc rất ngon, tôi thích nhất là sủi cảo.", ipa: "Zhōngguó cài fēicháng hǎochī, wǒ zuì xǐhuān jiǎozi.", difficulty: "medium", theme: "food" },
      { id: "zh-f5", text: "服务员，请给我一杯绿茶。", translation: "Phục vụ ơi, cho tôi một ly trà xanh.", ipa: "Fúwùyuán, qǐng gěi wǒ yì bēi lǜchá.", difficulty: "easy", theme: "food" },
      ...
      { id: "zh-f10", text: "不同地区的饮食文化反映了当地的历史、地理和人民的生活方式。", translation: "Văn hóa ẩm thực ở các vùng khác nhau phản ánh lịch sử, địa lý và lối sống của người dân địa phương.", ipa: "Bùtóng dìqū de yǐnshí wénhuà fǎnyìng le dāngdì de lìshǐ, dìlǐ hé rénmín de shēnghuó fāngshì.", difficulty: "hard", theme: "food" },
    ],
  },
  {
    id: "zh-travel", name: "旅行", nameVi: "Du lịch", icon: "✈️",
    sentences: [
      { id: "zh-t1", text: "请问火车站怎么走？", translation: "Xin hỏi ga xe lửa đi đường nào?", ipa: "Qǐngwèn huǒchēzhàn zěnme zǒu?", difficulty: "easy", theme: "travel" },
      { id: "zh-t2", text: "我想买一张去北京的火车票。", translation: "Tôi muốn mua một vé tàu đến Bắc Kinh.", ipa: "Wǒ xiǎng mǎi yì zhāng qù Běijīng de huǒchē piào.", difficulty: "medium", theme: "travel" },
      { id: "zh-t3", text: "这个酒店离机场有多远？", translation: "Khách sạn này cách sân bay bao xa?", ipa: "Zhège jiǔdiàn lí jīchǎng yǒu duō yuǎn?", difficulty: "medium", theme: "travel" },
      { id: "zh-t4", text: "我的航班延误了两个小时。", translation: "Chuyến bay của tôi bị hoãn hai tiếng.", ipa: "Wǒ de hángbān yánwù le liǎng gè xiǎoshí.", difficulty: "medium", theme: "travel" },
      { id: "zh-t5", text: "长城是中国最著名的景点之一。", translation: "Vạn Lý Trường Thành là một trong những thắng cảnh nổi tiếng nhất Trung Quốc.", ipa: "Chángchéng shì Zhōngguó zuì zhùmíng de jǐngdiǎn zhī yī.", difficulty: "hard", theme: "travel" },
      ...
      { id: "zh-t10", text: "提前规划行程并预订住宿可以帮助您获得更顺畅的旅行体验。", translation: "Lên kế hoạch hành trình trước và đặt chỗ ở có thể giúp bạn có trải nghiệm du lịch suôn sẻ hơn.", ipa: "Tíqián guīhuà xíngchéng bìng yùdìng zhùsù kěyǐ bāngzhù nín huòdé gèng shùnchàng de lǚxíng tǐyàn.", difficulty: "hard", theme: "travel" },
    ],
  },
  {
    id: "zh-work", name: "工作", nameVi: "Công việc", icon: "💼",
    sentences: [
      { id: "zh-w1", text: "我在一家科技公司工作。", translation: "Tôi làm việc tại một công ty công nghệ.", ipa: "Wǒ zài yì jiā kējì gōngsī gōngzuò.", difficulty: "easy", theme: "work" },
      { id: "zh-w2", text: "下周三我们需要开会。", translation: "Tuần tới thứ Tư chúng ta cần họp.", ipa: "Xià zhōusān wǒmen xūyào kāihuì.", difficulty: "medium", theme: "work" },
      { id: "zh-w3", text: "这个项目的截止日期是什么时候？", translation: "Hạn chót của dự án này là khi nào?", ipa: "Zhège xiàngmù de jiézhǐ rìqī shì shénme shíhou?", difficulty: "medium", theme: "work" },
      { id: "zh-w4", text: "我对我们团队的能力很有信心。", translation: "Tôi rất tự tin vào năng lực của đội chúng tôi.", ipa: "Wǒ duì wǒmen tuánduì de nénglì hěn yǒu xìnxīn.", difficulty: "hard", theme: "work" },
      { id: "zh-w5", text: "我们来讨论一下这个季度的报告。", translation: "Chúng ta hãy thảo luận về báo cáo quý này.", ipa: "Wǒmen lái tǎolùn yíxià zhège jìdù de bàogào.", difficulty: "medium", theme: "work" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "zh-education8", text: "素质教育不仅仅关注学生的学业成绩，更注重培养他们的综合能力和品德。", translation: "Giáo dục chất lượng không chỉ tập trung vào thành tích học tập của học sinh mà còn chú trọng bồi dưỡng năng lực toàn diện và phẩm chất đạo đức của họ.", ipa: "Sùzhì jiàoyù bùjǐnjǐn guānzhù xuéshēng de xuéyè chéngjì, gèng zhùzhòng péiyǎng tāmen de zōnghé nénglì hé pǐndé.", difficulty: "medium", theme: "education" },
...
import { englishExtraThemes6 } from "./speakingCoachExpansion6";
