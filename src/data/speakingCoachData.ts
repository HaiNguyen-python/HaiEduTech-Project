...
const englishThemes: SpeakingTheme[] = [
  {
    ...
    sentences: [
      { id: "en-g1", text: "Hello, my name is Anna and I am a student.", translation: "Xin chào, tên tôi là Anna và tôi là sinh viên.", ipa: "/həˈloʊ maɪ neɪm ɪz ænə ənd aɪ æm ə studənt/", difficulty: "easy", theme: "greetings" },
      ...
      { id: "en-g7", text: "How have you been doing lately?", translation: "Dạo này bạn thế nào?", ipa: "/haʊ hæv juː bɪn duɪŋ leɪtli/", difficulty: "medium", theme: "greetings" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-d4", text: "She has been working on this project since last Monday.", translation: "Cô ấy đã làm việc trong dự án này từ thứ Hai tuần trước.", ipa: "/ʃi hæz bɪn wərkɪŋ ɑːn ðɪs pɹɑʤɛkt sɪns læst məndi/", difficulty: "medium", theme: "daily" },
      ...
      { id: "en-d9", text: "It's important to balance work and leisure for a healthy lifestyle.", translation: "Điều quan trọng là phải cân bằng công việc và giải trí để có một lối sống lành mạnh.", ipa: "/ɪts ɪmpɔɹtənt tə bæləns wərk ənd lɛʒər fɔːr ə hɛlθi laɪfstaɪl/", difficulty: "hard", theme: "daily" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-t5", text: "I need to check in my luggage before going through security.", translation: "Tôi cần gửi hành lý trước khi qua cổng an ninh.", ipa: "/aɪ nid tə ʧɛk ɪn maɪ ləgəʤ bɪfɔɹ goʊɪŋ θɹu sɪkjʊɹəti/", difficulty: "medium", theme: "travel" },
  ...
  },
  {
    ...
    sentences: [
      { id: "en-w1", text: "I work as a software engineer at a technology company.", translation: "Tôi làm kỹ sư phần mềm tại một công ty công nghệ.", ipa: "/aɪ wərk æz ə sɔftwɛɹ ɛnʤənɪɹ æt ə tɛknɑləʤi kəmpəni/", difficulty: "easy", theme: "work" },
      ...
      { id: "en-w4", text: "I am confident that our team can deliver excellent results.", translation: "Tôi tự tin rằng đội của chúng tôi có thể mang lại kết quả xuất sắc.", ipa: "/aɪ æm kɑnfədənt ðæt ˈaʊər tim kæn dɪlɪvər ɛksələnt ɹɪzəlts/", difficulty: "hard", theme: "work" },
      ...
      { id: "en-w6", text: "What is your typical workday like?", translation: "Một ngày làm việc điển hình của bạn như thế nào?", ipa: "/wʌt ɪz jɔːr tɪpəkəl wərkdeɪ laɪk/", difficulty: "easy", theme: "work" },
  ...
  },
  {
    ...
    sentences: [
      { id: "en-e1", text: "I am studying English to improve my communication skills.", translation: "Tôi đang học tiếng Anh để cải thiện kỹ năng giao tiếp.", ipa: "/aɪ æm stədiɪŋ ɪŋglɪʃ tə ɪmpɹuv maɪ kəmjunəkeɪʃən skɪlz/", difficulty: "easy", theme: "education" },
      { id: "en-e2", text: "The university offers a wide range of courses for international students.", translation: "Trường đại học cung cấp nhiều khóa học cho sinh viên quốc tế.", ipa: "/ðə junəvərsəti ɔfərz ə waɪd ɹeɪnʤ əv kɔɹsəz fɔːr ɪntərnæʃənəl studənts/", difficulty: "medium", theme: "education" },
      ...
      { id: "en-e4", text: "She graduated with honors from a prestigious university.", translation: "Cô ấy tốt nghiệp loại giỏi từ một trường đại học danh tiếng.", ipa: "/ʃi gɹæʤueɪtɪd wɪð ɑnərz fɹəm ə pɹɛstɪʤəs junəvərsəti/", difficulty: "medium", theme: "education" },
      { id: "en-e5", text: "Technology has transformed the way we learn and teach.", translation: "Công nghệ đã thay đổi cách chúng ta học và dạy.", ipa: "/tɛknɑləʤi hæz tɹænsfɔɹmd ðə weɪ wi lərn ənd tiʧ/", difficulty: "medium", theme: "education" },
      ...
      { id: "en-e9", text: "I'm considering pursuing a master's degree in linguistics.", translation: "Tôi đang cân nhắc theo học bằng thạc sĩ về ngôn ngữ học.", ipa: "/aɪm kənsɪdərɪŋ pərsuɪŋ ə mæstərz dɪgɹi ɪn lɪŋgwɪstɪks/", difficulty: "medium", theme: "education" },
      { id: "en-e10", text: "Lifelong learning is essential for personal and professional development in today's world.", translation: "Học tập suốt đời là điều cần thiết cho sự phát triển cá nhân và nghề nghiệp trong thế giới ngày nay.", ipa: "/laɪflɔŋ lərnɪŋ ɪz ɪsɛnʃəl fɔːr pɜrsənəl ənd pɹəfɛʃənəl dɪvɛləpmənt ɪn tədeɪz wərld/", difficulty: "hard", theme: "education" },
    ],
  },
  {
    ...
    sentences: [
      ...
      { id: "en-h6", text: "Eating a balanced diet, which includes plenty of fruits and vegetables, helps prevent many diseases.", translation: "Ăn một chế độ ăn uống cân bằng, bao gồm nhiều trái cây và rau củ, giúp ngăn ngừa nhiều bệnh tật.", ipa: "/itɪŋ ə bælənst daɪʌt wɪʧ ɪnkludz plɛnti əv fɹuts ənd vɛʤtəbəlz hɛlps pɹɪvɛnt mɛni dɪzizəz/", difficulty: "medium", theme: "health" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-food5", text: "Learning to cook diverse cuisines can be a rewarding and enjoyable experience for anyone.", translation: "Học cách nấu các món ăn đa dạng có thể là một trải nghiệm bổ ích và thú vị cho bất kỳ ai.", ipa: "/lərnɪŋ tə kʊk daɪvərs kwɪzinz kæn bi ə ɹɪwɔɹdɪŋ ənd ɛnʤɔjʌbəl ɪkˈspɪəriəns fɔːr ɛniwən/", difficulty: "medium", theme: "food" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-tech5", text: "Online learning has made education accessible to people around the world.", translation: "Học trực tuyến đã giúp giáo dục tiếp cận được với mọi người trên thế giới.", ipa: "/ɔnlaɪn lərnɪŋ hæz meɪd ɛʤəkeɪʃən æksɛsəbəl tə ˈpiːpəl əraʊnd ðə wərld/", difficulty: "medium", theme: "technology" },
      ...
      { id: "en-tech8", text: "The rapid advancement of technology presents both opportunities and challenges for society.", translation: "Sự phát triển nhanh chóng của công nghệ mang lại cả cơ hội lẫn thách thức cho xã hội.", ipa: "/ðə ɹæpəd ədvænsmənt əv tɛknɑləʤi pɹɛzənts boʊθ ɑpərtunətiz ənd ʧælənʤɪz fɔːr səsaɪʌti/", difficulty: "hard", theme: "technology" },
      { id: "en-tech9", text: "Cloud computing allows businesses to store and access data remotely without physical servers.", translation: "Điện toán đám mây cho phép doanh nghiệp lưu trữ và truy cập dữ liệu từ xa mà không cần máy chủ vật lý.", ipa: "/klaʊd kəmpjutɪŋ əlaʊz bɪznəsəz tə stɔɹ ənd æksɛs deɪtə ɹimoʊtli wɪθaʊt fɪzɪkəl sərvərz/", difficulty: "hard", theme: "technology" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-env3", text: "Renewable energy sources like solar and wind power are becoming more affordable.", translation: "Các nguồn năng lượng tái tạo như năng lượng mặt trời và gió ngày càng trở nên hợp lý hơn.", ipa: "/ɹinuʌbəl ɛnərʤi sɔɹsəz laɪk soʊlər ənd waɪnd paʊər ɑːr bɪkəmɪŋ mɔɹ əfɔɹdəbəl/", difficulty: "medium", theme: "environment" },
      { id: "en-env4", text: "Deforestation has a devastating impact on biodiversity and local communities.", translation: "Phá rừng có tác động tàn khốc đến đa dạng sinh học và cộng đồng địa phương.", ipa: "/dɪfɔɹɪsteɪʃən hæz ə dɛvəsteɪtɪŋ ɪmpækt ɑːn baɪoʊdaɪvərsəti ənd loʊkəl kəmjunətiz/", difficulty: "medium", theme: "environment" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-ho6", text: "The neighborhood is quiet and safe, perfect for families.", translation: "Khu phố yên tĩnh và an toàn, hoàn hảo cho các gia đình.", ipa: "/ðə neɪbərhʊd ɪz kwaɪʌt ənd seɪf pərfɛkt fɔːr fæməliz/", difficulty: "medium", theme: "housing" },
      { id: "en-ho7", text: "I would like to schedule a viewing for the property listed online.", translation: "Tôi muốn đặt lịch xem bất động sản được đăng trực tuyến.", ipa: "/aɪ wʊd laɪk tə skɛʤʊl ə vjuɪŋ fɔːr ðə pɹɑpərti lɪstəd ɔnlaɪn/", difficulty: "medium", theme: "housing" },
      ...
      { id: "en-ho10", text: "The process of buying a home involves multiple steps including mortgage approval, property inspection, and legal documentation.", translation: "Quá trình mua nhà bao gồm nhiều bước như phê duyệt thế chấp, kiểm tra tài sản và giấy tờ pháp lý.", ipa: "/ðə pɹɑsɛs əv baɪɪŋ ə hoʊm ɪnvɑlvz məltəpəl stɛps ɪnkludɪŋ mɔɹgəʤ əpɹuvəl pɹɑpərti ɪnspɛkʃən ənd ligəl dɑkjəmɛnteɪʃən/", difficulty: "hard", theme: "housing" },
    ],
  },
  {
    ...
    sentences: [
      ...
      { id: "en-ss2", text: "I would like to return this item, please.", translation: "Tôi muốn trả lại sản phẩm này.", ipa: "/aɪ wʊd laɪk tə ɹɪtərn ðɪs aɪtəm pliz/", difficulty: "easy", theme: "shopping-services" },
      ...
      { id: "en-ss5", text: "I need to make an appointment at the bank to open a new account.", translation: "Tôi cần đặt lịch hẹn ở ngân hàng để mở tài khoản mới.", ipa: "/aɪ nid tə meɪk ən əpɔjntmənt æt ðə bæŋk tə oʊpən ə nu əkaʊnt/", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss6", text: "The customer service representative was very helpful and resolved my issue quickly.", translation: "Nhân viên dịch vụ khách hàng rất hữu ích và giải quyết vấn đề của tôi nhanh chóng.", ipa: "/ðə kəstəmər sərvəs ɹɛpɹəzɛntətɪv wəz vɛɹi hɛlpfəl ənd ɹizɑlvd maɪ ɪʃu kwɪkli/", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss7", text: "Could you recommend the best deal on smartphones currently available?", translation: "Bạn có thể gợi ý ưu đãi tốt nhất cho điện thoại thông minh hiện có không?", ipa: "/kʊd juː ɹɛkəmɛnd ðə bɛst dil ɑːn smɑɹtfoʊnz kərʌntli əveɪləbəl/", difficulty: "medium", theme: "shopping-services" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-ac9", text: "The doctoral dissertation required three years of intensive research and data analysis across multiple case studies.", translation: "Luận án tiến sĩ đòi hỏi ba năm nghiên cứu chuyên sâu và phân tích dữ liệu qua nhiều nghiên cứu trường hợp.", ipa: "/ðə dɑktərəl dɪsərteɪʃən ɹikwaɪərd θɹi jɪɹz əv ɪntɛnsɪv ɹisərʧ ənd deɪtə ənæləsəs əkɹɔs məltəpəl keɪs stədiz/", difficulty: "hard", theme: "academic" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-sd7", text: "Digital literacy is becoming as important as traditional literacy in the modern world.", translation: "Hiểu biết kỹ thuật số đang trở nên quan trọng như khả năng đọc viết truyền thống.", ipa: "/dɪʤətəl ˈlɪtərəsi ɪz bɪkəmɪŋ æz ɪmpɔɹtənt æz tɹədɪʃənəl ˈlɪtərəsi ɪn ðə mɑdərn wərld/", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd8", text: "The algorithm determines which content appears on your feed based on your browsing history and interactions.", translation: "Thuật toán quyết định nội dung nào xuất hiện trên bảng tin dựa trên lịch sử duyệt web và tương tác của bạn.", ipa: "/ðə ælgərɪðəm dətərmənz wɪʧ kɑntɛnt əpɪɹz ɑːn jɔːr fid beɪst ɑːn jɔːr bɹaʊzɪŋ hɪstəri ənd ɪntərækʃənz/", difficulty: "hard", theme: "social-digital" },
