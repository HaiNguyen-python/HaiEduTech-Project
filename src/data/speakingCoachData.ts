...
const englishThemes: SpeakingTheme[] = [
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-d5", text: "The weather forecast says it will rain throughout the weekend.", translation: "Dự báo thời tiết nói trời sẽ mưa suốt cuối tuần.", ipa: "/ðə ˈwɛðər ˈfɔːrˌkæst sɛz ɪt wɪl reɪn θruˈaʊt ðə ˈwiːˌkɛnd/", difficulty: "hard", theme: "daily" },
      ...
      { id: "en-d9", text: "It's important to balance work and leisure for a healthy lifestyle.", translation: "Điều quan trọng là phải cân bằng công việc và giải trí để có một lối sống lành mạnh.", ipa: "/ɪts ˌɪmˈpɔːrtənt tuː ˈbæləns wɜːrk ənd ˈlɛʒər fɔːr ə ˈhɛlθi ˈlaɪfˌstaɪl/", difficulty: "hard", theme: "daily" },
  ...
  },
  {
    ...
    sentences: [
      { id: "en-t1", text: "Excuse me, where is the train station?", translation: "Xin lỗi, ga tàu ở đâu?", ipa: "/ɪkˈskjuːs miː wɛr ɪz ðə treɪn ˈsteɪʃən/", difficulty: "easy", theme: "travel" },
      ...
      { id: "en-t4", text: "The flight has been delayed due to severe weather conditions.", translation: "Chuyến bay đã bị hoãn do điều kiện thời tiết khắc nghiệt.", ipa: "/ðə flaɪt hæz bɪn dɪˈleɪd duː tuː səˈvɪr ˈwɛðər kənˈdɪʃənz/", difficulty: "hard", theme: "travel" },
      ...
      { id: "en-t7", text: "Is there a direct bus to the airport?", translation: "Có xe buýt trực tiếp đến sân bay không?", ipa: "/ɪz ðɛr ə dərˈɛkt bʌs tuː ðə ˈɛrˌpɔːrt/", difficulty: "easy", theme: "travel" },
      ...
      { id: "en-t10", text: "Exploring new cultures and historical sites is the best part of traveling.", translation: "Khám phá các nền văn hóa mới và các di tích lịch sử là phần thú vị nhất của việc đi du lịch.", ipa: "/ɪkˈsplɔːrɪŋ nuː ˈkʌltʃərz ənd hɪˈstɔːrɪkəl saɪts ɪz ðə bɛst pɑːrt ʌv ˈtrævəlɪŋ/", difficulty: "hard", theme: "travel" },
    ],
  },
  {
    id: "en-work", name: "Work & Business", nameVi: "Công việc & Kinh doanh", icon: "💼",
    sentences: [
      { id: "en-w1", text: "I work as a software engineer at a technology company.", translation: "Tôi làm kỹ sư phần mềm tại một công ty công nghệ.", ipa: "/aɪ wɜːrk æz ə ˈsɔːfˌtwɛr ˈɛndʒəˈnɪr æt ə tɛkˈnɑːlədʒi ˈkʌmpəˌniː/", difficulty: "easy", theme: "work" },
      ...
      { id: "en-w3", text: "The deadline for this project has been extended by two weeks.", translation: "Hạn chót cho dự án này đã được gia hạn thêm hai tuần.", ipa: "/ðə ˈdɛdˌlaɪn fɔːr ðɪs ˈprɑːdʒɛkt hæz bɪn ɪkˈstɛndəd baɪ tuː wiːks/", difficulty: "medium", theme: "work" },
      ...
      { id: "en-w6", text: "What is your typical workday like?", translation: "Một ngày làm việc điển hình của bạn như thế nào?", ipa: "/wʌt ɪz jɔːr ˈtɪpəkəl ˈwɜːrkˌdeɪ laɪk/", difficulty: "easy", theme: "work" },
      ...
      { id: "en-w10", text: "Effective collaboration and communication are crucial for team success.", translation: "Sự hợp tác và giao tiếp hiệu quả là rất quan trọng để đội nhóm thành công.", ipa: "/ɪˈfɛktɪv kəˌlæbərˈeɪʃən ənd kəˌmjuːnəˈkeɪʃən ɑːr ˈkruːʃəl fɔːr tiːm səkˈsɛs/", difficulty: "hard", theme: "work" },
    ],
  },
  {
    ...
    sentences: [
      ...
      { id: "en-e3", text: "Critical thinking is one of the most important skills in education.", translation: "Tư duy phản biện là một trong những kỹ năng quan trọng nhất trong giáo dục.", ipa: "/ˈkrɪtɪkəl ˈθɪŋkɪŋ ɪz wʌn ʌv ðə moʊst ˌɪmˈpɔːrtənt skɪlz ɪn ˌɛdʒəˈkeɪʃən/", difficulty: "hard", theme: "education" },
      ...
      { id: "en-e5", text: "Technology has transformed the way we learn and teach.", translation: "Công nghệ đã thay đổi cách chúng ta học và dạy.", ipa: "/tɛkˈnɑːlədʒi hæz trænˈsfɔːrmd ðə weɪ wiː lɜːrn ənd tiːtʃ/", difficulty: "medium", theme: "education" },
      { id: "en-e6", text: "What subject are you studying?", translation: "Bạn đang học môn gì?", ipa: "/wʌt səbˈdʒɛkt ɑːr juː ˈstʌdiɪŋ/", difficulty: "easy", theme: "education" },
      { id: "en-e7", text: "I need to prepare for my exams next week.", translation: "Tôi cần chuẩn bị cho các kỳ thi vào tuần tới.", ipa: "/aɪ niːd tuː priˈpɛr fɔːr maɪ ɪɡˈzæmz nɛkst wiːk/", difficulty: "easy", theme: "education" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-h5", text: "Regular exercise is crucial for maintaining good physical and mental health.", translation: "Tập thể dục thường xuyên rất quan trọng để duy trì sức khỏe thể chất và tinh thần tốt.", ipa: "/ˈrɛɡjələr ˈɛksərˌsaɪz ɪz ˈkruːʃəl fɔːr meɪnˈteɪnɪŋ ɡʊd ˈfɪzɪkəl ənd ˈmɛntəl hɛlθ/", difficulty: "medium", theme: "health" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-tech5", text: "Many people rely on smartphones for communication, work, and entertainment purposes.", translation: "Nhiều người phụ thuộc vào điện thoại thông minh cho mục đích giao tiếp, công việc và giải trí.", ipa: "/ˈmɛni ˈpiːpəl rɪˈlaɪ ɑːn ˈsmɑːrtˌfoʊnz fɔːr kəˌmjuːnəˈkeɪʃən wɜːrk ənd ˌɛntərˈteɪnmənt ˈpɜːrpəsəz/", difficulty: "medium", theme: "tech" },
      { id: "en-tech6", text: "The development of artificial intelligence is rapidly transforming various industries and aspects of daily life.", translation: "Sự phát triển của trí tuệ nhân tạo đang nhanh chóng biến đổi nhiều ngành công nghiệp và các khía cạnh của cuộc sống hàng ngày.", ipa: "/ðə dɪˈvɛləpmənt ʌv ˌɑːrtəˈfɪʃəl ˌɪnˈtɛlədʒəns ɪz ˈræpədli trænˈsfɔːrmɪŋ ˈvɛriəs ˈɪndəstriz ənd ˈæˌspɛkts ʌv ˈdeɪli laɪf/", difficulty: "medium", theme: "tech" },
      { id: "en-tech7", text: "Cloud computing allows users to access their files and applications from any device with an internet connection.", translation: "Điện toán đám mây cho phép người dùng truy cập các tệp và ứng dụng của họ từ mọi thiết bị có kết nối internet.", ipa: "/klaʊd kəmˈpjuːtɪŋ əˈlaʊz ˈjuːzərz tuː ˈækˌsɛs ðɛr faɪlz ənd ˌæpləˈkeɪʃənz frʌm ˈɛni dɪˈvaɪs wɪð æn ˈɪntərˌnɛt kəˈnɛkʃən/", difficulty: "medium", theme: "tech" },
      { id: "en-tech8", text: "Cybersecurity measures are essential to protect personal data and private information from potential online threats.", translation: "Các biện pháp an ninh mạng là điều cần thiết để bảo vệ dữ liệu cá nhân và thông tin riêng tư khỏi các mối đe dọa trực tuyến tiềm ẩn.", ipa: "/ˈsaɪbərsɪˌkjʊrəti ˈmɛʒərz ɑːr ɛˈsɛnʃəl tuː prəˈtɛkt ˈpɜːrsɪnəl ˈdeɪtə ənd ˈpraɪvət ˌɪnfərˈmeɪʃən frʌm pəˈtɛnʃəl ˈɔːnˌlaɪn θrɛts/", difficulty: "medium", theme: "tech" },
      { id: "en-tech9", text: "The rapid advancement of quantum computing promises to revolutionize fields like cryptography and drug discovery, albeit facing significant engineering challenges.", translation: "Sự tiến bộ nhanh chóng của điện toán lượng tử hứa hẹn sẽ cách mạng hóa các lĩnh vực như mã hóa và khám phá thuốc, mặc dù phải đối mặt với những thách thức kỹ thuật đáng kể.", ipa: "/ðə ˈræpəd ədˈvænsmənt ʌv ˈkwɑːntəm kəmˈpjuːtɪŋ ˈprɑːməsəz tuː ˌrɛvəˈluːʃəˌnaɪz fiːldz laɪk krɪpˈtɑːɡrəfi ənd drʌɡ dɪˈskʌvəri ɔːlˈbiːɪt ˈfeɪsɪŋ səɡˈnɪfɪkənt ˈɛndʒəˈnɪrɪŋ ˈtʃæləndʒɪz/", difficulty: "hard", theme: "tech" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-food9", text: "The burgeoning farm-to-table movement emphasizes locally sourced, seasonal produce, fostering sustainability and supporting small agricultural communities.", translation: "Phong trào trang trại đến bàn ăn đang phát triển mạnh mẽ nhấn mạnh sản phẩm địa phương, theo mùa, thúc đẩy tính bền vững và hỗ trợ các cộng đồng nông nghiệp nhỏ.", ipa: "/ðə ˈbɜːrdʒənɪŋ fɑːrmtuːˈteɪbəl ˈmuːvmənt ˈɛmfəˌsaɪzəz ˈloʊkəli sɔːrst ˈsiːzənəl prəˈduːs ˈfɑːstərɪŋ səˌsteɪnəˈbɪlɪti ənd səˈpɔːrtɪŋ smɔːl ˌæɡrəˈkʌltʃərəl kəˈmjuːnətiz/", difficulty: "hard", theme: "food" },
      { id: "en-food10", text: "Molecular gastronomy, a culinary discipline, explores the physical and chemical transformations of ingredients during cooking, often resulting in innovative and surprising dishes.", translation: "Ẩm thực phân tử, một ngành ẩm thực, khám phá các biến đổi vật lý và hóa học của nguyên liệu trong quá trình nấu ăn, thường dẫn đến những món ăn sáng tạo và bất ngờ.", ipa: "/məˈlɛkjələr ɡæˈstrɑːnəmi ə ˈkjuːlɪˌnɛri ˈdɪsəplən ɪkˈsplɔːrz ðə ˈfɪzɪkəl ənd ˈkɛməkəl ˌtrænsfərˈmeɪʃənz ʌv ˌɪnˈɡriːdiənts ˈdʊrɪŋ ˈkʊkɪŋ ˈɔːfən rɪˈzʌltɪŋ ɪn ˈɪnəˌveɪtɪv ənd sərˈpraɪzɪŋ ˈdɪʃəz/", difficulty: "hard", theme: "food" },
    ],
  },
  {
    ...
    sentences: [
      ...
      { id: "en-culture6", text: "Attending live concerts or theater performances offers a unique and engaging form of entertainment.", translation: "Tham dự các buổi hòa nhạc trực tiếp hoặc biểu diễn sân khấu mang đến một hình thức giải trí độc đáo và hấp dẫn.", ipa: "/əˈtɛndɪŋ laɪv ˈkɑːnsərts ɔːr ˈθiːətər pərˈfɔːrmənsəz ˈɔːfərz ə juˈniːk ənd ɛnˈɡeɪdʒɪŋ fɔːrm ʌv ˌɛntərˈteɪnmənt/", difficulty: "medium", theme: "culture" },
      { id: "en-culture7", text: "Literature across various languages provides profound insights into human experiences and societal values.", translation: "Văn học ở nhiều ngôn ngữ khác nhau cung cấp những hiểu biết sâu sắc về trải nghiệm con người và giá trị xã hội.", ipa: "/ˈlɪtərətʃər əˈkrɔːs ˈvɛriəs ˈlæŋɡwədʒəz prəˈvaɪdz proʊˈfaʊnd ˈɪnˌsaɪts ˈɪntu ˈhjuːmən ɪkˈspɪriənsɪz ənd səˈsaɪɪtəl ˈvæljuz/", difficulty: "medium", theme: "culture" },
      { id: "en-culture8", text: "Cultural exchange programs facilitate understanding and appreciation between people from different backgrounds.", translation: "Các chương trình giao lưu văn hóa tạo điều kiện thuận lợi cho sự hiểu biết và đánh giá cao giữa những người có hoàn cảnh khác nhau.", ipa: "/ˈkʌltʃərəl ɪksˈtʃeɪndʒ ˈproʊˌɡræmz fəˈsɪləˌteɪt ˌʌndərˈstændɪŋ ənd əˌpriːʃiˈeɪʃən bɪˈtwiːn ˈpiːpəl frʌm ˈdɪfərənt ˈbækˌɡraʊndz/", difficulty: "medium", theme: "culture" },
      { id: "en-culture9", text: "The proliferation of digital media platforms has democratized access to diverse artistic expressions, allowing independent creators to reach global audiences unprecedentedly.", translation: "Sự phát triển của các nền tảng truyền thông kỹ thuật số đã dân chủ hóa quyền truy cập vào các biểu hiện nghệ thuật đa dạng, cho phép những người sáng tạo độc lập tiếp cận khán giả toàn cầu một cách chưa từng có.", ipa: "/ðə ˌproʊlɪfərˈeɪʃən ʌv ˈdɪdʒətəl ˈmiːdiə ˈplætˌfɔːrmz hæz dɪˈmɑːkrəˌtaɪzd ˈækˌsɛs tuː daɪˈvɜːrs ɑːrˈtɪstɪk ɪkˈsprɛʃənz əˈlaʊɪŋ ˌɪndɪˈpɛndənt kriˈeɪtərz tuː riːtʃ ˈɡloʊbəl ˈɑːdiənsəz ənˈprɛsəˌdɛntɪdli/", difficulty: "hard", theme: "culture" },
      { id: "en-culture10", text: "Understanding the intricate interplay between historical contexts, societal norms, and individual creativity is fundamental to appreciating the depth and evolution of cultural phenomena worldwide.", translation: "Hiểu được sự tương tác phức tạp giữa bối cảnh lịch sử, chuẩn mực xã hội và sự sáng tạo cá nhân là điều cơ bản để đánh giá chiều sâu và sự phát triển của các hiện tượng văn hóa trên toàn thế giới.", ipa: "/ˌʌndərˈstændɪŋ ðə ˈɪntrəkət ˈɪntərˌpleɪ bɪˈtwiːn hɪˈstɔːrɪkəl ˈkɑːnˌtɛksts səˈsaɪɪtəl nɔːrmz ənd ˌɪndəˈvɪdʒəwəl ˌkriːeɪˈtɪvəti ɪz ˌfʌndəˈmɛntəl tuː əˈpriːʃiˌeɪtɪŋ ðə dɛpθ ənd ˌɛvəˈluːʃən ʌv ˈkʌltʃərəl fəˈnɑːmənə ˈwɜːrlˈdwaɪd/", difficulty: "hard", theme: "culture" },
    ],
  },
  {
    id: "en-technology", name: "Technology", nameVi: "Công nghệ", icon: "💻",
    sentences: [
      { id: "en-tech1", text: "Technology has transformed the way we communicate with each other.", translation: "Công nghệ đã thay đổi cách chúng ta giao tiếp với nhau.", ipa: "/tɛkˈnɑːlədʒi hæz trænˈsfɔːrmd ðə weɪ wiː kəˈmjuːnəˌkeɪt wɪð iːtʃ ˈʌðər/", difficulty: "easy", theme: "technology" },
      { id: "en-tech2", text: "I use my smartphone for almost everything, from banking to shopping.", translation: "Tôi dùng điện thoại thông minh cho hầu hết mọi thứ, từ ngân hàng đến mua sắm.", ipa: "/aɪ juːs maɪ ˈsmɑːrtˌfoʊn fɔːr ˈɔːlˌmoʊst ˈɛvriˌθɪŋ frʌm ˈbæŋkɪŋ tuː ˈʃɑːpɪŋ/", difficulty: "easy", theme: "technology" },
      { id: "en-tech3", text: "Artificial intelligence is becoming increasingly important in everyday life.", translation: "Trí tuệ nhân tạo ngày càng trở nên quan trọng trong cuộc sống hàng ngày.", ipa: "/ˌɑːrtəˈfɪʃəl ˌɪnˈtɛlədʒəns ɪz bɪˈkʌmɪŋ ɪnˈkriːsɪŋli ˌɪmˈpɔːrtənt ɪn ˈɛvriˈdeɪ laɪf/", difficulty: "medium", theme: "technology" },
      { id: "en-tech4", text: "Social media platforms have changed the way people share information.", translation: "Các nền tảng mạng xã hội đã thay đổi cách mọi người chia sẻ thông tin.", ipa: "/ˈsoʊʃəl ˈmiːdiə ˈplætˌfɔːrmz hæv tʃeɪndʒd ðə weɪ ˈpiːpəl ʃɛr ˌɪnfərˈmeɪʃən/", difficulty: "medium", theme: "technology" },
      { id: "en-tech5", text: "Online learning has made education accessible to people around the world.", translation: "Học trực tuyến đã giúp giáo dục tiếp cận được với mọi người trên thế giới.", ipa: "/ˈɔːnˌlaɪn ˈlɜːrnɪŋ hæz meɪd ˌɛdʒəˈkeɪʃən ækˈsɛsəbəl tuː ˈpiːpəl ərˈaʊnd ðə wɜːrld/", difficulty: "medium", theme: "technology" },
      { id: "en-tech6", text: "Cybersecurity is a growing concern as more data is stored online.", translation: "An ninh mạng là mối lo ngại ngày càng tăng khi nhiều dữ liệu được lưu trữ trực tuyến.", ipa: "/ˈsaɪbərsɪˌkjʊrəti ɪz ə ˈɡroʊɪŋ kənˈsɜːrn æz mɔːr ˈdeɪtə ɪz stɔːrd ˈɔːnˌlaɪn/", difficulty: "medium", theme: "technology" },
      ...
      { id: "en-tech8", text: "The rapid advancement of technology presents both opportunities and challenges for society.", translation: "Sự phát triển nhanh chóng của công nghệ mang lại cả cơ hội lẫn thách thức cho xã hội.", ipa: "/ðə ˈræpəd ədˈvænsmənt ʌv tɛkˈnɑːlədʒi ˈprɛzənts boʊθ ˌɑːpərˈtuːnətiz ənd ˈtʃæləndʒɪz fɔːr səˈsaɪəti/", difficulty: "hard", theme: "technology" },
      { id: "en-tech9", text: "Cloud computing allows businesses to store and access data remotely without physical servers.", translation: "Điện toán đám mây cho phép doanh nghiệp lưu trữ và truy cập dữ liệu từ xa mà không cần máy chủ vật lý.", ipa: "/klaʊd kəmˈpjuːtɪŋ əˈlaʊz ˈbɪznəsəz tuː stɔːr ənd ˈækˌsɛs ˈdeɪtə riˈmoʊtli wɪˈθaʊt ˈfɪzɪkəl ˈsɜːrvərz/", difficulty: "hard", theme: "technology" },
      { id: "en-tech10", text: "The ethical implications of artificial intelligence require careful consideration by policymakers and technologists alike.", translation: "Những hệ quả đạo đức của trí tuệ nhân tạo đòi hỏi sự cân nhắc cẩn thận từ cả các nhà hoạch định chính sách và nhà công nghệ.", ipa: "/ðə ˈɛθɪkəl ˌɪmpləˈkeɪʃənz ʌv ˌɑːrtəˈfɪʃəl ˌɪnˈtɛlədʒəns ˌriːˈkwaɪər ˈkɛrfəl kənˌsɪdərˈeɪʃən baɪ ˈpɑːləsiˌmeɪkərz ənd ˌtɛkˈnɑːlədʒɪsts əˈlaɪk/", difficulty: "hard", theme: "technology" },
    ],
  },
  {
    id: "en-environment", name: "Environment", nameVi: "Môi trường", icon: "🌍",
    sentences: [
      { id: "en-env1", text: "We should recycle more to protect the environment.", translation: "Chúng ta nên tái chế nhiều hơn để bảo vệ môi trường.", ipa: "/wiː ʃʊd riˈsaɪkəl mɔːr tuː prəˈtɛkt ðə ɪnˈvaɪrənmənt/", difficulty: "easy", theme: "environment" },
      ...
      { id: "en-env6", text: "Many countries are investing in green technology to reduce carbon emissions.", translation: "Nhiều quốc gia đang đầu tư vào công nghệ xanh để giảm lượng khí thải carbon.", ipa: "/ˈmɛni ˈkʌntriz ɑːr ˌɪnˈvɛstɪŋ ɪn ɡriːn tɛkˈnɑːlədʒi tuː rəˈduːs ˈkɑːrbən ɪˈmɪʃənz/", difficulty: "medium", theme: "environment" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-ho7", text: "I would like to schedule a viewing for the property listed online.", translation: "Tôi muốn đặt lịch xem bất động sản được đăng trực tuyến.", ipa: "/aɪ wʊd laɪk tuː ˈskɛdʒʊl ə ˈvjuːɪŋ fɔːr ðə ˈprɑːpərti ˈlɪstəd ˈɔːnˌlaɪn/", difficulty: "medium", theme: "housing" },
      { id: "en-ho8", text: "The landlord requires a two-month deposit before moving in.", translation: "Chủ nhà yêu cầu đặt cọc hai tháng trước khi dọn vào.", ipa: "/ðə ˈlændˌlɔːrd riˈkwaɪərz ə tuːmʌnθ dəˈpɑːzɪt bɪˈfɔːr ˈmuːvɪŋ ɪn/", difficulty: "medium", theme: "housing" },
      { id: "en-ho9", text: "Energy-efficient homes are becoming increasingly popular due to rising utility costs and environmental awareness.", translation: "Nhà tiết kiệm năng lượng ngày càng phổ biến do chi phí tiện ích tăng và nhận thức về môi trường.", ipa: "/ˈɛnərdʒiɪˈfɪʃənt hoʊmz ɑːr bɪˈkʌmɪŋ ɪnˈkriːsɪŋli ˈpɑːpjələr duː tuː ˈraɪzɪŋ juˈtɪləti kɑːsts ənd ɪnˌvaɪrənˈmɛntəl əˈwɛrnəs/", difficulty: "hard", theme: "housing" },
      { id: "en-ho10", text: "The process of buying a home involves multiple steps including mortgage approval, property inspection, and legal documentation.", translation: "Quá trình mua nhà bao gồm nhiều bước như phê duyệt thế chấp, kiểm tra tài sản và giấy tờ pháp lý.", ipa: "/ðə ˈprɑːˌsɛs ʌv ˈbaɪɪŋ ə hoʊm ˌɪnˈvɑːlvz ˈmʌltəpəl stɛps ˌɪnˈkluːdɪŋ ˈmɔːrɡədʒ əˈpruːvəl ˈprɑːpərti ˌɪnˈspɛkʃən ənd ˈliːɡəl ˌdɑːkjəmɛnˈteɪʃən/", difficulty: "hard", theme: "housing" },
    ],
  },
  {
    ...
    sentences: [
      ...
      { id: "en-ss3", text: "Do you accept credit cards?", translation: "Bạn có chấp nhận thẻ tín dụng không?", ipa: "/duː juː ækˈsɛpt ˈkrɛdət kɑːrdz/", difficulty: "easy", theme: "shopping-services" },
      ...
      { id: "en-ss7", text: "Could you recommend the best deal on smartphones currently available?", translation: "Bạn có thể gợi ý ưu đãi tốt nhất cho điện thoại thông minh hiện có không?", ipa: "/kʊd juː ˌrɛkəˈmɛnd ðə bɛst diːl ɑːn ˈsmɑːrtˌfoʊnz ˈkɜːrəntli əˈveɪləbəl/", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss8", text: "I would like to compare the features and prices of these two laptops before making a decision.", translation: "Tôi muốn so sánh tính năng và giá của hai chiếc laptop này trước khi quyết định.", ipa: "/aɪ wʊd laɪk tuː kəmˈpɛr ðə ˈfiːtʃərz ənd ˈpraɪsəz ʌv ðiːz tuː ˈlæpˌtɑːps bɪˈfɔːr ˈmeɪkɪŋ ə dɪˈsɪʒən/", difficulty: "medium", theme: "shopping-services" },
      { id: "en-ss9", text: "Consumer protection laws ensure that buyers have the right to refunds for defective products within a specified period.", translation: "Luật bảo vệ người tiêu dùng đảm bảo người mua có quyền hoàn tiền cho sản phẩm lỗi trong thời hạn nhất định.", ipa: "/kənˈsuːmər prəˈtɛkʃən lɔːz ɛnˈʃʊr ðæt ˈbaɪərz hæv ðə raɪt tuː rɪˈfʌndz fɔːr dɪˈfɛktɪv ˈprɑːdəkts wɪˈðɪn ə ˈspɛsəˌfaɪd ˈpɪriəd/", difficulty: "hard", theme: "shopping-services" },
      { id: "en-ss10", text: "The rise of subscription-based services has fundamentally changed how consumers access and pay for products ranging from software to groceries.", translation: "Sự phát triển của dịch vụ theo thuê bao đã thay đổi căn bản cách người tiêu dùng truy cập và thanh toán cho sản phẩm từ phần mềm đến tạp hóa.", ipa: "/ðə raɪz ʌv səbˈskrɪpʃənbeɪst ˈsɜːrvəsəz hæz ˌfʌndəˈmɛntəli tʃeɪndʒd haʊ kənˈsuːmərz ˈækˌsɛs ənd peɪ fɔːr ˈprɑːdəkts ˈreɪndʒɪŋ frʌm ˈsɔːfˌtwɛr tuː ˈɡroʊsəriz/", difficulty: "hard", theme: "shopping-services" },
    ],
  },
  {
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "en-sd3", text: "I prefer watching short videos over reading long articles online.", translation: "Tôi thích xem video ngắn hơn là đọc bài viết dài trực tuyến.", ipa: "/aɪ prəˈfɜːr ˈwɑːtʃɪŋ ʃɔːrt ˈvɪdioʊz ˈoʊvər ˈriːdɪŋ lɔːŋ ˈɑːrtəkəlz ˈɔːnˌlaɪn/", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd4", text: "Online privacy settings should be reviewed regularly to protect personal data.", translation: "Cài đặt quyền riêng tư trực tuyến nên được xem xét thường xuyên để bảo vệ dữ liệu cá nhân.", ipa: "/ˈɔːnˌlaɪn ˈpraɪvəsi ˈsɛtɪŋz ʃʊd biː riˈvjuːd ˈrɛɡjələrli tuː prəˈtɛkt ˈpɜːrsɪnəl ˈdeɪtə/", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd5", text: "Influencer marketing has become a major advertising strategy for many brands.", translation: "Tiếp thị qua người có ảnh hưởng đã trở thành chiến lược quảng cáo chính của nhiều thương hiệu.", ipa: "/ˈɪnfluənsər ˈmɑːrkətɪŋ hæz bɪˈkʌm ə ˈmeɪdʒər ˈædvərˌtaɪzɪŋ ˈstrætədʒi fɔːr ˈmɛni brændz/", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd6", text: "It is important to verify information before sharing it on social media.", translation: "Điều quan trọng là xác minh thông tin trước khi chia sẻ trên mạng xã hội.", ipa: "/ɪt ɪz ˌɪmˈpɔːrtənt tuː ˈvɛrəˌfaɪ ˌɪnfərˈmeɪʃən bɪˈfɔːr ˈʃɛrɪŋ ɪt ɑːn ˈsoʊʃəl ˈmiːdiə/", difficulty: "medium", theme: "social-digital" },
      { id: "en-sd7", text: "Digital literacy is becoming as important as traditional literacy in the modern world.", translation: "Hiểu biết kỹ thuật số đang trở nên quan trọng như khả năng đọc viết truyền thống.", ipa: "/ˈdɪdʒətəl ˈlɪtərəsi ɪz bɪˈkʌmɪŋ æz ˌɪmˈpɔːrtənt æz trəˈdɪʃənəl ˈlɪtərəsi ɪn ðə ˈmɑːdərn wɜːrld/", difficulty: "medium", theme: "social-digital" },
