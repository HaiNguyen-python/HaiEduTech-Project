...
export const B1_READING: B1ReadingPassage[] = [
  {
    ...
    timeMinutes: 8,
    textFi:
      "Uutinen: Helsingin metron kehitys jatkuu vilkkaana\n\nHelsingin metro saa kaksi uutta linjaa ensi vuonna, mikä on merkittävä parannus pääkaupunkiseudun saavutettavuuteen. Liikennelaitoksen mukaan matkustajat hyötyvät tästä laajennuksesta erityisesti aamuisin, kun ruuhka on tyypillisesti pahimmillaan ja monet ihmiset matkustavat kotoa töihin tai kouluun.\n\nProjektin aikataulu on tarkentunut, ja uudet asemat avataan toukokuussa. Suunnitelmaan kuuluu myös laajempaa kaupunkikehitystä, sillä uusien asemien lähellä rakennetaan parhaillaan myös uusia asuntoja sadoille asukkaille. Tämä tekee alueista houkuttelevia asuinpaikkoja, joista on helpot kulkuyhteydet keskustaan.\n\nKaupunki toivoo, että yhä useampi asukas vaihtaisi auton julkiseen liikenteeseen uuden ja nopean reitin myötä. Tavoitteena on vähentää liikenteen päästöjä ja helpottaa katujen ruuhkautumista. Julkisen liikenteen kehittäminen on tärkeä osa Helsingin strategiaa, ja uudet linjat auttavat tekemään arjesta sujuvampaa kaikille kuntalaisille. Matkustajien odotetaan ottavan uudet yhteydet innolla vastaan heti niiden valmistuttua ensi keväänä.",
  ...
  },
  {
    ...
    timeMinutes: 6,
    textFi:
      "Hei!\n\nKiitos paljon viestistäsi ja mielenkiinnostasi asuntoa kohtaan. Oli mukavaa saada kuulla sinusta. Voin kertoa, että asunto on edelleen vapaana, joten voimme keskustella asiasta lisää. Kyseessä on valoisa ja viihtyisä koti, joka on kahden huoneen kokoinen. Se sopii hyvin esimerkiksi yhdelle henkilölle tai pariskunnalle.\n\nAsunnon vuokra on 850 euroa kuukaudessa. On kuitenkin tärkeää huomata, että sähkö ei sisälly hintaan, vaan sinun täytyy tehdä oma sähkösopimus energiayhtiön kanssa. Vesimaksu ja internet saattavat kuulua hintaan, mutta sähköstä huolehdit itse. Asunto vapautuu pian, ja voit muuttaa sisään 1.6. alkaen. Toivoisin, että uusi asukas voisi sitoutua asumaan täällä vähintään vuoden.\n\nEnnen kuin teemme lopullisen päätöksen, olisi mukavaa, jos voisimme tavata ennen sopimuksen tekemistä. Haluaisin näyttää sinulle asunnon ja keskustella muista yksityiskohdista kasvotusten. Kerro minulle, mikä päivä sinulle sopisi parhaiten ensi viikolla.\n\nOdotan vastaustasi ja toivotan hyvää päivänjatkoa!\n\nYstävällisin terveisin,\nMatti",
  ...
  },
  {
    ...
    timeMinutes: 7,
    textFi:
      "Uutinen: Suomalaiset ja sauna\n\nUuden tutkimuksen mukaan sauna on edelleen erittäin tärkeä osa suomalaista kulttuuria ja arkea. Tutkimustulokset osoittavat, että yli 80 prosenttia suomalaisista käy saunassa vähintään kerran viikossa. Sauna ei ole vain peseytymispaikka, vaan se on tila, jossa ihmiset rentoutuvat ja juttelevat rauhassa perheen tai ystävien kanssa. Joskus suomalaiset saattavat jopa pitää tärkeitä työpalavereita lauteilla istuen.\n\nSuomessa on monenlaisia saunoja, mutta niiden suosio vaihtelee asuinpaikan mukaan. Erityisen suosittu ja perinteinen vaihtoehto on puulämmitteinen sauna, jonka tuoksua monet rakastavat. Toisaalta kaupungeissa sähkösauna on nykyään paljon yleisempi sen helppouden ja nopeuden vuoksi. Vaikka sähkösauna on kätevä kerrostalossa, monet haaveilevat silti aidosta puukiukaasta.\n\nMoni suomalainen kokee, että saunominen kuuluu olennaisena osana elämänrytmiin. Itse asiassa monet vastaajat sanovat suoraan, että ilman säännöllistä saunaa heidän koko viikkonsa tuntuisi vaillinaiselta. Sauna on paikka, jossa arjen stressi unohtuu ja keho puhdistuu viikon kiireistä. On vaikea kuvitella Suomea ilman tätä lämmintä perinnettä.",
  ...
  },
  {
    ...
    timeMinutes: 5,
    textFi:
      "Hyvät asukkaat!\n\nMeillä on iloisia uutisia kaikille asukkaille. Talon piha-alueelle on asennettu uudet kierrätysastiat, jotta voimme yhdessä huolehtia ympäristöstä paremmin. On erittäin tärkeää, että jokainen asukas noudattaa uusia lajitteluohjeita huolellisesti.\n\nEri jätteet, kuten muovi, lasi ja paperi, on lajiteltava tarkasti omiin astioihinsa. Näin voimme varmistaa, että materiaalit päätyvät uusiokäyttöön. Huomioikaa myös, että sekajätettä saa laittaa vain mustaan astiaan. Muihin värillisiin astioihin sekajäte ei kuulu. Jotta astioihin mahtuisi mahdollisimman paljon tavaraa, pahvilaatikot on litistettävä kunnolla ennen astiaan laittamista. Tyhjät ja suuret laatikot vievät muuten turhaa tilaa muiden asukkaiden roskilta.\n\nToivomme, että uudet järjestelyt tekevät kierrättämisestä helppoa ja sujuvaa kaikille talon asukkaille. Jos teillä on kysyttävää jätteiden lajittelusta, voitte ottaa yhteyttä huoltoyhtiöön. Muistakaa pitää myös piha-alue siistinä.\n\nKiitos hyvästä yhteistyöstä ja mukavaa alkanutta viikkoa kaikille!\n\nTerveisin,\nTaloyhtiön hallitus",
  ...
  },
  {
    ...
    timeMinutes: 8,
    textFi:
      "Hyvä asiakas,\n\nOlemme käsitelleet hakemuksesi opintotuesta, jonka lähetit meille aiemmin tänä vuonna. Meillä on ilo ilmoittaa, että päätöksemme on myönteinen ja saat tukea opintojasi varten. Hakemuksesi mukaan olet oikeutettu tukeen koko lukuvuoden ajalle.\n\nSaat tukea yhteensä 270 euroa kuukaudessa ajalla 1.9.–31.5. Tämä tarkoittaa, että tukea maksetaan yhdeksän kuukauden ajan, jos opinto-oikeutesi säilyy voimassa. Tuki maksetaan kuukauden ensimmäisenä arkipäivänä suoraan ilmoittamallesi pankkitilille. Huomioithan, että arkipäiviin eivät kuulu viikonloput tai arkipyhät, joten maksupäivä voi vaihdella hieman kuukausittain. Ensimmäinen maksuerä maksetaan siten syyskuun ensimmäisenä arkipäivänä.\n\nSinun on kuitenkin seurattava opintojesi edistymistä tarkasti. Jos opintosi keskeytyvät tai niissä tapahtuu muita merkittäviä muutoksia, ilmoita siitä Kelaan välittömästi. On tärkeää, että saamme tiedon ajoissa, jotta tukea ei makseta liikaa. Jos sinulla on kysyttävää tästä päätöksestä, voit ottaa yhteyttä asiakaspalveluumme tai vierailla verkkosivuillamme osoitteessa kela.fi.\n\nYstävällisin terveisin,\n\nKela",
...
import {
  ...
  B1_WRITING_EXP3,
  B1_SPEAKING_EXP3,
} from "./ykiB1Expansion3";
import {
  B1_READING_EXP4,
  B1_LISTENING_EXP4,
  B1_WRITING_EXP4,
  B1_SPEAKING_EXP4,
} from "./ykiB1Expansion4";

export const B1_READING_ALL: B1ReadingPassage[] = [
  ...B1_READING,
  ...B1_READING_EXPANSION,
  ...B1_READING_EXPANSION2,
  ...B1_READING_EXP3,
...
export const B1_LISTENING_ALL: B1ListeningClip[] = [
  ...B1_LISTENING,
  ...B1_LISTENING_EXPANSION,
  ...B1_LISTENING_EXPANSION2,
  ...B1_LISTENING_EXP3,
...
export const B1_WRITING_ALL: B1WritingTemplate[] = [
  ...B1_WRITING,
  ...B1_WRITING_EXPANSION,
  ...B1_WRITING_EXPANSION2,
  ...B1_WRITING_EXP3,
...
export const B1_SPEAKING_ALL: B1SpeakingSituation[] = [
  ...B1_SPEAKING,
  ...B1_SPEAKING_EXPANSION,
  ...B1_SPEAKING_EXPANSION2,
  ...B1_SPEAKING_EXP3,
