...
const GENERIC: Template[] = [
  { form: "nom", fi: "Tämä {w} on minulle tärkeä.", en: "This {en} is important to me." },
...
const NOUN_POOLS: Record<string, Template[]> = {
  ...
  "Weather & Seasons": [
    { form: "nom", fi: "Tänään ulkona on {w}.", en: "Today there is {en} outside." },
    { form: "part", fi: "Radio lupaa {w} huomiseksi.", en: "The radio forecasts {en} for tomorrow." },
    { form: "elat", fi: "Suomalaiset puhuvat usein {w}.", en: "Finns often talk about the {en}." },
    { form: "nom", fi: "{W} vaikuttaa suunnitelmiimme.", en: "The {en} affects our plans." },
  ],
  "Time & Calendar": [
    ...
    { form: "nom", fi: "Merkitsin {w} kalenteriin.", en: "I marked the {en} in the calendar." },
  ],
  "Numbers & Math": [
    { form: "nom", fi: "Opettaja kirjoitti {w} taululle laskutehtävään.", en: "The teacher wrote the {en} on the board for the exercise." },
    { form: "part", fi: "Lasken {w} päässä nopeasti.", en: "I calculate the {en} in my head quickly." },
    { form: "elat", fi: "Keskustelimme {w} matematiikan tunnilla.", en: "We discussed the {en} in the maths lesson." },
    { form: "nom", fi: "Tehtävän vastauksena on {w}.", en: "The answer to the exercise is the {en}." },
  ],
  "Colors & Shapes": [
