...
export const B1_READING_EXPANSION: B1ReadingPassage[] = [
  {
    ...
    timeMinutes: 7,
    textFi:
      "Uutinen: Sähköpotkulaudat kaupungissa\n\nSähköpotkulautojen suosio on kasvanut nopeasti suomalaisissa kaupungeissa viime vuosien aikana. Monet asukkaat pitävät niitä todella kätevänä tapana liikkua keskustassa, koska niillä pääsee nopeasti ja helposti paikasta toiseen ilman omaa autoa tai bussia. Ne ovat tulleet tärkeäksi osaksi kaupunkilaisten arkea.\n\nKaikki eivät kuitenkaan ole tyytyväisiä tähän muutokseen, vaan osa asukkaista on huolissaan turvallisuudesta. Viime vuonna onnettomuuksien määrä kasvoi selvästi, mikä on aiheuttanut paljon keskustelua paikallisten keskuudessa. Onnettomuudet ja vaaratilanteet ovat saaneet viranomaiset toimimaan tilanteen parantamiseksi.\n\nTämän vuoksi kaupunki päätti rajoittaa sähköpotkulautojen nopeutta erityisesti jalkakäytävillä, jotta jalankulkijat voisivat liikkua rauhassa. Tavoitteena on vähentää kolareita ja lisätä yleistä turvallisuutta kaduilla. Uudet säännöt ja nopeusrajoitukset astuvat voimaan ensi kuussa. Kaupunki toivoo, että uudet rajoitukset tekevät liikkumisesta turvallisempaa kaikille, mutta samalla säilyttävät potkulaudat hyvänä vaihtoehtona liikkua kaupunkiympäristössä. Onkin mielenkiintoista nähdä, miten uudet säännöt vaikuttavat ihmisten liikkumistottumuksiin tulevaisuudessa.",
  ...
  },
  {
    ...
    timeMinutes: 5,
    textFi:
      "Aihe: Sähköposti: Lääkäriaika peruttu\n\nHyvä asiakas,\n\nLähetämme teille tämän viestin, koska meillä on ikäviä uutisia varaukseenne liittyen. Valitettavasti joudumme perumaan teille varatun lääkäriajan, jonka piti olla tänä keskiviikkona klo 10.00. Syy tähän yllättävään muutokseen on se, että lääkäri Salonen on valitettavasti tullut sairaaksi eikä pysty ottamaan potilaita vastaan lähipäivinä.\n\nOn erittäin tärkeää, että saatte uuden ajan mahdollisimman pian. Voitte varata itsellenne uuden ajan joko sähköisen verkkopalvelumme kautta osoitteessa terveyskeskus.fi tai soittamalla asiakaspalveluumme numeroon 010 123 4567. Puhelinpalvelumme on auki arkisin kello kahdeksasta alkaen. Jos varaatte ajan verkossa, voitte valita teille parhaiten sopivan päivän ja kellonajan muiden vapaana olevien lääkäreiden listalta.\n\nPahoittelemme tästä peruutuksesta mahdollisesti aiheutuvaa ylimääräistä vaivaa ja harmia. Toivomme, että löydätte uuden sopivan ajan pian. Mikäli teillä on kiireellinen hätätilanne, ottakaa yhteys päivystykseen.\n\nYstävällisin terveisin,\n\nTerveyskeskus",
  ...
  },
  {
    ...
    timeMinutes: 8,
    textFi:
      "Uutinen: Suomi julistettiin maailman onnellisimmaksi maaksi\n\nSuomi on jälleen kerran valittu maailman onnellisimmaksi maaksi YK:n uusimmassa vuosittaisessa raportissa. Tämä kunnianosoitus on herättänyt paljon keskustelua sekä kotimaassa että ulkomailla. Tutkijoiden mukaan suomalaisten onnellisuuden taustalla on useita tärkeitä tekijöitä, kuten vahva luottamus toisiin ihmisiin, korkeatasoinen koulutus, toimiva terveydenhuolto sekä puhdas luonnon läheisyys. Nämä asiat luovat turvallisen ympäristön elää ja asua.\n\nToisaalta monet suomalaiset itse yllättyvät näistä tuloksista, kun he lukevat uutisia aiheesta. Syynä tähän on se, että elämä Pohjolassa ei aina tunnu helpolta; esimerkiksi talvi on Suomessa tyypillisesti hyvin pitkä, kylmä ja pimeä. Monen on vaikea yhdistää harmaata säätä ja onnellisuusmitalia toisiinsa.\n\nAsiantuntijat kuitenkin painottavat, että tässä tutkimuksessa onnellisuus ei tarkoita pelkästään hetkellistä iloa, naurua tai riemua. Sen sijaan kyse on syvemmästä tyytyväisyydestä omaan elämään ja yhteiskunnan vakauteen. Vaikka sää on harmaa, suomalaiset voivat luottaa siihen, että apua saa tarvittaessa ja palvelut pelaavat. Tämä kokonaisuus tekee Suomesta maailman onnellisimman maan vuosi toisensa jälkeen.",
  ...
  },
  {
    ...
    timeMinutes: 4,
    textFi:
      "Tiedote asiakkaillemme!\n\nKesä on tullut, ja se tuo mukanaan pieniä muutoksia kirjastopalveluihimme. Haluamme muistuttaa kaikkia asiakkaitamme siitä, että kaupungin pääkirjasto on suljettu juhannuksena 21.–24.6. Tämä tarkoittaa, että ovet pysyvät kiinni yhteensä neljä päivää keskikesän juhlan ajan. Suunnittelethan siis lainasi ja vierailusi ajoissa ennen tätä taukoa.\n\nLähikirjastomme palvelevat teitä kuitenkin läpi kesäkuun ajan arkisin. Lähikirjastot ovat avoinna ma–pe kello 10–18. Huomaathan kuitenkin, että nämä toimipisteet ovat suljettuina viikonloppuisin, joten ne eivät ole auki lauantaina tai sunnuntaina. Jos olet tehnyt varauksia ja haluat saada luettavaa lomaasi varten, varatut kirjat voi noutaa helposti myös kiertävästä kirjastoautosta.\n\nToivomme, että kaikilla on mukava ja aurinkoinen juhannus kirjojen parissa. Mikäli aukioloajoista tai muista palveluista herää kysymyksiä, voit aina kysyä lisää ystävälliseltä henkilökunnaltamme paikan päällä. Voit myös katsoa tarkemmat tiedot ja ajankohtaiset uutiset verkkosivuiltamme. Tervetuloa kirjastoon hyödyntämään kesän palveluita!",
  ...
  },
  {
    ...
    timeMinutes: 6,
    textFi:
      "Hei Mai,\n\nKiitos paljon työhakemuksestasi, jonka lähetit meille. Olemme lukeneet hakemuksesi ja CV:si mielenkiinnolla, ja olemme nyt iloisia voidessamme kutsua sinut haastatteluun ensi torstaina 12.6. kello 14.00.\n\nHaastattelu pidetään toimistollamme, joka sijaitsee keskustassa osoitteessa Mannerheimintie 12. Saavuttuasi perille voit tulla suoraan 4. kerrokseen, jossa vastaanottomme ottaa sinut vastaan.\n\nOle hyvä ja ota mukaan voimassa oleva henkilöllisyystodistus sekä paperinen kopio tutkintotodistuksestasi. Haluaisimme tutustua sinuun paremmin ja kuulla lisää osaamisestasi. On hyvä varata tilaisuuteen riittävästi aikaa, sillä arvioimme, että haastattelu kestää noin 45 minuuttia. Jos sinulla on jotain kysyttävää ennen tapaamistamme, voit vastata tähän viestiin.\n\nVahvistathan tulosi mahdollisimman pian sähköpostitse, jotta tiedämme varautua saapumiseesi. Toivottavasti nähdään ensi viikolla!\n\nYstävällisin terveisin,\n\nLaura Mäkinen\nHR-osasto",
  ...
  },
  {
    ...
    timeMinutes: 8,
    textFi:
      "Uutinen: Suomalainen ruokakulttuuri muuttuu\n\nSuomalaisten ruokatottumukset ovat muuttuneet merkittävästi viimeisen kymmenen vuoden aikana. Vaikka perinteinen kotiruoka on edelleen suosittua, moni suomalainen on alkanut pohtia omia valintojaan tarkemmin. Yhä useampi ihminen syö nykyään kasvisruokaa ja haluaa tietoisesti vähentää lihan kulutusta jokapäiväisessä elämässään.\n\nTutkimusten mukaan erityisesti nuoret kaupunkilaiset ovat kiinnostuneita ympäristöystävällisestä ruoasta. Heille on tärkeää, että ruoan tuotanto ei kuormita luontoa liikaa. Tämä muutos näkyy selvästi suomalaisessa arjessa ja palveluissa. Esimerkiksi ruokakaupoissa on nykyään myynnissä paljon enemmän erilaisia kasvistuotteita kuin ennen. Valikoima on laajentunut kauratuotteista erilaisiin kasvisproteiineihin.\n\nMyös ulkona syöminen on helpottunut niille, jotka eivät halua syödä lihaa, sillä ravintolat tarjoavat usein monipuolisia vegaanivaihtoehtoja kaikille asiakkaille. Aikaisemmin vegaaninen annos saattoi olla harvinaisuus, mutta nyt se on monessa paikassa itsestäänselvyys. Ruoka-alan asiantuntijoiden mukaan tämä trendi ei ole loppumassa, vaan he uskovat, että kehitys tulee jatkumaan samalla tavalla myös tulevaisuudessa. Kasvispainotteinen ruokavalio on tullut jäädäkseen suomalaiseen yhteiskuntaan.",
  ...
  },
  {
    ...
    timeMinutes: 8,
    textFi:
      "Hyvä veronmaksaja,\n\nVerohallinto haluaa ilmoittaa, että uusi verokorttinne vuodelle 2025 on nyt valmis ja se on lähetetty tarkastettavaksi. On erittäin tärkeää, että käytte lukemassa verokorttinne tiedot huolellisesti mahdollisimman pian. Voitte tehdä tämän helposti ja turvallisesti osoitteessa vero.fi kirjautumalla palveluun omilla verkkopankkitunnuksillanne.\n\nEri ihmisten elämäntilanteet muuttuvat usein vuoden aikana. Jos huomaatte, että tulonne ovat muuttuneet tai vähennyksenne ovat erilaiset kuin aikaisemmin, on tärkeää ilmoittaa siitä Verohallintoon viipymättä. Jos arvionne tuloista nousee tai laskee huomattavasti, veroprosenttia täytyy korjata, jotta maksatte oikean määrän veroa vuoden aikana. \n\nMuutokset verokorttiin voi tehdä kahdella helpolla tavalla: joko suoraan verkossa omaveropalvelussa tai soittamalla palvelunumeroomme puhelimitse. Mikäli kaikki tiedot ovat oikein eikä tulonne määrä ole muuttunut, teidän ei tarvitse tehdä mitään erityistä. Tässä tapauksessa vanha verokortti on edelleen voimassa ja verotus jatkuu sen mukaisesti.\n\nYstävällisin terveisin,\nVerohallinto",
