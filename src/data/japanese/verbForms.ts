...
export const JA_VERBS: JaVerb[] = [
  ...
  v("手伝う", "てつだう", "tetsudau", "giúp đỡ", "to help", "1", ["手伝います", "手伝って", "手伝った", "手伝わない", "手伝える", "手伝おう", "手伝われる", "手伝わせる", "手伝え", "手伝えば"]),
  ...
  v("電話する", "でんわする", "denwa suru", "gọi điện", "to phone", "irregular", ["電話します", "電話して", "電話した", "電話しない", "電話できる", "電話しよう", "電話される", "電話させる", "電話しろ", "電話すれば"]),
];
