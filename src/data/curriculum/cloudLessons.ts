...
print(f"On-prem hòa vốn sau: {months_to_breakeven:.1f} tháng")`,
        ...
        quiz: [
          { question: "Mô hình nào KHÁCH HÀNG quản lý OS?", options: ["SaaS", "PaaS", "IaaS", "FaaS"], answer: 2, explanation: "IaaS — khách hàng quản lý OS, runtime, app. Nhà cung cấp chỉ lo phần cứng và ảo hóa." },
          { question: "Đặc tính 'Rapid elasticity' nghĩa là gì?", options: ["Truy cập nhanh", "Co giãn nhanh theo nhu cầu", "Trả tiền theo dùng", "Bảo mật cao"], answer: 1, explanation: "Rapid elasticity là khả năng tự động scale up/down nhanh chóng để đáp ứng nhu cầu thay đổi." },
          { question: "Gmail là dịch vụ thuộc mô hình nào?", options: ["IaaS", "PaaS", "SaaS", "DaaS"], answer: 2, explanation: "Gmail là SaaS — phần mềm sẵn sàng dùng, người dùng không quản lý hạ tầng hay runtime." },
          { question: "Public Cloud KHÁC Private Cloud ở điểm nào?", options: ["Public rẻ hơn", "Public chia sẻ hạ tầng nhiều khách hàng", "Public không bảo mật", "Không khác gì"], answer: 1, explanation: "Public Cloud chia sẻ hạ tầng (multi-tenant) cho nhiều khách hàng; Private Cloud dành riêng cho 1 tổ chức." },
          { question: "Lợi ích KHÔNG PHẢI của Cloud là?", options: ["Giảm CAPEX", "Mở rộng toàn cầu", "Loại bỏ hoàn toàn rủi ro bảo mật", "Tính phí theo dùng"], answer: 2, explanation: "Cloud không loại bỏ rủi ro bảo mật — nó tuân theo Shared Responsibility Model: nhà cung cấp lo hạ tầng, khách hàng lo data & cấu hình." },
        ],
      },
      {
        id: "cloud-fund-2",
