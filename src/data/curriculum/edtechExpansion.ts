        ...
        quiz: [
          {
            ...
            questionEn: "Who is the author of Finland's famous 'Phenomenon-Based Learning' model?",
            optionsEn: ["Hannele Niemi", "Kirsti Lonka", "Sami Paavola", "Auli Toom"],
            explanationEn: "Kirsti Lonka (UH) is one of the strongest advocates of phenomenon-based learning.",
          },
          {
            ...
            questionEn: "The 'Knowledge Creation' metaphor belongs to which pair of authors?",
            optionsEn: ["Niemi & Toom", "Paavola & Hakkarainen", "Lonka & Salmela-Aro", "Löfström & Nevgi"],
            explanationEn: "Sami Paavola and Kai Hakkarainen proposed the 'third metaphor' alongside acquisition and participation.",
          },
          {
            ...
            questionEn: "What do the EDA and SBI scales measure in learning?",
            optionsEn: ["Student IQ", "Engagement and burnout", "Reading speed", "Coding ability"],
            explanationEn: "Katariina Salmela-Aro developed EDA (Engagement) and SBI (Study Burnout Inventory).",
          },
          {
            ...
            questionEn: "Why must every Finnish teacher hold a Master's degree?",
            optionsEn: [
              "It's legally required but has no scientific basis",
              "Because of the 'research-based teacher education' model (Toom, Husu)",
              "Because of high salaries",
              "Because of religious tradition",
            ],
            explanationEn: "The Toom & Husu model requires teachers to have practical research competence.",
          },
          {
            ...
            questionEn: "Which of the following is the University of Helsinki's official publication repository?",
            optionsEn: ["arxiv.org", "helda.helsinki.fi", "pubmed.gov", "jstor.org"],
            explanationEn: "HELDA is UH's repository for theses and articles.",
          },
        ],
      },
    ],
