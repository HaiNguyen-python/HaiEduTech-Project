...
export const chinesePronunciationLessons: PronLesson[] = [
  // ------------------------------------------------------------- 1. Overview
  {
    ...
    quiz: [
      { promptVi: "Âm tiết hǎo có thanh mẫu là gì?", promptEn: "What is the initial in hǎo?", options: ["h", "ao", "a", "không có"], answer: 0, explainVi: "h là thanh mẫu, ao là vận mẫu.", explainEn: "h is the initial, ao is the final." },
      ...
      { promptVi: "Pinyin dùng để làm gì?", promptEn: "What is pinyin used for?", options: ["Thay chữ Hán trong văn bản", "Ghi cách đọc và gõ chữ Hán", "Chỉ dùng cho trẻ em", "Ghi nghĩa của từ"], answer: 1, explainVi: "Pinyin ghi âm đọc và dùng để gõ chữ Hán.", explainEn: "Pinyin records pronunciation and is used for typing." },
      { promptVi: "Phần nào bắt buộc phải có trong mọi âm tiết?", promptEn: "Which part is compulsory in every syllable?", options: ["Thanh mẫu", "Vận mẫu", "Âm cuối -ng", "Âm cuốn lưỡi"], answer: 1, explainVi: "Vận mẫu và thanh điệu là bắt buộc.", explainEn: "The final and the tone are compulsory." },
  ...
  // ------------------------------------------------------------- 2. Initials
  {
    ...
    quiz: [
      ...
      { promptVi: "j q x luôn đi kèm với vận mẫu nào?", promptEn: "j q x are always followed by which vowels?", options: ["a hoặc o", "i hoặc ü", "u hoặc e", "er"], answer: 1, explainVi: "j q x chỉ kết hợp với i và ü.", explainEn: "j q x only combine with i and ü." },
      { promptVi: "吃 chī khác 知 zhī ở điểm nào?", promptEn: "How does chī differ from zhī?", options: ["Thanh điệu", "Bật hơi", "Vận mẫu", "Không khác gì"], answer: 1, explainVi: "ch bật hơi, zh không bật hơi.", explainEn: "ch is aspirated, zh is not." },
      { promptVi: "Âm h tiếng Trung phát ra ở đâu?", promptEn: "Where is Mandarin h produced?", options: ["Môi", "Gốc lưỡi, sâu trong họng", "Chân răng", "Mũi"], answer: 1, explainVi: "h là âm ma sát ở gốc lưỡi.", explainEn: "h is a velar fricative." },
      ...
      { promptVi: "Cách kiểm tra bật hơi tại nhà?", promptEn: "How can you test aspiration at home?", options: ["Soi gương", "Đặt tờ giấy trước miệng", "Bịt tai", "Nói thật to"], answer: 1, explainVi: "Tờ giấy rung mạnh nghĩa là có bật hơi.", explainEn: "Strong paper movement means aspiration." },
    ],
  },
  ...
  // ------------------------------------------------------------- 3. Finals
  {
    ...
    quiz: [
      ...
      { promptVi: "Âm ü được đọc thế nào?", promptEn: "How is ü pronounced?", options: ["Như u tiếng Việt", "Môi tròn như u, lưỡi như i", "Như i tiếng Việt", "Như ơ"], answer: 1, explainVi: "Môi tròn của u kết hợp vị trí lưỡi của i.", explainEn: "Rounded lips of u with the tongue of i." },
      ...
      { promptVi: "Nguyên âm kép cần đọc thế nào?", promptEn: "How should compound vowels be read?", options: ["Tách rời từng âm", "Trượt liền mạch", "Chỉ đọc âm đầu", "Chỉ đọc âm cuối"], answer: 1, explainVi: "Phải trượt liên tục, không ngắt.", explainEn: "Glide continuously without a break." },
    ],
  },
  ...
  // ------------------------------------------------------------- 4. Tones
  {
    ...
    quiz: [
      { promptVi: "Thanh nào cao và bằng?", promptEn: "Which tone is high and level?", options: ["Thanh 1", "Thanh 2", "Thanh 3", "Thanh 4"], answer: 0, explainVi: "Thanh 1 giữ cao độ đều.", explainEn: "Tone 1 stays level and high." },
      { promptVi: "Thanh nào xuống rồi lên?", promptEn: "Which tone dips then rises?", options: ["Thanh 1", "Thanh 2", "Thanh 3", "Thanh 4"], answer: 2, explainVi: "Thanh 3 có đường cong xuống rồi lên.", explainEn: "Tone 3 falls then rises." },
      { audio: "马", promptVi: "Nghe và chọn thanh điệu", promptEn: "Listen and choose the tone", options: ["Thanh 1", "Thanh 2", "Thanh 3", "Thanh 4"], answer: 2, explainVi: "马 mǎ là thanh 3.", explainEn: "马 mǎ is tone 3." },
      { audio: "骂", promptVi: "Nghe và chọn thanh điệu", promptEn: "Listen and choose the tone", options: ["Thanh 1", "Thanh 2", "Thanh 3", "Thanh 4"], answer: 3, explainVi: "骂 mà là thanh 4, đổ xuống.", explainEn: "骂 mà is tone 4, falling." },
      { promptVi: "买 mǎi nghĩa là gì?", promptEn: "What does 买 mǎi mean?", options: ["Bán", "Mua", "Ngủ", "Hỏi"], answer: 1, explainVi: "mǎi là mua, mài là bán.", explainEn: "mǎi is buy, mài is sell." },
      { promptVi: "Với vận mẫu iu, dấu thanh đặt ở đâu?", promptEn: "In iu, where does the tone mark go?", options: ["Trên i", "Trên u", "Trên cả hai", "Không ghi dấu"], answer: 1, explainVi: "iu ghi dấu trên u: liù.", explainEn: "iu takes the mark on u: liù." },
      { promptVi: "Với vận mẫu ui, dấu thanh đặt ở đâu?", promptEn: "In ui, where does the tone mark go?", options: ["Trên u", "Trên i", "Trên cả hai", "Không ghi dấu"], answer: 1, explainVi: "ui ghi dấu trên i: huì.", explainEn: "ui takes the mark on i: huì." },
      { promptVi: "Âm tiết thứ hai của 妈妈 đọc thế nào?", promptEn: "How is the second syllable of 妈妈 read?", options: ["Thanh 1", "Thanh 4", "Thanh nhẹ", "Thanh 2"], answer: 2, explainVi: "māma - âm tiết 2 là thanh nhẹ.", explainEn: "māma - the second syllable is neutral." },
  ...
  // ------------------------------------------------------------- 5. Tone change
  {
    ...
    quiz: [
      ...
      { promptVi: "Khi đếm số, 一 đọc thanh mấy?", promptEn: "When counting, which tone is 一?", options: ["Thanh 1", "Thanh 2", "Thanh 3", "Thanh 4"], answer: 0, explainVi: "Đếm yī, èr, sān thì 一 là thanh 1.", explainEn: "Counting yī, èr, sān keeps tone 1." },
      ...
      { promptVi: "Sách vở ghi thanh nào?", promptEn: "Which tone do textbooks print?", options: ["Thanh sau biến điệu", "Thanh gốc", "Không ghi thanh", "Tùy sách"], answer: 1, explainVi: "Sách ghi thanh gốc, người nói tự biến điệu.", explainEn: "Books print the original tone; speakers apply sandhi." },
    ],
  },
  ...
  // ------------------------------------------------------------- 6. Vietnamese traps
  {
    ...
    quiz: [
      ...
      { promptVi: "绿 lǜ khác 路 lù ở điểm nào?", promptEn: "How does 绿 lǜ differ from 路 lù?", options: ["Thanh điệu", "Nguyên âm ü so với u", "Thanh mẫu", "Không khác"], answer: 1, explainVi: "ü có môi tròn nhưng lưỡi ở vị trí i.", explainEn: "ü has rounded lips with the tongue of i." },
      ...
      { audio: "新", promptVi: "Nghe và chọn âm cuối", promptEn: "Listen and choose the ending", options: ["-n", "-ng", "-m", "Không có"], answer: 0, explainVi: "新 xīn kết thúc bằng -n.", explainEn: "新 xīn ends with -n." },
      { audio: "星", promptVi: "Nghe và chọn âm cuối", promptEn: "Listen and choose the ending", options: ["-n", "-ng", "-m", "Không có"], answer: 1, explainVi: "星 xīng kết thúc bằng -ng.", explainEn: "星 xīng ends with -ng." },
      { promptVi: "Lỗi phổ biến nhất của người Việt khi học phát âm tiếng Trung?", promptEn: "The most common Vietnamese pronunciation mistake?", options: ["Đọc sai thanh 1", "Mất phân biệt cuốn lưỡi", "Đọc quá to", "Đọc quá chậm"], answer: 1, explainVi: "Nhầm zh-z, ch-c, sh-s là lỗi số một.", explainEn: "Merging zh-z, ch-c, sh-s is mistake number one." },
      { promptVi: "j và z khác nhau thế nào?", promptEn: "How do j and z differ?", options: ["j mặt lưỡi, z chân răng", "j chân răng, z mặt lưỡi", "Cả hai cuốn lưỡi", "Không khác"], answer: 0, explainVi: "j là âm mặt lưỡi, z là âm chân răng.", explainEn: "j is palatal, z is dental." },
      { promptVi: "Cách tự kiểm tra phát âm hiệu quả nhất?", promptEn: "Best way to self-check pronunciation?", options: ["Đọc thầm", "Ghi âm rồi nghe lại", "Chỉ đọc pinyin", "Nghe nhạc"], answer: 1, explainVi: "Ghi âm giúp bạn nghe được lỗi của chính mình.", explainEn: "Recording lets you hear your own errors." },
      { promptVi: "半 bàn và 棒 bàng khác nhau ở đâu?", promptEn: "How do 半 bàn and 棒 bàng differ?", options: ["Thanh điệu", "Thanh mẫu", "Âm cuối -n và -ng", "Không khác"], answer: 2, explainVi: "Chỉ khác âm cuối -n so với -ng.", explainEn: "Only the -n versus -ng ending differs." },
    ],
  },
];
