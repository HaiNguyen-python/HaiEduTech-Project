...
export const chinesePronunciationLessons: PronLesson[] = [
  // ------------------------------------------------------------- 1. Overview
  {
    ...
    quiz: [
      ...
      { promptVi: "Phần nào bắt buộc phải có trong mọi âm tiết?", promptEn: "Which part is compulsory in every syllable?", options: ["Initial / Thanh mẫu", "Final / Vận mẫu", "Ending -ng", "Retroflex"], answer: 1, explainVi: "Vận mẫu và thanh điệu là bắt buộc.", explainEn: "The final and the tone are compulsory." },
  ...
  // ------------------------------------------------------------- 2. Initials
  {
    ...
    quiz: [
      ...
      { promptVi: "吃 chī khác 知 zhī ở điểm nào?", promptEn: "How does chī differ from zhī?", options: ["Thanh điệu", "Bật hơi", "Final / Vận mẫu", "Không khác gì"], answer: 1, explainVi: "ch bật hơi, zh không bật hơi.", explainEn: "ch is aspirated, zh is not." },
  ...
  // ------------------------------------------------------------- 4. Tones
  {
    ...
    quiz: [
      { promptVi: "Thanh nào cao và bằng?", promptEn: "Which tone is high and level?", options: ["Tone 1 / Thanh 1", "Tone 2 / Thanh 2", "Tone 3 / Thanh 3", "Tone 4 / Thanh 4"], answer: 0, explainVi: "Thanh 1 giữ cao độ đều.", explainEn: "Tone 1 stays level and high." },
      { promptVi: "Thanh nào xuống rồi lên?", promptEn: "Which tone dips then rises?", options: ["Tone 1 / Thanh 1", "Tone 2 / Thanh 2", "Tone 3 / Thanh 3", "Tone 4 / Thanh 4"], answer: 2, explainVi: "Thanh 3 có đường cong xuống rồi lên.", explainEn: "Tone 3 falls then rises." },
      { audio: "马", promptVi: "Nghe và chọn thanh điệu", promptEn: "Listen and choose the tone", options: ["Tone 1 / Thanh 1", "Tone 2 / Thanh 2", "Tone 3 / Thanh 3", "Tone 4 / Thanh 4"], answer: 2, explainVi: "马 mǎ là thanh 3.", explainEn: "马 mǎ is tone 3." },
      { audio: "骂", promptVi: "Nghe và chọn thanh điệu", promptEn: "Listen and choose the tone", options: ["Tone 1 / Thanh 1", "Tone 2 / Thanh 2", "Tone 3 / Thanh 3", "Tone 4 / Thanh 4"], answer: 3, explainVi: "骂 mà là thanh 4, đổ xuống.", explainEn: "骂 mà is tone 4, falling." },
      ...
      { promptVi: "Âm tiết thứ hai của 妈妈 đọc thế nào?", promptEn: "How is the second syllable of 妈妈 read?", options: ["Tone 1 / Thanh 1", "Tone 4 / Thanh 4", "Neutral / Thanh nhẹ", "Tone 2 / Thanh 2"], answer: 2, explainVi: "māma - âm tiết 2 là thanh nhẹ.", explainEn: "māma - the second syllable is neutral." },
  ...
  // ------------------------------------------------------------- 5. Tone change
  {
    ...
    quiz: [
      ...
      { promptVi: "Khi đếm số, 一 đọc thanh mấy?", promptEn: "When counting, which tone is 一?", options: ["Tone 1 / Thanh 1", "Tone 2 / Thanh 2", "Tone 3 / Thanh 3", "Tone 4 / Thanh 4"], answer: 0, explainVi: "Đếm yī, èr, sān thì 一 là thanh 1.", explainEn: "Counting yī, èr, sān keeps tone 1." },
  ...
  // ------------------------------------------------------------- 6. Vietnamese traps
  {
    ...
    quiz: [
      ...
      { promptVi: "绿 lǜ khác 路 lù ở điểm nào?", promptEn: "How does 绿 lǜ differ from 路 lù?", options: ["Thanh điệu", "Nguyên âm ü so với u", "Initial / Thanh mẫu", "Không khác"], answer: 1, explainVi: "ü có môi tròn nhưng lưỡi ở vị trí i.", explainEn: "ü has rounded lips with the tongue of i." },
      ...
      { promptVi: "半 bàn và 棒 bàng khác nhau ở đâu?", promptEn: "How do 半 bàn and 棒 bàng differ?", options: ["Thanh điệu", "Initial / Thanh mẫu", "Âm cuối -n và -ng", "Không khác"], answer: 2, explainVi: "Chỉ khác âm cuối -n so với -ng.", explainEn: "Only the -n versus -ng ending differs." },
    ],
  },
];
