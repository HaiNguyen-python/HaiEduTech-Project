...
export const englishExtraThemes3: SpeakingTheme[] = [
  {
    ...
    sentences: [
      { id: "en-m1", text: "I try to save a little money every month.", translation: "Tôi cố gắng tiết kiệm một ít tiền mỗi tháng.", difficulty: "easy", theme: "money" },
      { id: "en-m2", text: "Can I pay by credit card or only by cash?", translation: "Tôi trả bằng thẻ tín dụng được không hay chỉ bằng tiền mặt?", difficulty: "easy", theme: "money" },
      { id: "en-m3", text: "The exchange rate is not very good today.", translation: "Tỷ giá hôm nay không tốt lắm.", difficulty: "medium", theme: "money" },
      { id: "en-m4", text: "Investing in stocks can be risky for beginners.", translation: "Đầu tư cổ phiếu có thể rủi ro cho người mới.", difficulty: "medium", theme: "money" },
      { id: "en-m5", text: "I'm trying to live within my budget this year.", translation: "Năm nay tôi đang cố sống trong ngân sách của mình.", difficulty: "medium", theme: "money" },
      { id: "en-m6", text: "Inflation has affected the price of basic groceries.", translation: "Lạm phát đã ảnh hưởng đến giá thực phẩm thiết yếu.", difficulty: "hard", theme: "money" },
      { id: "en-m7", text: "Financial literacy should be taught in every school.", translation: "Kiến thức tài chính nên được dạy ở mọi trường học.", difficulty: "hard", theme: "money" },
      { id: "en-m8", text: "I prefer to compare prices before buying anything expensive.", translation: "Tôi thích so sánh giá trước khi mua thứ gì đắt tiền.", difficulty: "medium", theme: "money" },
    ],
  },
  {
    id: "en-emotions", name: "Feelings & Emotions", nameVi: "Cảm xúc", icon: "😊",
    sentences: [
      { id: "en-e1", text: "I feel really happy when I'm with my friends.", translation: "Tôi cảm thấy rất vui khi ở bên bạn bè.", difficulty: "easy", theme: "emotions" },
      { id: "en-e2", text: "Sometimes I feel anxious about the future.", translation: "Đôi khi tôi cảm thấy lo lắng về tương lai.", difficulty: "medium", theme: "emotions" },
      { id: "en-e3", text: "Listening to music helps me relax after a long day.", translation: "Nghe nhạc giúp tôi thư giãn sau một ngày dài.", difficulty: "medium", theme: "emotions" },
      { id: "en-e4", text: "It's okay to ask for help when you feel overwhelmed.", translation: "Không sao cả khi bạn nhờ giúp đỡ lúc cảm thấy quá tải.", difficulty: "hard", theme: "emotions" },
      { id: "en-e5", text: "Gratitude can completely change your mindset.", translation: "Lòng biết ơn có thể thay đổi hoàn toàn tư duy của bạn.", difficulty: "hard", theme: "emotions" },
      { id: "en-e6", text: "I'm a little nervous about the presentation tomorrow.", translation: "Tôi hơi hồi hộp về buổi thuyết trình ngày mai.", difficulty: "medium", theme: "emotions" },
      { id: "en-e7", text: "Spending time in nature lifts my mood instantly.", translation: "Dành thời gian trong thiên nhiên cải thiện tâm trạng tôi ngay.", difficulty: "medium", theme: "emotions" },
    ],
  },
  {
    id: "en-jobinterview", name: "Job Interview", nameVi: "Phỏng vấn xin việc", icon: "💼",
    sentences: [
      { id: "en-j1", text: "Tell me a little about yourself.", translation: "Hãy giới thiệu sơ về bản thân bạn.", difficulty: "easy", theme: "job" },
      { id: "en-j2", text: "Why are you interested in this position?", translation: "Tại sao bạn quan tâm đến vị trí này?", difficulty: "easy", theme: "job" },
      { id: "en-j3", text: "I have five years of experience in marketing.", translation: "Tôi có năm năm kinh nghiệm trong lĩnh vực marketing.", difficulty: "medium", theme: "job" },
      { id: "en-j4", text: "My biggest strength is my ability to learn quickly.", translation: "Điểm mạnh nhất của tôi là khả năng học hỏi nhanh.", difficulty: "medium", theme: "job" },
      { id: "en-j5", text: "I'm looking for an opportunity to grow professionally.", translation: "Tôi tìm kiếm cơ hội phát triển chuyên môn.", difficulty: "medium", theme: "job" },
      { id: "en-j6", text: "Could you tell me more about the team culture?", translation: "Bạn có thể nói thêm về văn hóa đội nhóm không?", difficulty: "hard", theme: "job" },
      { id: "en-j7", text: "I'd love to contribute my analytical skills to your project.", translation: "Tôi rất muốn đóng góp kỹ năng phân tích cho dự án của bạn.", difficulty: "hard", theme: "job" },
      { id: "en-j8", text: "Thank you for considering my application.", translation: "Cảm ơn vì đã xem xét hồ sơ của tôi.", difficulty: "easy", theme: "job" },
    ],
  },
  {
    id: "en-shopping", name: "Shopping & Bargaining", nameVi: "Mua sắm & Trả giá", icon: "🛍️",
    sentences: [
      { id: "en-sh1", text: "How much does this shirt cost?", translation: "Cái áo này giá bao nhiêu?", difficulty: "easy", theme: "shopping" },
      { id: "en-sh2", text: "Do you have this in a smaller size?", translation: "Bạn có cái này size nhỏ hơn không?", difficulty: "easy", theme: "shopping" },
      { id: "en-sh3", text: "Can you give me a discount if I buy two?", translation: "Bạn giảm giá nếu tôi mua hai cái được không?", difficulty: "medium", theme: "shopping" },
      { id: "en-sh4", text: "I'd like to return this item, please.", translation: "Tôi muốn trả lại món hàng này, xin vui lòng.", difficulty: "medium", theme: "shopping" },
      { id: "en-sh5", text: "Online shopping has changed the way we buy clothes.", translation: "Mua sắm trực tuyến đã thay đổi cách chúng ta mua quần áo.", difficulty: "hard", theme: "shopping" },
      { id: "en-sh6", text: "I always check reviews before making a purchase.", translation: "Tôi luôn xem đánh giá trước khi mua hàng.", difficulty: "medium", theme: "shopping" },
      { id: "en-sh7", text: "Sustainable fashion is becoming more popular.", translation: "Thời trang bền vững đang ngày càng phổ biến.", difficulty: "hard", theme: "shopping" },
    ],
  },
  {
    id: "en-health", name: "Health & Doctor", nameVi: "Sức khỏe & Bác sĩ", icon: "🏥",
    sentences: [
      { id: "en-h1", text: "I have a headache and a slight fever.", translation: "Tôi bị nhức đầu và sốt nhẹ.", difficulty: "easy", theme: "health" },
      { id: "en-h2", text: "I'd like to make an appointment with Dr. Smith.", translation: "Tôi muốn đặt lịch hẹn với bác sĩ Smith.", difficulty: "medium", theme: "health" },
      { id: "en-h3", text: "Take this medicine twice a day after meals.", translation: "Uống thuốc này hai lần một ngày sau bữa ăn.", difficulty: "medium", theme: "health" },
      { id: "en-h4", text: "Exercising regularly is good for your heart.", translation: "Tập thể dục thường xuyên tốt cho tim của bạn.", difficulty: "medium", theme: "health" },
      { id: "en-h5", text: "Mental health is just as important as physical health.", translation: "Sức khỏe tinh thần cũng quan trọng như sức khỏe thể chất.", difficulty: "hard", theme: "health" },
      { id: "en-h6", text: "I usually drink at least two liters of water a day.", translation: "Tôi thường uống ít nhất hai lít nước mỗi ngày.", difficulty: "medium", theme: "health" },
      { id: "en-h7", text: "Preventive care can save lives in the long run.", translation: "Chăm sóc phòng ngừa có thể cứu mạng về lâu dài.", difficulty: "hard", theme: "health" },
    ],
  },
  {
    id: "en-news", name: "News & Current Events", nameVi: "Tin tức & Thời sự", icon: "📰",
    sentences: [
      { id: "en-n1", text: "Did you hear about the news this morning?", translation: "Bạn có nghe tin sáng nay không?", difficulty: "easy", theme: "news" },
      { id: "en-n2", text: "The election results were announced last night.", translation: "Kết quả bầu cử đã được công bố tối qua.", difficulty: "medium", theme: "news" },
      { id: "en-n3", text: "Social media spreads information very quickly.", translation: "Mạng xã hội lan truyền thông tin rất nhanh.", difficulty: "medium", theme: "news" },
      { id: "en-n4", text: "We should always verify sources before sharing news.", translation: "Chúng ta nên luôn xác minh nguồn trước khi chia sẻ tin.", difficulty: "hard", theme: "news" },
      { id: "en-n5", text: "Reading international news broadens your perspective.", translation: "Đọc tin tức quốc tế mở rộng tầm nhìn của bạn.", difficulty: "hard", theme: "news" },
      { id: "en-n6", text: "The headlines today are quite alarming.", translation: "Các tiêu đề hôm nay khá đáng báo động.", difficulty: "medium", theme: "news" },
    ],
  },
];
