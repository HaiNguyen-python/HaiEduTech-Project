...
export const themeTopUps: Record<string, SpeakingSentence[]> = {
  // ====== ENGLISH ======
  "en-emergency": [
    { id: "tu-en-em1", text: "Please call an ambulance right now.", translation: "Làm ơn gọi xe cứu thương ngay.", ipa: "/pliːz kɔːl æn ˈæmbjələns raɪt naʊ/", difficulty: "easy", theme: "emergency" },
  ...
  "en-feelings": [
    ...
    { id: "tu-en-fe2", text: "She looked surprised when she heard the news.", translation: "Cô ấy có vẻ ngạc nhiên khi nghe tin.", ipa: "/ʃiː lʊkt sərˈpraɪzd wɛn ʃiː hɜːrd ðə nuːz/", difficulty: "medium", theme: "feelings" },
    { id: "tu-en-fe3", text: "I was deeply moved by his honest speech.", translation: "Tôi xúc động sâu sắc trước bài phát biểu chân thành của anh ấy.", ipa: "/aɪ wɑːz ˈdiːpli muːvd baɪ hɪz ˈɑːnəst spiːtʃ/", difficulty: "hard", theme: "feelings" },
    { id: "tu-en-fe4", text: "Honestly, I'm feeling a little overwhelmed lately.", translation: "Thật lòng mà nói, dạo này tôi cảm thấy hơi quá tải.", ipa: "/ˈɑːnəstli aɪm ˈfiːlɪŋ ə ˈlɪtəl ˌoʊvərˈwɛlmd ˈleɪtli/", difficulty: "hard", theme: "feelings" },
  ],
  "en-future": [
  ...
  "en-hobbies": [
    ...
    { id: "tu-en-ho2", text: "Playing the guitar helps me relax after a long day.", translation: "Chơi guitar giúp tôi thư giãn sau một ngày dài.", ipa: "/ˈpleɪɪŋ ðə ɡɪˈtɑːr hɛlps miː rɪˈlæks ˈæftər ə lɔːŋ deɪ/", difficulty: "medium", theme: "hobbies" },
    { id: "tu-en-ho3", text: "Lately I've been getting into pottery and ceramics.", translation: "Gần đây tôi đang dần thích nghệ thuật gốm sứ.", ipa: "/ˈleɪtli aɪv bɪn ˈɡɛtɪŋ ˈɪntu ˈpɑːtəri ənd sərˈæmɪks/", difficulty: "hard", theme: "hobbies" },
  ],
  "en-jobinterview": [
    { id: "tu-en-ji1", text: "I believe my background fits this role very well.", translation: "Tôi tin rằng kinh nghiệm của mình rất phù hợp với vị trí này.", ipa: "/aɪ bɪˈliːv maɪ ˈbækˌɡraʊnd fɪts ðɪs roʊl ˈvɛri wɛl/", difficulty: "medium", theme: "jobinterview" },
    { id: "tu-en-ji2", text: "One of my strengths is solving problems under pressure.", translation: "Một trong những điểm mạnh của tôi là giải quyết vấn đề dưới áp lực.", ipa: "/wʌn ʌv maɪ strɛŋkθs ɪz ˈsɑːlvɪŋ ˈprɑːbləmz ˈʌndər ˈprɛʃər/", difficulty: "hard", theme: "jobinterview" },
  ],
  "en-money": [
  ...
  "en-movies": [
    ...
    { id: "tu-en-mv2", text: "The cinematography in that film was absolutely stunning.", translation: "Quay phim trong bộ phim đó thực sự tuyệt đẹp.", ipa: "/ðə ˌsɪnɪməˈtɑːɡrəfi ɪn ðæt fɪlm wɑːz ˌæbsəˈluːtli ˈstʌnɪŋ/", difficulty: "hard", theme: "movies" },
  ],
  "en-restaurant": [
  ...
  "en-shopping": [
    ...
    { id: "tu-en-sh2", text: "Is there a discount if I pay in cash?", translation: "Trả tiền mặt có được giảm giá không?", ipa: "/ɪz ðɛr ə dɪˈskaʊnt ɪf aɪ peɪ ɪn kæʃ/", difficulty: "medium", theme: "shopping" },
    { id: "tu-en-sh3", text: "I'm just browsing for now, thanks.", translation: "Tôi chỉ đang xem qua thôi, cảm ơn.", ipa: "/aɪm dʒʌst ˈbraʊzɪŋ fɔːr naʊ θæŋks/", difficulty: "easy", theme: "shopping" },
  ],
  "en-sports": [
    { id: "tu-en-sp1", text: "I usually go jogging three times a week.", translation: "Tôi thường đi chạy bộ ba lần một tuần.", ipa: "/aɪ ˈjuːʒəwəli ɡoʊ ˈdʒɑːɡɪŋ θriː taɪmz ə wiːk/", difficulty: "easy", theme: "sports" },
    { id: "tu-en-sp2", text: "Team sports teach you discipline and cooperation.", translation: "Thể thao đồng đội dạy bạn tính kỷ luật và sự hợp tác.", ipa: "/tiːm spɔːrts tiːtʃ juː ˈdɪsəplən ənd koʊˌɑːpərˈeɪʃən/", difficulty: "hard", theme: "sports" },
  ],
