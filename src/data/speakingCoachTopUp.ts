...
export const themeTopUps: Record<string, SpeakingSentence[]> = {
  // ====== ENGLISH ======
  "en-emergency": [
    { id: "tu-en-em1", text: "Please call an ambulance right now.", translation: "Làm ơn gọi xe cứu thương ngay.", difficulty: "easy", theme: "emergency" },
    { id: "tu-en-em2", text: "I think I need to go to the hospital.", translation: "Tôi nghĩ tôi cần đến bệnh viện.", difficulty: "easy", theme: "emergency" },
    { id: "tu-en-em3", text: "There has been a small accident on the corner.", translation: "Vừa có một tai nạn nhỏ ở góc đường.", difficulty: "medium", theme: "emergency" },
    { id: "tu-en-em4", text: "Could you tell me where the nearest pharmacy is?", translation: "Bạn cho tôi biết hiệu thuốc gần nhất ở đâu được không?", difficulty: "medium", theme: "emergency" },
    { id: "tu-en-em5", text: "Stay calm and follow the safety instructions carefully.", translation: "Hãy bình tĩnh và làm theo hướng dẫn an toàn cẩn thận.", difficulty: "hard", theme: "emergency" },
  ],
  "en-emotions": [
    { id: "tu-en-emo1", text: "I feel really happy when I spend time with my family.", translation: "Tôi cảm thấy rất hạnh phúc khi dành thời gian cho gia đình.", difficulty: "easy", theme: "emotions" },
    { id: "tu-en-emo2", text: "Sometimes I get nervous before an important meeting.", translation: "Đôi khi tôi hồi hộp trước một cuộc họp quan trọng.", difficulty: "medium", theme: "emotions" },
    { id: "tu-en-emo3", text: "Talking to a close friend always cheers me up.", translation: "Trò chuyện với một người bạn thân luôn khiến tôi vui hơn.", difficulty: "hard", theme: "emotions" },
  ],
  "en-family": [
    { id: "tu-en-fam1", text: "My parents live in a small town near the coast.", translation: "Bố mẹ tôi sống ở một thị trấn nhỏ gần biển.", difficulty: "medium", theme: "family" },
    { id: "tu-en-fam2", text: "We usually have dinner together every Sunday.", translation: "Chúng tôi thường ăn tối cùng nhau vào mỗi Chủ nhật.", difficulty: "medium", theme: "family" },
  ],
  "en-feelings": [
    { id: "tu-en-fe1", text: "I felt a bit tired after work today.", translation: "Hôm nay tôi cảm thấy hơi mệt sau giờ làm.", difficulty: "easy", theme: "feelings" },
    { id: "tu-en-fe2", text: "She looked surprised when she heard the news.", translation: "Cô ấy có vẻ ngạc nhiên khi nghe tin.", difficulty: "medium", theme: "feelings" },
    { id: "tu-en-fe3", text: "I was deeply moved by his honest speech.", translation: "Tôi xúc động sâu sắc trước bài phát biểu chân thành của anh ấy.", difficulty: "hard", theme: "feelings" },
    { id: "tu-en-fe4", text: "Honestly, I'm feeling a little overwhelmed lately.", translation: "Thật lòng mà nói, dạo này tôi cảm thấy hơi quá tải.", difficulty: "hard", theme: "feelings" },
  ],
  "en-future": [
    { id: "tu-en-fu1", text: "In five years, I hope to work abroad.", translation: "Trong năm năm tới, tôi hy vọng được làm việc ở nước ngoài.", difficulty: "medium", theme: "future" },
    { id: "tu-en-fu2", text: "Technology will probably change our daily routines completely.", translation: "Công nghệ có lẽ sẽ thay đổi hoàn toàn thói quen hàng ngày của chúng ta.", difficulty: "hard", theme: "future" },
  ],
  "en-hobbies": [
    { id: "tu-en-ho1", text: "I love taking photos of nature on the weekend.", translation: "Tôi thích chụp ảnh thiên nhiên vào cuối tuần.", difficulty: "easy", theme: "hobbies" },
    { id: "tu-en-ho2", text: "Playing the guitar helps me relax after a long day.", translation: "Chơi guitar giúp tôi thư giãn sau một ngày dài.", difficulty: "medium", theme: "hobbies" },
    { id: "tu-en-ho3", text: "Lately I've been getting into pottery and ceramics.", translation: "Gần đây tôi đang dần thích nghệ thuật gốm sứ.", difficulty: "hard", theme: "hobbies" },
  ],
  "en-jobinterview": [
    { id: "tu-en-ji1", text: "I believe my background fits this role very well.", translation: "Tôi tin rằng kinh nghiệm của mình rất phù hợp với vị trí này.", difficulty: "medium", theme: "jobinterview" },
    { id: "tu-en-ji2", text: "One of my strengths is solving problems under pressure.", translation: "Một trong những điểm mạnh của tôi là giải quyết vấn đề dưới áp lực.", difficulty: "hard", theme: "jobinterview" },
  ],
  "en-money": [
    { id: "tu-en-mo1", text: "I try to save a small amount every month.", translation: "Tôi cố gắng tiết kiệm một khoản nhỏ mỗi tháng.", difficulty: "medium", theme: "money" },
    { id: "tu-en-mo2", text: "Investing wisely can really change your financial future.", translation: "Đầu tư khôn ngoan thực sự có thể thay đổi tương lai tài chính của bạn.", difficulty: "hard", theme: "money" },
  ],
  "en-movies": [
    { id: "tu-en-mv1", text: "My favorite genre is science fiction.", translation: "Thể loại yêu thích của tôi là khoa học viễn tưởng.", difficulty: "easy", theme: "movies" },
    { id: "tu-en-mv2", text: "The cinematography in that film was absolutely stunning.", translation: "Quay phim trong bộ phim đó thực sự tuyệt đẹp.", difficulty: "hard", theme: "movies" },
  ],
  "en-restaurant": [
    { id: "tu-en-re1", text: "Could we have the menu, please?", translation: "Cho chúng tôi xin thực đơn được không?", difficulty: "easy", theme: "restaurant" },
    { id: "tu-en-re2", text: "I'd like the chef's recommendation for today.", translation: "Tôi muốn món được đầu bếp gợi ý hôm nay.", difficulty: "medium", theme: "restaurant" },
  ],
  "en-shopping": [
    { id: "tu-en-sh1", text: "Do you have this in a smaller size?", translation: "Cái này có cỡ nhỏ hơn không?", difficulty: "easy", theme: "shopping" },
    { id: "tu-en-sh2", text: "Is there a discount if I pay in cash?", translation: "Trả tiền mặt có được giảm giá không?", difficulty: "medium", theme: "shopping" },
    { id: "tu-en-sh3", text: "I'm just browsing for now, thanks.", translation: "Tôi chỉ đang xem qua thôi, cảm ơn.", difficulty: "easy", theme: "shopping" },
  ],
  "en-sports": [
    { id: "tu-en-sp1", text: "I usually go jogging three times a week.", translation: "Tôi thường đi chạy bộ ba lần một tuần.", difficulty: "easy", theme: "sports" },
    { id: "tu-en-sp2", text: "Team sports teach you discipline and cooperation.", translation: "Thể thao đồng đội dạy bạn tính kỷ luật và sự hợp tác.", difficulty: "hard", theme: "sports" },
  ],
