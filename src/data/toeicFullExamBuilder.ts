...
const domainThemes = [
  ...
  },
  {
    ...
    product: "patient scheduling app",
    place: "outpatient clinic",
    department: "nursing team",
    event: "staff wellness seminar",
  },
  {
    label: "Real Estate and Property",
    company: "Maple Realty Partners",
    product: "property listing platform",
    place: "model showroom",
    department: "leasing team",
    event: "open-house weekend",
  },
  {
    label: "Hospitality and Restaurant",
    company: "Garden Bistro Group",
    product: "online reservation system",
    place: "main dining room",
    department: "kitchen staff",
    event: "menu tasting evening",
  },
  {
    label: "Energy and Utilities",
    company: "Northwind Energy Co.",
    product: "smart meter program",
    place: "field office",
    department: "field operations",
    event: "infrastructure briefing",
  },
  {
    label: "Legal and Consulting",
    company: "Pinecrest Legal Advisors",
    product: "client intake portal",
    place: "boardroom",
    department: "advisory team",
    event: "compliance workshop",
  },
  {
    label: "Pharmaceutical and Research",
    company: "BlueCedar Biotech",
    product: "lab analytics suite",
    place: "research wing",
    department: "R&D team",
    event: "clinical update meeting",
  },
  {
    label: "Automotive and Transport",
    company: "Crestline Motors",
    product: "fleet maintenance plan",
    place: "service garage",
    department: "service department",
    event: "dealership training day",
  },
  {
    label: "Banking and Insurance",
    company: "Anchor Bay Bank",
    product: "mobile banking app",
    place: "downtown branch",
    department: "client advisory team",
    event: "investor briefing",
  },
  {
    label: "Sports and Recreation",
    company: "Apex Fitness Centers",
    product: "membership renewal portal",
    place: "main studio",
    department: "trainer team",
    event: "season opening event",
  },
  {
    label: "Aviation and Travel Tech",
    company: "Skybridge Airlines",
    product: "in-flight entertainment app",
    place: "airline lounge",
    department: "ground operations",
    event: "route launch briefing",
  },
];
