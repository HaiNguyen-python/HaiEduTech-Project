...
export const SWEDISH_EXAMPLE_OVERRIDES: Record<string, SwedishExampleOverride> = {
  ...
  arbete:         { sv: "Mitt arbete börjar klockan åtta varje morgon.",       vi: "Công việc của tôi bắt đầu lúc tám giờ mỗi sáng.",            en: "My work starts at eight every morning." },
  hälsa:          { sv: "God sömn är viktig för hälsan.",                      vi: "Ngủ ngon rất quan trọng cho sức khoẻ.",                      en: "Good sleep is important for health." },
  utbildning:     { sv: "En bra utbildning öppnar många dörrar.",              vi: "Một nền giáo dục tốt mở ra nhiều cánh cửa.",                 en: "A good education opens many doors." },
