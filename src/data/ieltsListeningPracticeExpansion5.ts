...
export const ieltsListeningPracticeSetsExpansion5: ListeningPracticeSet[] = [
  ...
  // ============================================================
  {
    ...
    rate: 0.85,
    questions: [
      { type: "mcq", prompt: "When did the community garden open?", options: ["2011", "2001", "2009", "2015"], answer: 0 },
      ...
      { type: "mcq", prompt: "The café closes today at:", options: ["3 pm", "5 pm", "6 pm", "4 pm"], answer: 3 },
      { type: "mcq", prompt: "This week's free workshop topic is:", options: ["composting", "pest control", "watering", "pruning"], answer: 0 },
