...
export const LESSON_DEEP: Record<string, LessonDeepDive> = {
  ...
  "a1-pron": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Anna", sv: "Säg 'sju' för mig.", ipa: "/sɛɡ ɧɵ fœr mɪɡ./", vi: "Đọc 'sju' (bảy) cho tớ nghe.", en: "Say 'sju' for me." },
        { speaker: "Lin", sv: "Sju... sjuksköterska.", ipa: "/ɧɵ.. ɧɵkɧøːtɛʂkɑː./", vi: "Bảy... y tá.", en: "Seven... nurse." },
        { speaker: "Anna", sv: "Bra! Och nu 'tjugo'?", ipa: "/bra! ɔɕ nɵ ɕʉːɡɔ?/", vi: "Hay! Còn 'tjugo' (20)?", en: "Nice! Now 'tjugo'?" },
        { speaker: "Lin", sv: "Tjugo, tjugoett, tjugotvå.", ipa: "/ɕʉːɡɔ, ɕʉːɡuːɛt, ɕʉːɡɔtvoː./", vi: "Hai mươi, hai mốt, hai hai.", en: "Twenty, twenty-one, twenty-two." },
        { speaker: "Anna", sv: "Försök 'vit' och 'vitt'.", ipa: "/fœʂœk vɪt ɔɕ vɪt./", vi: "Thử 'vit' và 'vitt' xem.", en: "Try 'vit' and 'vitt'." },
        { speaker: "Lin", sv: "Viiit... vitt. Långt och kort!", ipa: "/viːiːɪt.. vɪt. lɔŋt ɔɕ kɔʈ!/", vi: "Viiit... vitt. Dài và ngắn!", en: "Viiit... vitt. Long and short!" },
        { speaker: "Anna", sv: "Perfekt. Du är redo för YKI.", ipa: "/pɛrfɛkt. dʉː ɛr reːdɔ fœr yːɕiː./", vi: "Hoàn hảo. Bạn sẵn sàng thi YKI rồi.", en: "Perfect. You're ready for YKI." },
      ],
    },
    model: {
      ...
      sv: "Hej! Jag heter Lin. Jag är tjugoåtta år gammal. Jag bor i Helsingfors. Jag arbetar som sjuksköterska på ett sjukhus. På fritiden tycker jag om att läsa och att lyssna på musik. Jag pratar vietnamesiska, engelska och lite svenska. Jag vill bli bättre på uttalet, särskilt sj- och tj-ljudet.", ipa: "/hɛj! jaɡ heːtɛr lɪn. jaɡ ɛr ɕʉːɡuːɔtɑː ɔr ɡamal. jaɡ bɔr ɪ hɛlsɪŋfɔʂ. jaɡ arbeːtar sɔm ɧɵkɧøːtɛʂka poː ɛt ɧɵkhɵs. pɔ friːtiːdɛn tʏkɕɛr jaɡ ɔm at lɛːsɑː ɔɕ at lʏsna pɔ mʉːsɪk. jaɡ prɑːtar viːɛtnɑːmeːsɪska, ɛŋɛlskɑː ɔɕ liːtɛ svɛnska. jaɡ vɪl blɪ bɛtrɛ poː ɵtɑːlɛt, sɛʂɕɪlt ɧ ɔɕ ɕljʉːdɛt./",
  ...
  "a1-self": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Eva", sv: "Hej! Vad heter du?", ipa: "/hɛj! vad heːtɛr dʉː?/", vi: "Xin chào! Bạn tên gì?", en: "Hi! What's your name?" },
        { speaker: "Mai", sv: "Jag heter Mai. Och du?", ipa: "/jaɡ heːtɛr mɑːɪ. ɔɕ dʉː?/", vi: "Tôi tên là Mai. Còn cô?", en: "I'm Mai. And you?" },
        { speaker: "Eva", sv: "Jag heter Eva. Var kommer du ifrån?", ipa: "/jaɡ heːtɛr eːva. var kɔmɛr dʉː ɪfrɔn?/", vi: "Tôi tên là Eva. Bạn đến từ đâu?", en: "I'm Eva. Where are you from?" },
        { speaker: "Mai", sv: "Jag kommer från Vietnam, från Hanoi.", ipa: "/jaɡ kɔmɛr frɔn viːɛtnam, frɔn hɑːnuːiː./", vi: "Tôi đến từ Việt Nam, từ Hà Nội.", en: "I'm from Vietnam, from Hanoi." },
        { speaker: "Eva", sv: "Vad jobbar du med?", ipa: "/vad jɔbar dɵ mɛd?/", vi: "Bạn làm nghề gì?", en: "What do you do for work?" },
        { speaker: "Mai", sv: "Jag jobbar som ingenjör hos Nokia.", ipa: "/jaɡ jɔbar sɔm ɪŋɛnjœr hɔs nuːɕiːɑː./", vi: "Tôi làm kỹ sư ở Nokia.", en: "I work as an engineer at Nokia." },
        { speaker: "Eva", sv: "Vad bra! Har du familj här?", ipa: "/vad bra! har dɵ fɑːmɪlj hɛr?/", vi: "Tốt quá! Bạn có gia đình ở đây không?", en: "Great! Do you have family here?" },
        { speaker: "Mai", sv: "Ja, jag har en man och två barn.", ipa: "/ja, jaɡ har ɛn man ɔɕ tvɔ baɳ./", vi: "Có, tôi có một chồng và hai con.", en: "Yes, a husband and two kids." },
        { speaker: "Eva", sv: "Välkommen till klassen!", ipa: "/vɛlkɔmɛn tɪl klasɛn!/", vi: "Chào mừng bạn đến lớp!", en: "Welcome to the class!" },
      ],
    },
    model: {
      titleVi: "Đoạn văn mẫu: tự giới thiệu chuẩn YKI Tala A1",
      titleEn: "Model paragraph: YKI Tala A1 standard self-intro",
      sv: "Hej, jag heter Mai Nguyen. Jag är trettiotvå år gammal. Jag kommer från Vietnam men nu bor jag i Vasa. Jag har bott i Finland i tre år. Jag är gift och har två barn, en flicka och en pojke. Jag jobbar som mjukvaruingenjör på ett finskt företag. På fritiden lagar jag vietnamesisk mat och promenerar vid havet. Jag lär mig svenska eftersom jag vill jobba med svenskspråkiga kollegor.", ipa: "/hɛj, jaɡ heːtɛr mɑːɪ ŋʉːyːɛn. jaɡ ɛr trɛtiːɔtvoː ɔr ɡamal. jaɡ kɔmɛr frɔn viːɛtnam mɛn nɵ bɔr jaɡ ɪ vɑːsa. jaɡ har bɔt ɪ fɪnland ɪ treː ɔr. jaɡ ɛr jɪft ɔɕ har tvɔ baɳ, ɛn flɪkkɑː ɔɕ ɛn pɔjɕɛ. jaɡ jɔbar sɔm mjɵkvɑːrʉːɪŋɛnjœr poː ɛt fɪnskt føːreːtaɡ. pɔ friːtiːdɛn lɑːɡar jaɡ viːɛtnɑːmeːsɪsk mat ɔɕ pruːmeːneːrar vɪd hɑːvɛt. jaɡ lɛr mɪɡ svɛnskɑː ɛftɛʂɔm jaɡ vɪl jɔba mɛd svɛnsksproːɕiːɡa kɔleːɡɔr./",
  ...
  "a1-num": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Mai", sv: "Hej, hur mycket kostar en biljett till Tammerfors?", ipa: "/hɛj, hɵr mʏkɕɛt kɔstar ɛn bɪljɛt tɪl tamɛrfɔʂ?/", vi: "Chào, vé đi Tampere bao nhiêu?", en: "Hi, how much is a ticket to Tampere?" },
        { speaker: "Säljare", sv: "Tjugosju euro och femtio cent.", ipa: "/ɕʉːɡɔɧʉː eːʉːruː ɔɕ fɛmtiːɔ sɛnt./", vi: "27 euro 50 cent.", en: "Twenty-seven euros fifty cents." },
        { speaker: "Mai", sv: "När går nästa buss?", ipa: "/nɛr ɡɔr nɛsta bɵs?/", vi: "Khi nào chuyến xe tiếp theo khởi hành?", en: "When does the next bus leave?" },
        { speaker: "Säljare", sv: "Klockan fjorton och fyrtiofem.", ipa: "/klɔkkan fjɔʈɔn ɔɕ fʏʈiːuːfɛm./", vi: "14h45.", en: "At 14:45." },
        { speaker: "Mai", sv: "Jag tar två biljetter, tack.", ipa: "/jaɡ tar tvɔ bɪljɛtɛr, takk./", vi: "Tôi lấy 2 vé.", en: "I'll take two tickets, please." },
        { speaker: "Säljare", sv: "Det blir femtiofem euro jämnt.", ipa: "/dɛt blɪr fɛmtiːuːfɛm eːʉːrɔ jɛmnt./", vi: "Tổng là 55 euro chẵn.", en: "That's fifty-five euros even." },
        { speaker: "Mai", sv: "Här är hundra euro.", ipa: "/hɛr ɛr hɵndrɑː eːʉːruː./", vi: "Đây là 100 euro.", en: "Here's a hundred euros." },
        { speaker: "Säljare", sv: "Och fyrtiofem tillbaka. Trevlig resa!", ipa: "/ɔɕ fʏʈiːuːfɛm tɪlbɑːka. trɛvlɪɡ reːsɑː!/", vi: "Và 45 euro trả lại. Chúc đi vui!", en: "And 45 back. Have a nice trip!" },
      ],
    },
    model: {
      titleVi: "Đoạn văn: thông tin cá nhân bằng con số",
      titleEn: "Paragraph: personal info in numbers",
      sv: "Jag heter Hai. Jag är fyrtiotre år gammal. Jag bor på Storgatan tjugoett, lägenhet sju. Mitt telefonnummer är noll-fyrtio-ett-två-tre-fyra-fem-sex-sju-åtta. Min postkod är sextusen-ett-hundra. Jag har tre barn: en flicka på nio år och två pojkar på tolv och femton år. Jag arbetar trettiosju och en halv timme i veckan.", ipa: "/jaɡ heːtɛr hɑːɪ. jaɡ ɛr fʏʈiːɔtreː ɔr ɡamal. jaɡ bɔr pɔ stɔrɡɑːtan ɕʉːɡuːɛt, lɛːjɛnhɛt ɧɵ. mɪt teːleːfɔnɵmɛr ɛr nɔlfʏʈiːuːɛttvɔtrɛfyːrafɛmsɛksɧʉːɔta. mɪn pɔstkɔd ɛr sɛkstʉːsɛnɛthɵndra. jaɡ har trɛ baɳ: ɛn flɪkka pɔ niːuː ɔr ɔɕ tvɔ pɔjkar pɔ tɔlv ɔɕ fɛmtɔn ɔr. jaɡ arbeːtar trɛtiːɔɧʉː ɔɕ ɛn halv tɪmeː ɪ vɛkkan./",
  ...
  "a1-alphabet": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Receptionist", sv: "Vad heter du?", ipa: "/vad heːtɛr dʉː?/", vi: "Bạn tên gì?", en: "What's your name?" },
        { speaker: "Mai", sv: "Mai Nguyen.", ipa: "/mɑːɪ ŋʉːyːɛn./", vi: "Mai Nguyễn.", en: "Mai Nguyen." },
        { speaker: "Receptionist", sv: "Kan du bokstavera efternamnet?", ipa: "/kan dɵ bɔkstɑːveːrɑː ɛftɛɳamnɛt?/", vi: "Bạn đánh vần họ giúp tôi nhé?", en: "Can you spell the last name?" },
        { speaker: "Mai", sv: "N som i Niklas, G som i Gustav, U som i Ulf, Y som i Yvonne, E som i Erik, N som i Niklas.", ipa: "/n sɔm ɪ nɪklas, ɡ sɔm ɪ ɡɵstav, ɵ sɔm iː ɵlf, ʏ sɔm iː yːvɔnɛ, ɛ sɔm iː eːrɪk, n sɔm ɪ nɪklas./", vi: "N như Niklas, G như Gustav, U như Ulf, Y như Yvonne, E như Erik, N như Niklas.", en: "N as in Niklas, G as in Gustav, U as in Ulf, Y as in Yvonne, E as in Erik, N as in Niklas." },
        { speaker: "Receptionist", sv: "Tack. Och förnamnet?", ipa: "/takk. ɔɕ fœɳamnɛt?/", vi: "Cảm ơn. Còn tên?", en: "Thanks. And first name?" },
        { speaker: "Mai", sv: "M som i Martin, A som i Adam, I som i Ivar.", ipa: "/m sɔm ɪ maʈɪn, a sɔm iː ɑːdam, ɪ sɔm iː iːvar./", vi: "M như Martin, A như Adam, I như Ivar.", en: "M as in Martin, A as in Adam, I as in Ivar." },
        { speaker: "Receptionist", sv: "Perfekt, då har jag det.", ipa: "/pɛrfɛkt, dɔ har jaɡ dɛt./", vi: "Hoàn hảo, tôi đã ghi xong.", en: "Perfect, got it." },
      ],
    },
    model: {
      titleVi: "Đoạn văn ngắn: tại sao alphabet là bài đầu tiên",
      titleEn: "Short paragraph: why the alphabet is lesson one",
      sv: "Det svenska alfabetet har tjugonio bokstäver. De tre sista är å, ä och ö. När jag bokar tid hos läkaren eller på banken behöver jag ofta bokstavera mitt namn. Då säger jag 'M som i Martin, A som i Adam'. Det här systemet kallas bokstaveringsalfabetet. Om jag inte kan alfabetet är det svårt att fylla i blanketter, slå upp ord och stava rätt på YKI-provet.", ipa: "/dɛt svɛnskɑː alfɑːbeːtɛt har ɕʉːɡuːniːɔ bɔkstɛːvɛr. dɛ trɛ sɪstɑː ɛr ɔ, ɛː ɔɕ œ. nɛr jaɡ buːkar tɪd hɔs lɛːkɑːrɛn ɛlɛr pɔ banɕɛn beːhøːvɛr jaɡ ɔfta bɔkstɑːveːra mɪt namn. dɔ sɛːjɛr jaɡ m sɔm ɪ maʈɪn, a sɔm iː ɑːdam. dɛt hɛr sʏsteːmɛt kalas bɔkstɑːveːrɪŋsalfɑːbeːtɛt. ɔm jaɡ ɪntɛ kan alfɑːbeːtɛt ɛr dɛt svɔʈ at fʏlɑː ɪ blanɕɛtɛr, sloː ɵp ɔɖ ɔɕ stɑːva rɛt poː yːɕɪpruːvɛt./",
  ...
  "a1-greetings": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Erik", sv: "God morgon, Mai!", ipa: "/ɡɔd mɔrɡɔn, mɑːiː!/", vi: "Chào buổi sáng, Mai!", en: "Good morning, Mai!" },
        { speaker: "Mai", sv: "God morgon, Erik! Hur mår du?", ipa: "/ɡɔd mɔrɡɔn, eːrɪk! hɵr mɔr dʉː?/", vi: "Chào buổi sáng, Erik! Bạn khoẻ không?", en: "Morning, Erik! How are you?" },
        { speaker: "Erik", sv: "Bra, tack! Och du?", ipa: "/bra, takk! ɔɕ dʉː?/", vi: "Khoẻ, cảm ơn! Còn bạn?", en: "Good, thanks! And you?" },
        { speaker: "Mai", sv: "Trött men glad. Mycket att göra idag.", ipa: "/trœt mɛn ɡlad. mʏkɕɛt at jøːrɑː iːdaɡ./", vi: "Mệt nhưng vui. Hôm nay nhiều việc lắm.", en: "Tired but happy. A lot to do today." },
        { speaker: "Erik", sv: "Vill du ha kaffe?", ipa: "/vɪl dɵ ha kafeː?/", vi: "Bạn uống cà phê không?", en: "Want some coffee?" },
        { speaker: "Mai", sv: "Ja tack, gärna!", ipa: "/ja takk, jɛɳɑː!/", vi: "Vâng, có chứ!", en: "Yes please!" },
        { speaker: "Erik", sv: "Varsågod.", ipa: "/vaʂoːɡɔd./", vi: "Mời bạn.", en: "Here you go." },
        { speaker: "Mai", sv: "Tack så mycket.", ipa: "/takk sɔ mʏkɕɛt./", vi: "Cảm ơn nhiều.", en: "Thanks a lot." },
      ],
    },
    model: {
      titleVi: "Đoạn văn: cách chào hỏi trong ngày",
      titleEn: "Paragraph: greetings throughout the day",
      sv: "På morgonen säger jag 'God morgon' till mina kollegor. Klockan tio byter jag till 'Hej' eller bara 'Hejsan' eftersom morgonen är slut. På eftermiddagen frågar jag alltid 'Hur är det?' när jag möter någon. På kvällen, när jag lämnar kontoret, säger jag 'Hej då' och 'Trevlig kväll'. Hemma innan jag sover säger jag 'God natt' till barnen. Att hälsa rätt visar att jag respekterar svensk kultur.", ipa: "/pɔ mɔrɡuːnɛn sɛːjɛr jaɡ ɡɔd mɔrɡɔn tɪl miːna kɔleːɡɔr. klɔkkan tiːɔ byːtɛr jaɡ tɪl hɛj ɛlɛr bɑːra hɛjsan ɛftɛʂɔm mɔrɡuːnɛn ɛr slɵt. poː ɛftɛrmɪdɑːjɛn froːɡar jaɡ altɪd hɵr ɛr dɛt? nɛr jaɡ møːtɛr noːɡɔn. pɔ kvɛlɛn, nɛr jaɡ lɛmnar kɔntuːrɛt, sɛːjɛr jaɡ hɛj dɔ ɔɕ trɛvlɪɡ kvɛl. hɛmɑː ɪnan jaɡ suːvɛr sɛːjɛr jaɡ ɡɔd nat tɪl baɳɛn. at hɛlsa rɛt viːsar at jaɡ rɛspɛkteːrar svɛnsk kɵltɵr./",
  ...
  "a1-pronouns": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Lin", sv: "Vem är det?", ipa: "/vɛm ɛr dɛt?/", vi: "Đó là ai?", en: "Who is that?" },
        { speaker: "Mai", sv: "Det är min man. Han heter Hai.", ipa: "/dɛt ɛr mɪn man. han heːtɛr hɑːiː./", vi: "Đó là chồng tôi. Anh ấy tên Hải.", en: "That's my husband. His name is Hai." },
        { speaker: "Lin", sv: "Och hon? Är hon din syster?", ipa: "/ɔɕ hɔn? ɛr hɔn dɪn sʏstɛr?/", vi: "Còn cô ấy? Là chị bạn à?", en: "And her? Is she your sister?" },
        { speaker: "Mai", sv: "Ja, hennes namn är Lan. Hon bor i Hanoi.", ipa: "/ja, hɛnɛs namn ɛr lan. hɔn bɔr ɪ hɑːnuːiː./", vi: "Vâng, cô ấy tên là Lan. Sống ở Hà Nội.", en: "Yes, her name is Lan. She lives in Hanoi." },
        { speaker: "Lin", sv: "Vad gör de tillsammans?", ipa: "/vad jœr dɛ tɪlsamans?/", vi: "Họ làm gì cùng nhau?", en: "What do they do together?" },
        { speaker: "Mai", sv: "De lagar mat. Deras specialitet är phở.", ipa: "/dɛ lɑːɡar mat. deːras speːsiːɑːliːtɛt ɛr phở./", vi: "Họ nấu ăn. Đặc sản của họ là phở.", en: "They cook. Their specialty is pho." },
        { speaker: "Lin", sv: "Får jag prova en gång?", ipa: "/fɔr jaɡ pruːvɑː ɛn ɡɔŋ?/", vi: "Tôi có thể thử một lần không?", en: "May I try sometime?" },
        { speaker: "Mai", sv: "Självklart! Jag bjuder dig nästa helg.", ipa: "/ɧɛlvklaʈ! jaɡ bjʉːdɛr dɪɡ nɛsta hɛlɡ./", vi: "Tất nhiên! Cuối tuần sau tôi mời bạn.", en: "Of course! I'll invite you next weekend." },
      ],
    },
    model: {
      titleVi: "Đoạn văn: gia đình tôi qua các đại từ",
      titleEn: "Paragraph: my family through pronouns",
      sv: "Min familj är liten. Vi är fyra personer: jag, min man och våra två barn. Min man heter Hai. Han är ingenjör och hans favoritmat är pho. Vår dotter heter Linh och hennes lillebror heter Minh. De tycker om att leka tillsammans. Min syster bor i Vietnam. Hennes barn är våra kusiner. Vi pratar med dem på telefon varje söndag.", ipa: "/mɪn fɑːmɪlj ɛr liːtɛn. viː ɛr fyːra pɛʂuːnɛr: jaɡ, mɪn man ɔɕ voːra tvɔ baɳ. mɪn man heːtɛr hɑːɪ. han ɛr ɪŋɛnjœr ɔɕ hans fɑːvuːrɪtmat ɛr phɔ. vɔr dɔtɛr heːtɛr lɪnh ɔɕ hɛnɛs lɪlɛbrɔr heːtɛr mɪnh. dɛ tʏkɕɛr ɔm at leːka tɪlsamans. mɪn sʏstɛr bɔr ɪ viːɛtnam. hɛnɛs baɳ ɛr voːra kʉːsiːnɛr. vɪ prɑːtar mɛd dɛm pɔ teːleːfɔn varjɛ sœndaɡ./",
  ...
  "a1-en-ett": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Lin", sv: "Wow, lägenheten är fin!", ipa: "/vɔv, lɛːjɛnheːtɛn ɛr fɪn!/", vi: "Wow, căn hộ đẹp quá!", en: "Wow, the flat is nice!" },
        { speaker: "Mai", sv: "Tack! Här är vardagsrummet.", ipa: "/takk! hɛr ɛr vaɖaɡsrɵmɛt./", vi: "Cảm ơn! Đây là phòng khách.", en: "Thanks! Here's the living room." },
        { speaker: "Lin", sv: "Soffan är jättestor.", ipa: "/sɔfan ɛr jɛtɛstɔr./", vi: "Cái sofa to ghê.", en: "The sofa is huge." },
        { speaker: "Mai", sv: "Ja, och bordet är från IKEA.", ipa: "/ja, ɔɕ bɔɖɛt ɛr frɔn iːɕeːɑː./", vi: "Đúng, và cái bàn là từ IKEA.", en: "Yes, and the table is from IKEA." },
        { speaker: "Lin", sv: "Vad har du för fönster!", ipa: "/vad har dɵ fœr fœnstɛr!/", vi: "Cửa sổ nhà bạn đẹp ghê!", en: "What windows you have!" },
        { speaker: "Mai", sv: "Det är tre fönster i rummet.", ipa: "/dɛt ɛr trɛ fœnstɛr ɪ rɵmɛt./", vi: "Có 3 cửa sổ trong phòng.", en: "There are three windows in the room." },
        { speaker: "Lin", sv: "Var är badrummet?", ipa: "/var ɛr badrɵmɛt?/", vi: "Phòng tắm ở đâu?", en: "Where's the bathroom?" },
        { speaker: "Mai", sv: "Det ligger bredvid köket.", ipa: "/dɛt lɪɡɛr brɛdvɪd ɕøːɕɛt./", vi: "Nằm cạnh nhà bếp.", en: "Right next to the kitchen." },
      ],
    },
    model: {
      titleVi: "Đoạn văn: căn hộ của tôi",
      titleEn: "Paragraph: my flat",
      sv: "Jag bor i en lägenhet i Vasa. Lägenheten har tre rum: ett vardagsrum, ett sovrum och ett kök. Vardagsrummet är stort och ljust. I rummet finns en soffa, ett bord och en TV. Soffan är blå och bordet är vitt. Köket är litet men praktiskt. Det finns en spis, ett kylskåp och en diskmaskin. Badrummet ligger bredvid sovrummet. Jag tycker om min lägenhet eftersom det är nära havet.", ipa: "/jaɡ bɔr iː ɛn lɛːjɛnhɛt ɪ vɑːsa. lɛːjɛnheːtɛn har trɛ rɵm: ɛt vaɖaɡsrɵm, ɛt sɔvrɵm ɔɕ ɛt ɕœk. vaɖaɡsrɵmɛt ɛr stɔʈ ɔɕ ljɵst. ɪ rɵmɛt fɪns ɛn sɔfa, ɛt bɔɖ ɔɕ ɛn tv. sɔfan ɛr bloː ɔɕ bɔɖɛt ɛr vɪt. ɕøːɕɛt ɛr liːtɛt mɛn praktɪskt. dɛt fɪns ɛn spɪs, ɛt ɕʏlskɔp ɔɕ ɛn dɪskmaɧɪn. badrɵmɛt lɪɡɛr brɛdvɪd sɔvrɵmɛt. jaɡ tʏkɕɛr ɔm mɪn lɛːjɛnhɛt ɛftɛʂɔm dɛt ɛr nɛːra hɑːvɛt./",
  ...
  "a1-questions": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Eva", sv: "Vad heter du?", ipa: "/vad heːtɛr dʉː?/", vi: "Bạn tên gì?", en: "What's your name?" },
        { speaker: "Mai", sv: "Mai Nguyen.", ipa: "/mɑːɪ ŋʉːyːɛn./", vi: "Mai Nguyễn.", en: "Mai Nguyen." },
        { speaker: "Eva", sv: "Var kommer du ifrån?", ipa: "/var kɔmɛr dʉː ɪfrɔn?/", vi: "Bạn đến từ đâu?", en: "Where are you from?" },
        { speaker: "Mai", sv: "Från Vietnam.", ipa: "/frɔn viːɛtnam./", vi: "Từ Việt Nam.", en: "From Vietnam." },
        { speaker: "Eva", sv: "När kom du till Finland?", ipa: "/nɛr kɔm dɵ tɪl fɪnland?/", vi: "Khi nào bạn đến Phần Lan?", en: "When did you come to Finland?" },
        { speaker: "Mai", sv: "För tre år sedan.", ipa: "/fœr treː ɔr seːdan./", vi: "Cách đây 3 năm.", en: "Three years ago." },
        { speaker: "Eva", sv: "Varför vill du lära dig svenska?", ipa: "/varfœr vɪl dɵ lɛːra dɪɡ svɛnskɑː?/", vi: "Vì sao bạn muốn học tiếng Thụy Điển?", en: "Why do you want to learn Swedish?" },
        { speaker: "Mai", sv: "För att jobba med kollegor på finlandssvenska.", ipa: "/fœr at jɔba mɛd kɔleːɡɔr pɔ fɪnlandsvɛnskɑː./", vi: "Để làm việc với đồng nghiệp nói tiếng Thụy Điển Phần Lan.", en: "To work with Finland-Swedish colleagues." },
        { speaker: "Eva", sv: "Hur många timmar studerar du i veckan?", ipa: "/hɵr mɔŋa tɪmar stʉːdeːrar dʉː ɪ vɛkkan?/", vi: "Bạn học bao nhiêu giờ mỗi tuần?", en: "How many hours do you study per week?" },
        { speaker: "Mai", sv: "Cirka tio timmar.", ipa: "/sɪrka tiːɔ tɪmar./", vi: "Khoảng 10 giờ.", en: "About ten hours." },
      ],
    },
    model: {
      titleVi: "Đoạn văn: tự đặt câu hỏi cho chính mình",
      titleEn: "Paragraph: questioning yourself",
      sv: "Varje söndag skriver jag svar på fem frågor: Vad har jag lärt mig den här veckan? Vem har jag pratat svenska med? Var har jag använt språket? När har jag känt mig osäker? Hur kan jag bli bättre nästa vecka? Den här rutinen hjälper mig att se mina framsteg. Att ställa rätt frågor är viktigare än att kunna alla svar.", ipa: "/varjɛ sœndaɡ skriːvɛr jaɡ svar pɔ fɛm froːɡɔr: vad har jaɡ lɛʈ mɪɡ dɛn hɛr vɛkkan? vɛm har jaɡ prɑːtat svɛnska mɛd? var har jaɡ anvɛnt sproːɕɛt? nɛr har jaɡ ɕɛnt mɪɡ uːsɛːɕɛr? hɵr kan jaɡ blɪ bɛtrɛ nɛsta vɛkka? dɛn hɛr rʉːtiːnɛn hjɛlpɛr mɪɡ at sɛ miːna framstɛɡ. at stɛla rɛt froːɡɔr ɛr vɪktiːɡɑːreː ɛn at kɵnɑː ala svar./",
  ...
  "a1-colors-clothes": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Mai", sv: "Hej, har ni den här tröjan i röd?", ipa: "/hɛj, har nɪ dɛn hɛr trøːjan ɪ rœd?/", vi: "Chào, các bạn có chiếc áo này màu đỏ không?", en: "Hi, do you have this top in red?" },
        { speaker: "Säljare", sv: "Ja, vilken storlek?", ipa: "/ja, vɪlɕɛn stɔɭɛk?/", vi: "Có, cỡ nào?", en: "Yes, what size?" },
        { speaker: "Mai", sv: "Storlek M, tack.", ipa: "/stɔɭɛk m, takk./", vi: "Cỡ M, cảm ơn.", en: "Size M, please." },
        { speaker: "Säljare", sv: "Varsågod. Vill du prova?", ipa: "/vaʂoːɡɔd. vɪl dɵ pruːvɑː?/", vi: "Mời bạn. Muốn thử không?", en: "Here you go. Want to try it?" },
        { speaker: "Mai", sv: "Ja, var ligger provrummet?", ipa: "/ja, var lɪɡɛr prɔvrɵmɛt?/", vi: "Có, phòng thử ở đâu?", en: "Yes, where's the fitting room?" },
        { speaker: "Säljare", sv: "Där borta till höger.", ipa: "/dɛr bɔʈa tɪl høːjɛr./", vi: "Bên kia, bên phải.", en: "Over there to the right." },
        { speaker: "Mai", sv: "Tröjan är fin men för stor. Har ni S?", ipa: "/trøːjan ɛr fɪn mɛn fœr stɔr. har nɪ s?/", vi: "Áo đẹp nhưng to quá. Có cỡ S không?", en: "It's nice but too big. Got an S?" },
        { speaker: "Säljare", sv: "Tyvärr, bara M och L kvar i den röda färgen.", ipa: "/tyːvɛr, bɑːra m ɔɕ l kvar ɪ dɛn røːda fɛrjɛn./", vi: "Tiếc là chỉ còn M và L màu đỏ.", en: "Sorry, only M and L left in red." },
        { speaker: "Mai", sv: "Då tar jag den svarta i S istället.", ipa: "/dɔ tar jaɡ dɛn svaʈɑː ɪ s ɪstɛlɛt./", vi: "Vậy tôi lấy màu đen cỡ S.", en: "Then I'll take the black one in S." },
      ],
    },
    model: {
      titleVi: "Đoạn văn: mô tả tủ quần áo",
      titleEn: "Paragraph: describing my wardrobe",
      sv: "I min garderob har jag många kläder. Jag har tre vita skjortor, två svarta byxor och en blå klänning. Min favorittröja är röd och mjuk. Till jobbet bär jag oftast en vit skjorta och en grå kavaj. På fritiden tycker jag om gröna och bruna färger. Mina barn har också många färgglada kläder: en gul jacka, ett rött par stövlar och en blå halsduk. Vintern i Finland kräver varma kläder, så vi har också tjocka rockar och ulliga mössor.", ipa: "/ɪ mɪn ɡaɖeːrɔb har jaɡ mɔŋa klɛːdɛr. jaɡ har trɛ viːta ɧɔʈɔr, tvɔ svaʈa byːksɔr ɔɕ ɛn blɔ klɛnɪŋ. mɪn fɑːvuːrɪtrøːjɑː ɛr rœd ɔɕ mjɵk. tɪl jɔbɛt bɛr jaɡ ɔftast ɛn vɪt ɧɔʈɑː ɔɕ ɛn ɡrɔ kɑːvaj. pɔ friːtiːdɛn tʏkɕɛr jaɡ ɔm ɡrøːnɑː ɔɕ brʉːna fɛrjɛr. miːna baɳ har ɔkksɔ mɔŋa fɛrɡlɑːda klɛːdɛr: ɛn ɡɵl jakka, ɛt rœt par stœvlar ɔɕ ɛn blɔ halsdɵk. vɪntɛɳ ɪ fɪnland krɛːvɛr varma klɛːdɛr, sɔ vɪ har ɔkksɔ ɕɔkka rɔkkar ɔɕ ɵliːɡa mœsɔr./",
  ...
  "a1-body-health": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Receptionist", sv: "Hej, Vasa hälsocentral.", ipa: "/hɛj, vɑːsa hɛlsuːsɛntral./", vi: "Chào, trung tâm y tế Vasa.", en: "Hi, Vasa health centre." },
        { speaker: "Mai", sv: "Hej, jag mår dåligt och behöver träffa en läkare.", ipa: "/hɛj, jaɡ mɔr doːlɪɡt ɔɕ beːhøːvɛr trɛfɑː ɛn lɛːkɑːreː./", vi: "Chào, tôi không khoẻ và cần gặp bác sĩ.", en: "Hi, I'm unwell and need to see a doctor." },
        { speaker: "Receptionist", sv: "Vad är det för fel?", ipa: "/vad ɛr dɛt fœr fɛl?/", vi: "Bạn bị làm sao?", en: "What's wrong?" },
        { speaker: "Mai", sv: "Jag har ont i halsen och hostar mycket.", ipa: "/jaɡ har ɔnt ɪ halsɛn ɔɕ hɔstar mʏkɕɛt./", vi: "Tôi đau họng và ho nhiều.", en: "I have a sore throat and a bad cough." },
        { speaker: "Receptionist", sv: "Har du feber?", ipa: "/har dɵ feːbɛr?/", vi: "Bạn có sốt không?", en: "Do you have a fever?" },
        { speaker: "Mai", sv: "Ja, 38,5 grader sedan i går.", ipa: "/ja, 38,5 ɡrɑːdɛr seːdan ɪ ɡɔr./", vi: "Có, 38,5 độ từ hôm qua.", en: "Yes, 38.5 since yesterday." },
        { speaker: "Receptionist", sv: "Kan du komma klockan tre i eftermiddag?", ipa: "/kan dɵ kɔma klɔkkan treː iː ɛftɛrmɪdaɡ?/", vi: "Bạn đến lúc 3h chiều được không?", en: "Can you come at 3 PM today?" },
        { speaker: "Mai", sv: "Ja, tack. Vart ska jag gå?", ipa: "/ja, takk. vaʈ ska jaɡ ɡoː?/", vi: "Vâng, cảm ơn. Tôi đi đâu?", en: "Yes, thanks. Where do I go?" },
        { speaker: "Receptionist", sv: "Anmäl dig i receptionen på första våningen.", ipa: "/anmɛl dɪɡ ɪ reːsɛptiːuːnɛn pɔ fœʂta voːnɪŋɛn./", vi: "Đăng ký tại quầy lễ tân tầng 1.", en: "Check in at reception on the first floor." },
      ],
    },
    model: {
      titleVi: "Đoạn văn: kể bệnh ngắn với bác sĩ",
      titleEn: "Paragraph: short symptom report to a doctor",
      sv: "God morgon doktorn. Jag mår inte bra. Sedan tre dagar har jag ont i huvudet och i halsen. Jag hostar på natten och har svårt att sova. I morse var min temperatur 38,5 grader. Jag har också ont i magen efter att jag äter. Jag tar paracetamol men det hjälper inte mycket. Jag är inte allergisk mot någon medicin. Jag vill veta vad jag har och om jag behöver vara hemma från jobbet.", ipa: "/ɡɔd mɔrɡɔn dɔktɔɳ. jaɡ mɔr ɪntɛ bra. seːdan trɛ dɑːɡar har jaɡ ɔnt ɪ hʉːvʉːdɛt ɔɕ ɪ halsɛn. jaɡ hɔstar pɔ natɛn ɔɕ har svɔʈ at suːva. ɪ mɔʂɛ var mɪn tɛmpeːrɑːtɵr 38,5 ɡrɑːdɛr. jaɡ har ɔkksoː ɔnt ɪ mɑːjɛn ɛftɛr at jaɡ ɛːtɛr. jaɡ tar pɑːrɑːseːtɑːmɔl mɛn dɛt hjɛlpɛr ɪntɛ mʏkɕɛt. jaɡ ɛr ɪnteː alɛrjɪsk mɔt noːɡɔn meːdiːsɪn. jaɡ vɪl veːta vad jaɡ har ɔɕ ɔm jaɡ beːhøːvɛr vɑːra hɛma frɔn jɔbɛt./",
  ...
  "a1-daily-routine": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Lin", sv: "Vad gör du på morgonen?", ipa: "/vad jœr dɵ pɔ mɔrɡuːnɛn?/", vi: "Sáng bạn làm gì?", en: "What do you do in the morning?" },
        { speaker: "Mai", sv: "Jag vaknar klockan sex och tar en dusch.", ipa: "/jaɡ vaknar klɔkkan sɛks ɔɕ tar ɛn dɵɧ./", vi: "Tôi dậy lúc 6h và tắm.", en: "I wake up at six and shower." },
        { speaker: "Lin", sv: "Och sedan?", ipa: "/ɔɕ seːdan?/", vi: "Rồi sao?", en: "And then?" },
        { speaker: "Mai", sv: "Jag äter frukost och åker till jobbet med spårvagnen.", ipa: "/jaɡ ɛːtɛr frʉːkɔst ɔɕ oːɕɛr tɪl jɔbɛt mɛd spɔrvaŋnɛn./", vi: "Tôi ăn sáng rồi đi làm bằng tàu điện.", en: "I eat breakfast and take the tram to work." },
        { speaker: "Lin", sv: "När börjar du jobba?", ipa: "/nɛr bœrjar dɵ jɔbɑː?/", vi: "Bạn bắt đầu làm khi nào?", en: "When do you start work?" },
        { speaker: "Mai", sv: "Klockan halv nio. Jag jobbar till sjutton.", ipa: "/klɔkkan halv niːɔ. jaɡ jɔbar tɪl ɧɵtɔn./", vi: "Lúc 8:30. Tôi làm đến 17h.", en: "At 8:30. I work until 5 PM." },
        { speaker: "Lin", sv: "Vad gör du på kvällen?", ipa: "/vad jœr dɵ pɔ kvɛlɛn?/", vi: "Buổi tối bạn làm gì?", en: "What do you do in the evening?" },
        { speaker: "Mai", sv: "Jag lagar middag, läser och pluggar svenska.", ipa: "/jaɡ lɑːɡar mɪdaɡ, lɛːsɛr ɔɕ plɵɡar svɛnskɑː./", vi: "Tôi nấu cơm tối, đọc sách và học tiếng Thụy Điển.", en: "I cook dinner, read and study Swedish." },
        { speaker: "Lin", sv: "Disciplinerad! Och jag som bara streamar Netflix.", ipa: "/dɪssɪpliːneːrad! ɔɕ jaɡ sɔm bɑːra streːɑːmar nɛtflɪks./", vi: "Kỷ luật ghê! Còn tớ chỉ xem Netflix thôi.", en: "Disciplined! And I just stream Netflix." },
      ],
    },
    model: {
      titleVi: "Đoạn văn 100 từ: một ngày thường của tôi",
      titleEn: "100-word paragraph: my typical day",
      sv: "En vanlig vardag börjar klockan sex. Jag vaknar, tar en dusch och äter frukost: havregryn, kaffe och en frukt. Klockan halv åtta åker jag till jobbet med tåget. På jobbet svarar jag på mejl och har möten på engelska och lite på svenska. Klockan tolv äter jag lunch med kollegor i personalmatsalen. Efter jobbet handlar jag på K-Market och cyklar hem. Hemma lagar jag middag, leker med barnen och läser en bok. Innan jag sover repeterar jag tio nya svenska ord. Klockan elva släcker jag lampan.", ipa: "/ɛn vanlɪɡ vaɖaɡ bœrjar klɔkkan sɛks. jaɡ vaknar, tar ɛn dɵɧ ɔɕ ɛːtɛr frʉːkɔst: havrɛɡrʏn, kafeː ɔɕ ɛn frɵkt. klɔkkan halv ɔtɑː oːɕɛr jaɡ tɪl jɔbɛt mɛd toːjɛt. pɔ jɔbɛt svɑːrar jaɡ pɔ mɛjl ɔɕ har møːtɛn poː ɛŋɛlskɑː ɔɕ liːtɛ pɔ svɛnska. klɔkkan tɔlv ɛːtɛr jaɡ lɵnɕ mɛd kɔleːɡɔr ɪ pɛʂuːnalmatsɑːlɛn. ɛftɛr jɔbɛt handlar jaɡ pɔ kmarɕɛt ɔɕ sʏklar hɛm. hɛma lɑːɡar jaɡ mɪdaɡ, leːɕɛr mɛd baɳɛn ɔɕ lɛːsɛr ɛn bɔk. ɪnan jaɡ suːvɛr reːpeːteːrar jaɡ tiːɔ nyːa svɛnskɑː ɔɖ. klɔkkan ɛlva slɛkɕɛr jaɡ lampan./",
  ...
  "a1-hobbies": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Erik", sv: "Vad ska du göra i helgen?", ipa: "/vad ska dɵ jøːrɑː ɪ hɛljɛn?/", vi: "Cuối tuần bạn làm gì?", en: "What are you doing this weekend?" },
        { speaker: "Mai", sv: "Jag ska träffa min man och våra barn.", ipa: "/jaɡ ska trɛfa mɪn man ɔɕ voːra baɳ./", vi: "Tôi sẽ gặp chồng và các con.", en: "I'll meet my husband and kids." },
        { speaker: "Erik", sv: "Vad gillar ni att göra tillsammans?", ipa: "/vad jɪlar niː at jøːra tɪlsamans?/", vi: "Cả nhà thích làm gì cùng nhau?", en: "What do you all like to do together?" },
        { speaker: "Mai", sv: "Vi gillar att cykla och att laga mat. Och du?", ipa: "/vɪ jɪlar at sʏklɑː ɔɕ at lɑːɡa mat. ɔɕ dʉː?/", vi: "Chúng tôi thích đạp xe và nấu ăn. Còn bạn?", en: "We like cycling and cooking. You?" },
        { speaker: "Erik", sv: "Jag tycker om att läsa och spelar fotboll på söndagar.", ipa: "/jaɡ tʏkɕɛr ɔm at lɛːsɑː ɔɕ speːlar fɔtbɔl pɔ sœndɑːɡar./", vi: "Tôi thích đọc sách và chơi bóng đá Chủ nhật.", en: "I like reading and play football on Sundays." },
        { speaker: "Mai", sv: "Var spelar du?", ipa: "/var speːlar dʉː?/", vi: "Bạn chơi ở đâu?", en: "Where do you play?" },
        { speaker: "Erik", sv: "I parken bredvid Sandviken.", ipa: "/ɪ parɕɛn brɛdvɪd sandviːɕɛn./", vi: "Ở công viên cạnh Sandviken.", en: "In the park next to Sandviken." },
        { speaker: "Mai", sv: "Kul! Vi kanske kommer och hejar.", ipa: "/kɵl! vɪ kanɧɛ kɔmɛr ɔɕ heːjar./", vi: "Vui đấy! Có khi chúng tôi qua cổ vũ.", en: "Fun! Maybe we'll drop by to cheer." },
      ],
    },
    model: {
      titleVi: "Đoạn văn: sở thích và lý do",
      titleEn: "Paragraph: hobbies and reasons",
      sv: "Jag har tre stora intressen: matlagning, fotografi och språk. Jag tycker om att laga vietnamesisk mat eftersom det påminner mig om Hanoi. Min favoritmat är phở bò. Jag fotograferar gärna när vi reser i Finland - särskilt skärgården och norrskenet. På fritiden lyssnar jag på finlandssvenska poddar för att bli bättre på språket. Jag gillar inte att titta på TV länge, men jag tycker om att läsa böcker på svenska. På helgen tränar jag yoga och cyklar med min familj.", ipa: "/jaɡ har trɛ stuːrɑː ɪntrɛsɛn: matlaŋnɪŋ, fuːtɔɡrɑːfiː ɔɕ sprɔk. jaɡ tʏkɕɛr ɔm at lɑːɡa viːɛtnɑːmeːsɪsk mat ɛftɛʂɔm dɛt poːmɪnɛr mɪɡ ɔm hɑːnuːɪ. mɪn fɑːvuːrɪtmat ɛr phở bò. jaɡ fuːtɔɡrɑːfeːrar jɛɳa nɛr vɪ reːsɛr ɪ fɪnland  sɛʂɕɪlt ɧɛrɡɔɖɛn ɔɕ nɔrɧeːnɛt. pɔ friːtiːdɛn lʏsnar jaɡ pɔ fɪnlandsvɛnska pɔdar fœr at blɪ bɛtrɛ pɔ sproːɕɛt. jaɡ jɪlar ɪnteː at tɪta pɔ tv lɛŋɛ, mɛn jaɡ tʏkɕɛr ɔm at lɛːsa bœkɕɛr pɔ svɛnska. pɔ hɛljɛn trɛːnar jaɡ yːuːɡɑː ɔɕ sʏklar mɛd mɪn fɑːmɪlj./",
  ...
  "a1-doctor": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Läkare", sv: "Hej, vad är det för fel?", ipa: "/hɛj, vad ɛr dɛt fœr fɛl?/", vi: "Chào, bạn bị gì?", en: "Hi, what's wrong?" },
        { speaker: "Mai", sv: "Jag har ont i halsen och hostar mycket.", ipa: "/jaɡ har ɔnt ɪ halsɛn ɔɕ hɔstar mʏkɕɛt./", vi: "Tôi đau họng và ho nhiều.", en: "I have a sore throat and bad cough." },
        { speaker: "Läkare", sv: "Hur länge har du varit sjuk?", ipa: "/hɵr lɛŋɛ har dɵ vɑːrɪt ɧɵk?/", vi: "Bạn ốm bao lâu rồi?", en: "How long have you been sick?" },
        { speaker: "Mai", sv: "Sedan fyra dagar.", ipa: "/seːdan fyːra dɑːɡar./", vi: "Từ 4 ngày trước.", en: "For four days." },
        { speaker: "Läkare", sv: "Har du feber?", ipa: "/har dɵ feːbɛr?/", vi: "Có sốt không?", en: "Any fever?" },
        { speaker: "Mai", sv: "Ja, 38,2 grader i morse.", ipa: "/ja, 38,2 ɡrɑːdɛr ɪ mɔʂeː./", vi: "Có, 38,2 độ sáng nay.", en: "Yes, 38.2 this morning." },
        { speaker: "Läkare", sv: "Öppna munnen, jag ska titta.", ipa: "/œpna mɵnɛn, jaɡ ska tɪtɑː./", vi: "Mở miệng nào, tôi xem nhé.", en: "Open your mouth, I'll have a look." },
        { speaker: "Mai", sv: "Är det allvarligt?", ipa: "/ɛr dɛt alvaɭɪɡt?/", vi: "Có nghiêm trọng không?", en: "Is it serious?" },
        { speaker: "Läkare", sv: "Nej, det är en virusinfektion. Vila och drick mycket vatten.", ipa: "/nɛj, dɛt ɛr ɛn viːrʉːsɪnfɛktiːɔn. viːlɑː ɔɕ drɪkk mʏkɕɛt vatɛn./", vi: "Không, là nhiễm virus. Hãy nghỉ và uống nhiều nước.", en: "No, just a virus. Rest and drink plenty of water." },
        { speaker: "Mai", sv: "Kan jag få ett sjukintyg för tre dagar?", ipa: "/kan jaɡ foː ɛt ɧʉːɕɪntʏɡ fœr trɛ dɑːɡar?/", vi: "Tôi có thể xin giấy nghỉ 3 ngày không?", en: "May I get a sick note for three days?" },
        { speaker: "Läkare", sv: "Absolut. Du får det vid receptionen.", ipa: "/absuːlɵt. dɵ fɔr dɛt vɪd reːsɛptiːuːnɛn./", vi: "Chắc chắn. Bạn nhận ở lễ tân.", en: "Of course. You'll get it at reception." },
      ],
    },
    model: {
      titleVi: "Đoạn văn: kể lại buổi khám với gia đình",
      titleEn: "Paragraph: telling family about the visit",
      sv: "Igår var jag hos läkaren på Vasa hälsocentral. Jag har varit sjuk sedan fyra dagar. Jag berättade att jag har ont i halsen, hostar och har feber. Läkaren tittade i halsen och lyssnade på mina lungor. Hon sa att det är en virusinfektion. Jag fick inte antibiotika men hon skrev ett sjukintyg för tre dagar. Hon rekommenderade att jag dricker mycket vatten, vilar och tar paracetamol mot febern. Nu mår jag lite bättre och hoppas att jag kan jobba igen på måndag.", ipa: "/iːɡɔr var jaɡ hɔs lɛːkɑːrɛn pɔ vɑːsa hɛlsuːsɛntral. jaɡ har vɑːrɪt ɧɵk seːdan fyːra dɑːɡar. jaɡ beːrɛtɑːdeː at jaɡ har ɔnt ɪ halsɛn, hɔstar ɔɕ har feːbɛr. lɛːkɑːrɛn tɪtɑːdeː ɪ halsɛn ɔɕ lʏsnɑːdɛ pɔ miːna lɵŋɔr. hɔn sɑː at dɛt ɛr ɛn viːrʉːsɪnfɛktiːɔn. jaɡ fɪkk ɪnteː antiːbiːuːtiːka mɛn hɔn skrɛv ɛt ɧʉːɕɪntʏɡ fœr trɛ dɑːɡar. hɔn reːkɔmɛndeːrɑːdeː at jaɡ drɪkɕɛr mʏkɕɛt vatɛn, viːlar ɔɕ tar pɑːrɑːseːtɑːmɔl mɔt feːbɛɳ. nɵ mɔr jaɡ liːtɛ bɛtreː ɔɕ hɔpas at jaɡ kan jɔbɑː iːjɛn pɔ mɔndaɡ./",
  ...
  "a1-shopping": {
    ...
    dialogue: {
      ...
      lines: [
        { speaker: "Kassör", sv: "Hej, har du stamkundskort?", ipa: "/hɛj, har dɵ stamkɵndskɔʈ?/", vi: "Chào, bạn có thẻ khách quen không?", en: "Hi, do you have a loyalty card?" },
        { speaker: "Mai", sv: "Nej, jag har inte.", ipa: "/nɛj, jaɡ har ɪnteː./", vi: "Không, tôi không có.", en: "No, I don't." },
        { speaker: "Kassör", sv: "Det blir tjugotvå euro och femtio cent.", ipa: "/dɛt blɪr ɕʉːɡɔtvoː eːʉːruː ɔɕ fɛmtiːɔ sɛnt./", vi: "Tổng 22 euro 50 cent.", en: "That's 22.50." },
        { speaker: "Mai", sv: "Kan jag betala med kort?", ipa: "/kan jaɡ beːtɑːla mɛd kɔʈ?/", vi: "Tôi trả thẻ được không?", en: "Can I pay by card?" },
        { speaker: "Kassör", sv: "Självklart. Knappa in koden.", ipa: "/ɧɛlvklaʈ. knapɑː ɪn kuːdɛn./", vi: "Tất nhiên. Nhập mã PIN nhé.", en: "Sure, enter your PIN." },
        { speaker: "Mai", sv: "Klart.", ipa: "/klaʈ./", vi: "Xong.", en: "Done." },
        { speaker: "Kassör", sv: "Vill du ha en påse?", ipa: "/vɪl dɵ hɑː ɛn poːseː?/", vi: "Bạn lấy túi không?", en: "Want a bag?" },
        { speaker: "Mai", sv: "Ja tack, en stor.", ipa: "/ja takk, ɛn stɔr./", vi: "Có, một túi to.", en: "Yes please, a big one." },
        { speaker: "Kassör", sv: "Den kostar trettio cent extra. Här är kvittot. Trevlig dag!", ipa: "/dɛn kɔstar trɛtiːɔ sɛnt ɛkstra. hɛr ɛr kvɪtɔt. trɛvlɪɡ daɡ!/", vi: "Túi 30 cent. Đây là hoá đơn. Chúc một ngày vui!", en: "It's 30 cents extra. Here's the receipt. Have a nice day!" },
      ],
    },
    model: {
      titleVi: "Đoạn văn: kế hoạch đi chợ cuối tuần",
      titleEn: "Paragraph: weekend grocery plan",
      sv: "Varje lördag morgon går jag och min man till K-Market i centrum. Vi skriver en inköpslista först: bröd, mjölk, ägg, kyckling, ris och grönsaker. Vi tittar också på reaerbjudanden eftersom det sparar pengar. Jag älskar att jämföra priser per kilo. Vid kassan betalar jag med kort och tar alltid med en återanvändbar tygpåse. Efter affären köper vi kanelbullar på Robert's Coffee och dricker kaffe tillsammans. Det är vårt favoritrutin för helgen.", ipa: "/varjɛ lœɖaɡ mɔrɡɔn ɡɔr jaɡ ɔɕ mɪn man tɪl kmarɕɛt ɪ sɛntrɵm. vɪ skriːvɛr ɛn ɪnɕœpslɪsta fœʂt: brœd, mjœlk, ɛɡ, ɕʏkklɪŋ, rɪs ɔɕ ɡrœnsɑːɕɛr. vɪ tɪtar ɔkksɔ pɔ reːɑːɛrbjʉːdandɛn ɛftɛʂɔm dɛt spɑːrar pɛŋar. jaɡ ɛlskar at jɛmføːra priːsɛr pɛr ɕiːlɔ. vɪd kasan beːtɑːlar jaɡ mɛd kɔʈ ɔɕ tar altɪd mɛd ɛn oːteːranvɛndbar tʏɡpoːsɛ. ɛftɛr afɛːrɛn ɕøːpɛr vɪ kɑːnɛlbɵlar pɔ ruːbɛʈs kɔfeːeː ɔɕ drɪkɕɛr kafɛ tɪlsamans. dɛt ɛr vɔʈ fɑːvuːrɪtrʉːtɪn fœr hɛljɛn./",
