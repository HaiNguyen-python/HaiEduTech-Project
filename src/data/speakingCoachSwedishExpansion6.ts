...
const b2: SpeakingTheme[] = [
  ...
  },
  {
    ...
    sentences: [
      { id: "e6-sv-in1", text: "Språket är nyckeln till att komma in i samhället.", translation: "Ngôn ngữ là chìa khóa để hòa nhập xã hội.", difficulty: "hard", theme: "integration" },
      { id: "e6-sv-in2", text: "Många nyanlända saknar nätverk på arbetsmarknaden.", translation: "Nhiều người mới đến thiếu mạng lưới trên thị trường lao động.", difficulty: "hard", theme: "integration" },
      { id: "e6-sv-in3", text: "Mångfald berikar både arbetsplatser och skolor.", translation: "Sự đa dạng làm giàu cả nơi làm việc lẫn trường học.", difficulty: "hard", theme: "integration" },
      { id: "e6-sv-in4", text: "Det tar tid att förstå oskrivna sociala regler.", translation: "Cần thời gian để hiểu các quy tắc xã hội bất thành văn.", difficulty: "hard", theme: "integration" },
      { id: "e6-sv-in5", text: "Jag försöker behålla min kultur och samtidigt anpassa mig.", translation: "Tôi cố giữ văn hóa của mình đồng thời thích nghi.", difficulty: "hard", theme: "integration" },
      { id: "e6-sv-in6", text: "Validering av utländska examina går ofta för långsamt.", translation: "Việc công nhận bằng cấp nước ngoài thường quá chậm.", difficulty: "hard", theme: "integration" },
      { id: "e6-sv-in7", text: "Praktik är ofta första steget till en fast anställning.", translation: "Thực tập thường là bước đầu tới công việc chính thức.", difficulty: "hard", theme: "integration" },
      { id: "e6-sv-in8", text: "Fördomar minskar när människor möts i vardagen.", translation: "Định kiến giảm khi con người gặp nhau trong đời thường.", difficulty: "hard", theme: "integration" },
      { id: "e6-sv-in9", text: "Föreningslivet är ett bra sätt att skaffa vänner.", translation: "Sinh hoạt hội nhóm là cách tốt để kết bạn.", difficulty: "hard", theme: "integration" },
      { id: "e6-sv-in10", text: "Tvåspråkiga barn har en tydlig fördel senare i livet.", translation: "Trẻ song ngữ có lợi thế rõ rệt về sau.", difficulty: "hard", theme: "integration" },
    ],
  },
  {
...
const c1: SpeakingTheme[] = [
  ...
  },
  {
    ...
    sentences: [
      { id: "e6-sv-cu1", text: "Lagom genomsyrar allt från arkitektur till löneförhandlingar.", translation: "Tinh thần 'lagom' thấm vào mọi thứ, từ kiến trúc tới đàm phán lương.", difficulty: "hard", theme: "culture" },
      { id: "e6-sv-cu2", text: "Allemansrätten ger alla tillgång till naturen, med ansvar.", translation: "Quyền tiếp cận thiên nhiên cho tất cả, kèm trách nhiệm.", difficulty: "hard", theme: "culture" },
      { id: "e6-sv-cu3", text: "Midsommar firas med sill, dans och alldeles för mycket regn.", translation: "Lễ hạ chí có cá trích, khiêu vũ và mưa nhiều quá mức.", difficulty: "hard", theme: "culture" },
      { id: "e6-sv-cu4", text: "Konsensuskulturen gör beslut långsamma men hållbara.", translation: "Văn hóa đồng thuận khiến quyết định chậm nhưng bền.", difficulty: "hard", theme: "culture" },
      { id: "e6-sv-cu5", text: "Tilliten till institutioner är ovanligt hög i Norden.", translation: "Niềm tin vào thể chế ở Bắc Âu cao khác thường.", difficulty: "hard", theme: "culture" },
      { id: "e6-sv-cu6", text: "Föräldraledigheten delas allt jämnare mellan föräldrarna.", translation: "Nghỉ thai sản ngày càng được chia đều giữa cha mẹ.", difficulty: "hard", theme: "culture" },
      { id: "e6-sv-cu7", text: "Att komma i tid betraktas som ett tecken på respekt.", translation: "Đúng giờ được coi là dấu hiệu của sự tôn trọng.", difficulty: "hard", theme: "culture" },
      { id: "e6-sv-cu8", text: "Diskussioner förs sakligt, sällan med höjd röst.", translation: "Tranh luận diễn ra khách quan, hiếm khi lớn tiếng.", difficulty: "hard", theme: "culture" },
      { id: "e6-sv-cu9", text: "Naturen är för många svenskar en form av återhämtning.", translation: "Với nhiều người Thụy Điển, thiên nhiên là cách hồi phục.", difficulty: "hard", theme: "culture" },
      { id: "e6-sv-cu10", text: "Fikapausen fyller en social funktion, inte bara en kulinarisk.", translation: "Giờ fika có chức năng xã hội, không chỉ là chuyện ăn uống.", difficulty: "hard", theme: "culture" },
    ],
  },
];
