    ...
    lessons: [
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "Then, I summarized both positions and highlighted the pros and cons of each approach." },
        ],
          },
        ],
        vocabulary: [
    ...
    lessons: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "So, if that statistics course doesn't count, what are my other options for electives?" },
