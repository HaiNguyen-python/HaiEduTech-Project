    ...
    lessons: [
      {
        ...
        keySituations: [
          ...
          { speaker: "Staff", line: "Let me see what discounts we have available. Yes, we have a small discount for buying two items. Follow me to the cash register and I'll apply it for you." },
          ...
          { speaker: "Staff", line: "Of course. Let me check if we have a medium in stock for you." },
          { speaker: "You", line: "Okay, thank you. I'll wait here." },
          { speaker: "Staff", line: "Yes, we do! I'll process the exchange for you now." },
        ],
          },
          {
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
          { speaker: "Waiter", line: "Good evening! I see you've had a few minutes to look over the menu. Are you ready to order?" },
          { speaker: "You", line: "Everything looks delicious, but I'm having a hard time deciding. What do you recommend?" },
          { speaker: "Waiter", line: "If you enjoy seafood, the grilled salmon is our best seller. It's caught fresh and seasoned with lemon and herbs." },
          ...
          { speaker: "You", line: "Just regular tap water with some ice will be fine, thank you. Roughly how long do you think it will take for the food to arrive?" },
          { speaker: "Waiter", line: "It should be ready in about fifteen to twenty minutes. I'll bring your water right away." },
          { speaker: "You", line: "Perfect, thank you!" },
        ],
          },
          {
          ...
          { speaker: "Waiter", line: "The chef confirmed both the Spicy Pad Thai and the Ginger Stir-fry are nut-free. However, please be aware that our dessert, the almond tart, does contain nuts." },
          { speaker: "You", line: "That sounds great. I'll take the Ginger Stir-fry, and for dessert, I'll have the fresh fruit salad instead of the almond tart." },
          { speaker: "Waiter", line: "Excellent choice. I'll make sure to note your peanut allergy for the kitchen and that you'd like the fresh fruit." },
        ],
          },
          {
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "Great, thanks for your help! Have a wonderful afternoon." },
          { speaker: "Local", line: "You're welcome! You too. Good luck with the museum!" },
        ],
          },
          {
          ...
          { speaker: "Driver", line: "I should be there in about 5 minutes, give or take." },
          { speaker: "You", line: "Okay, thank you. I'll wait here." },
        ],
          },
        ],
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "I'm a graphic designer. I create branding and marketing materials for different companies." },
          { speaker: "New Friend", line: "That sounds interesting! So, do you mainly work with local businesses?" },
        ],
          },
          {
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "What can we even do about it? It seems unavoidable." },
          { speaker: "Friend", line: "Well, there are things like browser extensions and privacy settings we can use to limit it." },
        ],
          },
        ],
        vocabulary: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Receptionist", line: "One moment, please. Let me check the system for that name." },
          { speaker: "Receptionist", line: "Welcome! I see a deluxe room booked for three nights." },
          { speaker: "You", line: "That is correct. Does the room have a view of the city or the ocean?" },
          { speaker: "Receptionist", line: "Your room is on the 10th floor with a beautiful ocean view." },
          { speaker: "You", line: "Great! Could I also request extra towels and a late checkout?" },
          { speaker: "Receptionist", line: "Yes, we can definitely arrange for extra towels. Regarding late checkout, what time were you considering?" },
          { speaker: "You", line: "I was hoping for around 2 PM, if possible. Thank you for checking. Have a lovely evening." },
        ],
          },
        ],
        vocabulary: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "No, I didn't see anyone suspicious, and I didn't notice anyone standing too close. What happens next? Do I need to fill out a report?" },
          { speaker: "Officer", line: "Yes, you'll need to fill out a report. Please wait here while I print the form for you." },
        ],
          },
        ],
        vocabulary: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "Yes, I can hear a low clicking sound every few minutes." },
          { speaker: "Landlord", line: "That helps. I will send an experienced technician to check it. When can I expect you to be home?" },
        ],
          },
        ],
        vocabulary: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "Are these documents acceptable to open an account?" },
          { speaker: "Teller", line: "Yes, these documents are perfect. Now, let's go over the savings account options and choose the best one for you." },
        ],
          },
          {
            ...
            sampleDialogue: [
          { speaker: "You", line: "Excuse me, this ATM just swallowed my card." },
          ...
          { speaker: "Guard", line: "You will need to speak with the bank staff inside to retrieve it." },
          { speaker: "You", line: "Thank you. Should I go to the customer service desk near the entrance?" },
          { speaker: "Guard", line: "Yes, please take a number and wait for the next available teller there." },
          { speaker: "You", line: "Okay, thank you. Will it take long to open the machine and get my card back?" },
          { speaker: "Guard", line: "The bank staff inside will be able to help you with that. It usually takes about ten minutes for them to retrieve a card safely." },
        ],
          },
        ],
        vocabulary: [
      ...
      // NEW LESSONS for Life Skills
      {
        ...
        keySituations: [
          ...
          { speaker: "Friend", line: "Should I add the garlic with the onions?" },
          { speaker: "You", line: "No, let's add the garlic a little later so it doesn't burn. What's next after the onions?" },
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Colleague", line: "Yes, apparently there's a good chance of one this afternoon. Hopefully, the temperature drops below twenty five degrees soon." },
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "I'm thinking we can do some appetizers and drinks. I'll take care of the main dish. And most importantly, make sure she doesn't suspect anything!" },
          ...
          { speaker: "You", line: "Families gather, eat traditional food, and give lucky money in red envelopes to children." },
          { speaker: "Friend", line: "That sounds lovely. Is there anything special happening on the actual New Year's Day?" },
    ...
    lessons: [
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "My greatest strength is my ability to quickly adapt to new technologies and teach them to others." },
          ...
          { speaker: "You", line: "That is a great question. Conflict is natural when workers are passionate, and I have experience with it. I recall a situation at my previous job where two team members disagreed on a project direction." },
          { speaker: "Interviewer", line: "What was the specific disagreement about during that project?" },
          { speaker: "You", line: "One team member, David, wanted a mobile-first approach, but Sarah insisted on a desktop-first design." },
          { speaker: "Interviewer", line: "How did you step in to manage their strong feelings?" },
          { speaker: "You", line: "I listened to both David and Sarah separately, allowing each to express their viewpoint fully without interruption. This helped to acknowledge their feelings and understand their core concerns." },
          { speaker: "Interviewer", line: "And what did you do next after that initial discussion?" },
          { speaker: "You", line: "After those individual discussions, I brought them together for a meeting. I encouraged them to brainstorm solutions that could integrate both mobile and desktop considerations, emphasizing the overall project goal." },
        ],
          },
        ],
        vocabulary: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Speaker", line: "TechFlow? Interesting! I think I've seen some of your recent social media campaigns. They're quite distinctive." },
          { speaker: "You", line: "Oh, that's great to hear! We've been working hard on those. Perhaps we could connect later and discuss them further?" },
          { speaker: "Speaker", line: "Yes, I'd like that. Please do send me a message. I look forward to hearing more about your projects at TechFlow." },
        ],
          },
          {
          ...
          { speaker: "Message", line: "I am working on a similar project and would love to exchange ideas." },
          { speaker: "Reply", line: "Thanks for reaching out! I would be happy to chat." },
          { speaker: "Message", line: "I am specifically interested in how your team used Python for predictive consumer behavior analysis." },
          { speaker: "Reply", line: "That was the most challenging part of the whole strategy, but also the most rewarding." },
          { speaker: "Message", line: "Could you tell me more about your approach?" },
          { speaker: "Reply", line: "Of course, I would love to share. Let's schedule a brief call to discuss it further." },
        ],
          },
        ],
        vocabulary: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Manager", line: "That's great. Is there anything blocking your work on other tasks?" },
          { speaker: "Sarah", line: "Yes, I'm waiting on some sales data from the finance team for the Q4 forecast." },
          { speaker: "Manager", line: "Okay. I will follow up with them to make sure you get that data before the end of the day." },
          ...
          { speaker: "Marketing", line: "Thanks. From Marketing's side, we have a lot of social media ads scheduled for early April." },
          { speaker: "Engineering", line: "We are still debugging the checkout page, so our schedule is looking quite full." },
          { speaker: "Marketing", line: "For our campaign, we need the final assets by March 20th." },
          { speaker: "Marketing", line: "This includes the high-resolution images and the technical documentation for the website." },
          { speaker: "Engineering", line: "That's tight for us. Can we push to March 25th?" },
          { speaker: "Marketing", line: "Okay, March 25th works for us. We'll inform the translation agency." },
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "I want to ensure you leave here with practical tools you can use for your teams." },
          { speaker: "You", line: "So, let's dive into our first major trend: automation, which is closely linked to smart technology." },
          { speaker: "You", line: "To start, let's look at this first slide to see the growth we've seen compared to last year." },
        ],
          },
          {
            title: "Handling Q&A",
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Body", line: "Hi Team, Thank you for a productive meeting this morning." },
          { speaker: "Body", line: "It was helpful to discuss our goals for the next three months." },
          { speaker: "Body", line: "Please find below the action items we agreed on." },
          { speaker: "Body", line: "The deadline for all items is October 15th." },
          { speaker: "Body", line: "I will share this summary with the whole department later today." },
          { speaker: "Body", line: "Please reply to this email if anything is unclear." },
          { speaker: "Body", line: "Best regards, Nguyen" },
        ],
          },
          {
          ...
          { speaker: "Body", line: "I am reaching out to request the updated Q4 budget allocation for our department." },
          { speaker: "Body", line: "We need the specific figures for the marketing and operations teams." },
          { speaker: "Body", line: "In particular, we must confirm the funds for the upcoming regional conference." },
          { speaker: "Body", line: "Could you also check whether the travel expenses for it are already approved?" },
          { speaker: "Body", line: "I would appreciate your reply by Friday if possible." },
          { speaker: "Body", line: "Thank you for your help. Best regards, Nguyen" },
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "We could, however, offer 10% off if you commit to a two-year contract." },
          ...
          { speaker: "You", line: "If you could increase the offer to $60,000, I would be ready to sign the contract today." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
          { speaker: "You", line: "Good morning. Can everyone hear me? I'm going to share my screen to show the third-quarter sales report." },
          ...
          { speaker: "Colleague", line: "You are on mute. We can see you talking, but we cannot hear your introduction yet." },
          { speaker: "You", line: "Oops, sorry about that! I forgot I muted myself while the coffee machine was running." },
          { speaker: "Colleague", line: "No problem at all. It happens to the best of us during remote meetings." },
          { speaker: "Colleague", line: "Thanks. Now that you are unmuted, could you please zoom in on the chart a little bit?" },
          { speaker: "You", line: "Sure, let me adjust the zoom to one hundred and fifty percent for better visibility." },
        ],
          },
          {
          ...
          { speaker: "You", line: "Completed the initial wireframes for the new feature." },
          { speaker: "You", line: "I also made progress on the landing page's visual design based on the layout we discussed this morning." },
          { speaker: "You", line: "Waiting for copy from Sarah for the product description section." },
          { speaker: "You", line: "I noticed some placeholder text still remains in the second section of the page, which needs Sarah's input." },
          { speaker: "You", line: "Blocked on API access for the user authentication module." },
          { speaker: "You", line: "If anyone needs urgent help before I return tomorrow, please tag the project manager directly." },
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Customer", line: "So it's coming now? I just hope the sandwich is still hot." },
          ...
          { speaker: "You", line: "Yes, it covers both liquid spills and cracked screens. It's comprehensive protection." },
      ...
      // NEW Professional lessons
      {
        ...
        keySituations: [
          ...
          { speaker: "HR", line: "Most people gather in the cafeteria on the second floor around noon. After this, we can go down to the second floor." },
          { speaker: "You", line: "Sounds good. Is my department also on the second floor?" },
          { speaker: "HR", line: "Yes, your department, Marketing, is on the second floor. Your desk is right by the window here. I can help you get started with setting up your computer." },
          { speaker: "You", line: "That would be great, thank you! I'll get settled in once that's done." },
        ],
          },
          {
          ...
          { speaker: "Colleague", line: "We meet in the open lounge area near the coffee machine. It's a good spot." },
          { speaker: "You", line: "Okay, that sounds convenient. I'll make sure to be there." },
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "Rumors can get distorted quickly when they travel through different departments like that." },
          { speaker: "Colleague", line: "You're right. I should probably focus on my work instead of office gossip. I'll get back to those spreadsheets." },
          { speaker: "You", line: "That sounds like a good plan. See you at the team meeting later then." },
        ],
          },
        ],
        vocabulary: [
    ...
    lessons: [
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
          { speaker: "Moderator", line: "Welcome everyone. Our topic today is: Should social media be banned for children under 16?" },
          ...
          { speaker: "Moderator", line: "But can education really compete with how these apps are built to keep kids online, Speaker 2?" },
          ...
          { speaker: "Moderator", line: "Thank you, Speaker 1. We have heard strong points from both sides. Let's move on to some questions from our audience." },
        ],
          },
          {
          ...
          { speaker: "Classmate", line: "I partially agree, but personal choices still play a role. For example, people can choose to learn new skills or move to cities with more jobs." },
          { speaker: "You", line: "The author would acknowledge that, but argues structural barriers often constrain individual agency, making those choices more difficult for some." },
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Advisor", line: "That's a great idea. Do you have anything specific in mind?" },
          { speaker: "You", line: "Yes, I'm interested in taking an elective in Data Science." },
          { speaker: "Advisor", line: "Great choice. Data Science is very popular because it complements almost any major. You'll need to complete a prerequisite, which is Introduction to Statistics 101." },
          { speaker: "You", line: "I took a similar statistics course at my community college last year. Does that count towards the prerequisite?" },
          { speaker: "Advisor", line: "Let's check the equivalency for your community college course. If it doesn't count, we can look at other options." },
          { speaker: "You", line: "Okay, that sounds good. If it doesn't count, what other electives would you recommend?" },
        ],
          },
          {
          ...
          { speaker: "You", line: "That works perfectly for me. How do I apply for the room?" },
          { speaker: "Housing Office", line: "Fill in the online form on our website, and we will confirm your place within two working days." },
        ],
          },
        ],
        vocabulary: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Host", line: "You can just leave them by the door, here. We usually put them on this mat." },
          { speaker: "You", line: "Okay, thank you for showing me." },
        ],
          },
        ],
        vocabulary: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Peer", line: "Yes, there were a few points in the main body we could discuss. Also, just let me know if you want me to read the final version tomorrow." },
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You (as Vietnam)", line: "Cities like Hanoi and Ho Chi Minh City have seen encouraging results. We're also very interested in collaborating on satellite monitoring of ocean waste." },
