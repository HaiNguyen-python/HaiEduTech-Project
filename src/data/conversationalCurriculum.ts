    ...
    lessons: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "No, I didn't see anyone suspicious, and I didn't notice anyone standing too close. What happens next?" },
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "You", line: "Great. I'm ready to proceed with the application." },
          ...
          { speaker: "Staff", line: "The bank staff inside will be able to help you. It usually takes about ten minutes for them to retrieve a card safely." },
        ],
          },
        ],
        vocabulary: [
    ...
    lessons: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Subject", line: "It was helpful to discuss our goals for the next three months." },
          { speaker: "Body", line: "Please find below the action items we agreed on." },
          { speaker: "Subject", line: "Please note, the deadline for all items is October 15th." },
          { speaker: "Body", line: "This date is the middle of next month, as we discussed." },
          { speaker: "Body", line: "I'll be sending this summary to the entire department shortly." },
          { speaker: "Subject", line: "Please encourage everyone to reply if they have any questions." },
        ],
          },
          {
          ...
          { speaker: "Subject", line: "We'll need the specific figures for the marketing and operations teams." },
          { speaker: "Body", line: "Yes, we especially need to confirm the funds for the upcoming regional conference." },
          { speaker: "Subject", line: "Could you also check if the travel expenses for it are already approved?" },
          { speaker: "Body", line: "I appreciate your quick assistance with these financial details." },
          { speaker: "Subject", line: "Thank you for your help, and I look forward to hearing from you soon." },
        ],
          },
        ],
        vocabulary: [
      ...
      },
      {
        ...
        keySituations: [
          ...
          { speaker: "Colleague", line: "Thanks, Tom. Now that you're unmuted, could you please zoom in on the chart a little bit?" },
