        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Staff", line: "Yes, you get 15% off the second item as part of our promotion." },
              { speaker: "You", line: "That sounds like a good deal. I should get one for my brother too." },
              { speaker: "Staff", line: "That is a great idea. Would he prefer the blue or the black?" },
              { speaker: "You", line: "Great, I'll take the blue one in medium and the black in large." },
              { speaker: "Staff", line: "Excellent. Would you like to try them on first in the fitting room?" },
              { speaker: "You", line: "No thank you, I am sure about the sizes. I will pay now." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Staff", line: "I found a medium in the navy blue. would you like to try it on in the fitting room?" },
              { speaker: "You", line: "That would be great. This one looks a lot more comfortable already." },
              ...
              { speaker: "You", line: "That is perfect. Does that apply even if I have already removed the price tags?" },
              { speaker: "Staff", line: "Actually, please keep the tags attached if you want to return it for a refund later." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "Oh, I see. There was a big storm in the northern hub recently." },
              { speaker: "Agent", line: "Exactly. The local courier had to stop deliveries for safety reasons." },
              { speaker: "You", line: "Is it still scheduled for morning delivery tomorrow?" },
              { speaker: "Agent", line: "Yes, it should be at your doorstep before noon." },
              { speaker: "You", line: "Can I get a tracking update sent to my email?" },
              { speaker: "Agent", line: "Of course. I am setting up automatic notifications for you now." },
              { speaker: "You", line: "That is very helpful. Will it include a photo of the delivery?" },
              { speaker: "Agent", line: "Yes, if the driver leaves it on your porch, you will see it." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Waiter", line: "Of course. Now, the salmon comes with one choice. Would you like any sides with that?" },
              { speaker: "You", line: "I'm looking for something light. A garden salad, please." },
              { speaker: "Waiter", line: "Great. We have balsamic vinaigrette, ranch, or Italian dressing for the salad. Which would you prefer?" },
              { speaker: "You", line: "I will go with the balsamic vinaigrette on the side, please." },
              { speaker: "Waiter", line: "Perfect. Would you like to start with an appetizer like our bruschetta or garlic bread?" },
              { speaker: "You", line: "No thank you, the salmon and the salad will be enough for me tonight." },
              { speaker: "Waiter", line: "I understand. I will place your order with the kitchen immediately." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "Are the almonds served on the side or mixed into the cake?" },
              { speaker: "Waiter", line: "The almonds are crushed inside the batter, so they cannot be removed." },
              { speaker: "You", line: "Good to know, I'll skip dessert then. Thank you for checking!" },
              { speaker: "Waiter", line: "Would you like to try our fruit platter instead? It is very fresh." },
              { speaker: "You", line: "Does the fruit platter use any shared equipment with the nut dishes?" },
              { speaker: "Waiter", line: "No, we use a separate prep station for fruit to prevent cross-contamination." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Waiter", line: "Was it the Caesar salad for seat number one and the burger for seat two?" },
              { speaker: "Friend", line: "Yes, and please add the chocolate cake to the second bill." },
              { speaker: "Waiter", line: "No problem. Will you be paying with cash or by credit card?" },
              { speaker: "You", line: "I will use my card. Do you accept mobile payments like Apple Pay?" },
              { speaker: "Waiter", line: "Yes, we do. I will bring the card reader over in just a moment." },
              { speaker: "Friend", line: "I have a ten-dollar bill, so I will pay for my portion in cash." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "Ten minutes sounds quite reasonable. I think I prefer to walk and see the sights." },
              { speaker: "Local", line: "It is a very scenic route. You will walk through the historic park." },
              { speaker: "You", line: "That sounds lovely. Is the museum entrance on the main street?" },
              { speaker: "Local", line: "No, you have to go around the corner to the North Gate." },
              { speaker: "You", line: "Thank you so much for your help. I really appreciate it." },
              { speaker: "Local", line: "You're very welcome! I hope you enjoy the art exhibition today." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "No problem. Should I walk to the corner to make it easier for you?" },
              { speaker: "Driver", line: "No, please stay by the fountain. It is safer to pick you up there." },
              { speaker: "You", line: "Understood. I see a white sedan approaching. Is your license plate ending in 42?" },
              { speaker: "Driver", line: "That is not me. I am driving a silver SUV. I just turned the corner." },
              { speaker: "You", line: "Oh, I see you now! You are right behind the yellow taxi." },
              { speaker: "Driver", line: "Exactly. I am pulling over to the curb now. Please watch for traffic." },
              { speaker: "You", line: "I see you. I have two shopping bags. Is it okay to put them in the trunk?" },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "I'm in digital marketing. I mostly manage social media for tech startups." },
              { speaker: "New Friend", line: "That sounds busy. Do you enjoy the creative side of it?" },
              { speaker: "You", line: "I do, but it's a lot of data too. How about you?" },
              { speaker: "New Friend", line: "I'm a freelance photographer. I specialize in food and travel portraits." },
              { speaker: "You", line: "That sounds fascinating! Have you worked on any interesting projects lately?" },
              { speaker: "New Friend", line: "I just finished a series for a new Italian cookbook. Want to see some of my work?" },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "I can imagine! Were you using a professional camera or just your phone?" },
              { speaker: "Friend", line: "I bought a used DSLR before the trip. It was difficult to learn at first." },
              { speaker: "You", line: "That's impressive. Did you take any classes or were you self-taught?" },
              { speaker: "Friend", line: "I mostly watched videos and practiced every morning at sunrise." },
              { speaker: "You", line: "Wow, what a great way to start the day. Do you have a favorite photo from that trip?" },
              { speaker: "Friend", line: "Yes, a photo of a golden temple reflected in a quiet pond." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Doctor", line: "Let me check your throat and listen to your breathing first." },
              { speaker: "You", line: "Of course. Is it anything serious, Doctor?" },
              { speaker: "Doctor", line: "Your throat is quite red and swollen. I believe you have a bacterial infection." },
              { speaker: "You", line: "What should I do to treat it? I need to go back to work." },
              { speaker: "Doctor", line: "I'll prescribe some antibiotics. Take them twice a day after meals." },
              { speaker: "You", line: "Should I finish the whole box even if I feel better in two days?" },
              { speaker: "Doctor", line: "Yes, it is very important to finish the full seven-day course." },
              { speaker: "You", line: "I understand. Can I take anything for the headache pain?" },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Trainer", line: "Start with 3 sets of 10 reps. Don't go too heavy at first while you learn the motion." },
              { speaker: "You", line: "That sounds manageable. How long should I rest between each of those sets?" },
              { speaker: "Trainer", line: "Take a 60-second break between sets to let your muscles recover. Stay hydrated too." },
              { speaker: "You", line: "Should I move to the treadmill or the stationary bikes after I finish this?" },
              { speaker: "Trainer", line: "The stationary bikes are great for a cool-down. Try cycling for ten minutes at a moderate pace." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Support", line: "I see. Are there any unusual lights blinking on the front of the device?" },
              { speaker: "You", line: "The power light is green, but the internet light is flashing orange constantly." },
              { speaker: "Support", line: "That indicates a signal problem. Let me run a diagnostic test on your line. Please hold." },
              { speaker: "You", line: "Okay, I will stay on the line. How long will the test take?" },
              { speaker: "Support", line: "It should only take about two minutes to check the signal strength to your house." },
              { speaker: "You", line: "Thank you. I really need to get back online for a video meeting at noon." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Friend", line: "That is a good first step to protect your privacy." },
              { speaker: "You", line: "Which VPN service do you recommend for a beginner?" },
              { speaker: "Friend", line: "I use one called PrivacyGuard. It is very simple to install." },
              { speaker: "You", line: "Is it expensive? I do not want a high monthly fee." },
              { speaker: "Friend", line: "It costs five dollars a month, but your security is worth it." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Agent", line: "Wonderful. Any checked baggage?" },
              { speaker: "You", line: "Just one suitcase, please. Do I need to put it on the scale now?" },
              { speaker: "Agent", line: "Yes, please. It weighs 18 kilograms, so it is well under the limit." },
              { speaker: "You", line: "Great. Should I take my laptop out of my carry-on bag for security?" },
              { speaker: "Agent", line: "Yes, you will need to do that at the security checkpoint upstairs." },
              { speaker: "You", line: "Thank you for the advice. Which way is the departure lounge?" },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "That sounds fair. I have a late flight, so that extra time helps." },
              { speaker: "Receptionist", line: "I will make a note on your account. Here is your key card." },
              { speaker: "You", line: "Thank you. Is the high-speed Wi-Fi included in the room price?" },
              { speaker: "Receptionist", line: "Yes, it is free. The password is printed on the card holder." },
              { speaker: "You", line: "Great. What time is breakfast served in the morning?" },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Operator", line: "Tell me about the victim. Is the person conscious and breathing?" },
              { speaker: "You", line: "He is conscious, but his arm is bleeding heavily and he seems very confused." },
              { speaker: "Operator", line: "Are there any hazards like spilled fuel or fire at the scene?" },
              { speaker: "You", line: "No fire, but there is a lot of broken glass on the road." },
              { speaker: "Operator", line: "I am dispatching paramedics and police now. What is your name and phone number?" },
              { speaker: "You", line: "My name is Sam Miller and my number is 555-0123." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "The train was very crowded. I only noticed it was missing when I got off." },
              { speaker: "Officer", line: "I understand. Can you describe what was in it?" },
              { speaker: "You", line: "My ID, two credit cards, and about $50 in cash." },
              { speaker: "Officer", line: "What color and material was the wallet itself?" },
              { speaker: "You", line: "It is a small, dark brown leather wallet with a silver zipper." },
              { speaker: "Officer", line: "Have you contacted your bank to freeze your credit cards yet?" },
              { speaker: "You", line: "Not yet, I came straight here after I realized it was gone." },
              { speaker: "Officer", line: "You should call them immediately. I will start the official police report now." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "That is quite a lot. Do I get the deposit back when I move out?" },
              { speaker: "Landlord", line: "Of course, provided there is no damage to the walls or furniture." },
              { speaker: "You", line: "That sounds fair. What about parking? Is there a garage?" },
              { speaker: "Landlord", line: "There's one spot included. Additional spots are $50/month." },
              { speaker: "You", line: "Is the parking area gated and secure during the night?" },
              { speaker: "Landlord", line: "Yes, we have security cameras and a remote-controlled gate for all residents." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "No, it is quiet, but it just won't heat up the living room." },
              { speaker: "Landlord", line: "I'll send a technician tomorrow morning. Is 9 AM okay?" },
              { speaker: "You", line: "That works for me. Will you be here or should I wait?" },
              { speaker: "Landlord", line: "The repairman, Mr. Miller, will come directly to your door." },
              { speaker: "You", line: "Okay. Should I provide him with a parking pass for the driveway?" },
              { speaker: "Landlord", line: "Yes, please leave it on your kitchen counter." },
              { speaker: "You", line: "I will do that. I hope it is an easy fix." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Teller", line: "Thank you. This bill from Maple Street is perfect. Everything looks correct." },
              { speaker: "You", line: "Great. Before we finalize everything, what's the interest rate?" },
              { speaker: "Teller", line: "Currently 2.5% per year for our standard savings." },
              { speaker: "You", line: "That sounds fair. Is there a monthly fee for maintaining this account?" },
              { speaker: "Teller", line: "There is no fee if you keep a minimum balance of five hundred dollars." },
              { speaker: "You", line: "I understand. Does this also include access to mobile banking?" },
              { speaker: "Teller", line: "Yes, it does. You can transfer money and pay bills using our app." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "Does that fee apply even if the machine malfunctions like this?" },
              { speaker: "Staff", line: "No, we will waive the fee since you didn't receive your cash." },
              { speaker: "You", line: "That is a relief. Can you help me get my card back now?" },
              { speaker: "Staff", line: "I will need to see your passport to verify your identity first." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Friend", line: "Good point. How many cloves of garlic do we need for this pasta?" },
              { speaker: "You", line: "The instructions call for three cloves, finely minced." },
              { speaker: "Friend", line: "I will use the garlic press to save some time." },
              { speaker: "You", line: "Perfect. Should I turn the stove to medium heat or high heat?" },
              { speaker: "Friend", line: "Medium heat is better so the onions cook evenly." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Instructor", line: "Yes, a warm, damp cloth will keep the dough moist." },
              { speaker: "You", line: "Will the dough rise significantly during this time?" },
              { speaker: "Instructor", line: "It will expand just a little bit, but we are mostly letting the gluten relax." },
              { speaker: "You", line: "I see. What is the next step after the 20 minutes are over?" },
              { speaker: "Instructor", line: "We will divide the dough into two equal portions for loaves." },
              { speaker: "You", line: "Do we need to grease the baking pans with butter or oil?" },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Vet", line: "Does his stomach look bloated or feel sensitive when you touch it?" },
              { speaker: "You", line: "It feels a bit firm, and he whimpered when I picked him up earlier." },
              { speaker: "Vet", line: "I see. Let me run some blood tests. It could be a stomach infection." },
              { speaker: "You", line: "How long will it take to get the results back from the lab?" },
              { speaker: "Vet", line: "We should have the initial results in about thirty minutes." },
              { speaker: "You", line: "Should I keep him here, or can I wait in the reception area?" },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "Should I leave the bowl out all day or set a schedule?" },
              { speaker: "Staff", line: "A schedule is better to prevent her from becoming overweight." },
              { speaker: "You", line: "I see. Does she need a specific water bowl too?" },
              { speaker: "Staff", line: "Actually, many cats prefer ceramic bowls or stainless steel over plastic." },
              { speaker: "You", line: "That is good to know. Do you have any toy recommendations?" },
              { speaker: "Staff", line: "Kittens have a lot of energy, so I suggest laser pointers and feathers." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Friend", line: "Wait, did you think the special effects were better than the last movie?" },
              { speaker: "You", line: "The CGI was incredible, especially during the big battle in London." },
              { speaker: "Friend", line: "I heard that scene took six months to film. Is that true?" },
              { speaker: "You", line: "I believe so. The lighting and the action looked very realistic." },
              { speaker: "Friend", line: "What about the soundtrack? Marvel movies always have great music." },
              { speaker: "You", line: "The music was perfect. It really builds the tension in the second half." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "That is a relief. Where are the sessions usually held?" },
              { speaker: "Organizer", line: "Practice is every Saturday at 9 AM." },
              { speaker: "You", line: "Are they at the Community Park fields on West Street?" },
              { speaker: "Organizer", line: "Yes, we use Field number three, right behind the parking lot." },
              { speaker: "You", line: "Is there a registration fee I need to pay today?" },
              { speaker: "Organizer", line: "The fee is fifty dollars, which includes your team jersey." },
              { speaker: "You", line: "Great. Do I need to bring any specific equipment?" },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Friend", line: "Excellent! That temperature is much better for sitting outside." },
              { speaker: "You", line: "I agree. The wind will be light, so it should stay quite warm." },
              { speaker: "Friend", line: "Let's do Sunday then. I'll bring the grill." },
              { speaker: "You", line: "That would be a huge help. I will prepare the meat and salads." },
              { speaker: "Friend", line: "Great. What time should we start the fire?" },
              { speaker: "You", line: "How about 1:00 PM? That gives us plenty of time to cook." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Colleague", line: "Me too. I prefer autumn leaves and cool breezes over this humidity." },
              { speaker: "You", line: "Exactly. Do you think the air conditioning is working properly in here?" },
              { speaker: "Colleague", line: "It feels a bit warm near the window. Let's move to the breakroom." },
              { speaker: "You", line: "Good idea. I really need a glass of ice water right now." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "I will order pizza and snacks. Can you handle the cake?" },
              { speaker: "Friend", line: "Sure! Chocolate or vanilla?" },
              { speaker: "You", line: "She loves chocolate. Maybe one with dark chocolate frosting would be best." },
              { speaker: "Friend", line: "I know a great bakery. Should I have them write 'Happy Birthday Mai'?" },
              { speaker: "You", line: "Yes, please. They can use gold or pink icing for the letters." },
              { speaker: "Friend", line: "Got it. I will pick it up at five o'clock on Saturday afternoon." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Friend", line: "I've heard about the special rice cake. What is it called?" },
              { speaker: "You", line: "It is called Banh Chung. It's a square sticky rice cake with pork." },
              ...
              { speaker: "Friend", line: "That is so kind. Should I bring a gift for your parents?" },
              { speaker: "You", line: "A small box of cookies or some fruit would be perfect." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Interviewer", line: "Adaptability is crucial here. Can you give me an example?" },
              { speaker: "You", line: "When our team shifted to remote work, I redesigned our workflow and increased productivity by 20%." },
              { speaker: "Interviewer", line: "Twenty percent is a significant improvement. How did you measure that?" },
              { speaker: "You", line: "I used project management software to track our task completion rates weekly." },
              { speaker: "Interviewer", line: "Excellent. Did you face any resistance from your team during this transition?" },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Interviewer", line: "What was the compromise you eventually reached with them?" },
              { speaker: "You", line: "We decided to build a responsive design that adapted to both screens." },
              { speaker: "Interviewer", line: "That sounds like a fair solution for everyone involved." },
              { speaker: "You", line: "The result was a stronger project and the team learned to collaborate better." },
              { speaker: "You", line: "Our user engagement actually increased by fifteen percent after the launch." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "Yes, we are working hard to expand our reach this quarter." },
              { speaker: "Speaker", line: "It sounds like you are facing some interesting challenges right now." },
              { speaker: "You", line: "Definitely. I would love to connect on LinkedIn to stay in touch." },
              { speaker: "Speaker", line: "Absolutely! I post weekly updates about automation and design there." },
              { speaker: "You", line: "That would be perfect. Do you have a business card or a QR code?" },
              { speaker: "Speaker", line: "Here's my card. My email address and profile link are on the back." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Message", line: "I noticed you mentioned a 15% increase in conversion rates, which is very impressive." },
              { speaker: "Reply", line: "Are you free for a virtual coffee next week?" },
              { speaker: "Message", line: "That would be great! How about Tuesday at 3 PM?" },
              { speaker: "Reply", line: "Tuesday at 3 PM works perfectly for me. Should I send a Zoom link?" },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Manager", line: "Are you missing the budget figures or the actual spending numbers?" },
              { speaker: "Sarah", line: "I need the final spending numbers for the marketing department specifically." },
              { speaker: "Manager", line: "I see. Have you reached out to the department head yet?" },
              { speaker: "Sarah", line: "I sent two emails to David, but I have not received a response yet." },
              { speaker: "Manager", line: "I'll follow up with finance today." },
              { speaker: "Sarah", line: "Thank you. Once I have those figures, I can finalize the summary page." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Engineering", line: "Our lead developer will be away for two days next week." },
              { speaker: "Marketing", line: "If we wait until the 25th, the translation team won't have enough time." },
              { speaker: "You", line: "Let's compromise - March 22nd. Does that work for everyone?" },
              { speaker: "Engineering", line: "That gives us exactly forty-eight extra hours. I think we can make it work." },
              { speaker: "Marketing", line: "As long as we receive everything by Friday morning, we can stay on track." },
              { speaker: "You", line: "Great. I will update the project management board with the new deadline." },
              { speaker: "Engineering", line: "I will inform the development team about the priority change immediately." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "These ideas should help you save time and increase your monthly productivity." },
              { speaker: "You", line: "Before we dive into the data, I want to check something with you." },
              { speaker: "You", line: "Let me start with a quick question - how many of you have used AI at work this year?" },
              { speaker: "You", line: "Please raise your hands high so I can see everyone in the back." },
              { speaker: "You", line: "That looks like about eighty percent of the room, which is fascinating." },
              { speaker: "You", line: "Now, keep your hand up if you use it every single day." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Audience", line: "What about the low performance we saw in the first quarter?" },
              { speaker: "You", line: "We factored that in. The growth is driven largely by Q3 and Q4." },
              { speaker: "Audience", line: "Is this 15% consistent across all international markets, like the UK?" },
              { speaker: "You", line: "The UK saw 12%, but the Asian market pushed our average higher." },
              { speaker: "Audience", line: "Have these figures been verified by an independent internal auditor?" },
              { speaker: "You", line: "Our finance team reviewed them twice before this presentation today." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Subject", line: "Perfect. Let's make sure everyone knows exactly what their specific task is." },
              { speaker: "Body", line: "1. Sarah: Update the marketing deck." },
              { speaker: "Subject", line: "Remind her to include the new branding colors and the revised logo." },
              { speaker: "Body", line: "2. Tom: Run the financial projections." },
              { speaker: "Subject", line: "He should focus on the sales growth for the European market specifically." },
              { speaker: "Body", line: "3. Lisa: Schedule client demos." },
              { speaker: "Subject", line: "She needs to contact at least five potential clients by Friday." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Body", line: "That would be very helpful for my planning meeting on Monday morning." },
              { speaker: "Subject", line: "I need a few more hours to review the latest adjustments from the finance director." },
              { speaker: "Body", line: "Could you kindly share this by end of week?" },
              { speaker: "Subject", line: "I will do my best to send the PDF document before Friday afternoon." },
              { speaker: "Body", line: "Please let me know if you need any clarification." },
              { speaker: "Subject", line: "Thank you, I will contact you if I have questions about the logistics costs." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Colleague", line: "Will two extra weeks be enough to fix the bugs in the payment system?" },
              { speaker: "You", line: "Yes, Sarah mentioned that the security patches are almost finished." },
              { speaker: "Colleague", line: "If we delay, will it affect the marketing budget for the promotion?" },
              { speaker: "You", line: "I checked with marketing, and they can adjust the social media ads easily." },
              { speaker: "Colleague", line: "Okay, that is good news. I was worried about the costs." },
              { speaker: "You", line: "Let's meet tomorrow to finalize the new schedule together." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "No problem at all. Do you want me to help you cross-reference the May data as well?" },
              { speaker: "Tom", line: "If you have ten minutes, that would be incredibly helpful to ensure everything is perfect." },
              { speaker: "You", line: "Sure. I also noticed the font size is a bit inconsistent on the last three pages." },
              { speaker: "Tom", line: "Oh, I see. I must have missed that when I copy-pasted the summary chart." },
              { speaker: "You", line: "It is a small detail, but using the standard template will make it look much more professional." },
              { speaker: "Tom", line: "You are right. I will reformat those pages now to match the rest of the document." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "That seems like a reasonable middle ground. Let me look at our current project margins." },
              { speaker: "Client", line: "If you can agree to that price, we can sign the documents by Friday." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "That sounds reasonable. How many extra days of vacation would that include?" },
              { speaker: "HR", line: "We can add five extra days, bringing your total to twenty days per year." },
              { speaker: "You", line: "The base salary is still slightly below my target, but the flexibility helps." },
              { speaker: "HR", line: "We also offer a fully remote Friday policy and a comprehensive health plan." },
              { speaker: "You", line: "Could I also discuss the signing bonus?" },
              { speaker: "HR", line: "We could offer a one-time bonus of $3,000 to help with your transition." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Tom", line: "Can you see my screen now? It should show the spreadsheet with the monthly projections." },
              { speaker: "You", line: "Yes, we can. Go ahead and explain the data for the European market first." },
              { speaker: "Tom", line: "Great. Please look at row fifteen. Our profits in Berlin increased by twelve percent this June." },
              { speaker: "Colleague", line: "That is impressive growth. Did the new marketing campaign contribute to those specific numbers?" },
              { speaker: "Tom", line: "Exactly. We spent five thousand dollars on social media ads in that region." },
              { speaker: "You", line: "I am very pleased with these results. Is everyone ready to discuss the next slide?" },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "The backend team has not shared the credentials for the staging environment yet." },
              { speaker: "You", line: "Sarah, no rush - just drop the copy in the doc when you can. I'll pick it up tomorrow morning." },
              { speaker: "You", line: "I know our time zones are eight hours apart, so please disregard this until you start." },
              { speaker: "You", line: "I will check the shared folder at 9:00 AM my time to see the updates." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Customer", line: "I should have been informed earlier. This is a very long time to wait for a snack." },
              { speaker: "You", line: "I completely understand your frustration. It is our busiest hour and we are short-staffed today." },
              { speaker: "Customer", line: "That is not my problem. I just want my food so I can leave." },
              { speaker: "You", line: "Of course. I will go to the kitchen now and bring it to your table personally." },
              { speaker: "You", line: "As an apology, I'd like to offer a 20% discount on your next order." },
              { speaker: "Customer", line: "Well, that helps. Thank you. I appreciate you taking responsibility for the mistake." },
              { speaker: "You", line: "You are very welcome. Here is a voucher for your next visit. Is there anything else I can do?" },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "Yes, it covers both! We also provide a loaner laptop while yours is being repaired." },
              { speaker: "Customer", line: "That sounds like a good deal. I'll take it." },
              { speaker: "You", line: "Excellent. Also, will you be using this for travel or mostly at home?" },
              { speaker: "Customer", line: "I plan to take it to the office every day in my backpack." },
              { speaker: "You", line: "In that case, I recommend this padded sleeve for only fifteen dollars." },
              { speaker: "Customer", line: "That is a practical idea. Let's add that to the total as well." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "Right now, it is two pages long, which is a bit much for the directors to read quickly." },
              { speaker: "Sarah", line: "I see what you mean. I was worried about leaving out important details for the board meeting." },
              { speaker: "You", line: "Just keep the main data points there and move the rest to the appendix section." },
              ...
              { speaker: "You", line: "Perfect. Can you send me the revised version by 4:00 PM today?" },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "No problem at all. Which of these tasks requires your specific expertise the most?" },
              { speaker: "Tom", line: "Only I can do the final analysis, but the data entry is very time-consuming." },
              { speaker: "You", line: "In 그hat case, I will ask Sarah to handle the data entry for you this afternoon." },
              { speaker: "Tom", line: "That would save me at least four hours. Are you sure she has the time?" },
              { speaker: "You", line: "Yes, her main project finished early. This will allow you to focus on the analysis." },
              { speaker: "Tom", line: "I feel much better now. I was worried I would have to work all weekend." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "Great! The view of the park is wonderful, and I love the natural light." },
              { speaker: "HR", line: "I thought you would like it. You will find your laptop and employee handbook already on the desk." },
              { speaker: "You", line: "Perfect. Who should I reach out to if I have questions about the project?" },
              { speaker: "HR", line: "Your buddy is Tom - he'll help you during your first week." },
              { speaker: "You", line: "That's helpful. Does Tom sit near this department as well?" },
              { speaker: "HR", line: "Yes, he sits just two desks away from you, right next to the printer." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "Perfect. Which software does the team use for task management?" },
              { speaker: "Colleague", line: "We use Jira for tracking tasks and Figma for all our designs." },
              { speaker: "You", line: "I'm very familiar with Figma. Will I be focus on mobile or desktop?" },
              { speaker: "Colleague", line: "For the next month, we are focusing on the mobile banking app." },
              { speaker: "You", line: "That's exciting. It sounds like a fast-paced environment." },
              { speaker: "Colleague", line: "It is, but we always take lunch breaks together at 1:00 PM." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Client", line: "Six weeks is perfect. We are launching a new product line in two months." },
              { speaker: "You", line: "I can definitely meet that deadline. We will have a working prototype by the third week." },
              ...
              { speaker: "Client", line: "Does that price include the high-resolution images and specialized copywriting for the pages?" },
              { speaker: "You", line: "The entry price covers design and development. I can add a content package for an extra fee." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Client", line: "Fair enough. Let's include it. I want our customers to see our weekly updates." },
              { speaker: "You", line: "Great. I will draft a new contract amendment and send it over for your signature today." },
              { speaker: "Client", line: "That sounds professional. When will the total work be completed with this addition?" },
              { speaker: "You", line: "Adding the blog will extend the timeline by one week. We are now looking at a May 15th launch." },
              { speaker: "Client", line: "That works for me. By the way, I am still waiting for the invoice for last month." },
              { speaker: "You", line: "Actually, I sent the $1,200 invoice on Monday. It might be in your spam folder." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Colleague", line: "That sounds better for me. Did you see any wildlife there?" },
              { speaker: "You", line: "We saw a few deer and some very colorful birds near the water." },
              { speaker: "Colleague", line: "That sounds peaceful. How long did the whole hike take you?" },
              { speaker: "You", line: "It took about three hours. We stopped for a picnic at the summit." },
              { speaker: "Colleague", line: "I love the idea of a picnic. What did you bring to eat?" },
              { speaker: "You", line: "Just some simple turkey sandwiches, apples, and plenty of water." },
              { speaker: "Colleague", line: "I might go this Saturday then. Is the parking lot usually crowded?" },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Colleague", line: "I suppose so, but people are saying his sales numbers were quite low last quarter." },
              { speaker: "You", line: "Let's focus on our own work. If there's news, management will tell us." },
              { speaker: "Colleague", line: "I appreciate your professionalism. It is easy to get distracted by office drama." },
              { speaker: "You", line: "Exactly, and it's fairer to Tom if we don't spread unconfirmed information." },
              { speaker: "Colleague", line: "That is true. I wouldn't want people talking about me if I were in HR." },
              { speaker: "You", line: "Exactly. Let's finish the monthly report so we can leave on time today." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "For", line: "Features like infinite scrolling and constant notifications specifically target a child's developing brain." },
              { speaker: "Against", line: "Banning won't stop access - they'll find workarounds. Regulation and education work better." },
              { speaker: "Against", line: "Teenagers are tech-savvy; they will use VPNs or fake birthdays to bypass any age restriction." },
              { speaker: "Moderator", line: "If a ban is impossible to enforce, what is your alternative proposal for safety?" },
              { speaker: "Against", line: "Government regulation should force companies to disable 'like' counts and autoplay for younger users." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "A person cannot attend university if they cannot afford tuition or basic living expenses." },
              { speaker: "Professor", line: "That is an excellent point about the cycle of poverty." },
              { speaker: "Classmate", line: "I see your point, but isn't individual ambition a powerful variable too?" },
              { speaker: "You", line: "Ambition is important, but the data suggests that geography often determines success." },
              { speaker: "Professor", line: "Exactly. Let's look at the statistics on page forty-two regarding zip codes." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Friend", line: "Local business owners are worried that these costs could lead to layoffs or even permanent closures." },
              { speaker: "You", line: "However, long-term sustainability should outweigh short-term costs for the sake of future generations." },
              { speaker: "Friend", line: "That is a strong point. Perhaps the government could offer subsidies to help businesses transition." },
              { speaker: "You", line: "That sounds like a fair compromise. It would help protect jobs while lowering pollution levels." },
              { speaker: "Friend", line: "Do you think the public will be willing to pay more for products if the costs rise?" },
              { speaker: "You", line: "It is hard to say, but many people are becoming more conscious of their environmental footprint lately." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Person", line: "Could you explain how that would work in our office?" },
              { speaker: "You", line: "We could meet on Tuesdays for team brainstorming and work home the rest." },
              { speaker: "Person", line: "Wouldn't that make the office feel empty on Mondays?" },
              { speaker: "You", line: "Perhaps, but think about the money saved on heating and electricity." },
              { speaker: "Person", line: "I suppose that is a valid financial argument." },
              { speaker: "You", line: "Plus, people are happier without the long commute in heavy traffic." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Advisor", line: "I will check your transcript. If the credits transfer, you can skip the intro class." },
              { speaker: "You", line: "That would be perfect. When is the deadline for course registration?" },
              { speaker: "Advisor", line: "Registration closes on September 1st, exactly one week before the first day of instruction." },
              { speaker: "Advisor", line: "I recommend signing up early - popular classes fill fast, especially the lab sections." },
              { speaker: "You", line: "I will log into the student portal tonight to finalize my choices." },
              { speaker: "Advisor", line: "Good idea. Do you have any other questions about the campus layout or your meal plan?" },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You", line: "That is great to hear. Is there a meal plan included?" },
              { speaker: "Housing Office", line: "Not for off-campus housing, but the campus cafeteria offers plans starting at $200/month." },
              { speaker: "You", line: "I see. If I choose to cook myself, are the kitchens fully equipped?" },
              { speaker: "Housing Office", line: "Yes, they include a stove, oven, and refrigerator. You only need to bring your own pots and dishes." },
              { speaker: "You", line: "Can I visit the apartment before I sign the rental agreement tomorrow?" },
              { speaker: "Housing Office", line: "Certainly! I can schedule a viewing for you today at 3:00 PM." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Colleague", line: "That is a relief. If you look down here, people might think you are hiding something." },
              { speaker: "You", line: "I see. In my home country, staring directly at a boss can seem aggressive or rude." },
              { speaker: "Colleague", line: "That is a huge difference. How should I act if I visit your office there?" },
              { speaker: "You", line: "You should lower your gaze slightly when a senior manager is speaking to you." },
              { speaker: "Colleague", line: "I will keep that in mind. Should we practice some eye contact for our next meeting?" },
              { speaker: "You", line: "Yes, please. I want to make sure I look professional by local standards." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Host", line: "Just place them on that wooden rack by the door next to my blue sneakers." },
              { speaker: "You", line: "Perfect. Thank you for being so welcoming to your guest." },
              { speaker: "Host", line: "Of course! Can I offer you something to drink? I have some herbal tea and fresh orange juice." },
              { speaker: "You", line: "A glass of orange juice would be lovely, if it's not too much trouble." },
              { speaker: "Host", line: "No trouble at all. Please have a seat on the sofa while I get that for you." },
              { speaker: "You", line: "You have a beautiful home. How long have you lived in this neighborhood?" },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Friend", line: "What about the energy industry? That is a much larger issue, right?" },
              { speaker: "You", line: "It is. However, when we install solar panels, we change the whole market." },
              { speaker: "Friend", line: "That makes sense. If we stop buying certain items, companies must adapt." },
              { speaker: "You", line: "Exactly. Look at how many stores now offer organic and plastic-free options." },
              { speaker: "Friend", line: "That happened because people started asking for better choices, didn't it?" },
              { speaker: "You", line: "Precisely. Our wallets are like small voting machines for the planet." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Organizer", line: "It really is. Most of it comes from storm drains after heavy rain." },
              { speaker: "You", line: "I noticed a lot of small colorful pieces in the sand already." },
              { speaker: "Organizer", line: "Those are microplastics. They are very dangerous for the local sea birds." },
              { speaker: "You", line: "Are we focusing on a specific area of Sunnyside Beach today?" },
              { speaker: "Organizer", line: "Yes, we are moving north toward the pier where the tide is highest." },
              { speaker: "You", line: "I am ready to help. Do we meet back here at noon?" },
        ...
        keySituations: [
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Panelist", line: "Government and private companies must partner to fund these educational opportunities." },
              { speaker: "You", line: "What specific skills should we prioritize for the current workforce?" },
              { speaker: "Panelist", line: "Critical thinking, problem-solving, and basic coding are essential foundations." },
              { speaker: "You", line: "Do you think small businesses can afford to train their employees?" },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Professor", line: "Strong approach. It provides a more complete picture of the classroom environment." },
              { speaker: "You", line: "I am coordinating with three primary schools in the city to collect data." },
              { speaker: "Professor", line: "Make sure your sample size is large enough for statistical significance." },
              { speaker: "You", line: "I am aiming for at least 150 students for the quantitative portion." },
              { speaker: "Professor", line: "That should be sufficient. Will you use standardized puzzles for the tests?" },
              { speaker: "You", line: "I plan to use the 'Dimensional Change Card Sort' task for flexibility." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Peer", line: "I thought so. The table shows a 15 percent increase, but your conclusion says only 5 percent." },
              { speaker: "You", line: "That is a significant error. I will re-check the Excel sheet from last Tuesday immediately." },
              { speaker: "Peer", line: "No problem. Other than that, your citations for the Smith and Jones article are perfectly formatted." },
              { speaker: "You", line: "Thank you for being so thorough. I really value your perspective on this draft." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Friend", line: "Sustainable agriculture sounds promising, but does it produce enough food for eight billion people?" },
              { speaker: "You", line: "It can, if we focus on soil health and use technology like precision irrigation for better efficiency." },
              { speaker: "Friend", line: "Reducing food waste is something we can actually control in our own homes, right?" },
              { speaker: "You", line: "Definitely. Statistics show that nearly one-third of all food produced is thrown away globally." },
              { speaker: "Friend", line: "That is a shocking number! We really need better logistics to move food to where it's needed." },
              { speaker: "You", line: "True, but trade barriers often prevent surplus crops from reaching the most vulnerable countries." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "You (as Vietnam)", line: "Hanoi and Ho Chi Minh City are leading the way, especially in supermarkets and tourist areas." },
              { speaker: "Delegate", line: "Are there any financial incentives for businesses that switch to biodegradable materials?" },
              { speaker: "You (as Vietnam)", line: "Yes, our government offers tax breaks for companies producing eco-friendly bags and packaging." },
              { speaker: "Delegate", line: "And regarding the mangroves, how do they protect the ecosystem from future damage?" },
              { speaker: "You (as Vietnam)", line: "They act as natural filters for pollutants and shield our inland areas from rising sea levels." },
              { speaker: "Delegate", line: "Would Vietnam be interested in co-sponsoring a joint amendment on technical cooperation?" },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Friend", line: "Oh, you're right. The about page just sells coffee supplements for fifty dollars a bottle." },
              { speaker: "You", line: "Always check: Who wrote it? Where was it published? Is there a peer-reviewed study?" },
              { speaker: "Friend", line: "I guess a 'medical blog' is different from a real scientific publication like The Lancet." },
              { speaker: "You", line: "Exactly. Real breakthroughs are tested by many experts before they make such big claims." },
              { speaker: "Friend", line: "So, how can I be sure if a website is trustworthy next time?" },
              { speaker: "You", line: "Look for a .edu or .gov domain, or check websites like Reuters and the Mayo Clinic." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Classmate", line: "That sounds like a lot of work just to stay informed." },
              { speaker: "You", line: "It takes time, but using international news sites alongside local ones really helps." },
              { speaker: "Classmate", line: "Are there any websites that help compare different news perspectives?" },
              { speaker: "You", line: "Yes, sites like AllSides show headlines from the left, center, and right." },
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Friend", line: "Which book are you starting with? I need some recommendations for my own list." },
              { speaker: "You", line: "I'm reading 'Atomic Habits' first. It is perfect for learning how to build new routines." },
              { speaker: "Friend", line: "That sounds great. And what about your English goal? C1 is a very high level." },
              { speaker: "You", line: "I scheduled thirty minutes of advanced grammar study every morning before work." },
              { speaker: "Friend", line: "Consistency is definitely the key. Do you have a deadline for the official exam?" },
              { speaker: "You", line: "I plan to take the C1 Advanced test in December. That gives me twelve months." },
          ...
          },
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "Mentor", line: "How specifically did you change your approach for this new launch?" },
              { speaker: "You", line: "First, I assigned Sarah to handle the graphic design tasks." },
              { speaker: "Mentor", line: "That's good. Sarah is very talented with visual layouts." },
              { speaker: "You", line: "I also scheduled a fifteen-minute check-in meeting every morning." },
              { speaker: "Mentor", line: "Frequent communication helps catch small errors before they grow." },
              { speaker: "You", line: "It makes a huge difference. Everyone knows their responsibilities now." },
              { speaker: "Mentor", line: "Do you feel less stressed than you did last time?" },
              { speaker: "You", line: "Definitely. I have more energy to focus on the big picture." },
