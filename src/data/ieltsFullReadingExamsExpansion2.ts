...
F. The next frontier is electric bikes, which dramatically extend the realistic commuting range and make cycling viable for older riders or hilly cities such as Lisbon. Sales of e-bikes in the European Union overtook sales of electric cars in 2021 and have continued to climb, hinting that the quiet revolution of the bicycle is far from finished.`,
    questions: [
      ...
      { number: 5, type: "multiple-choice", prompt: "How was cycling commonly viewed for most of the twentieth century?",
        options: ["As a serious commuting choice", "As a children's toy or hobby", "As a luxury sport", "As a dangerous activity"],
        answer: "As a children's toy or hobby" },
      ...
      { number: 11, type: "fill-blank", prompt: "Electric bikes are particularly useful in older riders and in ___ cities.", answer: "hilly" },
