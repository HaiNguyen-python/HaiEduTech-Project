...
export const thptExams = [
  {
    ...
    "passages": [
      ...
      },
      {
        ...
        "text": "Cryptocurrency challenges traditional institutions. (18) ____. Bitcoin demonstrated blockchain's potential. (19) ____. (20) ____, governments develop regulatory frameworks. Environmental concerns exist because (21) ____. Despite challenges, adoption expands. (22) ____.",
        "questionRange": [
          18,
          22
        ]
    ...
    "questions": [
      ...
      {
        "id": 31,
        "text": "Where does this sentence best fit: \"These rapid advances make sustained ethical and policy attention indispensable.\"?",
        "options": [
          "[I]",
          "[II]",
          "[III]",
