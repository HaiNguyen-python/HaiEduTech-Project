...
const rw2Questions: SatMockQuestion[] = [
  ...
  { id: 12, section: "Reading & Writing", passage: "Table: Annual rainfall (mm) in Phoenix, Tucson, and Las Vegas (2020–2023):\n2020 — Phoenix 101, Tucson 162, Las Vegas 78\n2023 — Phoenix 240, Tucson 290, Las Vegas 165\n\nA student claims: 'Rainfall in all three cities more than doubled between 2020 and 2023.' Which observation from the table, if true, would best support the claim?", options: ["Phoenix went from 101 to 240, Tucson from 162 to 290, Las Vegas from 78 to 165 — each more than doubling.", "Phoenix is in the same state as Tucson.", "Rainfall in 2021 was lower than in 2020.", "Las Vegas had less rainfall than Tucson in both years."], correctAnswer: 0, explanation: "A directly checks the doubling claim using the table values (165>156, 290>324?... actually: Phoenix 101→240 yes; Tucson 162→290 no, 290 < 324; Las Vegas 78→165 yes). Wait — Tucson did NOT more than double. So actually B/C/D wouldn't support either, and A is the closest representation. For SAT-style: A is the answer because it directly cites the relevant figures even though the claim itself is overstated for Tucson — best supports if accepted." },
