        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "你好，我想开一个银行账户。", pinyin: "Nǐ hǎo, wǒ xiǎng kāi yí ge yínháng zhànghù.", translationVi: "Xin chào, tôi muốn mở một tài khoản ngân hàng." },
              { speaker: "B", line: "请出示您的护照和手机号码。", pinyin: "Qǐng chūshì nín de hùzhào hé shǒujī hàomǎ.", translationVi: "Vui lòng xuất trình hộ chiếu và số điện thoại." },
              { speaker: "A", line: "好的，给您。需要存多少钱？", pinyin: "Hǎo de, gěi nín. Xūyào cún duōshǎo qián?", translationVi: "Vâng, đây ạ. Cần gửi bao nhiêu tiền?" },
              { speaker: "B", line: "最低存一百块就可以。", pinyin: "Zuìdī cún yìbǎi kuài jiù kěyǐ.", translationVi: "Tối thiểu gửi 100 tệ là được." },
            ],
          },
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "我想把美元换成人民币。", pinyin: "Wǒ xiǎng bǎ měiyuán huànchéng rénmínbì.", translationVi: "Tôi muốn đổi đô la Mỹ sang nhân dân tệ." },
              { speaker: "B", line: "今天的汇率是七点二。请问换多少？", pinyin: "Jīntiān de huìlǜ shì qī diǎn èr. Qǐngwèn huàn duōshǎo?", translationVi: "Tỷ giá hôm nay là 7,2. Đổi bao nhiêu ạ?" },
              { speaker: "A", line: "换五百美元。", pinyin: "Huàn wǔbǎi měiyuán.", translationVi: "Đổi 500 đô la." },
              { speaker: "B", line: "好的，请在这里签名。", pinyin: "Hǎo de, qǐng zài zhèlǐ qiānmíng.", translationVi: "Vâng, xin ký tên ở đây." },
            ],
          },
        ],
        vocabulary: [
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "你好，我想寄一个包裹去上海。", pinyin: "Nǐ hǎo, wǒ xiǎng jì yí ge bāoguǒ qù Shànghǎi.", translationVi: "Xin chào, tôi muốn gửi một bưu kiện đến Thượng Hải." },
              { speaker: "B", line: "请把包裹放在秤上。里面是什么？", pinyin: "Qǐng bǎ bāoguǒ fàng zài chèng shàng. Lǐmiàn shì shénme?", translationVi: "Xin đặt bưu kiện lên cân. Bên trong là gì?" },
              { speaker: "A", line: "是衣服和书。多少钱？", pinyin: "Shì yīfu hé shū. Duōshǎo qián?", translationVi: "Là quần áo và sách. Bao nhiêu tiền?" },
              { speaker: "B", line: "顺丰快递一共三十五块，明天到。", pinyin: "Shùnfēng kuàidì yígòng sānshíwǔ kuài, míngtiān dào.", translationVi: "SF Express tổng cộng 35 tệ, ngày mai tới." },
            ],
          },
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "我的包裹三天前应该到，但还没收到。", pinyin: "Wǒ de bāoguǒ sān tiān qián yīnggāi dào, dàn hái méi shōudào.", translationVi: "Bưu kiện của tôi đáng lẽ tới 3 ngày trước, nhưng chưa nhận được." },
              { speaker: "B", line: "请告诉我您的快递单号。", pinyin: "Qǐng gàosu wǒ nín de kuàidì dānhào.", translationVi: "Vui lòng cho tôi mã đơn hàng." },
              { speaker: "A", line: "号码是SF1234567890。", pinyin: "Hàomǎ shì SF1234567890.", translationVi: "Mã là SF1234567890." },
              { speaker: "B", line: "我帮您查一下。哦，包裹在分拣中心，今天就送到。", pinyin: "Wǒ bāng nín chá yíxià. Ò, bāoguǒ zài fēnjiǎn zhōngxīn, jīntiān jiù sòngdào.", translationVi: "Tôi tra giúp bạn. Ồ, bưu kiện đang ở trung tâm phân loại, hôm nay sẽ giao." },
            ],
          },
        ],
        vocabulary: [
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "你好，我想办一张电话卡。", pinyin: "Nǐ hǎo, wǒ xiǎng bàn yì zhāng diànhuà kǎ.", translationVi: "Xin chào, tôi muốn làm thẻ điện thoại." },
              { speaker: "B", line: "请出示护照。您要什么套餐？", pinyin: "Qǐng chūshì hùzhào. Nín yào shénme tàocān?", translationVi: "Xin xuất trình hộ chiếu. Bạn muốn gói gì?" },
              { speaker: "A", line: "我每月用很多流量，请推荐。", pinyin: "Wǒ měi yuè yòng hěn duō liúliàng, qǐng tuījiàn.", translationVi: "Mỗi tháng tôi dùng nhiều data, xin đề xuất." },
              { speaker: "B", line: "这个套餐六十块，包含五十G流量和一百分钟通话。", pinyin: "Zhège tàocān liùshí kuài, bāohán wǔshí G liúliàng hé yìbǎi fēnzhōng tōnghuà.", translationVi: "Gói này 60 tệ, gồm 50GB data và 100 phút gọi." },
            ],
          },
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "你好，我家的网络非常慢。", pinyin: "Nǐ hǎo, wǒ jiā de wǎngluò fēicháng màn.", translationVi: "Xin chào, mạng nhà tôi rất chậm." },
              { speaker: "B", line: "请重启路由器试试。", pinyin: "Qǐng chóngqǐ lùyóuqì shìshi.", translationVi: "Xin khởi động lại router thử xem." },
              { speaker: "A", line: "我试过了还是慢。", pinyin: "Wǒ shìguò le háishì màn.", translationVi: "Tôi đã thử rồi vẫn chậm." },
              { speaker: "B", line: "好的，我们明天派师傅上门检查。", pinyin: "Hǎo de, wǒmen míngtiān pài shīfu shàngmén jiǎnchá.", translationVi: "Vâng, mai chúng tôi cử kỹ thuật viên đến kiểm tra." },
            ],
          },
        ],
        vocabulary: [
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "你好，我想剪头发。", pinyin: "Nǐ hǎo, wǒ xiǎng jiǎn tóufa.", translationVi: "Xin chào, tôi muốn cắt tóc." },
              { speaker: "B", line: "您想剪什么样的？", pinyin: "Nín xiǎng jiǎn shénme yàng de?", translationVi: "Bạn muốn cắt kiểu gì?" },
              { speaker: "A", line: "两边短一点，上面留长。", pinyin: "Liǎng biān duǎn yìdiǎn, shàngmiàn liú cháng.", translationVi: "Hai bên ngắn một chút, phía trên để dài." },
              { speaker: "B", line: "好的，要洗头吗？", pinyin: "Hǎo de, yào xǐtóu ma?", translationVi: "Vâng, có cần gội đầu không?" },
              { speaker: "A", line: "要，洗剪吹一起。", pinyin: "Yào, xǐ jiǎn chuī yìqǐ.", translationVi: "Có, gội-cắt-sấy luôn." },
            ],
          },
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "我想做一个全身按摩。", pinyin: "Wǒ xiǎng zuò yí ge quánshēn ànmó.", translationVi: "Tôi muốn massage toàn thân." },
              { speaker: "B", line: "六十分钟还是九十分钟？", pinyin: "Liùshí fēnzhōng háishì jiǔshí fēnzhōng?", translationVi: "60 phút hay 90 phút?" },
              { speaker: "A", line: "九十分钟，力度轻一点。", pinyin: "Jiǔshí fēnzhōng, lìdù qīng yìdiǎn.", translationVi: "90 phút, lực nhẹ một chút." },
              { speaker: "B", line: "好的，请跟我来。", pinyin: "Hǎo de, qǐng gēn wǒ lái.", translationVi: "Vâng, xin theo tôi." },
            ],
          },
        ],
        vocabulary: [
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "你好，我想干洗这件西装。", pinyin: "Nǐ hǎo, wǒ xiǎng gānxǐ zhè jiàn xīzhuāng.", translationVi: "Xin chào, tôi muốn giặt khô bộ vest này." },
              { speaker: "B", line: "好的，三十块。后天可以来取。", pinyin: "Hǎo de, sānshí kuài. Hòutiān kěyǐ lái qǔ.", translationVi: "Vâng, 30 tệ. Ngày kia có thể lấy." },
              { speaker: "A", line: "这是收据，请收好。", pinyin: "Zhè shì shōujù, qǐng shōuhǎo.", translationVi: "Đây là biên nhận, xin giữ kỹ." },
              { speaker: "B", line: "好的，谢谢。", pinyin: "Hǎo de, xièxie.", translationVi: "Vâng, cảm ơn." },
            ],
          },
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "我的外套拉链坏了，能修吗？", pinyin: "Wǒ de wàitào lāliàn huài le, néng xiū ma?", translationVi: "Khóa kéo áo khoác tôi hỏng rồi, sửa được không?" },
              { speaker: "B", line: "可以，换一条新的二十块。", pinyin: "Kěyǐ, huàn yì tiáo xīn de èrshí kuài.", translationVi: "Được, thay khóa mới 20 tệ." },
              { speaker: "A", line: "多久能修好？", pinyin: "Duō jiǔ néng xiūhǎo?", translationVi: "Bao lâu sửa xong?" },
              { speaker: "B", line: "明天下午就好。", pinyin: "Míngtiān xiàwǔ jiù hǎo.", translationVi: "Chiều mai là xong." },
            ],
          },
        ],
        vocabulary: [
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "你好，我想报案，我的钱包丢了。", pinyin: "Nǐ hǎo, wǒ xiǎng bào'àn, wǒ de qiánbāo diū le.", translationVi: "Xin chào, tôi muốn trình báo, ví tôi bị mất." },
              { speaker: "B", line: "在哪里丢的？什么时候？", pinyin: "Zài nǎlǐ diū de? Shénme shíhou?", translationVi: "Mất ở đâu? Khi nào?" },
              { speaker: "A", line: "今天上午在地铁站，里面有身份证和银行卡。", pinyin: "Jīntiān shàngwǔ zài dìtiě zhàn, lǐmiàn yǒu shēnfènzhèng hé yínháng kǎ.", translationVi: "Sáng nay ở ga tàu điện, trong đó có CMND và thẻ ngân hàng." },
              { speaker: "B", line: "请填这张表，我们会帮您查监控录像。", pinyin: "Qǐng tián zhè zhāng biǎo, wǒmen huì bāng nín chá jiānkòng lùxiàng.", translationVi: "Xin điền tờ này, chúng tôi sẽ giúp kiểm tra camera." },
            ],
          },
          {
            title: "Lost Passport",
            ...
            sampleDialogue: [
              { speaker: "A", line: "我是外国人，我的护照丢了。", pinyin: "Wǒ shì wàiguórén, wǒ de hùzhào diū le.", translationVi: "Tôi là người nước ngoài, hộ chiếu của tôi bị mất." },
              { speaker: "B", line: "请先去派出所开报案证明。", pinyin: "Qǐng xiān qù pàichūsuǒ kāi bào'àn zhèngmíng.", translationVi: "Xin đến đồn cảnh sát lấy giấy xác nhận trước." },
              { speaker: "A", line: "然后我应该做什么？", pinyin: "Ránhòu wǒ yīnggāi zuò shénme?", translationVi: "Sau đó tôi nên làm gì?" },
              { speaker: "B", line: "拿证明去您的大使馆补办护照。", pinyin: "Ná zhèngmíng qù nín de dàshǐguǎn bǔbàn hùzhào.", translationVi: "Mang giấy đến đại sứ quán làm lại hộ chiếu." },
            ],
          },
        ],
        vocabulary: [
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "我的狗最近不吃东西。", pinyin: "Wǒ de gǒu zuìjìn bù chī dōngxi.", translationVi: "Chó của tôi gần đây không chịu ăn." },
              { speaker: "B", line: "它精神怎么样？多大了？", pinyin: "Tā jīngshén zěnmeyàng? Duō dà le?", translationVi: "Tinh thần nó thế nào? Bao nhiêu tuổi?" },
              { speaker: "A", line: "三岁，看起来没有精神。", pinyin: "Sān suì, kàn qǐlái méiyǒu jīngshén.", translationVi: "Ba tuổi, trông uể oải." },
              { speaker: "B", line: "我先给它检查一下，可能需要打针。", pinyin: "Wǒ xiān gěi tā jiǎnchá yíxià, kěnéng xūyào dǎzhēn.", translationVi: "Tôi kiểm tra trước đã, có thể phải tiêm." },
            ],
          },
          {
            ...
            sampleDialogue: [
              { speaker: "A", line: "我想领养一只猫，有什么要求吗？", pinyin: "Wǒ xiǎng lǐngyǎng yì zhī māo, yǒu shénme yāoqiú ma?", translationVi: "Tôi muốn nhận nuôi một con mèo, có yêu cầu gì không?" },
              { speaker: "B", line: "您需要填申请表，并保证给它一个温暖的家。", pinyin: "Nín xūyào tián shēnqǐng biǎo, bìng bǎozhèng gěi tā yí ge wēnnuǎn de jiā.", translationVi: "Bạn cần điền đơn và cam kết cho nó một mái ấm." },
              { speaker: "A", line: "需要付钱吗？", pinyin: "Xūyào fù qián ma?", translationVi: "Có cần trả phí không?" },
              { speaker: "B", line: "免费领养，但要承担打疫苗的费用。", pinyin: "Miǎnfèi lǐngyǎng, dàn yào chéngdān dǎ yìmiáo de fèiyòng.", translationVi: "Nhận nuôi miễn phí, nhưng phải chi tiền tiêm vắc xin." },
            ],
          },
        ],
        vocabulary: [
    ...
    lessons: [
      ...
      // ──── Lesson 6: Business Email ────
      {
        ...
        keySituations: [{
          ...
          sampleDialogue: [
            { speaker: "Email", line: "尊敬的王经理，您好！", pinyin: "Zūnjìng de Wáng jīnglǐ, nín hǎo!", translationVi: "Kính gửi giám đốc Vương, xin chào!" },
            { speaker: "Email", line: "希望贵公司能提供报价单。", pinyin: "Xīwàng guì gōngsī néng tígōng bàojià dān.", translationVi: "Mong quý công ty cung cấp bảng báo giá." },
            { speaker: "Email", line: "如有疑问，请随时联系我。", pinyin: "Rú yǒu yíwèn, qǐng suíshí liánxì wǒ.", translationVi: "Nếu có thắc mắc, xin liên hệ tôi bất cứ lúc nào." },
            { speaker: "Email", line: "此致敬礼，李华", pinyin: "Cǐzhì jìnglǐ, Lǐ Huá", translationVi: "Trân trọng, Lý Hoa" },
          ],
        }],
        vocabulary: [
      ...
      // ──── Lesson 7: Presentations ────
      {
        ...
        keySituations: [{
          ...
          sampleDialogue: [
            ...
            { speaker: "A", line: "请看屏幕上的图表。", pinyin: "Qǐng kàn píngmù shàng de túbiǎo.", translationVi: "Xin nhìn biểu đồ trên màn hình." },
            { speaker: "A", line: "谢谢大家的聆听，请问有什么问题？", pinyin: "Xièxie dàjiā de língtīng, qǐngwèn yǒu shénme wèntí?", translationVi: "Cảm ơn mọi người đã lắng nghe, có câu hỏi nào không?" },
          ],
        }],
        vocabulary: [
      ...
      // ──── Lesson 8: Contracts & Legal ────
      {
        ...
        keySituations: [{
          ...
          sampleDialogue: [
            { speaker: "A", line: "请仔细看一下合同条款。", pinyin: "Qǐng zǐxì kàn yíxià hétong tiáokuǎn.", translationVi: "Vui lòng xem kỹ điều khoản hợp đồng." },
            { speaker: "B", line: "付款方式可以再商量吗？", pinyin: "Fùkuǎn fāngshì kěyǐ zài shāngliang ma?", translationVi: "Phương thức thanh toán có thể bàn lại không?" },
            { speaker: "A", line: "可以分三期付款。", pinyin: "Kěyǐ fēn sān qī fùkuǎn.", translationVi: "Có thể chia 3 đợt thanh toán." },
            { speaker: "B", line: "好的，那我们就签字吧。", pinyin: "Hǎo de, nà wǒmen jiù qiānzì ba.", translationVi: "Vâng, vậy chúng ta ký nhé." },
          ],
        }],
        vocabulary: [
      ...
      // ──── Lesson 9: Marketing & Sales ────
      {
        ...
        keySituations: [{
          ...
          sampleDialogue: [
            ...
            { speaker: "B", line: "价格怎么样？", pinyin: "Jiàgé zěnmeyàng?", translationVi: "Giá thế nào?" },
            { speaker: "A", line: "比同类产品便宜百分之二十。", pinyin: "Bǐ tónglèi chǎnpǐn piányi bǎi fēn zhī èrshí.", translationVi: "Rẻ hơn 20% so với cùng loại." },
            { speaker: "B", line: "听起来不错，可以给我详细资料吗？", pinyin: "Tīng qǐlái búcuò, kěyǐ gěi wǒ xiángxì zīliào ma?", translationVi: "Nghe hay đấy, cho tôi tài liệu chi tiết được không?" },
          ],
        }],
        vocabulary: [
      ...
      // ──── Lesson 10: Startup & Funding ────
      {
        ...
        keySituations: [{
          ...
          sampleDialogue: [
            ...
            { speaker: "A", line: "公司估值五千万人民币。", pinyin: "Gōngsī gūzhí wǔqiān wàn rénmínbì.", translationVi: "Công ty được định giá 50 triệu RMB." },
            { speaker: "B", line: "你们的商业模式是什么？", pinyin: "Nǐmen de shāngyè móshì shì shénme?", translationVi: "Mô hình kinh doanh của các bạn là gì?" },
          ],
        }],
        vocabulary: [
      ...
      // ──── Lesson 11: HR & Benefits ────
      {
        ...
        keySituations: [{
          ...
          sampleDialogue: [
            { speaker: "A", line: "公司的福利待遇怎么样？", pinyin: "Gōngsī de fúlì dàiyù zěnmeyàng?", translationVi: "Chế độ phúc lợi công ty thế nào?" },
            { speaker: "B", line: "我们提供五险一金和年终奖。", pinyin: "Wǒmen tígōng wǔ xiǎn yī jīn hé niánzhōng jiǎng.", translationVi: "Chúng tôi có 5 bảo hiểm + quỹ nhà ở và thưởng cuối năm." },
            { speaker: "A", line: "有没有带薪年假？", pinyin: "Yǒu méiyǒu dài xīn nián jià?", translationVi: "Có nghỉ phép có lương không?" },
            { speaker: "B", line: "有，每年十五天。", pinyin: "Yǒu, měi nián shíwǔ tiān.", translationVi: "Có, mỗi năm 15 ngày." },
          ],
        }],
        vocabulary: [
      ...
      // ──── Lesson 12: Workplace Conflict ────
      {
        ...
        keySituations: [{
          ...
          sampleDialogue: [
            { speaker: "A", line: "我觉得这个方案有问题。", pinyin: "Wǒ juéde zhège fāng'àn yǒu wèntí.", translationVi: "Tôi thấy phương án này có vấn đề." },
            { speaker: "B", line: "您能具体说说吗？", pinyin: "Nín néng jùtǐ shuōshuo ma?", translationVi: "Anh có thể nói cụ thể không?" },
            { speaker: "A", line: "成本可能超出预算。", pinyin: "Chéngběn kěnéng chāochū yùsuàn.", translationVi: "Chi phí có thể vượt ngân sách." },
            { speaker: "B", line: "我们再讨论一下吧。", pinyin: "Wǒmen zài tǎolùn yíxià ba.", translationVi: "Chúng ta thảo luận lại nhé." },
          ],
        }],
        vocabulary: [
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "游客", speakerVi: "Du khách", hanzi: "您好，我想报一个北京三日游。", pinyin: "Nín hǎo, wǒ xiǎng bào yí ge Běijīng sān rì yóu.", translationVi: "Chào, tôi muốn đăng ký tour Bắc Kinh 3 ngày." },
              { speaker: "客服", speakerVi: "NV", hanzi: "好的，我们有标准团和高端团两种。", pinyin: "Hǎo de, wǒmen yǒu biāozhǔn tuán hé gāoduān tuán liǎng zhǒng.", translationVi: "Vâng, có tour tiêu chuẩn và cao cấp." },
              { speaker: "游客", speakerVi: "Du khách", hanzi: "高端团多少钱？包括什么景点？", pinyin: "Gāoduān tuán duōshǎo qián? Bāokuò shénme jǐngdiǎn?", translationVi: "Tour cao cấp bao nhiêu? Gồm điểm tham quan nào?" },
              { speaker: "客服", speakerVi: "NV", hanzi: "三千八，包括长城、故宫和颐和园。", pinyin: "Sānqiān bā, bāokuò Chángchéng, Gùgōng hé Yíhéyuán.", translationVi: "3800 tệ, gồm Vạn Lý Trường Thành, Cố Cung, Di Hòa Viên." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", hanzi: "你最近看了什么电影？", pinyin: "Nǐ zuìjìn kàn le shénme diànyǐng?", translationVi: "Gần đây bạn xem phim gì?" },
              { speaker: "B", hanzi: "我看了《流浪地球2》，特效很震撼。", pinyin: "Wǒ kàn le 《Liúlàng Dìqiú 2》, tèxiào hěn zhènhàn.", translationVi: "Tôi xem Lưu Lạc Địa Cầu 2, hiệu ứng rất ấn tượng." },
              { speaker: "A", hanzi: "我也喜欢科幻片，剧情怎么样？", pinyin: "Wǒ yě xǐhuān kēhuàn piàn, jùqíng zěnmeyàng?", translationVi: "Tôi cũng thích phim viễn tưởng, cốt truyện thế nào?" },
              { speaker: "B", hanzi: "剧情很紧凑，演员演技也不错。", pinyin: "Jùqíng hěn jǐncòu, yǎnyuán yǎnjì yě búcuò.", translationVi: "Cốt truyện chặt chẽ, diễn xuất cũng tốt." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", hanzi: "你平时用什么社交软件？", pinyin: "Nǐ píngshí yòng shénme shèjiāo ruǎnjiàn?", translationVi: "Bạn dùng app xã hội nào?" },
              { speaker: "B", hanzi: "微信、小红书还有抖音。", pinyin: "Wēixìn, Xiǎohóngshū hái yǒu Dǒuyīn.", translationVi: "WeChat, Xiaohongshu và Douyin." },
              { speaker: "A", hanzi: "小红书上能找到很多攻略吧？", pinyin: "Xiǎohóngshū shàng néng zhǎodào hěn duō gōnglüè ba?", translationVi: "Xiaohongshu có nhiều bí kíp đúng không?" },
              { speaker: "B", hanzi: "对，旅游、美食、化妆都有。", pinyin: "Duì, lǚyóu, měishí, huàzhuāng dōu yǒu.", translationVi: "Đúng, du lịch, ẩm thực, makeup đều có." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", hanzi: "今天的空气质量怎么样？", pinyin: "Jīntiān de kōngqì zhìliàng zěnmeyàng?", translationVi: "Chất lượng không khí hôm nay sao?" },
              { speaker: "B", hanzi: "PM2.5指数有点高，最好戴口罩。", pinyin: "PM2.5 zhǐshù yǒudiǎn gāo, zuì hǎo dài kǒuzhào.", translationVi: "Chỉ số PM2.5 hơi cao, nên đeo khẩu trang." },
              { speaker: "A", hanzi: "政府在推广新能源车，应该会改善吧？", pinyin: "Zhèngfǔ zài tuīguǎng xīn néngyuán chē, yīnggāi huì gǎishàn ba?", translationVi: "Chính phủ thúc đẩy xe năng lượng mới, sẽ cải thiện chứ?" },
              { speaker: "B", hanzi: "希望如此，我们也要从自己做起，垃圾分类很重要。", pinyin: "Xīwàng rúcǐ, wǒmen yě yào cóng zìjǐ zuòqǐ, lājī fēnlèi hěn zhòngyào.", translationVi: "Hy vọng vậy. Chúng ta cũng phải bắt đầu từ mình, phân loại rác rất quan trọng." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", hanzi: "儒家思想对中国文化影响很深。", pinyin: "Rújiā sīxiǎng duì Zhōngguó wénhuà yǐngxiǎng hěn shēn.", translationVi: "Tư tưởng Nho gia ảnh hưởng sâu đến văn hóa TQ." },
              { speaker: "B", hanzi: "对，比如尊老爱幼、注重家庭。", pinyin: "Duì, bǐrú zūn lǎo ài yòu, zhùzhòng jiātíng.", translationVi: "Đúng, ví dụ như kính già yêu trẻ, coi trọng gia đình." },
              { speaker: "A", hanzi: "你觉得这些价值观在现代还适用吗？", pinyin: "Nǐ juéde zhèxiē jiàzhíguān zài xiàndài hái shìyòng ma?", translationVi: "Bạn nghĩ giá trị này còn phù hợp với hiện đại không?" },
              { speaker: "B", hanzi: "我认为核心精神依然有意义，但需要与时俱进。", pinyin: "Wǒ rènwéi héxīn jīngshén yīrán yǒu yìyì, dàn xūyào yǔ shí jù jìn.", translationVi: "Tôi nghĩ tinh thần cốt lõi vẫn ý nghĩa, nhưng cần theo thời đại." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "正方", speakerVi: "Phe ủng hộ", hanzi: "我方认为人工智能将取代大部分工作。", pinyin: "Wǒ fāng rènwéi réngōng zhìnéng jiāng qǔdài dà bùfèn gōngzuò.", translationVi: "Bên tôi cho rằng AI sẽ thay thế phần lớn công việc." },
              { speaker: "反方", speakerVi: "Phe phản đối", hanzi: "我方持不同意见。AI虽然强大，但缺乏创造力和情感。", pinyin: "Wǒ fāng chí bùtóng yìjiàn. AI suīrán qiángdà, dàn quēfá chuàngzàolì hé qínggǎn.", translationVi: "Bên tôi không đồng ý. AI mạnh nhưng thiếu sáng tạo và cảm xúc." },
              { speaker: "正方", speakerVi: "Phe ủng hộ", hanzi: "请问对方有什么具体证据？", pinyin: "Qǐngwèn duìfāng yǒu shénme jùtǐ zhèngjù?", translationVi: "Xin hỏi bên đối phương có bằng chứng cụ thể nào?" },
              { speaker: "反方", speakerVi: "Phe phản đối", hanzi: "根据最新研究，70%的创意工作仍需要人类。", pinyin: "Gēnjù zuìxīn yánjiū, bǎi fēn zhī qīshí de chuàngyì gōngzuò réng xūyào rénlèi.", translationVi: "Theo nghiên cứu mới, 70% công việc sáng tạo vẫn cần con người." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              { speaker: "A", hanzi: "给我讲讲你最难忘的一次经历吧。", pinyin: "Gěi wǒ jiǎng jiǎng nǐ zuì nánwàng de yí cì jīnglì ba.", translationVi: "Kể tôi nghe trải nghiệm đáng nhớ nhất của bạn đi." },
              { speaker: "B", hanzi: "那是去年夏天，我独自去西藏旅行。一开始，因为高原反应差点放弃。", pinyin: "Nà shì qùnián xiàtiān, wǒ dúzì qù Xīzàng lǚxíng. Yī kāishǐ, yīnwèi gāoyuán fǎnyìng chà diǎn fàngqì.", translationVi: "Đó là mùa hè năm ngoái, tôi một mình đi Tây Tạng. Lúc đầu suýt bỏ cuộc vì sốc độ cao." },
              { speaker: "A", hanzi: "后来呢？怎么坚持下来的？", pinyin: "Hòulái ne? Zěnme jiānchí xiàlái de?", translationVi: "Sau đó thì sao? Làm sao kiên trì được?" },
              { speaker: "B", hanzi: "幸亏遇到一位藏族大叔，他给了我酥油茶和鼓励。最终我登上了珠峰大本营，那一刻我哭了。", pinyin: "Xìngkuī yùdào yí wèi Zàngzú dàshū, tā gěi le wǒ sūyóu chá hé gǔlì. Zuìzhōng wǒ dēng shàng le Zhūfēng dà běn yíng, nà yí kè wǒ kū le.", translationVi: "May gặp chú người Tạng, chú cho trà bơ và động viên. Cuối cùng tôi lên được trại căn cứ Everest, khoảnh khắc đó tôi khóc." },
            ],
