        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "游客", line: "高端团多少钱？包括什么景点？", pinyin: "Gāoduān tuán duōshǎo qián? Bāokuò shénme jǐngdiǎn?", translationVi: "Tour cao cấp bao nhiêu? Gồm điểm tham quan nào?" },
              { speaker: "客服", line: "三千八，包括长城、故宫和颐和园。", pinyin: "Sānqiān bā, bāokuò Chángchéng, Gùgōng hé Yíhéyuán.", translationVi: "3800 tệ, gồm Vạn Lý Trường Thành, Cố Cung, Di Hòa Viên." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "A", line: "我也喜欢科幻片，剧情怎么样？", pinyin: "Wǒ yě xǐhuān kēhuàn piàn, jùqíng zěnmeyàng?", translationVi: "Tôi cũng thích phim viễn tưởng, cốt truyện thế nào?" },
              { speaker: "B", line: "剧情很紧凑，演员演技也不错。", pinyin: "Jùqíng hěn jǐncòu, yǎnyuán yǎnjì yě búcuò.", translationVi: "Cốt truyện chặt chẽ, diễn xuất cũng tốt." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "A", line: "小红书上能找到很多攻略吧？", pinyin: "Xiǎohóngshū shàng néng zhǎodào hěn duō gōnglüè ba?", translationVi: "Xiaohongshu có nhiều bí kíp đúng không?" },
              { speaker: "B", line: "对，旅游、美食、化妆都有。", pinyin: "Duì, lǚyóu, měishí, huàzhuāng dōu yǒu.", translationVi: "Đúng, du lịch, ẩm thực, makeup đều có." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "A", line: "政府在推广新能源车，应该会改善吧？", pinyin: "Zhèngfǔ zài tuīguǎng xīn néngyuán chē, yīnggāi huì gǎishàn ba?", translationVi: "Chính phủ thúc đẩy xe năng lượng mới, sẽ cải thiện chứ?" },
              { speaker: "B", line: "希望如此，我们也要从自己做起，垃圾分类很重要。", pinyin: "Xīwàng rúcǐ, wǒmen yě yào cóng zìjǐ zuòqǐ, lājī fēnlèi hěn zhòngyào.", translationVi: "Hy vọng vậy. Chúng ta cũng phải bắt đầu từ mình, phân loại rác rất quan trọng." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "A", line: "你觉得这些价值观在现代还适用吗？", pinyin: "Nǐ juéde zhèxiē jiàzhíguān zài xiàndài hái shìyòng ma?", translationVi: "Bạn nghĩ giá trị này còn phù hợp với hiện đại không?" },
              { speaker: "B", line: "我认为核心精神依然有意义，但需要与时俱进。", pinyin: "Wǒ rènwéi héxīn jīngshén yīrán yǒu yìyì, dàn xūyào yǔ shí jù jìn.", translationVi: "Tôi nghĩ tinh thần cốt lõi vẫn ý nghĩa, nhưng cần theo thời đại." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "正方", line: "请问对方有什么具体证据？", pinyin: "Qǐngwèn duìfāng yǒu shénme jùtǐ zhèngjù?", translationVi: "Xin hỏi bên đối phương có bằng chứng cụ thể nào?" },
              { speaker: "反方", line: "根据最新研究，70%的创意工作仍需要人类。", pinyin: "Gēnjù zuìxīn yánjiū, bǎi fēn zhī qīshí de chuàngyì gōngzuò réng xūyào rénlèi.", translationVi: "Theo nghiên cứu mới, 70% công việc sáng tạo vẫn cần con người." },
            ],
        ...
        keySituations: [
          {
            ...
            sampleDialogue: [
              ...
              { speaker: "A", line: "后来呢？怎么坚持下来的？", pinyin: "Hòulái ne? Zěnme jiānchí xiàlái de?", translationVi: "Sau đó thì sao? Làm sao kiên trì được?" },
