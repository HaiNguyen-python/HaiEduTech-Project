  ...
  public: {
    Tables: {
      ...
      your_corner_comment_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "your_corner_comment_reactions_comment_id_fkey"
            columns: ["comment_id"]
            isOneToOne: false
            referencedRelation: "your_corner_comments"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "your_corner_comment_reactions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      your_corner_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "your_corner_comments_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "your_corner_comments"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "your_corner_comments_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "your_corner_posts"
            referencedColumns: ["id"]
      ...
      your_corner_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "your_corner_reactions_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "your_corner_posts"
            referencedColumns: ["id"]
