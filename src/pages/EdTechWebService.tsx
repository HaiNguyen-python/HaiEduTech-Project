...
// ============================================================================
// Feature Recap Grid — restates every demo feature + extra advanced ones
// ============================================================================
const ALL_FEATURES = [
  { icon: LayoutDashboard, color: "emerald", title: { vi: "Smart Dashboard", en: "Smart Dashboard" }, desc: { vi: "Tổng quan lớp – tiến độ – doanh thu theo thời gian thực.", en: "Real-time overview of classes, progress and revenue." } },
  { icon: Bot, color: "violet", title: { vi: "AI Tutor 24/7", en: "AI Tutor 24/7" }, desc: { vi: "Trợ giảng AI trả lời học sinh ngay tức thì, đúng phong cách Thầy/Cô.", en: "AI assistant answers students instantly in your teaching style." } },
  { icon: Users, color: "primary", title: { vi: "Quản lý lớp học", en: "Class Management" }, desc: { vi: "Sĩ số, điểm danh, lịch học – đồng bộ realtime trên mọi thiết bị.", en: "Roster, attendance and schedule synced live across devices." } },
  { icon: ClipboardList, color: "rose", title: { vi: "Bài tập & Chấm điểm AI", en: "Assignments & AI Grading" }, desc: { vi: "Tự chấm trắc nghiệm, tự luận, Writing và Speaking theo rubric.", en: "Auto-grades MCQ, essays, Writing and Speaking by rubric." } },
  { icon: BarChart3, color: "sky", title: { vi: "Phân tích chuyên sâu", en: "Deep Analytics" }, desc: { vi: "Insight hành vi học tập, dự đoán điểm thi, gợi ý can thiệp.", en: "Behavior insights, score prediction and intervention hints." } },
  { icon: BookOpen, color: "indigo", title: { vi: "Bài giảng tương tác", en: "Interactive Lessons" }, desc: { vi: "Multimedia, quiz nhúng, flashcard, audio TTS chuẩn bản ngữ.", en: "Multimedia, embedded quizzes, flashcards and native TTS audio." } },
  { icon: Brain, color: "teal", title: { vi: "RL · Cá nhân hoá lộ trình", en: "RL · Adaptive Learning Path" }, desc: { vi: "Reinforcement Learning điều chỉnh độ khó theo từng học viên.", en: "Reinforcement Learning tunes difficulty per learner." } },
  { icon: AlertTriangle, color: "rose", title: { vi: "Cảnh báo sớm · Can thiệp giáo dục", en: "Early Warning · Education Intervention" }, desc: { vi: "Phát hiện học sinh học yếu, đề xuất phương án can thiệp.", en: "Detects at-risk learners and suggests intervention plans." } },
  { icon: Calendar, color: "primary", title: { vi: "Lịch học & Học phí tự động", en: "Schedule & Tuition Automation" }, desc: { vi: "Nhắc lịch, thu học phí, đối soát doanh thu tự động.", en: "Reminders, tuition collection and revenue reconciliation." } },
  { icon: Mail, color: "amber", title: { vi: "Báo cáo phụ huynh hàng tháng", en: "Monthly Parent Reports" }, desc: { vi: "Email bản tin tiến độ học tập gửi phụ huynh tự động mỗi tháng.", en: "Auto-emailed monthly progress newsletter to parents." } },
  { icon: FileText, color: "rose", title: { vi: "Chấm Writing theo Rubric AI", en: "AI Rubric Writing Grading" }, desc: { vi: "Chấm theo 4 tiêu chí IELTS, feedback chi tiết từng câu.", en: "Grades on 4 IELTS criteria with sentence-level feedback." } },
  { icon: MessageCircle, color: "violet", title: { vi: "Chấm Speaking · Phát âm AI", en: "AI Speaking & Pronunciation" }, desc: { vi: "Đo độ chính xác phát âm, ngữ điệu, tốc độ – chấm theo band.", en: "Measures pronunciation, intonation and pace, scored by band." } },
  { icon: Play, color: "sky", title: { vi: "Phòng học Live · Engagement AI", en: "Live Class · Engagement AI" }, desc: { vi: "Livestream HD, theo dõi mức độ tập trung và cảnh báo realtime.", en: "HD livestream with realtime focus tracking and alerts." } },
  { icon: Target, color: "indigo", title: { vi: "Skill Mastery Map", en: "Skill Mastery Map" }, desc: { vi: "Bản đồ năng lực từng kỹ năng – biết em cần luyện gì tiếp theo.", en: "Skill-by-skill mastery map showing what to practice next." } },
  { icon: Zap, color: "teal", title: { vi: "Smart Assign · Giao bài cá nhân hoá", en: "Smart Assign · Personalized Homework" }, desc: { vi: "Tự động chọn bài tập đúng vùng phát triển gần (ZPD) cho từng em.", en: "Auto-picks tasks inside each learner's Zone of Proximal Development." } },
  { icon: Trophy, color: "amber", title: { vi: "Gamification · Tăng động lực", en: "Gamification · Boost Motivation" }, desc: { vi: "XP, streak, huy hiệu, bảng xếp hạng – tăng tỉ lệ hoàn thành +38%.", en: "XP, streaks, badges and leaderboards – +38% completion lift." } },
  { icon: UserCog, color: "violet", title: { vi: "Quản lý nhân sự & CTV", en: "Staff & Contributor Management" }, desc: { vi: "Phân quyền, chấm công, bảng lương, KPI cho cả đội ngũ.", en: "Roles, time tracking, payroll and KPIs for your whole team." } },
  // Extra advanced features beyond the carousel
  { icon: Award, color: "amber", title: { vi: "Chứng chỉ điện tử + QR xác thực", en: "Digital Certificates + QR Verification" }, desc: { vi: "Xuất chứng chỉ PDF có chữ ký số, mã chống làm giả.", en: "PDF certificates with digital signature and anti-forgery codes." } },
  { icon: Search, color: "indigo", title: { vi: "Tối ưu SEO Google & AI Search", en: "Google + AI Search SEO" }, desc: { vi: "Schema Education, sitemap động, top khi phụ huynh tìm kiếm.", en: "Education schema and dynamic sitemap – ranks when parents search." } },
  { icon: ShieldCheck, color: "emerald", title: { vi: "Bảo mật cấp cao + GDPR", en: "Enterprise Security + GDPR" }, desc: { vi: "SSL/TLS 1.3, RLS, audit log, backup hằng ngày, watermark tài liệu.", en: "SSL/TLS 1.3, RLS, audit logs, daily backups, doc watermarking." } },
  { icon: Smartphone, color: "primary", title: { vi: "PWA · Cài đặt như App điện thoại", en: "PWA · Installable Mobile App" }, desc: { vi: "Học viên cài web như app, học offline, nhận push notification.", en: "Learners install the site as an app, learn offline, get push alerts." } },
  { icon: Cloud, color: "sky", title: { vi: "Lưu trữ video bài giảng bảo mật", en: "Secure Lesson Video Hosting" }, desc: { vi: "Hosting riêng, chống tải xuống, watermark động theo từng học viên.", en: "Private hosting, anti-download, per-learner dynamic watermarks." } },
  { icon: Database, color: "violet", title: { vi: "Data Warehouse + BI Dashboard", en: "Data Warehouse + BI Dashboard" }, desc: { vi: "Kho dữ liệu riêng, dashboard tuỳ biến cho ban giám hiệu.", en: "Private data warehouse with custom dashboards for leadership." } },
  { icon: Globe, color: "teal", title: { vi: "Đa ngôn ngữ Việt – Anh – Trung", en: "Multilingual VI · EN · ZH" }, desc: { vi: "Chuyển ngữ nội dung và giao diện chỉ với 1 cú click.", en: "Switch content and UI between languages in one click." } },
  { icon: TrendingUp, color: "rose", title: { vi: "A/B Testing & Tối ưu chuyển đổi", en: "A/B Testing & Conversion Optimization" }, desc: { vi: "Thử nghiệm landing page, CTA, giá – tăng tỉ lệ đăng ký.", en: "Test landing pages, CTAs and pricing to lift sign-ups." } },
  { icon: Bell, color: "amber", title: { vi: "Thông báo đa kênh: Email + Zalo + Push", en: "Multi-channel Notifications: Email + Zalo + Push" }, desc: { vi: "Một hành động → đẩy tin cùng lúc qua nhiều kênh.", en: "One action pushes notifications across multiple channels at once." } },
  { icon: Activity, color: "primary", title: { vi: "Theo dõi học viên realtime", en: "Realtime Learner Monitoring" }, desc: { vi: "Heatmap thời gian học, lượt mở bài, lượt nghe lại.", en: "Heatmaps of study time, lesson opens and replays." } },
  { icon: Lock, color: "emerald", title: { vi: "Đăng nhập SSO · Google · Microsoft", en: "SSO Login · Google · Microsoft" }, desc: { vi: "Tích hợp Google/Microsoft cho trường học & doanh nghiệp.", en: "Google / Microsoft SSO for schools and enterprise customers." } },
  { icon: Lightbulb, color: "indigo", title: { vi: "Trợ lý ý tưởng bài giảng AI", en: "AI Lesson Idea Assistant" }, desc: { vi: "Sinh outline, slide, bài kiểm tra chỉ từ một chủ đề.", en: "Generates outlines, slides and quizzes from a single topic." } },
] as const;

const recapColor: Record<string, { bg: string; text: string; ring: string }> = {
    ...
    <div className="mt-16 max-w-6xl mx-auto">
      <div className="text-center max-w-2xl mx-auto mb-8">
        <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/40 bg-emerald-500/5 px-3 py-1 text-xs font-semibold text-emerald-600 mb-3">
          ...
          {t("Tổng hợp tất cả tính năng", "Full Feature Recap")}
        </div>
        <h3 className="text-2xl sm:text-3xl font-display font-bold text-foreground">
          {t(
            "Toàn bộ tính năng Thầy/Cô sẽ nhận được",
            "Every feature you will receive"
          )}
        </h3>
        <p className="mt-3 text-muted-foreground">
          {t(
            "Tổng hợp lại tất cả tính năng trong bản demo phía trên – cùng nhiều tính năng nâng cao khác để dạy học và vận hành chuyên nghiệp hơn.",
            "A recap of every feature shown in the demo above – plus extra advanced features to teach and operate more professionally."
          )}
        </p>
      </div>
        ...
        {ALL_FEATURES.map((f, i) => {
          ...
          return (
            <motion.div
              ...
              className="group relative rounded-xl border-2 border-emerald-500/40 hover:border-emerald-500/80 bg-card p-5 transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-emerald-500/15"
            >
              <span className="pointer-events-none absolute inset-x-0 top-0 h-0.5 rounded-t-xl bg-gradient-to-r from-emerald-500 via-primary to-emerald-500 opacity-70" />
              <div className="flex items-start gap-3">
                <div className={`shrink-0 w-11 h-11 rounded-xl ${c.bg} ${c.text} ring-1 ${c.ring} flex items-center justify-center`}>
      ...
      <p className="mt-8 text-center text-sm text-muted-foreground">
        {t(
          `Tổng cộng ${ALL_FEATURES.length}+ tính năng sẵn sàng triển khai – có thể tuỳ biến theo nhu cầu thực tế của Thầy/Cô.`,
          `Over ${ALL_FEATURES.length}+ ready-to-deploy features – fully customizable to your needs.`
        )}
      </p>
    </div>
  );
