...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO title="Liên Hệ Thầy Hải - HaiEduTech | Tư Vấn Khóa Học" description="Liên hệ Thầy Hải: 0962.823.800, hainguyen240195@gmail.com. Tư vấn IELTS, HSK, TOEIC, du học, lập trình Python miễn phí qua Zalo, Facebook, LinkedIn." path="/contact" />
      <Navbar />
