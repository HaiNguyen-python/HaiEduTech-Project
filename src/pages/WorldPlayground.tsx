...
const zones: ExplorationZone[] = [
  // ==================== ZONE 1: GEOGRAPHY & WONDERS ====================
  {
    ...
    lessons: [
      ...
      {
        id: "geo-mounteverest-cn", country: "Trung Quốc & Nepal", countryEn: "China & Nepal", flag: "🏔️",
        title: "Cao nguyên Tây Tạng — Nóc nhà thứ ba",
        titleEn: "Tibetan Plateau — The Third Pole",
        summary: "Cao nguyên rộng 2,5 triệu km², trung bình 4.500 m so với mực nước biển — chứa nhiều băng nhất ngoài hai cực.",
        summaryEn: "A 2.5 million km² plateau averaging 4,500 m elevation — holding more ice than anywhere outside the polar regions.",
        funFact: "Sông băng Tây Tạng cấp nước cho 1,9 tỷ người ở 10 quốc gia châu Á.",
        funFactEn: "Tibetan glaciers supply water to 1.9 billion people across 10 Asian countries.",
        didYouKnow: "Người Tây Tạng có đột biến gen EPAS1 giúp họ thích nghi với độ cao thiếu oxy — thừa hưởng từ người Denisovan cổ đại.",
        didYouKnowEn: "Tibetans carry the EPAS1 gene mutation for high-altitude adaptation — inherited from ancient Denisovans.",
        image: "https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "geo-deadsea-il", country: "Israel & Jordan", countryEn: "Israel & Jordan", flag: "🇮🇱",
        title: "Biển Chết — Điểm thấp nhất Trái Đất",
        titleEn: "Dead Sea — Earth's lowest point",
        summary: "Mặt nước nằm 430 m dưới mực nước biển, độ mặn 34% — gấp gần 10 lần đại dương, khiến mọi vật đều nổi.",
        summaryEn: "430 m below sea level with 34% salinity — nearly 10× the ocean, so everything floats effortlessly.",
        funFact: "Mặt nước Biển Chết đang giảm khoảng 1 mét mỗi năm do bốc hơi và chuyển hướng dòng chảy.",
        funFactEn: "The Dead Sea drops about 1 meter per year due to evaporation and river diversion.",
        didYouKnow: "Bùn khoáng Biển Chết chứa 21 loại khoáng — 12 trong số đó không tồn tại ở bất kỳ nơi nào khác trên thế giới.",
        didYouKnowEn: "Dead Sea mud contains 21 minerals — 12 of which exist nowhere else on Earth.",
        image: "https://images.unsplash.com/photo-1542401886-65d6c61db217?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "geo-iguazu-ar", country: "Argentina & Brazil", countryEn: "Argentina & Brazil", flag: "🇦🇷",
        title: "Thác Iguazú — 275 dòng thác",
        titleEn: "Iguazú Falls — 275 cascades",
        summary: "Hệ thống 275 thác trải dài 2,7 km — rộng gấp 3 lần Niagara, được mệnh danh là 'Nước lớn' theo tiếng Guarani.",
        summaryEn: "A 275-cascade system spanning 2.7 km — three times wider than Niagara, named 'Big Water' in Guarani.",
        funFact: "Khi Đệ nhất phu nhân Eleanor Roosevelt nhìn thấy Iguazú, bà thốt lên: 'Tội nghiệp Niagara!'",
        funFactEn: "When First Lady Eleanor Roosevelt saw Iguazú, she exclaimed: 'Poor Niagara!'",
        didYouKnow: "'Họng Quỷ' (Garganta del Diablo) là điểm cao nhất 82 m, nơi 14 thác đổ chung tạo bọt nước cao tới 150 m.",
        didYouKnowEn: "'Devil's Throat' is the tallest drop at 82 m, where 14 falls converge with mist rising 150 m high.",
        image: "https://images.unsplash.com/photo-1547093349-3a3a85f5ee4d?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "geo-uluru-au", country: "Úc", countryEn: "Australia", flag: "🇦🇺",
        title: "Uluru — Trái tim đỏ của Úc",
        titleEn: "Uluru — Red heart of Australia",
        summary: "Khối đá sa thạch khổng lồ cao 348 m, chu vi 9,4 km — hình thành cách đây 550 triệu năm, đổi màu theo ánh mặt trời.",
        summaryEn: "A massive sandstone monolith 348 m tall and 9.4 km around — formed 550 million years ago, shifting color with sunlight.",
        funFact: "Uluru chỉ là 'phần nổi' — phần lớn khối đá nằm ngầm sâu tới 2,5 km dưới mặt đất.",
        funFactEn: "Uluru is just the 'tip' — most of the rock extends 2.5 km underground.",
        didYouKnow: "Người Anangu bản địa coi Uluru là thiêng liêng — từ tháng 10/2019, mọi hoạt động leo núi bị cấm vĩnh viễn.",
        didYouKnowEn: "The Anangu people consider Uluru sacred — climbing has been permanently banned since October 2019.",
        image: "https://images.unsplash.com/photo-1529108190281-9a4f620bc2d8?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "geo-baikal-ru", country: "Nga", countryEn: "Russia", flag: "🇷🇺",
        title: "Hồ Baikal — Hồ sâu nhất hành tinh",
        titleEn: "Lake Baikal — World's deepest lake",
        summary: "Sâu 1.642 m, chứa 23% lượng nước ngọt bề mặt của Trái Đất — đủ cho cả nhân loại uống trong 50 năm.",
        summaryEn: "1,642 m deep, holding 23% of Earth's surface freshwater — enough to supply all humanity for 50 years.",
        funFact: "Vào mùa đông, băng dày 1 m trong suốt như pha lê, có thể nhìn thấy đáy ở vùng nước nông.",
        funFactEn: "In winter, 1 m thick ice is crystal clear — you can see the bottom in shallow areas.",
        didYouKnow: "Baikal là hồ cổ nhất thế giới (25 triệu năm) và là nhà của 1.700 loài đặc hữu, gồm cả loài hải cẩu nước ngọt duy nhất 'nerpa'.",
        didYouKnowEn: "Baikal is Earth's oldest lake (25 million years) and home to 1,700 endemic species, including the world's only freshwater seal 'nerpa'.",
        image: "https://images.unsplash.com/photo-1606921231132-b1c7e1ea0563?auto=format&fit=crop&w=800&q=75",
      },
    ],
  },
  ...
  // ==================== ZONE 2: CULTURAL TAPESTRY ====================
  {
    ...
    lessons: [
      ...
      {
        id: "cul-diwali-in", country: "Ấn Độ", countryEn: "India", flag: "🪔",
        title: "Diwali — Lễ hội ánh sáng",
        titleEn: "Diwali — Festival of Lights",
        summary: "Lễ hội 5 ngày kỷ niệm chiến thắng của ánh sáng trước bóng tối — nhà nhà thắp đèn dầu diya, bắn pháo hoa và chia rangoli.",
        summaryEn: "A 5-day festival celebrating light over darkness — families light diya lamps, set fireworks, and create rangoli art.",
        funFact: "Diwali là kỳ nghỉ quốc gia ở 11 quốc gia — không chỉ Ấn Độ mà cả Fiji, Mauritius, Singapore.",
        funFactEn: "Diwali is a national holiday in 11 countries — not just India but also Fiji, Mauritius, Singapore.",
        didYouKnow: "Năm 2022, thành phố Ayodhya phá kỷ lục Guinness với 1,5 triệu ngọn đèn diya thắp cùng lúc bên sông Saryu.",
        didYouKnowEn: "In 2022, Ayodhya broke the Guinness record by lighting 1.5 million diya lamps simultaneously along the Saryu River.",
        image: "https://images.unsplash.com/photo-1605302357050-29760c8e5f0d?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "cul-tea-cn", country: "Trung Quốc", countryEn: "China", flag: "🍵",
        title: "Trà đạo Trung Hoa — Gongfu Cha",
        titleEn: "Chinese Tea Ceremony — Gongfu Cha",
        summary: "Nghi lễ pha trà với ấm tử sa nhỏ, hâm nóng nhiều lần, tập trung vào hương vị và sự tinh tế của từng giọt trà.",
        summaryEn: "A ritual using small Yixing clay teapots, multiple infusions, and full focus on aroma and the subtlety of each pour.",
        funFact: "Trà được phát hiện cách đây 4.700 năm bởi Hoàng Đế Thần Nông khi lá trà rơi vào nồi nước sôi.",
        funFactEn: "Tea was discovered 4,700 years ago when leaves fell into Emperor Shennong's boiling water.",
        didYouKnow: "Một ấm trà tử sa cổ Yixing chính hiệu có thể đắt hơn 1 triệu USD — vì 'thấm' hương trà sau hàng trăm năm sử dụng.",
        didYouKnowEn: "An authentic antique Yixing teapot can cost over $1 million — having absorbed tea aroma over centuries of use.",
        image: "https://images.unsplash.com/photo-1576092768241-dec231879fc3?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "cul-oktoberfest-de", country: "Đức", countryEn: "Germany", flag: "🍺",
        title: "Oktoberfest — Lễ hội bia Munich",
        titleEn: "Oktoberfest — Munich Beer Festival",
        summary: "Lễ hội bia lớn nhất thế giới kéo dài 16-18 ngày, đón 6 triệu khách và tiêu thụ 7 triệu lít bia mỗi năm.",
        summaryEn: "The world's largest beer festival lasts 16-18 days, welcoming 6 million visitors and serving 7 million liters of beer.",
        funFact: "Bia Oktoberfest phải đáp ứng luật Reinheitsgebot 1516 — chỉ được làm từ nước, đại mạch và hoa bia.",
        funFactEn: "Oktoberfest beer must follow the 1516 Reinheitsgebot purity law — only water, barley, and hops allowed.",
        didYouKnow: "Lễ hội bắt nguồn năm 1810 từ đám cưới Hoàng tử Ludwig — lúc đầu là lễ cưới hoàng gia, sau biến thành tiệc bia toàn dân.",
        didYouKnowEn: "It began in 1810 as Prince Ludwig's royal wedding — gradually evolving into a public beer celebration.",
        image: "https://images.unsplash.com/photo-1505075106905-fb052892c116?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "cul-aboriginal-au", country: "Úc", countryEn: "Australia", flag: "🪃",
        title: "Nghệ thuật chấm Aboriginal",
        titleEn: "Aboriginal Dot Painting",
        summary: "Hình thức nghệ thuật cổ xưa nhất hành tinh — kể chuyện 'Dreamtime' qua hàng triệu chấm sơn trên vỏ cây và đá.",
        summaryEn: "Earth's oldest continuous art form — telling 'Dreamtime' stories through millions of paint dots on bark and stone.",
        funFact: "Văn hóa Aboriginal đã tồn tại liên tục hơn 65.000 năm — nền văn hóa cổ xưa nhất còn tồn tại trên thế giới.",
        funFactEn: "Aboriginal culture has continued for 65,000+ years — the oldest living culture on Earth.",
        didYouKnow: "Boomerang không chỉ là vũ khí — có nhiều loại không quay lại, dùng để săn bắn hoặc làm nhạc cụ.",
        didYouKnowEn: "Boomerangs aren't only for returning — many types don't come back, used for hunting or as musical instruments.",
        image: "https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "cul-coffee-et", country: "Ethiopia", countryEn: "Ethiopia", flag: "☕",
        title: "Nghi lễ cà phê Ethiopia",
        titleEn: "Ethiopian Coffee Ceremony",
        summary: "Nghi lễ 1-2 giờ rang hạt sống, giã, pha trong bình jebena đất sét, rót 3 lượt với hương trầm hương lan tỏa.",
        summaryEn: "A 1-2 hour ritual: roast green beans, grind, brew in a clay jebena, and serve in 3 rounds with frankincense burning.",
        funFact: "Ethiopia là quê hương của cà phê — truyền thuyết kể rằng người chăn dê Kaldi phát hiện hạt cà phê khoảng năm 850.",
        funFactEn: "Ethiopia is coffee's birthplace — legend says goat herder Kaldi discovered the bean around the year 850.",
        didYouKnow: "Ba lượt cà phê có ý nghĩa: Abol (chuyển hóa), Tona (suy ngẫm), Baraka (chúc phúc) — bỏ qua được coi là rất bất lịch sự.",
        didYouKnowEn: "The 3 rounds carry meaning: Abol (transformation), Tona (reflection), Baraka (blessing) — skipping any is highly impolite.",
        image: "https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=800&q=75",
      },
    ],
  },
  ...
  // ==================== ZONE 3: GLOBAL LANGUAGES ====================
  {
    ...
    lessons: [
      ...
      {
        id: "lang-french-fr", country: "Pháp", countryEn: "France", flag: "🇫🇷",
        title: "Bonjour — Tiếng Pháp",
        titleEn: "Bonjour — French",
        summary: "Ngôn ngữ chính thức tại 29 quốc gia — ngôn ngữ ngoại giao, ẩm thực, thời trang và là một trong 6 ngôn ngữ chính của Liên Hợp Quốc.",
        summaryEn: "Official in 29 countries — the language of diplomacy, cuisine, fashion, and one of the UN's 6 official languages.",
        funFact: "Tiếng Pháp có 17 cách phát âm khác nhau cho âm 'o' — từ tinh tế nhất trong các ngôn ngữ Âu.",
        funFactEn: "French has 17 different ways to pronounce the 'o' sound — among Europe's most subtle languages.",
        didYouKnow: "Viện Hàn lâm Pháp (Académie Française) tồn tại từ 1635 với 40 'Bất tử' để bảo vệ sự thuần khiết của tiếng Pháp.",
        didYouKnowEn: "The Académie Française has existed since 1635 with 40 'Immortals' protecting French language purity.",
        image: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "lang-spanish-es", country: "Tây Ban Nha", countryEn: "Spain", flag: "🇪🇸",
        title: "Hola — Tiếng Tây Ban Nha",
        titleEn: "Hola — Spanish",
        summary: "Ngôn ngữ mẹ đẻ của 500 triệu người — đứng thứ 2 thế giới, chính thức tại 21 quốc gia, đa số ở châu Mỹ Latinh.",
        summaryEn: "Native to 500 million people — the world's 2nd most spoken native language, official in 21 countries.",
        funFact: "Dấu '¿' và '¡' ngược đầu là độc nhất tiếng Tây Ban Nha — báo trước câu hỏi/câu cảm thán.",
        funFactEn: "The inverted '¿' and '¡' are unique to Spanish — signaling questions/exclamations in advance.",
        didYouKnow: "Cuốn từ điển tiếng Tây Ban Nha của RAE có hơn 93.000 từ — và mỗi năm thêm khoảng 200 từ mới.",
        didYouKnowEn: "The RAE Spanish dictionary has 93,000+ entries — adding about 200 new words each year.",
        image: "https://images.unsplash.com/photo-1543783207-ec64e4d95325?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "lang-italian-it", country: "Ý", countryEn: "Italy", flag: "🇮🇹",
        title: "Ciao — Tiếng Ý",
        titleEn: "Ciao — Italian",
        summary: "Ngôn ngữ phát triển trực tiếp từ tiếng Latin — được coi là 'tiếng nói của âm nhạc' với hầu hết thuật ngữ nhạc cổ điển.",
        summaryEn: "Evolved directly from Latin — known as 'the language of music' with most classical music terminology.",
        funFact: "Đến năm 1861 chỉ có 2,5% dân Ý nói tiếng Ý — phần còn lại dùng các phương ngữ địa phương.",
        funFactEn: "Until 1861, only 2.5% of Italians spoke Italian — the rest used regional dialects.",
        didYouKnow: "'Ciao' bắt nguồn từ tiếng Venice 's-ciào vostro' nghĩa là 'tôi là nô lệ của bạn' — dạng chào kính cẩn thời trung cổ.",
        didYouKnowEn: "'Ciao' comes from the Venetian 's-ciào vostro' meaning 'I am your slave' — a medieval polite greeting.",
        image: "https://images.unsplash.com/photo-1555992336-fb0d29498b13?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "lang-turkish-tr", country: "Thổ Nhĩ Kỳ", countryEn: "Türkiye", flag: "🇹🇷",
        title: "Merhaba — Tiếng Thổ",
        titleEn: "Merhaba — Turkish",
        summary: "Ngôn ngữ kết dính (agglutinative) — một từ có thể dài như cả câu, nhờ thêm hậu tố nối tiếp nhau.",
        summaryEn: "An agglutinative language — one word can be sentence-long thanks to chained suffixes.",
        funFact: "Từ 'Çekoslovakyalılaştıramadıklarımızdanmışsınız' (50 chữ) nghĩa là 'bạn được cho là một trong những người chúng tôi không thể biến thành người Tiệp Khắc'.",
        funFactEn: "'Çekoslovakyalılaştıramadıklarımızdanmışsınız' (50 letters) means 'you are reportedly one of those we couldn't make Czechoslovakian'.",
        didYouKnow: "Năm 1928, Atatürk thay bảng chữ Ả Rập bằng bảng Latin chỉ trong 6 tuần — tỷ lệ biết chữ tăng từ 10% lên 90%.",
        didYouKnowEn: "In 1928, Atatürk replaced the Arabic script with Latin in just 6 weeks — literacy jumped from 10% to 90%.",
        image: "https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "lang-icelandic-is", country: "Iceland", countryEn: "Iceland", flag: "🇮🇸",
        title: "Halló — Tiếng Iceland",
        titleEn: "Halló — Icelandic",
        summary: "Tiếng Iceland gần như không thay đổi suốt 1.000 năm — người Iceland hôm nay vẫn đọc được sử thi Viking thế kỷ 13.",
        summaryEn: "Icelandic has barely changed in 1,000 years — modern Icelanders can still read 13th-century Viking sagas.",
        funFact: "Iceland không nhập từ ngoại — họ tự tạo từ mới bằng cách ghép các từ cổ Bắc Âu.",
        funFactEn: "Iceland refuses to import foreign words — they coin new terms by combining Old Norse roots.",
        didYouKnow: "'Tölva' (máy tính) ghép từ 'tala' (số) và 'völva' (tiên tri) — nghĩa đen: 'nữ tiên tri của các con số'.",
        didYouKnowEn: "'Tölva' (computer) combines 'tala' (number) and 'völva' (prophetess) — literally: 'prophetess of numbers'.",
        image: "https://images.unsplash.com/photo-1504829857797-ddff29c27927?auto=format&fit=crop&w=800&q=75",
      },
    ],
  },
  ...
  // ==================== ZONE 4: SPECIAL LANDMARKS ====================
  {
    ...
    lessons: [
      ...
      {
        id: "lm-flamenco-es", country: "Tây Ban Nha", countryEn: "Spain", flag: "💃",
        title: "Flamenco — Linh hồn Andalucía",
        titleEn: "Flamenco — Soul of Andalucía",
        summary: "Vũ điệu kết hợp cante (hát), toque (đàn guitar), baile (múa) — biểu tượng nhiệt huyết miền Nam Tây Ban Nha.",
        summaryEn: "A trio of cante (song), toque (guitar), and baile (dance) — the fiery icon of southern Spain.",
        funFact: "UNESCO công nhận Flamenco là Di sản phi vật thể của nhân loại năm 2010.",
        funFactEn: "UNESCO recognized Flamenco as Intangible Cultural Heritage in 2010.",
        didYouKnow: "Flamenco có gốc từ người Roma (Gypsy) định cư ở Andalucía thế kỷ 15 — pha trộn ảnh hưởng Moorish, Do Thái và Castilla.",
        didYouKnowEn: "Flamenco originated from the Roma (Gypsy) people who settled in Andalucía in the 15th century — blending Moorish, Jewish, and Castilian influences.",
        image: "https://images.unsplash.com/photo-1504609813442-a8924e83f76e?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "lm-windmill-nl", country: "Hà Lan", countryEn: "Netherlands", flag: "🌷",
        title: "Cối xay gió Hà Lan",
        titleEn: "Dutch Windmills",
        summary: "Hơn 1.000 cối xay gió cổ vẫn hoạt động — biểu tượng kỹ thuật giúp Hà Lan đẩy nước, xay bột và cưa gỗ suốt 700 năm.",
        summaryEn: "1,000+ historic windmills still operating — engineering icons that pumped water, milled grain, and sawed wood for 700 years.",
        funFact: "Hà Lan có 26% diện tích nằm dưới mực nước biển — cối xay gió đã giúp 'tạo ra' phần lớn đất canh tác.",
        funFactEn: "26% of the Netherlands sits below sea level — windmills literally helped 'create' much of the farmland.",
        didYouKnow: "Cối xay gió Kinderdijk (19 cối) được UNESCO công nhận là Di sản — vẫn dùng hàng năm để sơ tán nước trong tình huống khẩn cấp.",
        didYouKnowEn: "The 19 Kinderdijk windmills are a UNESCO World Heritage site — still used annually for emergency water evacuation.",
        image: "https://images.unsplash.com/photo-1534008897995-27a23e859048?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "lm-tulou-cn", country: "Trung Quốc", countryEn: "China", flag: "🏯",
        title: "Tulou Phúc Kiến — Pháo đài đất",
        titleEn: "Fujian Tulou — Earth fortresses",
        summary: "Hơn 46 ngôi nhà đất tròn khổng lồ của người Hakka, đường kính 70 m, chứa được 800 người trong một 'làng' khép kín.",
        summaryEn: "46+ massive circular Hakka earth buildings, 70 m wide, housing entire 'villages' of 800 people each.",
        funFact: "Tường tulou dày tới 1,8 m — chống được súng đạn, động đất và cả không kích B-2 thời CIA nghĩ là silo tên lửa!",
        funFactEn: "Tulou walls are up to 1.8 m thick — resisting bullets, earthquakes, and even fooling 1980s CIA into thinking they were missile silos!",
        didYouKnow: "Tulou cổ nhất có niên đại 1.200 năm — UNESCO công nhận 46 trong tổng số 20.000 tulou còn tồn tại là Di sản thế giới.",
        didYouKnowEn: "The oldest tulou date back 1,200 years — UNESCO recognized 46 of the 20,000 surviving structures as World Heritage.",
        image: "https://images.unsplash.com/photo-1545569310-78c2018b6d04?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "lm-onsen-jp", country: "Nhật Bản", countryEn: "Japan", flag: "♨️",
        title: "Onsen — Suối nước nóng Nhật",
        titleEn: "Onsen — Japanese hot springs",
        summary: "Hơn 27.000 suối nước nóng tự nhiên trên khắp Nhật Bản — nghi lễ tắm khoáng kết hợp thư giãn thân và tâm.",
        summaryEn: "27,000+ natural hot springs across Japan — a mineral-bath ritual harmonizing body and mind.",
        funFact: "Khỉ tuyết (Macaca fuscata) ở công viên Jigokudani cũng tắm onsen — biểu tượng du lịch nổi tiếng.",
        funFactEn: "Snow monkeys (Macaca fuscata) at Jigokudani Park also bathe in onsen — a famous tourist icon.",
        didYouKnow: "Để được gọi là 'onsen' chính hiệu, nước phải tự nhiên ấm trên 25°C và chứa ít nhất 1 trong 19 khoáng chất do luật quy định.",
        didYouKnowEn: "To be a true 'onsen', water must be naturally above 25°C and contain at least 1 of 19 legally specified minerals.",
        image: "https://images.unsplash.com/photo-1545569310-ce7a6e8fb1e0?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "lm-fado-pt", country: "Bồ Đào Nha", countryEn: "Portugal", flag: "🎶",
        title: "Fado — Tiếng hát saudade",
        titleEn: "Fado — The song of saudade",
        summary: "Thể loại nhạc bi tráng của Lisbon từ thế kỷ 19 — diễn tả 'saudade': nỗi nhớ nhung sâu lắng không thể dịch.",
        summaryEn: "A melancholic music genre from 19th-century Lisbon — expressing 'saudade': a deep, untranslatable longing.",
        funFact: "UNESCO công nhận Fado là Di sản phi vật thể nhân loại năm 2011.",
        funFactEn: "UNESCO inscribed Fado as Intangible Cultural Heritage in 2011.",
        didYouKnow: "Truyền thống Fado: khán giả phải im lặng tuyệt đối — vỗ tay giữa bài hát được coi là rất bất lịch sự.",
        didYouKnowEn: "Fado tradition demands absolute silence from the audience — clapping mid-song is considered deeply rude.",
        image: "https://images.unsplash.com/photo-1555881400-74d7acaacd8b?auto=format&fit=crop&w=800&q=75",
      },
    ],
  },
  ...
  // ==================== ZONE 5: GLOBAL CUISINE ====================
  {
    ...
    lessons: [
      ...
      {
        id: "cui-paella-es", country: "Tây Ban Nha", countryEn: "Spain", flag: "🥘",
        title: "Paella — Linh hồn Valencia",
        titleEn: "Paella — Soul of Valencia",
        summary: "Cơm vàng nghệ tây nấu trong chảo phẳng đáy rộng với gà, thỏ, hải sản — phần cháy 'socarrat' dưới đáy là tinh hoa.",
        summaryEn: "Saffron-yellow rice cooked in a wide flat pan with chicken, rabbit, or seafood — the bottom 'socarrat' crust is the prized treasure.",
        funFact: "Tên 'paella' xuất phát từ tiếng Latin 'patella' (chảo) — không phải tên món ăn.",
        funFactEn: "The name 'paella' comes from the Latin 'patella' (pan) — not the dish itself.",
        didYouKnow: "Người Valencia coi việc thêm chorizo vào paella là 'tội phạm ẩm thực' — chỉ có 10 nguyên liệu chính được công nhận chính thức.",
        didYouKnowEn: "Valencians consider adding chorizo to paella a 'culinary crime' — only 10 ingredients are officially recognized.",
        image: "https://images.unsplash.com/photo-1534080564583-6be75777b70a?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "cui-currywurst-de", country: "Đức", countryEn: "Germany", flag: "🌭",
        title: "Currywurst — Berlin street food",
        titleEn: "Currywurst — Berlin street food",
        summary: "Xúc xích thái lát phủ sốt cà chua trộn bột cà ri — món ăn nhanh huyền thoại sinh ra ở Berlin sau Thế chiến II.",
        summaryEn: "Sliced sausage smothered in curry-spiced ketchup — Berlin's iconic post-WWII fast food.",
        funFact: "Người Đức ăn 800 triệu phần currywurst mỗi năm — Berlin từng có cả bảo tàng riêng cho món này.",
        funFactEn: "Germans consume 800 million servings of currywurst annually — Berlin even had a dedicated museum.",
        didYouKnow: "Currywurst được Herta Heuwer phát minh năm 1949 khi đổi đồ ăn lấy bột cà ri từ binh sĩ Anh — bà đăng ký nhãn hiệu sốt 'Chillup' năm 1959.",
        didYouKnowEn: "Currywurst was invented in 1949 by Herta Heuwer who bartered with British soldiers for curry powder — she trademarked her 'Chillup' sauce in 1959.",
        image: "https://images.unsplash.com/photo-1599921841143-819065280020?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "cui-bibimbap-kr", country: "Hàn Quốc", countryEn: "South Korea", flag: "🍲",
        title: "Bibimbap — Cơm trộn Hàn",
        titleEn: "Bibimbap — Korean mixed rice",
        summary: "Cơm nóng trộn rau ngũ sắc, thịt bò, trứng và sốt gochujang — 'bibim' nghĩa là trộn, 'bap' là cơm.",
        summaryEn: "Hot rice topped with five-color vegetables, beef, egg, and gochujang sauce — 'bibim' means mix, 'bap' means rice.",
        funFact: "Bibimbap là một trong những món được phục vụ trên Korean Air — và cả trên Trạm Vũ trụ Quốc tế ISS.",
        funFactEn: "Bibimbap is served on Korean Air — and even on the International Space Station ISS.",
        didYouKnow: "Phiên bản 'dolsot bibimbap' nấu trong bát đá nóng đến 230°C — tạo lớp cơm cháy giòn 'nurungji' đặc trưng.",
        didYouKnowEn: "The 'dolsot bibimbap' version is cooked in a 230°C stone bowl — creating the signature crispy 'nurungji' rice crust.",
        image: "https://images.unsplash.com/photo-1590301157890-4810ed352733?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "cui-currythai-th", country: "Thái Lan", countryEn: "Thailand", flag: "🌶️",
        title: "Tom Yum & Pad Thai",
        titleEn: "Tom Yum & Pad Thai",
        summary: "Tom Yum: súp chua cay với sả, riềng, lá chanh; Pad Thai: phở xào trứng, đậu, tôm khô — cặp đôi vàng của ẩm thực Thái.",
        summaryEn: "Tom Yum: hot-and-sour soup with lemongrass, galangal, kaffir lime; Pad Thai: stir-fried noodles with egg, peanuts, dried shrimp — Thai cuisine's golden duo.",
        funFact: "Pad Thai được chính phủ tạo ra trong Thế chiến II để giảm tiêu thụ gạo và xây dựng bản sắc dân tộc.",
        funFactEn: "Pad Thai was government-created during WWII to reduce rice consumption and build national identity.",
        didYouKnow: "Ẩm thực Thái cân bằng 5 vị: ngọt, chua, mặn, đắng, cay — mỗi món đều phải đủ cả 5 vị này theo triết lý nấu ăn Thái.",
        didYouKnowEn: "Thai cuisine balances 5 tastes: sweet, sour, salty, bitter, spicy — every dish must include all 5 according to Thai culinary philosophy.",
        image: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?auto=format&fit=crop&w=800&q=75",
      },
      {
        id: "cui-falafel-il", country: "Trung Đông", countryEn: "Middle East", flag: "🧆",
        title: "Falafel & Hummus",
        titleEn: "Falafel & Hummus",
        summary: "Viên đậu gà chiên giòn ăn kèm bánh pita và hummus mịn — món chay biểu tượng vùng Levant suốt 1.000 năm.",
        summaryEn: "Crispy chickpea fritters served with pita and silky hummus — a vegetarian icon of the Levant for 1,000 years.",
        funFact: "Lebanon từng phá kỷ lục Guinness với đĩa hummus nặng 10.452 kg vào năm 2010.",
        funFactEn: "Lebanon set a Guinness record with a 10,452 kg plate of hummus in 2010.",
        didYouKnow: "Có 'cuộc chiến hummus' giữa Israel và Lebanon — tranh cãi gay gắt về quốc gia nào sở hữu công thức gốc.",
        didYouKnowEn: "There's an ongoing 'hummus war' between Israel and Lebanon — hot debate over which nation owns the original recipe.",
        image: "https://images.unsplash.com/photo-1547516508-cef0a92b6147?auto=format&fit=crop&w=800&q=75",
      },
    ],
  },
];
...
const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    id: "q6",
    emoji: "🗽",
    clue: "Tượng đồng xanh cao 93 m do Pháp tặng — biểu tượng tự do bên cảng New York.",
    clueEn: "A 93 m green copper statue gifted by France — symbol of liberty at New York harbor.",
    options: ["Hoa Kỳ", "Canada", "Anh Quốc", "Pháp"],
    optionsEn: ["USA", "Canada", "UK", "France"],
    answerIndex: 0,
  },
  {
    id: "q7",
    emoji: "🐘",
    clue: "Vương quốc Phật giáo có hơn 4.000 ngôi chùa và hệ chữ riêng với 44 phụ âm.",
    clueEn: "A Buddhist kingdom with 4,000+ temples and its own script of 44 consonants.",
    options: ["Việt Nam", "Thái Lan", "Lào", "Campuchia"],
    optionsEn: ["Vietnam", "Thailand", "Laos", "Cambodia"],
    answerIndex: 1,
  },
  {
    id: "q8",
    emoji: "🌷",
    clue: "Quốc gia của tulip, cối xay gió và 26% diện tích nằm dưới mực nước biển.",
    clueEn: "Land of tulips, windmills, and where 26% of the country sits below sea level.",
    options: ["Bỉ", "Hà Lan", "Đan Mạch", "Đức"],
    optionsEn: ["Belgium", "Netherlands", "Denmark", "Germany"],
    answerIndex: 1,
  },
  {
    id: "q9",
    emoji: "🏰",
    clue: "Lâu đài cổ tích trên đỉnh núi Bavaria, nguồn cảm hứng cho lâu đài Disney.",
    clueEn: "A fairytale castle atop a Bavarian peak — the inspiration for Disney's castle.",
    options: ["Pháp", "Áo", "Đức", "Thụy Sĩ"],
    optionsEn: ["France", "Austria", "Germany", "Switzerland"],
    answerIndex: 2,
  },
  {
    id: "q10",
    emoji: "🦒",
    clue: "Cao nguyên Serengeti và núi Kilimanjaro 5.895 m nằm tại quốc gia Đông Phi nào?",
    clueEn: "The Serengeti plains and the 5,895 m Kilimanjaro are in which East African country?",
    options: ["Kenya", "Tanzania", "Uganda", "Ethiopia"],
    optionsEn: ["Kenya", "Tanzania", "Uganda", "Ethiopia"],
    answerIndex: 1,
  },
  {
    id: "q11",
    emoji: "🍷",
    clue: "Quốc gia hình chiếc ủng — quê hương của pizza, pasta và đấu trường Colosseum.",
    clueEn: "The boot-shaped country — home of pizza, pasta, and the Colosseum.",
    options: ["Hy Lạp", "Tây Ban Nha", "Ý", "Bồ Đào Nha"],
    optionsEn: ["Greece", "Spain", "Italy", "Portugal"],
    answerIndex: 2,
  },
  {
    id: "q12",
    emoji: "🌋",
    clue: "Đất nước Nam Mỹ dài và hẹp nhất thế giới, kéo dài 4.300 km dọc Thái Bình Dương.",
    clueEn: "The world's longest, narrowest country — stretching 4,300 km along the Pacific in South America.",
    options: ["Peru", "Argentina", "Chile", "Colombia"],
    optionsEn: ["Peru", "Argentina", "Chile", "Colombia"],
    answerIndex: 2,
  },
];
