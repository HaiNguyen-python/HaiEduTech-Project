...
import {
  ...
  type StudentState, type RLRecommendation
} from "@/lib/rlEngine";
                            ...
                            <Table>
                              ...
                              <TableBody>
                                {studentStates.map((state) => (
                                  <TableRow
                                    key={state.userId}
                                    className={`cursor-pointer transition-colors ${selectedStudent?.userId === state.userId ? "bg-primary/5" : "hover:bg-muted/50"}`}
                                ...
                                <div className="pt-2 border-t border-border">
                                  ...
                                  <div className="flex flex-wrap gap-1">
                                    {selectedStudent.weakestAreas.map(a => (
                                      <span key={a} className="text-xs bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 px-2 py-0.5 rounded-full">
                              ...
                              >
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center gap-2">
                                    {hasHighPriority && <AlertTriangle className="w-4 h-4 text-red-500" />}
