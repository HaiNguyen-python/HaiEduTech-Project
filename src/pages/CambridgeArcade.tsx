...
import {
  ArrowLeft, Heart, Trophy, Sparkles, Star, Volume2, Rocket, Gamepad2,
} from "lucide-react";
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { key: "meteor" as const, emoji: "☄️", title: "Word Meteor", desc: t("Bắn nghĩa đúng cho thiên thạch từ vựng", "Tap the meaning of falling vocabulary meteors"), color: "from-red-500 to-orange-600" },
              ].map((g, idx) => (
                <motion.button
                  key={g.key}
