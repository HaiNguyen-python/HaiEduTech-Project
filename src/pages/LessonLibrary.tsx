          ...
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              <h1 className="text-3xl font-display font-bold mb-2 text-foreground">
                📚 {t("Thư viện bài học Ngôn ngữ & Công nghệ", "Language & Technology Lesson Library")}
              </h1>
              ...
              {loading ? (
                ...
                <div className="text-center py-12">
                  <p className="text-muted-foreground mb-4">{t("Chưa có bài học nào. Hãy tạo bài học từ trang quản trị!", "No lessons yet. Generate lessons from the admin page!")}</p>
                  <Link to="/teacher-admin" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-primary text-primary-foreground text-sm font-semibold hover:brightness-110">
                    {t("Tạo bài học", "Generate Lessons")} <ArrowRight className="w-4 h-4" />
                  </Link>
                </div>
              ) : (
                <>
