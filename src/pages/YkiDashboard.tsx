...
const allVocabModules = [...finnishVocabModules, ...finnishVocabExpansionModules, ...finnishVocabExpansion2Modules, ...finnishVocabExpansion3Modules, ...finnishVocabExpansion4Modules, ...finnishVocabExpansion5Modules, ...finnishVocabExpansion6Modules];
...
const allLessonModules = [...finnishLessonModules, ...finnishLessonExpansionModules, ...finnishLessonExpansion2Modules, ...finnishLessonExpansion3Modules, ...finnishLessonExpansion4Modules, ...finnishLessonExpansion5Modules, ...finnishLessonExpansion6Modules];
...
const VOCAB_IMAGES: Record<string, string> = {
  ...
  etuus: U("photo-1517841905240-472988babdf9"), sairauspäiväraha: U("photo-1576091160399-112ba8d25d1d"),
  ...
  lasku: U("photo-1596524430615-b46475ddff6e"), tarjoilija: U("photo-1559329007-40df8a9345d8"),
  ...
  hammassärky: U("photo-1541872703-74c5e44368f9"), oireet: U("photo-1579684385127-1ef15d508118"),
  päänsärky: U("photo-1616012480717-fd5867611ac7"), vatsa: U("photo-1606216794074-735e91aa2c92"),
  vatsakipu: U("photo-1527168027773-0cc890c4f42e"), yskä: U("photo-1506794778202-cad84cf45f1d"),
  särkylääke: U("photo-1587854692152-cbe660dbde88"), päivystys: U("photo-1529070538774-1843cb3265df"),
  sairausloma: U("photo-1527613426441-4da17471b66d"), verenvuoto: U("photo-1603398938378-e54eab446dde"),
  tajuton: U("photo-1516574187841-cb9cc2ca948b"), myrkytys: U("photo-1521119989659-a83eee488004"),
  elvyttää: U("photo-1516321318423-f06f85e504b3"),
  // Body parts
  pää: U("photo-1544348817-5f2cf14b88c8"), käsi: U("photo-1582213782179-e0d53f98f2ca"),
  jalka: U("photo-1515886657613-9f3515b0c78f"), selkä: U("photo-1484069560501-87d72b0c3669"),
  silmä: U("photo-1494869042583-f6c911f04b4c"), korva: U("photo-1494059980473-813e73ee784b"),
  nenä: U("photo-1516534775068-ba3e7458af70"), suu: U("photo-1581803118522-7b72a50f7e9f"),
  // Nature & Weather
  ...
  kurssi: U("photo-1507413245164-6160d8298b31"), luokka: U("photo-1509062522246-3755977927d7"),
  ...
  arvosana: U("photo-1606326608606-aa0b62935f2b"), luento: U("photo-1528605248644-14dd04022e31"),
  oppitunti: U("photo-1475721027785-f74eccf877e2"), valmistua: U("photo-1523050854058-8df90110c9f1"),
  läksy: U("photo-1494790108377-be9c29b29330"), tentti: U("photo-1517960413843-0aee8e2b3285"),
  lukio: U("photo-1434731071534-dcdcb8e0f104"), lukukausi: U("photo-1554224154-22dec7ec8818"),
  // Shopping
  kauppa: U("photo-1604719312566-8912e9227c6a"), hinta: U("photo-1589939705384-5185137a7f0f"),
  alennus: U("photo-1607083206968-13611e3d76db"), kassa: U("photo-1601598851547-4302969ef0e8"),
  kuitti: U("photo-1572883454114-3ef1f2b0a97c"), käteinen: U("photo-1450101215322-bf5cd27642fc"),
  kortti: U("photo-1556742111-a301076d9d18"), tarjous: U("photo-1556741533-6e6a62e8be5b"),
  ...
  // Public Services
  asumistuki: U("photo-1560518883-ce09059eeffa"), toimeentulotuki: U("photo-1516962215378-7fa2e137ae93"),
  henkilötunnus: U("photo-1633265486064-086b219458ec"), lapsilisä: U("photo-1503454537195-1dcabb73ffb9"),
  opintotuki: U("photo-1495364141860-b0d03eccd065"), viranomainen: U("photo-1506784365847-bbad939e9335"),
  paketti: U("photo-1566576912321-d58ddd7a6088"), osoite: U("photo-1518281361980-b26bfd556770"),
  lähettää: U("photo-1579783902614-a3fb3927b6a5"), allekirjoitus: U("photo-1423666639041-f56000c27a9a"),
  oleskelulupa: U("photo-1569154941061-e231b4725ef1"), työlupa: U("photo-1551882547-ff40c63fe5fa"),
  posti: U("photo-1557200134-90327ee9fafa"), kirje: U("photo-1520250497591-112f2f40a3f4"),
  postimaksu: U("photo-1553729784-e91953dec042"), postilaatikko: U("photo-1518495973542-4542c06a5843"),
  postinumero: U("photo-1519834785169-98be25ec3f84"), noutopiste: U("photo-1553272725-086100aecf5e"),
  asuinkunta: U("photo-1449824913935-59a10b8d2000"), ilmoittautua: U("photo-1557862921-37829c790f19"),
  liite: U("photo-1463453091185-61582044d556"), päätös: U("photo-1507925921958-8a62f3d1a50d"),
  valittaa: U("photo-1573497019418-b400bb3ab074"), valitus: U("photo-1453873531674-2151bcd01707"),
  vastaanottaa: U("photo-1589994965851-a8f479c573a9"),
  // Emergency
  ...
  onnettomuus: U("photo-1436450412740-6b988f486c6b"), ensiapu: U("photo-1533000759938-aa0ba70beceb"),
  vaara: U("photo-1558002038-1055907df827"), palovaroitin: U("photo-1585503418537-88331351ad99"),
  vakuutus: U("photo-1571008887538-b36bb32f4571"), pelastaa: U("photo-1590650153855-d9e808231d41"),
  hätäkeskus: U("photo-1508963493744-76fce69379c0"), hälytys: U("photo-1504439468489-c8920d796a29"),
  hätäuloskäynti: U("photo-1565538810643-b5bdb714032a"), ensiapulaukku: U("photo-1520206183501-b80df61043c2"),
  sammutin: U("photo-1542596594-649edbc13630"), sammuttaa: U("photo-1543269664-56d93c1b41a6"),
  evakuoida: U("photo-1563213126-a4273aed2016"), turvallisuus: U("photo-1530497610245-94d3c16cda28"),
  poliisi: U("photo-1531747056757-908f288c0737"), rikosilmoitus: U("photo-1518199266791-5375a83190d7"),
  varkaus: U("photo-1555949963-ff9fe0c870eb"), loukkaantua: U("photo-1556742393-d75f468bfcb0"),
  kaatua: U("photo-1560185007-cde436f6a4d0"),
  // Social & Feelings
  lahja: U("photo-1513151233558-d860c5398176"), juhla: U("photo-1530103862676-de8c9debad1d"),
  mielipide: U("photo-1521790361543-f645cf042ec4"), iloinen: U("photo-1492681290082-e932832941e6"),
  surullinen: U("photo-1541199249251-f713e6145474"), väsynyt: U("photo-1559418162-0d309d83c14e"),
  ...
  vierailla: U("photo-1543610892-0b1f7e6d8ac1"), jutella: U("photo-1561414927-6d86591d0c4f"),
  // Culture & Finland
  ...
  sauna: U("photo-1535530992057-309c4f7b01e7"), joulu: U("photo-1554475901-4538ddfbccc2"),
  pääsiäinen: U("photo-1457301353672-324d6d14f471"), vappu: U("photo-1504196606672-aef5c9cefc92"),
  kokko: U("photo-1475552113915-6fcb52652ba2"), perinne: U("photo-1539635278303-d4002c07eae3"),
  runeberginpäivä: U("photo-1558961363-fa8fdf82db35"), kansallislaulu: U("photo-1507676184212-d03ab07a01bf"),
  Kalevala: U("photo-1516321497487-e288fb19713f"), Lappi: U("photo-1568667256549-094345857637"),
  // Home & Housing
  ...
  sänky: U("photo-1504805572947-34fad45aed93"), lamppu: U("photo-1507692812060-98338d07aca3"),
  ...
  parveke: U("photo-1499916078039-922301b0eb9b"), avain: U("photo-1522202176988-66273c2fd55f"),
  naapuri: U("photo-1523289961852-7497c2f240c6"), sähkö: U("photo-1473341304170-971dccb5ac1e"),
  vuokra: U("photo-1567427018141-0584cfcbf1b8"), vuokrasopimus: U("photo-1577415124269-fc1140a69e91"),
  taloyhtiö: U("photo-1557199868-02a704bee21f"), remontti: U("photo-1513258496099-48168024aec0"),
  // Common verbs
  puhua: U("photo-1524578271613-d550eacf6090"), syödä: U("photo-1612277795421-9bc7706a4a34"),
  juoda: U("photo-1544145945-f90425340c7e"), mennä: U("photo-1516733968668-dbdce39c0651"),
  tulla: U("photo-1518770660439-4636190af475"), tehdä: U("photo-1581609836488-2f4b4c6b7ed7"),
  lukea: U("photo-1549925862-990da29462a7"), kirjoittaa: U("photo-1455390582262-044cdead277a"),
  asua: U("photo-1542884748-2b87b36c6b90"), opiskella: U("photo-1616803689943-5601631c7fec"),
  työskennellä: U("photo-1559757148-5c8be8f4f4bf"), ostaa: U("photo-1472851294608-062f824d29cc"),
  maksaa: U("photo-1510127034890-ba27508e9f1c"), odottaa: U("photo-1513519245088-0e12902e5a38"),
  auttaa: U("photo-1469571486292-0ba58a3f068b"), nukkua: U("photo-1531685250784-7569952593d2"),
  herätä: U("photo-1506126613408-eca07ce68773"), pestä: U("photo-1576502200916-3808e07386a5"),
  pukea: U("photo-1489987707025-afc232f7ea0f"), kävellä: U("photo-1551884170-09fb70a3a2ed"),
  lähteä: U("photo-1488085061387-422e29b40080"), palata: U("photo-1558036117-15d82a90b9b1"),
  muuttaa: U("photo-1600518464441-9154a4dea21b"), varata: U("photo-1502672260266-1c1ef2d93688"),
  pyytää: U("photo-1544776193-352d25ca82cd"),
  // Common nouns & adjectives
  auto: U("photo-1494976388531-d1058494cdd8"), ihminen: U("photo-1611532736597-de2d4265fba3"),
  lapsi: U("photo-1578763363228-6e8428de69b2"), raha: U("photo-1540270776932-e72e7c2d11cd"),
  kaupunki: U("photo-1477959858617-67f85cf4f1df"), sää: U("photo-1504608524841-42fe6f032b4b"),
  perhe: U("photo-1511895426328-dc8714191300"), ystävä: U("photo-1510511459019-5dda7724fd87"),
  aamu: U("photo-1553830591-d8632a99e6ff"), ilta: U("photo-1493836512294-502baa1986e2"),
  yö: U("photo-1507400492013-162706c8c05e"),
  // Greetings & Phrases
  hei: U("photo-1507120878965-54b2d370786d"), terve: U("photo-1609220136736-443140cffec6"),
  tervetuloa: U("photo-1558618666-fcd25c85f82e"), kiitos: U("photo-1491438590914-bc09fcaaf77a"),
  anteeksi: U("photo-1504307651254-35680f356dfd"),
  // Emotions & Personality
  onnellinen: U("photo-1586034542609-34c4e5fbf1ab"),
  pelokas: U("photo-1556155092-490a1ba16284"),
  ylpeä: U("photo-1585351923350-76af0c7bf7df"),
  rohkea: U("photo-1556761175-5973dc0f32e7"), ujo: U("photo-1517849845537-4d257902454a"),
  ahkera: U("photo-1506929562872-bb421503ef21"), laiska: U("photo-1554260570-9140fd3b7614"),
  kärsivällinen: U("photo-1546410531-bb4caa6b3939"), ystävällinen: U("photo-1527631746610-bca00a040d60"),
  rehellinen: U("photo-1521791055366-0d553872125f"), kiitollinen: U("photo-1568702846914-96b305d2aaeb"),
  stressaantunut: U("photo-1505330622279-bf7d7fc918f4"),
  // Technology
  tietokone: U("photo-1496181133206-80ce9b88a853"), puhelin: U("photo-1511707171634-5f897ff02aa9"),
  sähköposti: U("photo-1596526131083-e8c633c948d2"), salasana: U("photo-1498837167922-ddd27525d352"),
  ...
  näyttö: U("photo-1527443224154-c4a3942d3acf"), ladata: U("photo-1445527815300-e319a6529cd3"),
  tallentaa: U("photo-1511367461989-f85a21fda167"), verkkosivusto: U("photo-1460925895917-afdab827c52f"),
  hakukone: U("photo-1547852355-a54dc00cef42"), tabletti: U("photo-1544244015-0df4b3ffc6b0"),
  päivittää: U("photo-1583337130417-3346a1be7dee"),
  // Travel & Tourism
  hotelli: U("photo-1566073771259-6a8506099945"), majoitus: U("photo-1582719508461-905c673771eb"),
  varaus: U("photo-1532187863486-abf4dbca46c4"), passi: U("photo-1534330207526-8e81f10ec6fc"),
  viisumi: U("photo-1555475149-15447a0a53a3"), matkatoimisto: U("photo-1500382017468-9049fed747ef"),
  opas: U("photo-1551632811-561732d1e306"), nähtävyys: U("photo-1467269204594-9661b134dd2b"),
  retki: U("photo-1473116763249-2faaef81ccda"),
  muistomerkki: U("photo-1519681393784-d120267933ba"),
  museo: U("photo-1506880018603-83d5b814b5a6"), ranta: U("photo-1519315901367-f34ff9154487"),
  vuokrata: U("photo-1486218119243-13883505764c"),
  // Society & Media
  uutiset: U("photo-1495020689067-958852a7765e"), sanomalehti: U("photo-1504711331083-9c895941bf81"),
  vaalit: U("photo-1540910419892-4a36d2c3266c"), äänestää: U("photo-1579783900882-c0d0bae4a2c7"),
  laki: U("photo-1554907984-15263bfd63bd"), oikeus: U("photo-1611162617213-7d7a39e9b1d7"),
  verotus: U("photo-1524995997946-a1c2e315a42f"), kansalainen: U("photo-1516979187457-637abb4f9353"),
  mainos: U("photo-1557838923-2985c318be48"), toimittaja: U("photo-1471107340929-a87cd0f5b5f3"),
  ohjelma: U("photo-1607082349566-187342175e2f"), artikkeli: U("photo-1580508174046-170816f65662"),
  yhteiskunta: U("photo-1582408921715-18e7806365c1"),
  // Family (expansion4)
  ...
  serkku: U("photo-1526543249255-92e3f80b6072"), täti: U("photo-1544005313-94ddf0286df2"),
  setä: U("photo-1560472354-b33ff0c44a43"), anoppi: U("photo-1590523741831-ab7e8b8f9c7f"),
  sisarus: U("photo-1562534057-27c5f2e85d04"), tytär: U("photo-1517457373958-b7bdd4587205"),
  poika: U("photo-1582719471384-894fbb16f7ab"), puoliso: U("photo-1580477667995-2b94f01c9516"),
  // Food expansion
  ...
  // Hobbies expansion
  lenkkeily: U("photo-1535295972055-1c762f4483e5"), uinti: U("photo-1555436169-20e93ea9a7ff"),
  maalaus: U("photo-1474552226712-ac0f0961a954"), peli: U("photo-1511512578047-dfb367046420"),
  kalastus: U("photo-1504309092620-4d0ec726efa4"), pyöräily: U("photo-1541625602330-2277a4c46182"),
  valokuvaus: U("photo-1545205597-3d9d02c29597"), hiihtäminen: U("photo-1577115397428-27ef77a48e86"),
  luistelu: U("photo-1551632436-cbf8dd35adfa"), puutarha: U("photo-1416879595882-3373a0480b5b"),
  lautapeli: U("photo-1610890716171-6b1bb98ffd09"), käsityö: U("photo-1464746133101-a2c3f88e0dd9"),
  // Health expansion
  nuha: U("photo-1482517967863-00e15c9b44be"), polvi: U("photo-1472552944129-b035e9ea3744"),
  // Missing greetings & social
  näkemiin: U("photo-1585421514284-efb74c2b69ba"), kyllä: U("photo-1505693416388-ac5ce068fe85"),
  ei: U("photo-1486325212027-8081e485255e"),
  // Missing travel
  loma: U("photo-1508672019048-805c876b67e2"),
  // Pronouns & Puhekieli base words
  minä: U("photo-1580273916550-e323be2ae537"),
  sinä: U("photo-1558494949-ef010cbdcc31"),
  hän: U("photo-1558459654-c430be5b0e44"),
  me: U("photo-1550751827-4bd374c3f58b"),
  te: U("photo-1555993539-1732b0258235"),
  he: U("photo-1457369804613-52c61a468e7d"),
  tämä: U("photo-1453227588063-bb302b62f50b"),
  tuo: U("photo-1551836022-d5d88e9218df"),
  nyt: U("photo-1494172961521-33799ddd43a5"),
  sitten: U("photo-1494774157365-9e04c6720e47"),
  että: U("photo-1509909756405-be0199881695"),
  olla: U("photo-1531746020798-e6953c6e8e04"),
  se: U("photo-1557683316-973673baf926"),
  mikä: U("photo-1542744173-8e7e53415bb0"),
  kuka: U("photo-1560807707-8cc77767d783"),
  missä: U("photo-1573164713988-8665fc963095"),
  mutta: U("photo-1560472355-536de3962603"),
  ja: U("photo-1573496359142-b8d87734a5a2"),
  tai: U("photo-1560472355-109e0da2ae0e"),
  jos: U("photo-1573164713619-24c711fe7878"),
  kun: U("photo-1573496130141-e59c1e04eab2"),
  koska: U("photo-1573497161161-c3e73707e25c"),
  paljon: U("photo-1560472355-a3b0a7e9f8ae"),
  vähän: U("photo-1573164574511-73c773193279"),
};
