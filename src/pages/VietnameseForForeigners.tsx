...
import "@/data/vietnamese/detailedVFFExpansionV10"; // side-effect: adds City Life module
        ...
        {practice.items.map((item: any, i: number) => (
          <Card key={i} className="p-4">
            ...
            {practice.type === "fill-blank" && (
              <input
                className="w-full border-2 border-emerald-500/50 rounded-lg px-3 py-2 text-sm bg-background text-foreground focus:ring-2 focus:ring-primary/50 outline-none"
