        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {countryStats.map((s, i) => (
                <div key={i} className="bg-card border border-2 border-red-500/55 shadow-[0_3px_14px_-6px_rgba(239,68,68,0.28)] rounded-lg p-3 hover:border-primary/40 transition-colors">
          ...
          <div className="space-y-8 mb-12">
            {regions.map((region, idx) => (
              ...
              >
                <Card className="overflow-hidden border-2 border-red-500/55 shadow-[0_3px_14px_-6px_rgba(239,68,68,0.28)]">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {travelDestinations.map((d, i) => (
                <motion.div key={d.id} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }}>
                  <Card className="h-full border-2 border-red-500/55 shadow-[0_3px_14px_-6px_rgba(239,68,68,0.28)] hover:border-primary/40 transition-colors">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {festivals.map((f, i) => (
                <motion.div key={f.id} initial={{ opacity: 0, scale: 0.97 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }}>
                  <Card className="h-full border-2 border-red-500/55 shadow-[0_3px_14px_-6px_rgba(239,68,68,0.28)] hover:border-rose-500/40 transition-colors">
                    <CardContent className="p-5">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {travelEssentials.map((e, i) => (
                <motion.div key={e.id} initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }}>
                  <Card className="h-full border-2 border-red-500/55 shadow-[0_3px_14px_-6px_rgba(239,68,68,0.28)]">
                    <CardContent className="p-5">
                      ...
                      <div className="space-y-2 mb-4">
                        {e.details.map((d, j) => (
                          <div key={j} className="border-b border-2 border-red-500/45 pb-2 last:border-0">
