...
const CoursesOverview = () => {
  ...
  return (
    <section className="relative overflow-x-clip py-16 sm:py-20">
      ...
      <FloatingChibi src={chibiTeacher} alt="" className="absolute left-[4%] bottom-4 z-20 opacity-90" size={106} delay={0.6} />
      <FloatingChibi src={chibiPanda} alt="" className="absolute right-[4%] top-28 z-20 opacity-90" size={104} delay={1.2} />
      <FloatingChibi src={chibiCoder} alt="" className="absolute right-[4%] bottom-8 z-20 opacity-90" size={92} delay={1.8} flip />
