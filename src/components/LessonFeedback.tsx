        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-4 top-1/2 -translate-y-1/2 z-50 w-[min(360px,calc(100vw-2rem))] max-h-[85vh] flex flex-col rounded-2xl bg-card border-2 border-amber-300/40 shadow-2xl"
            >
              {/* Header */}
