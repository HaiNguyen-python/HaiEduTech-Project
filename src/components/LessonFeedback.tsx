        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-6 sm:right-10 top-[40%] -translate-y-[70%] z-50 w-[min(420px,calc(100vw-3.5rem))] max-h-[calc(100vh-2rem)] flex flex-col overflow-hidden rounded-2xl bg-card border-2 border-amber-300/40 shadow-2xl"
            >
              {/* Header */}
