...
const Navbar = () => {
  ...
  const swedishSubs: SubItem[] = [
    ...
    { to: "/swedish/svenskfinland", label: t("🇸🇪 Svenskfinland — Sống bằng tiếng Thụy Điển", "🇸🇪\u00a0 Life in Swedish") },
  ...
  const programmingSubs: SubItem[] = [
    ...
    { to: "/programming/cybersecurity", label: t("🛡️ Cybersecurity", "🛡️ Cybersecurity"), icon: Shield },
              ...
              <div className="sticky bottom-0 px-4 py-5 border-t border-border bg-background space-y-3">
                {user ? (
                  <>
                    ...
                    {/* Upgrade button hidden — all content is fully free */}
