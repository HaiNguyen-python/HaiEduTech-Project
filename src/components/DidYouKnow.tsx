...
const FACTS: Fact[] = [
  ...
  { emoji: "🇺🇸", category: "culture", vi: "Đại học Harvard ra đời năm 1636 — sớm hơn nước Mỹ đến 140 năm!", en: "Harvard was founded in 1636 — 140 years before the United States existed!", cta: { vi: "Lộ trình SAT", en: "SAT Roadmap", to: "/study-abroad/sat" } },
