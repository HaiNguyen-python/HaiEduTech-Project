...
const MILESTONES = [
  ...
  { words: 25, label: "Ledge 1", band: "A1 Start", x: 30, y: 72 },
  { words: 50, label: "Ledge 2", band: "A1 Mid", x: 45, y: 58 },
  { words: 100, label: "Ledge 3", band: "A1 Ready", x: 55, y: 44 },
  { words: 150, label: "Summit", band: "YKI A2 ⛷️", x: 68, y: 22 },
];
