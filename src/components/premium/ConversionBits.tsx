...
const ROWS: { vi: string; en: string; free: string | boolean; freeEn?: string }[] = [
  { vi: "Bài học mỗi khóa", en: "Lessons per course", free: false },
  { vi: "Đề thi thử", en: "Mock exams", free: false },
  { vi: "Chấm AI Writing/Speaking", en: "AI Writing/Speaking grading", free: false },
  { vi: "AI Speaking Coach (phát âm & IPA)", en: "AI Speaking Coach (pronunciation & IPA)", free: false },
  { vi: "Siêu từ điển & sổ tay học tập", en: "Super Dictionary & study notebook", free: false },
  { vi: "Trò chơi học tập & bảng xếp hạng", en: "Learning games & leaderboards", free: false },
  ...
  { vi: "Tư vấn AI học bổng & nghề nghiệp", en: "AI scholarship & career advisor", free: false },
