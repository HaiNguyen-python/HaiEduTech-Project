...
const DATA: Record<DashboardLanguage, LanguageDataset> = {
  ...
  vietnamese: {
    ...
    skills: [
      {
        key: "listening", label: "Tekstin ymmärtäminen-Listening (YKI)", scaleMax: 6, scaleUnit: "/6 YKI",
      ...
      {
        key: "reading", label: "Reading (YKI)", scaleMax: 6, scaleUnit: "/6 YKI",
      ...
      {
        key: "writing", label: "Kirjoittaminen-Writing (YKI)", scaleMax: 6, scaleUnit: "/6 YKI",
      ...
      {
        key: "speaking", label: "Puhuminen-Speaking (YKI)", scaleMax: 6, scaleUnit: "/6 YKI",
