...
// Curated dataset — figures aggregated from public 2018-2025 reports.
const DATA: Record<DashboardLanguage, LanguageDataset> = {
  english: {
    flag: "🇬🇧",
    exam: "IELTS / TOEFL / PTE / Cambridge",
    ...
    countries: [
      ...
      { name: "Nepal", flag: "🇳🇵", testTakers: 165 },
      { name: "Saudi Arabia", flag: "🇸🇦", testTakers: 140 },
      { name: "Bangladesh", flag: "🇧🇩", testTakers: 125 },
      { name: "Nigeria", flag: "🇳🇬", testTakers: 110 },
    ],
    scoreDistribution: [
      { band: "≤4.5", percent: 6 },
      { band: "5.0", percent: 9 },
    ...
    highlights: [
      ...
      { label: "Avg IELTS Overall (India 2024)", value: "6.3" },
      { label: "PTE Academic growth YoY", value: "+22%" },
      { label: "TOEFL iBT mean score (2024)", value: "88 / 120" },
      { label: "Cambridge B2 First pass rate", value: "78%" },
    ],
    sources: "British Council 2024, IDP IELTS Annual Report 2024, Pearson PTE 2025, ETS TOEFL 2024, Cambridge English",
  },
  chinese: {
    flag: "🇨🇳",
    ...
    countries: [
      ...
      { name: "Indonesia", flag: "🇮🇩", testTakers: 78 },
      { name: "Italy", flag: "🇮🇹", testTakers: 62 },
      { name: "Kazakhstan", flag: "🇰🇿", testTakers: 55 },
      { name: "Pakistan", flag: "🇵🇰", testTakers: 48 },
    ],
    scoreDistribution: [
      { band: "HSK 1", percent: 18 },
    ...
    highlights: [
      ...
      { label: "Confucius Classrooms (K-12)", value: "1,196" },
      { label: "Countries teaching Chinese", value: "180+" },
      { label: "HSK 3.0 levels", value: "9" },
      { label: "Intl students in China (2024)", value: "292K" },
      { label: "China share of global GDP", value: "17.4%" },
    ],
    sources: "Chinese Testing International (HSK) 2024, Hanban / CLEC 2025, China MOE Statistical Bulletin 2024",
  },
  vietnamese: {
    flag: "🇻🇳",
    ...
    countries: [
      ...
      { name: "China", flag: "🇨🇳", testTakers: 3.1 },
      { name: "Germany", flag: "🇩🇪", testTakers: 2.5 },
      { name: "France", flag: "🇫🇷", testTakers: 2.0 },
      { name: "Czech Rep.", flag: "🇨🇿", testTakers: 1.6 },
      { name: "Canada", flag: "🇨🇦", testTakers: 1.4 },
    ],
    scoreDistribution: [
      { band: "A1", percent: 28 },
      { band: "A2", percent: 24 },
    ...
    highlights: [
      ...
      { label: "Korean firms in Vietnam (2024)", value: "9,500+" },
      { label: "Japanese firms in Vietnam", value: "2,400+" },
      { label: "Inbound tourists (2024)", value: "17.6M" },
    ],
    sources: "VNU Hanoi (USSH), Vietnamese Ministry of Education 2024, GSO Vietnam 2024, World Bank 2025",
  },
  finnish: {
    flag: "🇫🇮",
    ...
    countries: [
      ...
      { name: "Philippines", flag: "🇵🇭", testTakers: 0.85 },
      { name: "Ukraine", flag: "🇺🇦", testTakers: 0.78 },
      { name: "Somalia", flag: "🇸🇴", testTakers: 0.62 },
      { name: "Thailand", flag: "🇹🇭", testTakers: 0.55 },
      { name: "Nigeria", flag: "🇳🇬", testTakers: 0.42 },
    ],
    scoreDistribution: [
      { band: "A1", percent: 6 },
      { band: "A2", percent: 16 },
    ...
    highlights: [
      ...
      { label: "YKI growth since 2018", value: "+180%" },
      { label: "Skilled-migration target / yr", value: "30,000" },
      { label: "Citizenship apps (2024)", value: "12,800" },
      { label: "Universities offering EN BSc/MSc", value: "13" },
      { label: "Foreign-born population share", value: "10.1%" },
    ],
    sources: "Opetushallitus (EDUFI) YKI Annual Report 2024, Statistics Finland 2025, Migri 2024",
  },
};
