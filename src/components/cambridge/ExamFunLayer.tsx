    ...
    <AnimatePresence>
      {cheer && (
        <motion.div
          ...
          className="pointer-events-none fixed bottom-24 left-1/2 z-40 -translate-x-1/2 rounded-full border-2 border-white bg-gradient-to-r from-[#FFD93D] via-[#FF9F1C] to-[#FF6B9D] px-6 py-3 text-lg font-black text-white shadow-xl"
        >
