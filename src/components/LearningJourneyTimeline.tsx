...
const LearningJourneyTimeline = () => {
  ...
  return (
    ...
    >
      <div className="glass-card rounded-3xl border-[6px] border-emerald-500 ring-[6px] ring-emerald-500/50 ring-offset-2 ring-offset-background shadow-[0_18px_50px_-8px_rgba(16,185,129,0.6)] px-4 py-8 sm:px-8 sm:py-10 relative overflow-visible">
        {/* Section header */}
