...
const LearningJourneyTimeline = () => {
  ...
  return (
    ...
    >
      <div className="glass-card rounded-3xl border-2 border-emerald-500 shadow-[0_10px_30px_-12px_rgba(16,185,129,0.4)] px-4 py-8 sm:px-8 sm:py-10 relative overflow-visible">
        {/* Section header */}
